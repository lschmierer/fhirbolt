...
impl Resource {
    pub fn id(&self) -> Option<&crate::r4::types::Id> {
        match self {
            ...
            Resource::EffectEvidenceSynthesis(r) => r.id.as_ref(),
            ...
            Resource::MedicinalProduct(r) => r.id.as_ref(),
            Resource::MedicinalProductAuthorization(r) => r.id.as_ref(),
            Resource::MedicinalProductContraindication(r) => r.id.as_ref(),
            Resource::MedicinalProductIndication(r) => r.id.as_ref(),
            Resource::MedicinalProductIngredient(r) => r.id.as_ref(),
            Resource::MedicinalProductInteraction(r) => r.id.as_ref(),
            Resource::MedicinalProductManufactured(r) => r.id.as_ref(),
            Resource::MedicinalProductPackaged(r) => r.id.as_ref(),
            Resource::MedicinalProductPharmaceutical(r) => r.id.as_ref(),
            Resource::MedicinalProductUndesirableEffect(r) => r.id.as_ref(),
            ...
            Resource::RiskEvidenceSynthesis(r) => r.id.as_ref(),
            ...
            Resource::SubstanceNucleicAcid(r) => r.id.as_ref(),
            Resource::SubstancePolymer(r) => r.id.as_ref(),
            Resource::SubstanceProtein(r) => r.id.as_ref(),
            Resource::SubstanceReferenceInformation(r) => r.id.as_ref(),
            Resource::SubstanceSourceMaterial(r) => r.id.as_ref(),
            Resource::SubstanceSpecification(r) => r.id.as_ref(),
