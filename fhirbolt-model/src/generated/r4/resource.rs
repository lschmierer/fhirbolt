...
impl Resource {
    ...
    pub fn meta(&self) -> Option<&crate::r4::types::Meta> {
        match self {
            ...
            Resource::EffectEvidenceSynthesis(r) => r.meta.as_deref(),
            ...
            Resource::MedicinalProduct(r) => r.meta.as_deref(),
            Resource::MedicinalProductAuthorization(r) => r.meta.as_deref(),
            Resource::MedicinalProductContraindication(r) => r.meta.as_deref(),
            Resource::MedicinalProductIndication(r) => r.meta.as_deref(),
            Resource::MedicinalProductIngredient(r) => r.meta.as_deref(),
            Resource::MedicinalProductInteraction(r) => r.meta.as_deref(),
            Resource::MedicinalProductManufactured(r) => r.meta.as_deref(),
            Resource::MedicinalProductPackaged(r) => r.meta.as_deref(),
            Resource::MedicinalProductPharmaceutical(r) => r.meta.as_deref(),
            Resource::MedicinalProductUndesirableEffect(r) => r.meta.as_deref(),
            ...
            Resource::RiskEvidenceSynthesis(r) => r.meta.as_deref(),
            ...
            Resource::SubstanceSpecification(r) => r.meta.as_deref(),
