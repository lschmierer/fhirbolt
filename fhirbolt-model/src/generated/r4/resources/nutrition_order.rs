                        ...
                        match map_access_key {
                            ...
                            Field::ProductName => {
                                if _ctx.from_json {
                                    ...
                                    r#product_name = Some(map_access.next_value()?);
                                }
                            }
                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::BaseFormulaProductName => {
                                if _ctx.from_json {
                                    let some = r#base_formula_product_name
                                    ...
                                    r#base_formula_product_name = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::AdditiveProductName => {
                                if _ctx.from_json {
                                    ...
                                    r#additive_product_name = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::AdministrationInstruction => {
                                if _ctx.from_json {
                                    let some = r#administration_instruction
                                        .get_or_insert(Default::default());
                                    if some.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "administrationInstruction",
                                    ...
                                    r#administration_instruction = Some(map_access.next_value()?);
                                }
                            }
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::serde_context::de::DESERIALIZATION_CONTEXT.with(|_ctx| {
                        ...
                        match map_access_key {
                            ...
                            Field::DateTime => {
                                if _ctx.from_json {
                                    ...
                                    r#date_time = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::AllergyIntolerance => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#allergy_intolerance.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::FoodPreferenceModifier => {
                                if _ctx.from_json {
                                    ...
                                    let vec = r#food_preference_modifier
                                        .get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::ExcludeFoodModifier => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#exclude_food_modifier.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::OralDiet => {
                    ...
                    Ok(NutritionOrder {
                        ...
                        r#encounter,
                        r#date_time: if _ctx.config.mode
                            == fhirbolt_shared::serde_context::de::DeserializationMode::Lax
                        {
