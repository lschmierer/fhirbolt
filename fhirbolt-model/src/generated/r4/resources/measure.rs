                        ...
                        match map_access_key {
                            ...
                            Field::Disclaimer => {
                                if _ctx.from_json {
                                    ...
                                    r#disclaimer = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::RiskAdjustment => {
                                if _ctx.from_json {
                                    ...
                                    r#risk_adjustment = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::RateAggregation => {
                                if _ctx.from_json {
                                    ...
                                    r#rate_aggregation = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::Guidance => {
                                if _ctx.from_json {
                                    ...
                                    r#guidance = Some(map_access.next_value()?);
                                }
                            }
