                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::ProductRelatedness => {
                                if _ctx.from_json {
                                    let some =
                                        r#product_relatedness.get_or_insert(Default::default());
                                    ...
                                    r#product_relatedness = Some(map_access.next_value()?);
                                }
                            }
                        ...
                        match map_access_key {
                            ...
                            Field::Actuality => {
                                if _ctx.from_json {
                                    ...
                                    r#actuality = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::Detected => {
                                if _ctx.from_json {
                                    ...
                                    r#detected = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::ResultingCondition => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#resulting_condition.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::Location => {
                            ...
                            Field::ReferenceDocument => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#reference_document.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::Study => {
