                        ...
                        match map_access_key {
                            ...
                            Field::TimingDate => {
                                if _ctx.from_json {
                                    ...
                                    r#timing = Some(ClaimSupportingInfoTiming::Date(
                                        map_access.next_value()?,
                                    ));
                                }
                            }
                            ...
                            Field::ValueBoolean => {
                                if _ctx.from_json {
                                    ...
                                    r#value = Some(ClaimSupportingInfoValue::Boolean(
                                        map_access.next_value()?,
                                    ));
                                }
                            }
                            ...
                            Field::ValueString => {
                                if _ctx.from_json {
                                    ...
                                    r#value = Some(ClaimSupportingInfoValue::String(
                                        map_access.next_value()?,
                                    ));
                                }
                            }
                        ...
                        match map_access_key {
                            ...
                            Field::CareTeamSequence => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#care_team_sequence.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::DiagnosisSequence => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#diagnosis_sequence.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::ProcedureSequence => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#procedure_sequence.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::InformationSequence => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#information_sequence.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::ServicedDate => {
                                if _ctx.from_json {
                                    ...
                                    r#serviced =
                                        Some(ClaimItemServiced::Date(map_access.next_value()?));
                                }
                            }
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::serde_context::de::DESERIALIZATION_CONTEXT.with(|_ctx| {
                    ...
                    Ok(Claim {
                        ...
                        r#priority: if _ctx.config.mode
                            == fhirbolt_shared::serde_context::de::DeserializationMode::Lax
                        {
