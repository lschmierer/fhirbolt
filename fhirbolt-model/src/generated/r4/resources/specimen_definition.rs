                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(SpecimenDefinitionTypeTested {
                        ...
                        r#is_derived,
                        r#type,
                        r#preference: if config.mode == fhirbolt_shared::DeserializationMode::Lax {
