                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::serde_context::de::DESERIALIZATION_CONTEXT.with(|_ctx| {
                        ...
                        match map_access_key {
                            ...
                            Field::Longitude => {
                                if _ctx.from_json {
                                    ...
                                    r#longitude = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::Latitude => {
                                if _ctx.from_json {
                                    ...
                                    r#latitude = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::Altitude => {
                                if _ctx.from_json {
                                    ...
                                    r#altitude = Some(map_access.next_value()?);
                                }
                            }
                    ...
                    Ok(LocationPosition {
                        ...
                        r#longitude: if _ctx.config.mode
                        ...
                        r#latitude: if _ctx.config.mode
                            == fhirbolt_shared::serde_context::de::DeserializationMode::Lax
                        {
                        ...
                        match map_access_key {
                            ...
                            Field::OpeningTime => {
                                if _ctx.from_json {
                                    ...
                                    r#opening_time = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::ClosingTime => {
                                if _ctx.from_json {
                                    ...
                                    r#closing_time = Some(map_access.next_value()?);
                                }
                            }
                        ...
                        match map_access_key {
                            ...
                            Field::HoursOfOperation => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#hours_of_operation.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
