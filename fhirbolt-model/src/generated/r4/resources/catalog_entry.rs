...
pub struct CatalogEntry {
    ...
    pub r#additional_identifier: Vec<super::super::types::Identifier>,
    ...
    pub r#additional_characteristic: Vec<super::super::types::CodeableConcept>,
    #[doc = "User for example for ATC classification, or."]
    pub r#additional_classification: Vec<super::super::types::CodeableConcept>,
    #[doc = "Used for example, to point to a substance, or to a device used to administer a medication."]
