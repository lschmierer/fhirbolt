                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::serde_context::de::DESERIALIZATION_CONTEXT.with(|_ctx| {
                        ...
                        match map_access_key {
                            ...
                            Field::ExposureState => {
                                if _ctx.from_json {
                                    ...
                                    r#exposure_state = Some(map_access.next_value()?);
                                }
                            }
                    ...
                    Ok(EffectEvidenceSynthesisResultsByExposure {
                        ...
                        r#exposure_state,
                        r#variant_state,
                        r#risk_evidence_synthesis: if _ctx.config.mode
                        ...
                        match map_access_key {
                            ...
                            Field::PrecisionEstimate => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#precision_estimate.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::Unknown(key) => if _ctx.config.mode
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::serde_context::de::DESERIALIZATION_CONTEXT.with(|_ctx| {
                        ...
                        match map_access_key {
                            ...
                            Field::ResultsByExposure => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#results_by_exposure.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                    ...
                    Ok(EffectEvidenceSynthesis {
                        ...
                        r#exposure: if _ctx.config.mode
                            == fhirbolt_shared::serde_context::de::DeserializationMode::Lax
                        {
                        ...
                        r#exposure_alternative: if _ctx.config.mode
                            == fhirbolt_shared::serde_context::de::DeserializationMode::Lax
                        {
