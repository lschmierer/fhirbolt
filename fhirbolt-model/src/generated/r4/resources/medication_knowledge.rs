...
impl Default for MedicationKnowledgeCost {
    fn default() -> Self {
        Self {
            ...
            r#source: Default::default(),
            r#cost: Box::new(super::super::types::Money {
                id: Some("$invalid".to_string()),
                ..Default::default()
            }),
        }
...
impl Default for MedicationKnowledgeRegulatorySchedule {
    fn default() -> Self {
        Self {
            ...
            r#extension: Default::default(),
            r#modifier_extension: Default::default(),
            r#schedule: Box::new(super::super::types::CodeableConcept {
                id: Some("$invalid".to_string()),
                ..Default::default()
            }),
        }
...
pub struct MedicationKnowledgeKinetics {
    ...
    pub r#area_under_curve: Vec<super::super::types::Quantity>,
    #[doc = "The median lethal dose of a drug."]
    pub r#lethal_dose_50: Vec<super::super::types::Quantity>,
...
pub struct MedicationKnowledge {
    ...
    pub r#contraindication: Vec<super::super::types::Reference>,
    #[doc = "Regulatory information about a medication."]
