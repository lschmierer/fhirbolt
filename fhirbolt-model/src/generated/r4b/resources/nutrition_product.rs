                        ...
                        match map_access_key {
                            ...
                            Field::Expiry => {
                                if _ctx.from_json {
                                    ...
                                    r#expiry = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::UseBy => {
                                if _ctx.from_json {
                                    ...
                                    r#use_by = Some(map_access.next_value()?);
                                }
                            }
