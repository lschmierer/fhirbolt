        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.r#substance_definition.as_ref() {
            match some {
                ...
                SubstanceDefinitionRelationshipSubstanceDefinition::CodeableConcept(ref value) => {
