                        ...
                        match map_access_key {
                            ...
                            Field::ReferenceStrength => {
                                if _ctx.from_json {
                                    ...
                                    let vec =
                                        r#reference_strength.get_or_insert(Default::default());
                                    vec.push(map_access.next_value()?);
                                }
                            }
                            Field::Unknown(key) => if _ctx.config.mode
