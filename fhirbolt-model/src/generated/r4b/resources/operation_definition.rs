                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                fhirbolt_shared::serde_context::de::DESERIALIZATION_CONTEXT.with(|_ctx| {
                    ...
                    Ok(OperationDefinitionParameterBinding {
                        ...
                        r#value_set: if _ctx.config.mode
                            == fhirbolt_shared::serde_context::de::DeserializationMode::Lax
                        {
                        ...
                        match map_access_key {
                            ...
                            Field::SearchType => {
                                if _ctx.from_json {
                                    ...
                                    r#search_type = Some(map_access.next_value()?);
                                }
                            }
                        ...
                        match map_access_key {
                            ...
                            Field::ParameterName => {
                                if _ctx.from_json {
                                    ...
                                    if r#parameter_name.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "parameterName",
                                        ));
                                    }
                                    r#parameter_name = Some(map_access.next_value()?);
                                }
                            }
                        ...
                        match map_access_key {
                            ...
                            Field::AffectsState => {
                                if _ctx.from_json {
                                    ...
                                    r#affects_state = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::InputProfile => {
                                if _ctx.from_json {
                                    ...
                                    r#input_profile = Some(map_access.next_value()?);
                                }
                            }
                            ...
                            Field::OutputProfile => {
                                if _ctx.from_json {
                                    ...
                                    r#output_profile = Some(map_access.next_value()?);
                                }
                            }
