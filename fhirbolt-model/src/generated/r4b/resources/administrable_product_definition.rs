                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::ValueDate => {
                                ...
                                if let AdministrableProductDefinitionPropertyValue::Date(variant) =
                                    r#enum
                                {
