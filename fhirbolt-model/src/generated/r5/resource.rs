...
impl Resource {
    ...
    pub fn meta(&self) -> Option<&Box<crate::r5::types::Meta>> {
        match self {
            Resource::Account(r) => r.meta.as_ref(),
            Resource::ActivityDefinition(r) => r.meta.as_ref(),
            Resource::ActorDefinition(r) => r.meta.as_ref(),
            Resource::AdministrableProductDefinition(r) => r.meta.as_ref(),
            ...
            Resource::ArtifactAssessment(r) => r.meta.as_ref(),
            ...
            Resource::BiologicallyDerivedProductDispense(r) => r.meta.as_ref(),
            ...
            Resource::ConditionDefinition(r) => r.meta.as_ref(),
            ...
            Resource::EvidenceReport(r) => r.meta.as_ref(),
            ...
            Resource::FormularyItem(r) => r.meta.as_ref(),
            Resource::GenomicStudy(r) => r.meta.as_ref(),
            ...
            Resource::ImagingSelection(r) => r.meta.as_ref(),
            ...
            Resource::Ingredient(r) => r.meta.as_ref(),
            Resource::InsurancePlan(r) => r.meta.as_ref(),
            Resource::InventoryItem(r) => r.meta.as_ref(),
            Resource::InventoryReport(r) => r.meta.as_ref(),
            ...
            Resource::ManufacturedItemDefinition(r) => r.meta.as_ref(),
            ...
            Resource::MedicinalProductDefinition(r) => r.meta.as_ref(),
            ...
            Resource::NutritionIntake(r) => r.meta.as_ref(),
            Resource::NutritionOrder(r) => r.meta.as_ref(),
            Resource::NutritionProduct(r) => r.meta.as_ref(),
            ...
            Resource::PackagedProductDefinition(r) => r.meta.as_ref(),
            ...
            Resource::Permission(r) => r.meta.as_ref(),
            ...
            Resource::RegulatedAuthorization(r) => r.meta.as_ref(),
            Resource::RelatedPerson(r) => r.meta.as_ref(),
            Resource::RequestOrchestration(r) => r.meta.as_ref(),
            Resource::Requirements(r) => r.meta.as_ref(),
            ...
            Resource::SubscriptionStatus(r) => r.meta.as_ref(),
            Resource::SubscriptionTopic(r) => r.meta.as_ref(),
            Resource::Substance(r) => r.meta.as_ref(),
            Resource::SubstanceDefinition(r) => r.meta.as_ref(),
