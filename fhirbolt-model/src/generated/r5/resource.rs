...
impl Resource {
    pub fn id(&self) -> Option<&crate::r5::types::Id> {
        match self {
            ...
            Resource::ActorDefinition(r) => r.id.as_ref(),
            ...
            Resource::ArtifactAssessment(r) => r.id.as_ref(),
            ...
            Resource::BiologicallyDerivedProductDispense(r) => r.id.as_ref(),
            ...
            Resource::ConditionDefinition(r) => r.id.as_ref(),
            ...
            Resource::FormularyItem(r) => r.id.as_ref(),
            Resource::GenomicStudy(r) => r.id.as_ref(),
            ...
            Resource::ImagingSelection(r) => r.id.as_ref(),
            ...
            Resource::InventoryItem(r) => r.id.as_ref(),
            Resource::InventoryReport(r) => r.id.as_ref(),
            ...
            Resource::NutritionIntake(r) => r.id.as_ref(),
            ...
            Resource::Permission(r) => r.id.as_ref(),
            ...
            Resource::RequestOrchestration(r) => r.id.as_ref(),
            Resource::Requirements(r) => r.id.as_ref(),
