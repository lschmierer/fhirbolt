...
pub struct Dosage {
    ...
    pub r#additional_instruction: Vec<super::super::types::CodeableConcept>,
    ...
    pub r#as_needed_for: Vec<super::super::types::CodeableConcept>,
    ...
    pub r#max_dose_per_period: Vec<super::super::types::Ratio>,
