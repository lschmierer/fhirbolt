...
pub enum ElementDefinitionDefaultValue {
    ...
    Integer64(Box<super::super::types::Integer64>),
...
pub struct ElementDefinitionExample {
    ...
    #[doc = "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension."]
    pub r#extension: Vec<Box<super::super::types::Extension>>,
    #[doc = "Describes the purpose of this example among the set of examples."]
...
pub struct ElementDefinitionConstraint {
    ...
    #[doc = "If true, indicates that the warning or best practice guideline should be suppressed."]
    pub r#suppress: Option<super::super::types::Boolean>,
...
pub struct ElementDefinitionBindingAdditional {
    ...
    #[doc = "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension."]
    pub r#extension: Vec<Box<super::super::types::Extension>>,
    #[doc = "The use of this additional binding."]
    pub r#purpose: super::super::types::Code,
    #[doc = "The valueSet that is being bound for the purpose."]
    pub r#value_set: super::super::types::Canonical,
    #[doc = "Documentation of the purpose of use of the bindingproviding additional information about how it is intended to be used."]
    pub r#documentation: Option<super::super::types::Markdown>,
    #[doc = "Concise documentation - for summary tables."]
    pub r#short_doco: Option<super::super::types::String>,
    #[doc = "Qualifies the usage of the binding. Typically bindings are qualified by jurisdiction, but they may also be qualified by gender, workflow status, clinical domain etc. The information to decide whether a usege context applies is usually outside the resource, determined by context, and this might present challenges for validation tooling."]
    pub r#usage: Vec<Box<super::super::types::UsageContext>>,
...
pub struct ElementDefinition {
    ...
    pub r#path: super::super::types::String,
    #[doc = "Codes that define how this element is represented in instances, when the deviation varies from the normal case. No extensions are allowed on elements with a representation of 'xmlAttr', no matter what FHIR serialization format is used."]
    ...
    #[doc = "Specifies for a primitive data type that the value of the data type cannot be replaced by an extension."]
    pub r#must_have_value: Option<super::super::types::Boolean>,
    #[doc = "Specifies a list of extensions that can appear in place of a primitive value."]
    pub r#value_alternatives: Vec<super::super::types::Canonical>,
    #[doc = "If true, implementations that produce or consume resources SHALL provide \"support\" for the element in some meaningful way. Note that this is being phased out and replaced by obligations (see below).  If false, the element may be ignored and not supported. If false, whether to populate or use the data element in any way is at the discretion of the implementation."]
    pub r#must_support: Option<super::super::types::Boolean>,
    #[doc = "If true, the value of this element affects the interpretation of the element or resource that contains it, and the value of the element cannot be ignored. Typically, this is used for status, negation and qualification codes. The effect of this is that the element cannot be ignored by systems: they SHALL either recognize the element and process it, and/or a pre-determination has been made that it is not relevant to their particular system. When used on the root element in an extension definition, this indicates whether or not the extension is a modifier extension."]
