...
#[doc = "Identifies the observation(s) that triggered the performance of this observation."]
...
pub struct ObservationTriggeredBy {
    ...
    #[doc = "Reference to the triggering observation."]
    pub r#observation: Box<super::super::types::Reference>,
    #[doc = "The type of trigger.\nReflex | Repeat | Re-run."]
    pub r#type: super::super::types::Code,
    #[doc = "Provides the reason why this observation was performed as a result of the observation(s) referenced."]
...
impl Default for ObservationTriggeredBy {
    fn default() -> Self {
        Self {
            ...
            r#observation: Box::new(super::super::types::Reference {
...
pub struct ObservationReferenceRange {
    ...
    #[doc = "The value of the normal value of the reference range."]
    pub r#normal_value: Option<Box<super::super::types::CodeableConcept>>,
    ...
    pub r#text: Option<super::super::types::Markdown>,
}
#[allow(clippy::derivable_impls)]
impl Default for ObservationReferenceRange {
    fn default() -> Self {
        Self {
            ...
            r#normal_value: Default::default(),
...
pub struct Observation {
    ...
    #[doc = "The reference to a FHIR ObservationDefinition resource that provides the definition that is adhered to in whole or in part by this Observation instance."]
    pub r#instantiates: Option<ObservationInstantiates>,
    ...
    #[doc = "Identifies the observation(s) that triggered the performance of this observation."]
    pub r#triggered_by: Vec<ObservationTriggeredBy>,
    ...
    #[doc = "Indicates the body structure on the subject's body where the observation was made (i.e. the target site)."]
    ...
    #[doc = "A reference to the device that generates the measurements or the device settings for the device."]
...
impl Default for Observation {
    fn default() -> Self {
        Self {
            ...
            r#triggered_by: Default::default(),
