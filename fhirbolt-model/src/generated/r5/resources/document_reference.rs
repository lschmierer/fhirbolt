...
pub struct DocumentReference {
    ...
    pub r#modality: Vec<Box<super::super::types::CodeableConcept>>,
    ...
    pub r#context: Vec<Box<super::super::types::Reference>>,
    ...
    pub r#event: Vec<Box<super::super::types::CodeableReference>>,
    #[doc = "The anatomic structures included in the document."]
    pub r#body_site: Vec<Box<super::super::types::CodeableReference>>,
