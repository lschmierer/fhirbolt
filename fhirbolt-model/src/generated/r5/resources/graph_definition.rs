...
pub struct GraphDefinitionNode {
    ...
    #[doc = "Internal ID of node - target for link references."]
    pub r#node_id: super::super::types::Id,
    #[doc = "Information about why this node is of interest in this graph definition."]
...
impl Default for GraphDefinitionNode {
    fn default() -> Self {
        Self {
            ...
            r#node_id: super::super::types::Id {
...
pub struct GraphDefinitionLink {
    ...
    #[doc = "The source node for this link."]
    pub r#source_id: super::super::types::Id,
    #[doc = "A FHIRPath expression that identifies one of FHIR References to other resources."]
    pub r#path: Option<super::super::types::String>,
    #[doc = "Which slice (if profiled)."]
    pub r#slice_name: Option<super::super::types::String>,
    #[doc = "The target node for this link."]
...
impl Default for GraphDefinitionLink {
    fn default() -> Self {
        Self {
            ...
            r#source_id: super::super::types::Id {
                id: Some("$invalid".to_string()),
                ..Default::default()
            },
...
pub struct GraphDefinition {
    ...
    #[doc = "A formal identifier that is used to identify this GraphDefinition when it is represented in other formats, or referenced in a specification, model, design or an instance."]
    ...
    #[doc = "Indicates the mechanism used to compare versions to determine which is more current."]
    pub r#version_algorithm: Option<GraphDefinitionVersionAlgorithm>,
    ...
    #[doc = "The date  (and optionally time) when the graph definition was last significantly changed. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the graph definition changes."]
    pub r#date: Option<super::super::types::DateTime>,
    #[doc = "The name of the organization or individual responsible for the release and ongoing maintenance of the graph definition."]
    ...
    #[doc = "A copyright statement relating to the graph definition and/or its contents. Copyright statements are generally legal restrictions on the use and publishing of the graph definition."]
    ...
    #[doc = "The Node at which instances of this graph start. If there is no nominated start, the graph can start at any of the nodes."]
    pub r#start: Option<super::super::types::Id>,
    #[doc = "Potential target for the link."]
