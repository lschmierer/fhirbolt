...
pub struct InsurancePlanPlanSpecificCostBenefitCost {
    ...
    pub r#qualifiers: Vec<super::super::types::CodeableConcept>,
...
pub struct InsurancePlan {
    ...
    pub r#coverage_area: Vec<super::super::types::Reference>,
    #[doc = "The contact details of communication devices available relevant to the specific Insurance Plan/Product. This can include addresses, phone numbers, fax numbers, mobile numbers, email addresses and web sites."]
