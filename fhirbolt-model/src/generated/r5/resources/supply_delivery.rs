...
pub struct SupplyDeliverySuppliedItem {
    ...
    #[doc = "The amount of the item that has been supplied.  Unit of measure may be included."]
...
pub struct SupplyDelivery {
    ...
    #[doc = "Indicates the type of supply being provided.  Examples include: Medication, Device, Biologically Derived Product."]
    pub r#type: Option<Box<super::super::types::CodeableConcept>>,
    #[doc = "The item that is being delivered or has been supplied."]
    pub r#supplied_item: Vec<SupplyDeliverySuppliedItem>,
    #[doc = "The date or time(s) the activity occurred."]
    pub r#occurrence: Option<SupplyDeliveryOccurrence>,
    #[doc = "The individual or organization responsible for supplying the delivery."]
    pub r#supplier: Option<Box<super::super::types::Reference>>,
    #[doc = "Identification of the facility/location where the delivery was shipped to."]
