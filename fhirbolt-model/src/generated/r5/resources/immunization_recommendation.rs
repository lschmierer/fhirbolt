...
pub struct ImmunizationRecommendationRecommendation {
    ...
    #[doc = "Nominal position of the recommended dose in a series as determined by the evaluation and forecasting process (e.g. dose 2 is the next recommended dose)."]
    pub r#dose_number: Option<super::super::types::String>,
    #[doc = "The recommended number of doses to achieve immunity as determined by the evaluation and forecasting process."]
