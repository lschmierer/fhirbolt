...
impl Default for AuditEventOccurred {
    fn default() -> AuditEventOccurred {
        AuditEventOccurred::Invalid
    }
}
...
impl Default for AuditEventAgentNetwork {
    fn default() -> AuditEventAgentNetwork {
        AuditEventAgentNetwork::Invalid
    }
}
