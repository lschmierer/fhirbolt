...
pub struct FormularyItem {
    ...
    #[doc = "Business identifier for this formulary item."]
    pub r#identifier: Vec<super::super::types::Identifier>,
    #[doc = "A code (or set of codes) that specify the product or service that is identified by this formulary item."]
