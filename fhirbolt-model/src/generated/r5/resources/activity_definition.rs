...
impl Default for ActivityDefinitionVersionAlgorithm {
    fn default() -> ActivityDefinitionVersionAlgorithm {
        ActivityDefinitionVersionAlgorithm::Invalid
    }
}
...
#[doc = "The timing or frequency upon which the described activity is to occur."]
#[derive(Debug, Clone, PartialEq)]
...
impl Default for ActivityDefinitionAsNeeded {
    fn default() -> ActivityDefinitionAsNeeded {
        ActivityDefinitionAsNeeded::Invalid
    }
}
...
pub struct ActivityDefinition {
    ...
    #[doc = "Indicates the mechanism used to compare versions to determine which is more current."]
    pub r#version_algorithm: Option<ActivityDefinitionVersionAlgorithm>,
    ...
    #[doc = "The date  (and optionally time) when the activity definition was last significantly changed. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the activity definition changes."]
    pub r#date: Option<super::super::types::DateTime>,
    #[doc = "The name of the organization or individual responsible for the release and ongoing maintenance of the activity definition."]
    ...
    #[doc = "A description of the kind of resource the activity definition is representing. For example, a MedicationRequest, a ServiceRequest, or a CommunicationRequest."]
    ...
    #[doc = "If a CodeableConcept is present, it indicates the pre-condition for performing the service.  For example \"pain\", \"on flare-up\", etc."]
    pub r#as_needed: Option<ActivityDefinitionAsNeeded>,
    ...
    pub r#specimen_requirement: Vec<super::super::types::Canonical>,
    #[doc = "Defines observation requirements for the action to be performed, such as body weight or surface area."]
    pub r#observation_requirement: Vec<super::super::types::Canonical>,
    #[doc = "Defines the observations that are expected to be produced by the action."]
    pub r#observation_result_requirement: Vec<super::super::types::Canonical>,
