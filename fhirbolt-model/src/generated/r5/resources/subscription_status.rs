...
pub struct SubscriptionStatusNotificationEvent {
    ...
    #[doc = "Either the sequential number of this event in this subscription context or a relative event number for this notification."]
    pub r#event_number: super::super::types::Integer64,
    #[doc = "The actual time this event occurred on the server."]
...
pub struct SubscriptionStatus {
    ...
    #[doc = "The type of event being conveyed with this notification."]
    ...
    pub r#events_since_subscription_start: Option<super::super::types::Integer64>,
    #[doc = "Detailed information about events relevant to this subscription notification."]
