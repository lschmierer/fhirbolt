...
impl Default for TestReportSetupActionAssertRequirementLink {
    fn default() -> TestReportSetupActionAssertRequirementLink {
        TestReportSetupActionAssertRequirementLink::Invalid
    }
}
