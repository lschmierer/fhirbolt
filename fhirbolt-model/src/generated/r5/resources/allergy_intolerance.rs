...
pub struct AllergyIntoleranceParticipant {
    ...
    #[doc = "Distinguishes the type of involvement of the actor in the activities related to the allergy or intolerance."]
...
pub struct AllergyIntoleranceReaction {
    ...
    pub r#manifestation: Vec<Box<super::super::types::CodeableReference>>,
...
pub struct AllergyIntolerance {
    ...
    #[doc = "Assertion about certainty associated with the propensity, or potential risk, of a reaction to the identified substance (including pharmaceutical product).  The verification status pertains to the allergy or intolerance, itself, not to any specific AllergyIntolerance attribute."]
    ...
    #[doc = "Indicates who or what participated in the activities related to the allergy or intolerance and how they were involved."]
    pub r#participant: Vec<AllergyIntoleranceParticipant>,
