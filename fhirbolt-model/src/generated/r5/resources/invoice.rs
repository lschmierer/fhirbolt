...
impl Default for InvoicePeriod {
    fn default() -> InvoicePeriod {
        InvoicePeriod::Invalid
    }
}
...
impl Default for InvoiceLineItemServiced {
    fn default() -> InvoiceLineItemServiced {
        InvoiceLineItemServiced::Invalid
    }
}
...
pub struct InvoiceLineItem {
    ...
    pub r#price_component: Vec<Box<super::super::types::MonetaryComponent>>,
}
...
pub struct Invoice {
    ...
    pub r#total_price_component: Vec<Box<super::super::types::MonetaryComponent>>,
