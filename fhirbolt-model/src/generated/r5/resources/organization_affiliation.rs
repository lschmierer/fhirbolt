...
pub struct OrganizationAffiliation {
    ...
    #[doc = "The network in which the participatingOrganization provides the role's services (if defined) at the indicated locations (if defined)."]
    pub r#network: Vec<super::super::types::Reference>,
    ...
    pub r#healthcare_service: Vec<super::super::types::Reference>,
    #[doc = "The contact details of communication devices available at the participatingOrganization relevant to this Affiliation."]
