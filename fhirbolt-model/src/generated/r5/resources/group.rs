...
pub struct Group {
    ...
    pub r#modifier_extension: Vec<super::super::types::Extension>,
    #[doc = "Business identifiers assigned to this participant by one of the applications involved.  These identifiers remain constant as the resource is updated and propagates from server to server."]
    ...
    #[doc = "Explanation of what the group represents and how it is intended to be used."]
...
impl Default for Group {
    fn default() -> Self {
        Self {
            ...
            r#membership: super::super::types::Code {
                id: Some("$invalid".to_string()),
                ..Default::default()
            },
