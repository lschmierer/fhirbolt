...
impl Default for LibraryVersionAlgorithm {
    fn default() -> LibraryVersionAlgorithm {
        LibraryVersionAlgorithm::Invalid
    }
}
...
impl Default for LibrarySubject {
    fn default() -> LibrarySubject {
        LibrarySubject::Invalid
    }
}
...
pub struct Library {
    ...
    #[doc = "Indicates the mechanism used to compare versions to determine which is more current."]
    pub r#version_algorithm: Option<LibraryVersionAlgorithm>,
    ...
    #[doc = "The date  (and optionally time) when the library was last significantly changed. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the library changes."]
    pub r#date: Option<super::super::types::DateTime>,
    #[doc = "The name of the organization or individual responsible for the release and ongoing maintenance of the library."]
