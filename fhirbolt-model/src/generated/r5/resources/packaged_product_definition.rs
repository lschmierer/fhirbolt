...
impl Default for PackagedProductDefinitionPackagingPropertyValue {
    fn default() -> PackagedProductDefinitionPackagingPropertyValue {
        PackagedProductDefinitionPackagingPropertyValue::Invalid
    }
}
...
pub struct PackagedProductDefinitionPackagingProperty {
    ...
    #[doc = "A value for the characteristic."]
    pub r#value: Option<PackagedProductDefinitionPackagingPropertyValue>,
}
...
pub struct PackagedProductDefinitionPackagingContainedItem {
    ...
    #[doc = "The number of this type of item within this packaging or for continuous items such as liquids it is the quantity (for example 25ml). See also PackagedProductDefinition.containedItemQuantity (especially the long definition)."]
...
pub struct PackagedProductDefinitionPackaging {
    ...
    #[doc = "May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions.\n\nModifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself)."]
    pub r#modifier_extension: Vec<Box<super::super::types::Extension>>,
    #[doc = "A business identifier that is specific to this particular part of the packaging, often assigned by the manufacturer. Including possibly Data Carrier Identifier (a GS1 barcode)."]
    pub r#identifier: Vec<Box<super::super::types::Identifier>>,
    #[doc = "The physical type of the container of the items."]
    pub r#type: Option<Box<super::super::types::CodeableConcept>>,
    #[doc = "Is this a part of the packaging (e.g. a cap or bottle stopper), rather than the packaging itself (e.g. a bottle or vial). The latter type are designed be a container, but the former are not."]
    pub r#component_part: Option<super::super::types::Boolean>,
    #[doc = "The quantity of packaging items contained at this layer of the package. This does not relate to the number of contained items but relates solely to the number of packaging items. When looking at the outermost layer it is always 1. If there are two boxes within, at the next layer it would be 2."]
    ...
    #[doc = "Manufacturer of this packaging item. When there are multiple values each one is a potential manufacturer of this packaging item."]
    pub r#manufacturer: Vec<Box<super::super::types::Reference>>,
    #[doc = "General characteristics of this item."]
    pub r#property: Vec<PackagedProductDefinitionPackagingProperty>,
    #[doc = "The item(s) within the packaging."]
    pub r#contained_item: Vec<PackagedProductDefinitionPackagingContainedItem>,
    #[doc = "Allows containers (and parts of containers) within containers, still as a part of a single packaged product. See also PackagedProductDefinition.packaging.containedItem.item(PackagedProductDefinition)."]
    pub r#packaging: Vec<PackagedProductDefinitionPackaging>,
}
...
pub struct PackagedProductDefinition {
    ...
    pub r#modifier_extension: Vec<Box<super::super::types::Extension>>,
    #[doc = "A unique identifier for this package as whole - not the the content of the package. Unique instance identifiers assigned to a package by manufacturers, regulators, drug catalogue custodians or other organizations."]
    pub r#identifier: Vec<Box<super::super::types::Identifier>>,
    ...
    pub r#type: Option<Box<super::super::types::CodeableConcept>>,
    #[doc = "The product this package model relates to, not the contents of the package (for which see package.containedItem)."]
    ...
    #[doc = "Identifies if the package contains different items, such as when a drug product is supplied with another item e.g. a diluent or adjuvant."]
    ...
    pub r#manufacturer: Vec<Box<super::super::types::Reference>>,
    #[doc = "Additional information or supporting documentation about the packaged product."]
    pub r#attached_document: Vec<Box<super::super::types::Reference>>,
    #[doc = "A packaging item, as a container for medically related items, possibly with other packaging items within, or a packaging component, such as bottle cap (which is not a device or a medication manufactured item)."]
    pub r#packaging: Option<PackagedProductDefinitionPackaging>,
    #[doc = "Allows the key features to be recorded, such as \"hospital pack\", \"nurse prescribable\", \"calendar pack\"."]
    pub r#characteristic: Vec<PackagedProductDefinitionPackagingProperty>,
}
