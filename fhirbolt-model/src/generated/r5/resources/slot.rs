...
pub struct Slot {
    ...
    #[doc = "The type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a location, rather than the location itself). If provided then this overrides the value provided on the Schedule resource."]
    pub r#service_type: Vec<Box<super::super::types::CodeableReference>>,
    ...
    pub r#appointment_type: Vec<Box<super::super::types::CodeableConcept>>,
