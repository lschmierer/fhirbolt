...
impl Default for PaymentReconciliationAllocationTargetItem {
    fn default() -> PaymentReconciliationAllocationTargetItem {
        PaymentReconciliationAllocationTargetItem::Invalid
    }
}
