...
impl crate::model::ResourceOrElement for EventDefinitionSubject {}
impl Default for EventDefinitionSubject {
    fn default() -> EventDefinitionSubject {
        EventDefinitionSubject::Invalid
    }
}
...
impl crate::model::ResourceOrElement for EventDefinition {}
impl serde::ser::Serialize for EventDefinition {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.r#subject.as_ref() {
            match some {
                EventDefinitionSubject::CodeableConcept(ref value) => {
                    state.serialize_entry("subjectCodeableConcept", value)?;
                }
                EventDefinitionSubject::Reference(ref value) => {
...
impl<'de> serde::de::Deserialize<'de> for EventDefinition {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#subject: Option<EventDefinitionSubject> = None;
                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::SubjectCodeableConcept => {
                                ...
                                r#subject = Some(EventDefinitionSubject::CodeableConcept(
                                    map_access.next_value()?,
                                ));
                            }
                            Field::SubjectReference => {
                                ...
                                r#subject = Some(EventDefinitionSubject::Reference(
                                    map_access.next_value()?,
                                ));
                            }
                            Field::Date => {
