...
impl crate::model::ResourceOrElement for BundleLink {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(BundleLink {
                        ...
                        r#relation: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for BundleEntrySearch {}
...
impl crate::model::ResourceOrElement for BundleEntryRequest {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(BundleEntryRequest {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#method: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for BundleEntryResponse {}
...
impl crate::model::ResourceOrElement for BundleEntry {}
...
impl crate::model::ResourceOrElement for Bundle {}
