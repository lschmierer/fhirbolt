...
impl crate::model::ResourceOrElement for DeviceUseStatementTiming {}
...
impl crate::model::ResourceOrElement for DeviceUseStatement {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(DeviceUseStatement {
                        ...
                        r#recorded_on,
                        r#source,
                        r#device: if config.mode == crate::DeserializationMode::Lax {
