...
impl crate::model::ResourceOrElement for ConsentSource {}
...
impl crate::model::ResourceOrElement for ConsentPolicy {}
...
impl crate::model::ResourceOrElement for ConsentVerification {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ConsentVerification {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#verified: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ConsentProvisionActor {}
...
impl crate::model::ResourceOrElement for ConsentProvisionData {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ConsentProvisionData {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#meaning: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ConsentProvision {}
...
impl crate::model::ResourceOrElement for Consent {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(Consent {
                        ...
                        r#scope: if config.mode == crate::DeserializationMode::Lax {
