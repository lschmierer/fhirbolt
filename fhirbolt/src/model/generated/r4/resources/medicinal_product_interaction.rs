...
impl crate::model::ResourceOrElement for MedicinalProductInteractionInteractantItem {}
...
impl crate::model::ResourceOrElement for MedicinalProductInteractionInteractant {}
                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::ItemReference => {
                                ...
                                r#item =
                                    Some(MedicinalProductInteractionInteractantItem::Reference(
                            ...
                            Field::ItemCodeableConcept => {
                                ...
                                r#item = Some(
                                    MedicinalProductInteractionInteractantItem::CodeableConcept(
                                        map_access.next_value()?,
                                    ),
                                );
                            }
...
impl crate::model::ResourceOrElement for MedicinalProductInteraction {}
