...
impl crate::model::ResourceOrElement for PaymentReconciliationDetail {}
...
impl crate::model::ResourceOrElement for PaymentReconciliationProcessNote {}
...
impl crate::model::ResourceOrElement for PaymentReconciliation {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(PaymentReconciliation {
                        ...
                        r#outcome,
                        r#disposition,
                        r#payment_date: if config.mode == crate::DeserializationMode::Lax {
                            r#payment_date.unwrap_or(Default::default())
                        } else {
                            r#payment_date.ok_or(serde::de::Error::missing_field("paymentDate"))?
                        },
                        r#payment_amount: if config.mode == crate::DeserializationMode::Lax {
