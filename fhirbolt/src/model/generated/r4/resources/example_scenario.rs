...
impl crate::model::ResourceOrElement for ExampleScenarioActor {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExampleScenarioActor {
                        ...
                        r#actor_id: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExampleScenarioInstanceVersion {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExampleScenarioInstanceVersion {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#version_id: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExampleScenarioInstanceContainedInstance {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExampleScenarioInstanceContainedInstance {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#resource_id: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExampleScenarioInstance {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExampleScenarioInstance {
                        ...
                        r#resource_type: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExampleScenarioProcessStepOperation {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExampleScenarioProcessStepOperation {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#number: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExampleScenarioProcessStepAlternative {}
...
impl crate::model::ResourceOrElement for ExampleScenarioProcessStep {}
...
impl crate::model::ResourceOrElement for ExampleScenarioProcess {}
...
impl crate::model::ResourceOrElement for ExampleScenario {}
