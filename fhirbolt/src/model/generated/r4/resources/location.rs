...
impl crate::model::ResourceOrElement for LocationPosition {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(LocationPosition {
                        ...
                        r#longitude: if config.mode == crate::DeserializationMode::Lax {
                            r#longitude.unwrap_or(Default::default())
                        } else {
                            r#longitude.ok_or(serde::de::Error::missing_field("longitude"))?
                        },
                        r#latitude: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for LocationHoursOfOperation {}
...
impl crate::model::ResourceOrElement for Location {}
