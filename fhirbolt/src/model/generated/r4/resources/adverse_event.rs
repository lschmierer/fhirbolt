...
impl crate::model::ResourceOrElement for AdverseEventSuspectEntityCausality {}
...
impl crate::model::ResourceOrElement for AdverseEventSuspectEntity {}
...
impl crate::model::ResourceOrElement for AdverseEvent {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(AdverseEvent {
                        ...
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#identifier,
                        r#actuality: if config.mode == crate::DeserializationMode::Lax {
