...
impl crate::model::ResourceOrElement for ProvenanceOccurred {}
...
impl crate::model::ResourceOrElement for ProvenanceAgent {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ProvenanceAgent {
                        ...
                        r#who: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ProvenanceEntity {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ProvenanceEntity {
                        ...
                        r#what: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Provenance {}
