...
impl crate::model::ResourceOrElement for MedicationDispenseStatusReason {}
...
impl crate::model::ResourceOrElement for MedicationDispenseMedication {}
...
impl crate::model::ResourceOrElement for MedicationDispensePerformer {}
...
impl crate::model::ResourceOrElement for MedicationDispenseSubstitution {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MedicationDispenseSubstitution {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#was_substituted: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MedicationDispense {}
