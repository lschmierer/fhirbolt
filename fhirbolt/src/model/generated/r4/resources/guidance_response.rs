...
impl crate::model::ResourceOrElement for GuidanceResponseModule {}
...
impl crate::model::ResourceOrElement for GuidanceResponse {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(GuidanceResponse {
                        ...
                        r#module: if config.mode == crate::DeserializationMode::Lax {
