...
impl crate::model::ResourceOrElement for MessageHeaderEvent {}
...
impl crate::model::ResourceOrElement for MessageHeaderDestination {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MessageHeaderDestination {
                        ...
                        r#name,
                        r#target,
                        r#endpoint: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MessageHeaderSource {}
...
impl crate::model::ResourceOrElement for MessageHeaderResponse {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MessageHeaderResponse {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#identifier: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MessageHeader {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MessageHeader {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#event: if config.mode == crate::DeserializationMode::Lax {
