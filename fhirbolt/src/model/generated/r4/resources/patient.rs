...
impl crate::model::ResourceOrElement for PatientDeceased {}
...
impl crate::model::ResourceOrElement for PatientMultipleBirth {}
...
impl crate::model::ResourceOrElement for PatientContact {}
...
impl crate::model::ResourceOrElement for PatientCommunication {}
...
impl crate::model::ResourceOrElement for PatientLink {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(PatientLink {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#other: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Patient {}
