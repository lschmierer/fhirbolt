...
impl crate::model::ResourceOrElement for ResearchSubject {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ResearchSubject {
                        ...
                        r#period,
                        r#study: if config.mode == crate::DeserializationMode::Lax {
                            r#study.unwrap_or(Default::default())
                        } else {
                            r#study.ok_or(serde::de::Error::missing_field("study"))?
                        },
                        r#individual: if config.mode == crate::DeserializationMode::Lax {
