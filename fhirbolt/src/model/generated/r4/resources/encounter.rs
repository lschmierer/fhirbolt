...
impl crate::model::ResourceOrElement for EncounterStatusHistory {}
...
impl crate::model::ResourceOrElement for EncounterClassHistory {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(EncounterClassHistory {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#class: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for EncounterParticipant {}
...
impl crate::model::ResourceOrElement for EncounterDiagnosis {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(EncounterDiagnosis {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#condition: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for EncounterHospitalization {}
...
impl crate::model::ResourceOrElement for EncounterLocation {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(EncounterLocation {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#location: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Encounter {}
