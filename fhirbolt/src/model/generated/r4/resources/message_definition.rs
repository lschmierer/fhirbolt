...
impl crate::model::ResourceOrElement for MessageDefinitionEvent {}
...
impl crate::model::ResourceOrElement for MessageDefinitionFocus {}
...
impl crate::model::ResourceOrElement for MessageDefinitionAllowedResponse {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MessageDefinitionAllowedResponse {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#message: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MessageDefinition {}
