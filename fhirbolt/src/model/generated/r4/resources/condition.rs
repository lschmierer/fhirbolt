...
impl crate::model::ResourceOrElement for ConditionOnset {}
...
impl crate::model::ResourceOrElement for ConditionAbatement {}
...
impl crate::model::ResourceOrElement for ConditionStage {}
...
impl crate::model::ResourceOrElement for ConditionEvidence {}
...
impl crate::model::ResourceOrElement for Condition {}
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::OnsetDateTime => {
                                let r#enum = r#onset
                                    .get_or_insert(ConditionOnset::DateTime(Default::default()));
