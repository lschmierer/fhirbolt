...
impl crate::model::ResourceOrElement for LinkageItem {}
...
impl<'de> serde::de::Deserialize<'de> for LinkageItem {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(LinkageItem {
                        ...
                        r#resource: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Linkage {}
...
impl<'de> serde::de::Deserialize<'de> for Linkage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
