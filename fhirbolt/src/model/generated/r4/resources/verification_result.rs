...
impl crate::model::ResourceOrElement for VerificationResultPrimarySource {}
...
impl crate::model::ResourceOrElement for VerificationResultAttestation {}
...
impl crate::model::ResourceOrElement for VerificationResultValidator {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(VerificationResultValidator {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#organization: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for VerificationResult {}
