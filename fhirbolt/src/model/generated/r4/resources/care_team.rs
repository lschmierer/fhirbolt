...
impl crate::model::ResourceOrElement for CareTeamParticipant {}
...
impl<'de> serde::de::Deserialize<'de> for CareTeamParticipant {
...
impl crate::model::ResourceOrElement for CareTeam {}
...
impl<'de> serde::de::Deserialize<'de> for CareTeam {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#period: Option<Box<super::super::types::Period>> = None;
                let mut r#participant: Option<Vec<CareTeamParticipant>> = None;
                ...
                let mut r#managing_organization: Option<Vec<Box<super::super::types::Reference>>> =
                    None;
