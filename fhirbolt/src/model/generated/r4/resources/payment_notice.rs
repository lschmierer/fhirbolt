...
impl crate::model::ResourceOrElement for PaymentNotice {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(PaymentNotice {
                        ...
                        r#provider,
                        r#payment: if config.mode == crate::DeserializationMode::Lax {
                        ...
                        r#payment_date,
                        r#payee,
                        r#recipient: if config.mode == crate::DeserializationMode::Lax {
