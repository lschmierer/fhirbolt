...
impl crate::model::ResourceOrElement for ProcedurePerformed {}
...
impl crate::model::ResourceOrElement for ProcedurePerformer {}
...
impl crate::model::ResourceOrElement for ProcedureFocalDevice {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ProcedureFocalDevice {
                        ...
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#action,
                        r#manipulated: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Procedure {}
