...
impl crate::model::ResourceOrElement for ExplanationOfBenefitSupportingInfoTiming {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitSupportingInfoValue {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitDiagnosisDiagnosis {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitProcedureProcedure {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAccidentLocation {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitItemServiced {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitItemLocation {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAddItemServiced {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAddItemLocation {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitBenefitBalanceFinancialAllowed {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitBenefitBalanceFinancialUsed {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitRelated {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitPayee {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitCareTeam {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefitCareTeam {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#sequence: if config.mode == crate::DeserializationMode::Lax {
                            r#sequence.unwrap_or(Default::default())
                        } else {
                            r#sequence.ok_or(serde::de::Error::missing_field("sequence"))?
                        },
                        r#provider: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitSupportingInfo {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::ValueString => {
                                ...
                                if let ExplanationOfBenefitSupportingInfoValue::String(variant) =
                                    r#enum
                                {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                    ...
                    Ok(ExplanationOfBenefitSupportingInfo {
                        ...
                        r#category: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitDiagnosis {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefitDiagnosis {
                        ...
                        r#diagnosis: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitProcedure {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefitProcedure {
                        ...
                        r#type: r#type.unwrap_or(vec![]),
                        r#date,
                        r#procedure: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitInsurance {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefitInsurance {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#focal: if config.mode == crate::DeserializationMode::Lax {
                            r#focal.unwrap_or(Default::default())
                        } else {
                            r#focal.ok_or(serde::de::Error::missing_field("focal"))?
                        },
                        r#coverage: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAccident {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitItemAdjudication {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitItemDetailSubDetail {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefitItemDetailSubDetail {
                        ...
                        r#revenue,
                        r#category,
                        r#product_or_service: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitItemDetail {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitItem {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAddItemDetailSubDetail {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAddItemDetail {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitAddItem {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitTotal {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefitTotal {
                        ...
                        r#amount: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitPayment {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitProcessNote {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitBenefitBalanceFinancial {}
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate :: DESERIALIZATION_CONFIG . with (| config | { let config = config . get () ; while let Some (map_access_key) = map_access . next_key () ? { match map_access_key { Field :: Id => { if r#id . is_some () { return Err (serde :: de :: Error :: duplicate_field ("id")) ; } r#id = Some (map_access . next_value () ?) ; } , Field :: Extension => { if r#extension . is_some () { return Err (serde :: de :: Error :: duplicate_field ("extension")) ; } r#extension = Some (map_access . next_value () ?) ; } , Field :: ModifierExtension => { if r#modifier_extension . is_some () { return Err (serde :: de :: Error :: duplicate_field ("modifierExtension")) ; } r#modifier_extension = Some (map_access . next_value () ?) ; } , Field :: Type => { if r#type . is_some () { return Err (serde :: de :: Error :: duplicate_field ("type")) ; } r#type = Some (map_access . next_value () ?) ; } , Field :: AllowedUnsignedInt => { let r#enum = r#allowed . get_or_insert (ExplanationOfBenefitBenefitBalanceFinancialAllowed :: UnsignedInt (Default :: default ())) ; if let ExplanationOfBenefitBenefitBalanceFinancialAllowed :: UnsignedInt (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("allowedUnsignedInt")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("allowed[x]")) ; } } , Field :: AllowedUnsignedIntPrimitiveElement => { let r#enum = r#allowed . get_or_insert (ExplanationOfBenefitBenefitBalanceFinancialAllowed :: UnsignedInt (Default :: default ())) ; if let ExplanationOfBenefitBenefitBalanceFinancialAllowed :: UnsignedInt (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_allowedUnsignedInt")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value () ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_allowed[x]")) ; } } , Field :: AllowedString => { let r#enum = r#allowed . get_or_insert (ExplanationOfBenefitBenefitBalanceFinancialAllowed :: String (Default :: default ())) ; if let ExplanationOfBenefitBenefitBalanceFinancialAllowed :: String (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("allowedString")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("allowed[x]")) ; } } , Field :: AllowedStringPrimitiveElement => { let r#enum = r#allowed . get_or_insert (ExplanationOfBenefitBenefitBalanceFinancialAllowed :: String (Default :: default ())) ; if let ExplanationOfBenefitBenefitBalanceFinancialAllowed :: String (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_allowedString")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value () ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_allowed[x]")) ; } } , Field :: AllowedMoney => { if r#allowed . is_some () { return Err (serde :: de :: Error :: duplicate_field ("allowedMoney")) ; } r#allowed = Some (ExplanationOfBenefitBenefitBalanceFinancialAllowed :: Money (map_access . next_value () ?)) ; } , Field :: UsedUnsignedInt => { let r#enum = r#used . get_or_insert (ExplanationOfBenefitBenefitBalanceFinancialUsed :: UnsignedInt (Default :: default ())) ; if let ExplanationOfBenefitBenefitBalanceFinancialUsed :: UnsignedInt (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("usedUnsignedInt")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("used[x]")) ; } } , Field :: UsedUnsignedIntPrimitiveElement => { let r#enum = r#used . get_or_insert (ExplanationOfBenefitBenefitBalanceFinancialUsed :: UnsignedInt (Default :: default ())) ; if let ExplanationOfBenefitBenefitBalanceFinancialUsed :: UnsignedInt (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_usedUnsignedInt")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value () ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_used[x]")) ; } } , Field :: UsedMoney => { if r#used . is_some () { return Err (serde :: de :: Error :: duplicate_field ("usedMoney")) ; } r#used = Some (ExplanationOfBenefitBenefitBalanceFinancialUsed :: Money (map_access . next_value () ?)) ; } , Field :: Unknown (key) => if config . mode == crate :: DeserializationMode :: Strict { return Err (serde :: de :: Error :: unknown_field (& key , & ["id" , "extension" , "modifierExtension" , "type" , "allowedUnsignedInt" , "allowedString" , "allowedMoney" , "usedUnsignedInt" , "usedMoney" ,])) ; } } } Ok (ExplanationOfBenefitBenefitBalanceFinancial { r#id , r#extension : r#extension . unwrap_or (vec ! []) , r#modifier_extension : r#modifier_extension . unwrap_or (vec ! []) , r#type : if config . mode == crate :: DeserializationMode :: Lax { r#type . unwrap_or (Default :: default ()) } else { r#type . ok_or (serde :: de :: Error :: missing_field ("type")) ? } , r#allowed , r#used , }) })
            }
        }
        deserializer.deserialize_map(Visitor)
    }
...
impl crate::model::ResourceOrElement for ExplanationOfBenefitBenefitBalance {}
...
impl crate::model::ResourceOrElement for ExplanationOfBenefit {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ExplanationOfBenefit {
                        ...
                        r#sub_type,
                        r#use: if config.mode == crate::DeserializationMode::Lax {
                        ...
                        r#billable_period,
                        r#created: if config.mode == crate::DeserializationMode::Lax {
                            r#created.unwrap_or(Default::default())
                        } else {
                            r#created.ok_or(serde::de::Error::missing_field("created"))?
                        },
                        r#enterer,
                        r#insurer: if config.mode == crate::DeserializationMode::Lax {
                        ...
                        r#claim,
                        r#claim_response,
                        r#outcome: if config.mode == crate::DeserializationMode::Lax {
