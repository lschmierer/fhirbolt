...
impl crate::model::ResourceOrElement for DeviceDefinitionManufacturer {}
...
impl crate::model::ResourceOrElement for DeviceDefinitionUdiDeviceIdentifier {}
...
impl crate::model::ResourceOrElement for DeviceDefinitionDeviceName {}
...
impl crate::model::ResourceOrElement for DeviceDefinitionSpecialization {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(DeviceDefinitionSpecialization {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#system_type: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for DeviceDefinitionCapability {}
...
impl crate::model::ResourceOrElement for DeviceDefinitionProperty {}
...
impl crate::model::ResourceOrElement for DeviceDefinitionMaterial {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(DeviceDefinitionMaterial {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#substance: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for DeviceDefinition {}
