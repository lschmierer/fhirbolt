...
impl crate::model::ResourceOrElement for TestScriptOrigin {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptOrigin {
                        ...
                        r#index: if config.mode == crate::DeserializationMode::Lax {
                            r#index.unwrap_or(Default::default())
                        } else {
                            r#index.ok_or(serde::de::Error::missing_field("index"))?
                        },
                        r#profile: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptDestination {}
...
impl crate::model::ResourceOrElement for TestScriptMetadataLink {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptMetadataLink {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#url: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptMetadataCapability {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptMetadataCapability {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#required: if config.mode == crate::DeserializationMode::Lax {
                            r#required.unwrap_or(Default::default())
                        } else {
                            r#required.ok_or(serde::de::Error::missing_field("required"))?
                        },
                        r#validated: if config.mode == crate::DeserializationMode::Lax {
                        ...
                        r#capabilities: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptMetadata {}
...
impl crate::model::ResourceOrElement for TestScriptFixture {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptFixture {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#autocreate: if config.mode == crate::DeserializationMode::Lax {
                            r#autocreate.unwrap_or(Default::default())
                        } else {
                            r#autocreate.ok_or(serde::de::Error::missing_field("autocreate"))?
                        },
                        r#autodelete: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptVariable {}
...
impl crate::model::ResourceOrElement for TestScriptSetupActionOperationRequestHeader {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptSetupActionOperationRequestHeader {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#field: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptSetupActionOperation {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptSetupActionOperation {
                        ...
                        r#content_type,
                        r#destination,
                        r#encode_request_url: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptSetupActionAssert {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptSetupActionAssert {
                        ...
                        r#value,
                        r#warning_only: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptSetupAction {}
...
impl crate::model::ResourceOrElement for TestScriptSetup {}
...
impl crate::model::ResourceOrElement for TestScriptTestAction {}
...
impl crate::model::ResourceOrElement for TestScriptTest {}
...
impl crate::model::ResourceOrElement for TestScriptTeardownAction {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(TestScriptTeardownAction {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#operation: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for TestScriptTeardown {}
...
impl crate::model::ResourceOrElement for TestScript {}
