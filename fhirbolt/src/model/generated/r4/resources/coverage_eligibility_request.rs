...
impl crate::model::ResourceOrElement for CoverageEligibilityRequestServiced {}
...
impl crate::model::ResourceOrElement for CoverageEligibilityRequestItemDiagnosisDiagnosis {}
...
impl crate::model::ResourceOrElement for CoverageEligibilityRequestSupportingInfo {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(CoverageEligibilityRequestSupportingInfo {
                        ...
                        r#information: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for CoverageEligibilityRequestInsurance {}
...
impl crate::model::ResourceOrElement for CoverageEligibilityRequestItemDiagnosis {}
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#diagnosis: Option<CoverageEligibilityRequestItemDiagnosisDiagnosis> =
                    None;
                crate :: DESERIALIZATION_CONFIG . with (| config | { let config = config . get () ; while let Some (map_access_key) = map_access . next_key () ? { match map_access_key { Field :: Id => { if r#id . is_some () { return Err (serde :: de :: Error :: duplicate_field ("id")) ; } r#id = Some (map_access . next_value () ?) ; } , Field :: Extension => { if r#extension . is_some () { return Err (serde :: de :: Error :: duplicate_field ("extension")) ; } r#extension = Some (map_access . next_value () ?) ; } , Field :: ModifierExtension => { if r#modifier_extension . is_some () { return Err (serde :: de :: Error :: duplicate_field ("modifierExtension")) ; } r#modifier_extension = Some (map_access . next_value () ?) ; } , Field :: DiagnosisCodeableConcept => { if r#diagnosis . is_some () { return Err (serde :: de :: Error :: duplicate_field ("diagnosisCodeableConcept")) ; } r#diagnosis = Some (CoverageEligibilityRequestItemDiagnosisDiagnosis :: CodeableConcept (map_access . next_value () ?)) ; } , Field :: DiagnosisReference => { if r#diagnosis . is_some () { return Err (serde :: de :: Error :: duplicate_field ("diagnosisReference")) ; } r#diagnosis = Some (CoverageEligibilityRequestItemDiagnosisDiagnosis :: Reference (map_access . next_value () ?)) ; } , Field :: Unknown (key) => if config . mode == crate :: DeserializationMode :: Strict { return Err (serde :: de :: Error :: unknown_field (& key , & ["id" , "extension" , "modifierExtension" , "diagnosisCodeableConcept" , "diagnosisReference" ,])) ; } } } Ok (CoverageEligibilityRequestItemDiagnosis { r#id , r#extension : r#extension . unwrap_or (vec ! []) , r#modifier_extension : r#modifier_extension . unwrap_or (vec ! []) , r#diagnosis , }) })
            }
        }
        deserializer.deserialize_map(Visitor)
    }
...
impl crate::model::ResourceOrElement for CoverageEligibilityRequestItem {}
...
impl crate::model::ResourceOrElement for CoverageEligibilityRequest {}
