...
impl crate::model::ResourceOrElement for InvoiceLineItemChargeItem {}
...
impl crate::model::ResourceOrElement for InvoiceParticipant {}
...
impl crate::model::ResourceOrElement for InvoiceLineItemPriceComponent {}
...
impl crate::model::ResourceOrElement for InvoiceLineItem {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(InvoiceLineItem {
                        ...
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#sequence,
                        r#charge_item: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Invoice {}
