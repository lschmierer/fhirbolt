...
impl crate::model::ResourceOrElement for MedicinalProductSpecialDesignationIndication {}
...
impl crate::model::ResourceOrElement for MedicinalProductNameNamePart {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MedicinalProductNameNamePart {
                        ...
                        r#part: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MedicinalProductNameCountryLanguage {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MedicinalProductNameCountryLanguage {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#country: if config.mode == crate::DeserializationMode::Lax {
                            r#country.unwrap_or(Default::default())
                        } else {
                            r#country.ok_or(serde::de::Error::missing_field("country"))?
                        },
                        r#jurisdiction,
                        r#language: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MedicinalProductName {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(MedicinalProductName {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#product_name: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for MedicinalProductManufacturingBusinessOperation {}
...
impl crate::model::ResourceOrElement for MedicinalProductSpecialDesignation {}
...
impl crate::model::ResourceOrElement for MedicinalProduct {}
