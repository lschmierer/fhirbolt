...
impl crate::model::ResourceOrElement for CompartmentDefinitionResource {}
...
impl crate::model::ResourceOrElement for CompartmentDefinition {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(CompartmentDefinition {
                        ...
                        r#search: if config.mode == crate::DeserializationMode::Lax {
