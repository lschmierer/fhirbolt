...
impl crate::model::ResourceOrElement for AuditEventEntityDetailValue {}
...
impl crate::model::ResourceOrElement for AuditEventAgentNetwork {}
...
impl crate::model::ResourceOrElement for AuditEventAgent {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(AuditEventAgent {
                        ...
                        r#alt_id,
                        r#name,
                        r#requestor: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for AuditEventSource {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(AuditEventSource {
                        ...
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#site,
                        r#observer: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for AuditEventEntityDetail {}
...
impl crate::model::ResourceOrElement for AuditEventEntity {}
...
impl crate::model::ResourceOrElement for AuditEvent {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(AuditEvent {
                        ...
                        r#action,
                        r#period,
                        r#recorded: if config.mode == crate::DeserializationMode::Lax {
