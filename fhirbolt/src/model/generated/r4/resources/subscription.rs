...
impl crate::model::ResourceOrElement for SubscriptionChannel {}
...
impl crate::model::ResourceOrElement for Subscription {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(Subscription {
                        ...
                        r#end,
                        r#reason: if config.mode == crate::DeserializationMode::Lax {
                        ...
                        r#error,
                        r#channel: if config.mode == crate::DeserializationMode::Lax {
