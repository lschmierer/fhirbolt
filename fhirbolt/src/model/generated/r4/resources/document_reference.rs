...
impl crate::model::ResourceOrElement for DocumentReferenceRelatesTo {}
...
impl crate::model::ResourceOrElement for DocumentReferenceContent {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(DocumentReferenceContent {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#attachment: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for DocumentReferenceContext {}
...
impl crate::model::ResourceOrElement for DocumentReference {}
