...
impl crate::model::ResourceOrElement for CatalogEntryRelatedEntry {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(CatalogEntryRelatedEntry {
                        ...
                        r#relationtype: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for CatalogEntry {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(CatalogEntry {
                        ...
                        r#type,
                        r#orderable: if config.mode == crate::DeserializationMode::Lax {
                            r#orderable.unwrap_or(Default::default())
                        } else {
                            r#orderable.ok_or(serde::de::Error::missing_field("orderable"))?
                        },
                        r#referenced_item: if config.mode == crate::DeserializationMode::Lax {
