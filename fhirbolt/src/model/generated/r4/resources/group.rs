...
impl crate::model::ResourceOrElement for GroupCharacteristicValue {}
...
impl crate::model::ResourceOrElement for GroupCharacteristic {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(GroupCharacteristic {
                        ...
                        r#exclude: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for GroupMember {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(GroupMember {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#entity: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for Group {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(Group {
                        ...
                        r#actual: if config.mode == crate::DeserializationMode::Lax {
