...
impl crate::model::ResourceOrElement for DetectedIssueIdentified {}
...
impl crate::model::ResourceOrElement for DetectedIssueEvidence {}
...
impl crate::model::ResourceOrElement for DetectedIssueMitigation {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(DetectedIssueMitigation {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#action: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for DetectedIssue {}
