...
impl crate::model::ResourceOrElement for ElementDefinitionDefaultValue {}
...
impl crate::model::ResourceOrElement for ElementDefinitionFixed {}
...
impl crate::model::ResourceOrElement for ElementDefinitionPattern {}
...
impl crate::model::ResourceOrElement for ElementDefinitionExampleValue {}
...
impl crate::model::ResourceOrElement for ElementDefinitionMinValue {}
...
impl crate::model::ResourceOrElement for ElementDefinitionMaxValue {}
...
impl crate::model::ResourceOrElement for ElementDefinitionSlicingDiscriminator {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ElementDefinitionSlicingDiscriminator {
                        ...
                        r#path: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ElementDefinitionSlicing {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ElementDefinitionSlicing {
                        ...
                        r#description,
                        r#ordered,
                        r#rules: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ElementDefinitionBase {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ElementDefinitionBase {
                        ...
                        r#min: if config.mode == crate::DeserializationMode::Lax {
                            r#min.unwrap_or(Default::default())
                        } else {
                            r#min.ok_or(serde::de::Error::missing_field("min"))?
                        },
                        r#max: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ElementDefinitionType {}
...
impl crate::model::ResourceOrElement for ElementDefinitionExample {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ElementDefinitionExample {
                        r#id,
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#label: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ElementDefinitionConstraint {}
...
impl crate::model::ResourceOrElement for ElementDefinitionBinding {}
...
impl crate::model::ResourceOrElement for ElementDefinitionMapping {}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(ElementDefinitionMapping {
                        r#id,
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#identity: if config.mode == crate::DeserializationMode::Lax {
                            r#identity.unwrap_or(Default::default())
                        } else {
                            r#identity.ok_or(serde::de::Error::missing_field("identity"))?
                        },
                        r#language,
                        r#map: if config.mode == crate::DeserializationMode::Lax {
...
impl crate::model::ResourceOrElement for ElementDefinition {}
                ...
                crate::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    while let Some(map_access_key) = map_access.next_key()? {
                        match map_access_key {
                            ...
                            Field::FixedCode => {
                                let r#enum = r#fixed.get_or_insert(ElementDefinitionFixed::Code(
                                    Default::default(),
                                ));
                            ...
                            Field::FixedDate => {
                                let r#enum = r#fixed.get_or_insert(ElementDefinitionFixed::Date(
                                    Default::default(),
                                ));
                            ...
                            Field::FixedString => {
                                let r#enum = r#fixed.get_or_insert(ElementDefinitionFixed::String(
                                    Default::default(),
                                ));
                            ...
                            Field::FixedTime => {
                                let r#enum = r#fixed.get_or_insert(ElementDefinitionFixed::Time(
                                    Default::default(),
                                ));
                            ...
                            Field::FixedUuid => {
                                let r#enum = r#fixed.get_or_insert(ElementDefinitionFixed::Uuid(
                                    Default::default(),
                                ));
                            ...
                            Field::FixedMeta => {
                                ...
                                r#fixed =
                                    Some(ElementDefinitionFixed::Meta(map_access.next_value()?));
                            }
                            ...
                            Field::PatternId => {
                                let r#enum = r#pattern.get_or_insert(ElementDefinitionPattern::Id(
                                    Default::default(),
                                ));
