                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::json::de::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(CoverageEligibilityResponse {
                        ...
                        r#requestor,
                        r#request: if config.mode == crate::json::de::DeserializationMode::Lax {
