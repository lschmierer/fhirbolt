                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                crate::json::de::DESERIALIZATION_CONFIG.with(|config| {
                    ...
                    Ok(SpecimenDefinitionTypeTested {
                        ...
                        r#is_derived,
                        r#type,
                        r#preference: if config.mode == crate::json::de::DeserializationMode::Lax {
