...
impl serde::ser::Serialize for MetadataResource {
...
impl<'de> serde::de::Deserialize<'de> for MetadataResource {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("MetadataResource")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<MetadataResource, V::Error>
            where
