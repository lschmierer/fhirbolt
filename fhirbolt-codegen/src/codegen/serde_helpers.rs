...
pub fn generate_serde_helpers(release: &str) -> SourceFile {
    ...
    SourceFile {
        ...
        source: quote! {
            ...
            impl<'de> serde::de::DeserializeSeed<'de> for &mut crate::context::de::DeserializationContext<PrimitiveElementOwned> {
                ...
                {
                    struct Visitor<'a>(&'a mut crate::context::de::DeserializationContext<PrimitiveElementOwned>);
                            ...
                            V: serde::de::MapAccess<'de>,
                        {
                            ...
                            while let Some(map_access_key) = map_access.next_key()? {
                                match map_access_key {
                                    ...
                                    Field::Unknown(key) => {
                                        if self.0.config.mode
                                            == crate::context::de::DeserializationMode::Strict
                                        {
                                            return Err(serde::de::Error::unknown_field(&key, &["id", "extension"]));
                                        }
                                    }
                                }
                            }
            ...
            impl<'de> serde::de::DeserializeSeed<'de> for &mut crate::context::de::DeserializationContext<Option<PrimitiveElementOwned>> {
                ...
                where
                    D: serde::de::Deserializer<'de>,
                {
                    struct Visitor<'a>(&'a mut crate::context::de::DeserializationContext<Option<PrimitiveElementOwned>>);
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                            ...
                            D: serde::de::Deserializer<'de>,
                        {
                            ...
                            self.0.transmute::<PrimitiveElementOwned>().deserialize(deserializer).map(Some)
                        }
                    }
            ...
            impl<'de> serde::de::DeserializeSeed<'de> for &mut crate::context::de::DeserializationContext<Vec<Option<PrimitiveElementOwned>>> {
                ...
                where
                    D: serde::de::Deserializer<'de>,
                {
                    struct Visitor<'a>(&'a mut crate::context::de::DeserializationContext<Vec<Option<PrimitiveElementOwned>>>);
