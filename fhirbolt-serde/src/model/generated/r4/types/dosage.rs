...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::types::DosageDoseAndRate>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#dose.as_ref() {
            match some {
                fhirbolt_model::r4::types::DosageDoseAndRateDose::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("doseRange", ctx))?;
                }
                fhirbolt_model::r4::types::DosageDoseAndRateDose::Quantity(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("doseQuantity", ctx))?;
                }
                fhirbolt_model::r4::types::DosageDoseAndRateDose::Invalid => {
        ...
        if let Some(some) = self.value.r#rate.as_ref() {
            match some {
                fhirbolt_model::r4::types::DosageDoseAndRateRate::Ratio(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("rateRatio", ctx))?;
                }
                fhirbolt_model::r4::types::DosageDoseAndRateRate::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("rateRange", ctx))?;
                }
                fhirbolt_model::r4::types::DosageDoseAndRateRate::Quantity(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("rateQuantity", ctx))?;
                }
                fhirbolt_model::r4::types::DosageDoseAndRateRate::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::types::DosageDoseAndRate>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::types::DosageDoseAndRate>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::types::DosageDoseAndRate>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize for crate::SerializationContext<&fhirbolt_model::r4::types::Dosage> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#as_needed.as_ref() {
            match some {
                fhirbolt_model::r4::types::DosageAsNeeded::Boolean(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::types::DosageAsNeeded::CodeableConcept(ref value) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("asNeededCodeableConcept", ctx)
                    })?;
                }
                fhirbolt_model::r4::types::DosageAsNeeded::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::types::Dosage>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::types::Dosage>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::types::Dosage>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
