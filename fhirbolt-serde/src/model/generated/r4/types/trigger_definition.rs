...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r4::types::TriggerDefinition>
{
                    ...
                    match map_access_key {
                        ...
                        Field::Data => {
                            if self.0.from_json {
                                ...
                                r#data = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: DataRequirement >> ()) ?) ;
                            } else {
