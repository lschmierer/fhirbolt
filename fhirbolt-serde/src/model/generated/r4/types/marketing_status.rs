...
use fhirbolt_model::r4::types::MarketingStatus;
impl serde::ser::Serialize for SerializationContext<&MarketingStatus> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#date_range.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#date_range, |ctx| state
                .serialize_entry("dateRange", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<MarketingStatus>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<MarketingStatus>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<MarketingStatus> {
    type Value = MarketingStatus;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<MarketingStatus>);
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(MarketingStatus {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#date_range.ok_or(serde::de::Error::missing_field("dateRange")))
                    },
                    r#restore_date,
                })
            }
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<MarketingStatus>> {
    type Value = Box<MarketingStatus>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<MarketingStatus>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<MarketingStatus>> {
    type Value = Vec<MarketingStatus>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<MarketingStatus>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<MarketingStatus>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
