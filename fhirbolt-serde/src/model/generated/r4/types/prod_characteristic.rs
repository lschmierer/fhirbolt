...
use fhirbolt_model::r4::types::ProdCharacteristic;
impl serde::ser::Serialize for SerializationContext<&ProdCharacteristic> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#height.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("height", ctx)));
        }
        if let Some(some) = self.value.r#width.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("width", ctx)));
        }
        if let Some(some) = self.value.r#depth.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("depth", ctx)));
        }
        if let Some(some) = self.value.r#weight.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("weight", ctx)));
        }
        if let Some(some) = self.value.r#nominal_volume.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("nominalVolume", ctx)));
        }
        if let Some(some) = self.value.r#external_diameter.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("externalDiameter", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#shape.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("shape", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_shape", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#shape.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("shape", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#color.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("color", &values));
                }
            ...
            tri!(self.with_context(&self.value.r#color, |ctx| state
                .serialize_entry("color", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#imprint.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("imprint", &values));
                }
                let requires_elements = self
                    .value
                    .r#imprint
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_imprint", ctx)));
                }
            }
        } else if !self.value.r#imprint.is_empty() {
            tri!(self.with_context(&self.value.r#imprint, |ctx| state
                .serialize_entry("imprint", ctx)));
        }
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#height: Option<Box<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#width: Option<Box<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#depth: Option<Box<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#weight: Option<Box<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#nominal_volume: Option<Box<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#external_diameter: Option<Box<fhirbolt_model::r4::types::Quantity>> =
                    None;
                let mut r#shape: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#color: Option<Vec<fhirbolt_model::r4::types::String>> = None;
                let mut r#imprint: Option<Vec<fhirbolt_model::r4::types::String>> = None;
                let mut r#image: Option<Vec<fhirbolt_model::r4::types::Attachment>> = None;
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Height => {
                            ...
                            > = self.0.transmute();
                            r#height = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Width => {
                            if r#width.is_some() {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Quantity>,
                            > = self.0.transmute();
                            r#width = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Depth => {
                            if r#depth.is_some() {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Quantity>,
                            > = self.0.transmute();
                            r#depth = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Weight => {
                            if r#weight.is_some() {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Quantity>,
                            > = self.0.transmute();
                            r#weight = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::NominalVolume => {
                        ...
                        Field::Shape => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#shape = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
