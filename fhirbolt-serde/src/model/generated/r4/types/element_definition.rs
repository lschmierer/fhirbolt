...
use fhirbolt_model::r4::types::ElementDefinitionSlicingDiscriminator;
...
use fhirbolt_model::r4::types::ElementDefinitionSlicing;
                    ...
                    match map_access_key {
                        ...
                        Field::Discriminator => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: types :: ElementDefinitionSlicingDiscriminator >> = self . 0 . transmute () ;
                                r#discriminator =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#discriminator.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: types :: ElementDefinitionSlicingDiscriminator > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Description => {
...
use fhirbolt_model::r4::types::ElementDefinitionBase;
...
use fhirbolt_model::r4::types::ElementDefinitionType;
...
use fhirbolt_model::r4::types::ElementDefinitionExample;
impl serde::ser::Serialize for SerializationContext<&ElementDefinitionExample> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::types::ElementDefinitionExampleValue as _Enum;
            match self.value.r#value {
                ...
                _Enum::Contributor(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueContributor", ctx)));
                }
                    ...
                    match map_access_key {
                        ...
                        Field::ValueCode => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Code>,
                                > = self.0.transmute();
                        ...
                        Field::ValueInstant => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Instant>,
                                > = self.0.transmute();
                        ...
                        Field::ValueMarkdown => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Markdown>,
                                > = self.0.transmute();
                        ...
                        Field::ValueOid => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Oid>,
                                > = self.0.transmute();
                        ...
                        Field::ValueTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Time>,
                                > = self.0.transmute();
                        ...
                        Field::ValueUnsignedInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::UnsignedInt>,
                                > = self.0.transmute();
                        ...
                        Field::ValueUrl => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Url>,
                                > = self.0.transmute();
                        ...
                        Field::ValueUuid => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4::types::Uuid>,
                                > = self.0.transmute();
...
use fhirbolt_model::r4::types::ElementDefinitionConstraint;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#xpath.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("xpath", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_xpath", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#xpath.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("xpath", ctx)));
        }
        if self.output == crate::context::Format::Json {
                        ...
                        Field::Xpath => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::types::String,
                                > = self.0.transmute();
                                r#xpath = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r4::types::ElementDefinitionBinding;
...
use fhirbolt_model::r4::types::ElementDefinitionMapping;
...
use fhirbolt_model::r4::types::ElementDefinition;
impl serde::ser::Serialize for SerializationContext<&ElementDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::types::ElementDefinitionDefaultValue as _Enum;
            if let Some(some) = self.value.r#default_value.as_ref() {
                match some {
                    ...
                    _Enum::Contributor(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueContributor", ctx)));
                    }
                    _Enum::DataRequirement(ref value) => {
                        tri!(self.with_context(value, |ctx| state
        ...
        {
            use fhirbolt_model::r4::types::ElementDefinitionFixed as _Enum;
            if let Some(some) = self.value.r#fixed.as_ref() {
                match some {
                    ...
                    _Enum::Contributor(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedContributor", ctx)));
                    }
                    _Enum::DataRequirement(ref value) => {
                        tri!(self.with_context(value, |ctx| state
        ...
        {
            use fhirbolt_model::r4::types::ElementDefinitionPattern as _Enum;
            if let Some(some) = self.value.r#pattern.as_ref() {
                match some {
                    ...
                    _Enum::Contributor(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternContributor", ctx)));
                    }
                    _Enum::DataRequirement(ref value) => {
                        tri!(self.with_context(value, |ctx| state
        ...
        {
            use fhirbolt_model::r4::types::ElementDefinitionMinValue as _Enum;
        ...
        {
            use fhirbolt_model::r4::types::ElementDefinitionMaxValue as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#label: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#code: Option<Vec<fhirbolt_model::r4::types::Coding>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::DefaultValueContributor => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Contributor>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Contributor(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        ...
                        Field::FixedContributor => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Contributor>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Contributor(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        ...
                        Field::PatternContributor => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Contributor>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Contributor(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
