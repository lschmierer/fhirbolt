...
use fhirbolt_model::r4::types::DataRequirementCodeFilter;
...
use fhirbolt_model::r4::types::DataRequirementDateFilter;
impl serde::ser::Serialize for SerializationContext<&DataRequirementDateFilter> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::types::DataRequirementDateFilterValue as _Enum;
...
use fhirbolt_model::r4::types::DataRequirementSort;
...
use fhirbolt_model::r4::types::DataRequirement;
impl serde::ser::Serialize for SerializationContext<&DataRequirement> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::types::DataRequirementSubject as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::CodeFilter => {
                            if self.0.from_json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4::types::DataRequirementCodeFilter>,
                                > = self.0.transmute();
                                r#code_filter = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::DateFilter => {
                            if self.0.from_json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4::types::DataRequirementDateFilter>,
                                > = self.0.transmute();
                                r#date_filter = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Sort => {
                            if self.0.from_json {
                                ...
                                > = self.0.transmute();
                                r#sort = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
