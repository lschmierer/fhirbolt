...
use fhirbolt_model::r4::resources::GroupCharacteristic;
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GroupCharacteristic {
                    ...
                    r#exclude: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#exclude.ok_or(serde::de::Error::missing_field("exclude")))
                    },
                    r#period,
                })
            }
...
use fhirbolt_model::r4::resources::GroupMember;
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GroupMember {
                    ...
                    r#entity: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#entity.ok_or(serde::de::Error::missing_field("entity")))
                    },
                    r#period,
                    r#inactive,
                })
...
use fhirbolt_model::r4::resources::Group;
...
impl serde::ser::Serialize for SerializationContext<&Group> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Group"));
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#actual.value.as_ref().map(Ok) {
            ...
            tri!(self.with_context(&self.value.r#actual, |ctx| state
                .serialize_entry("actual", ctx)));
        }
        ...
        if let Some(some) = self.value.r#managing_entity.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("managingEntity", ctx)));
        }
        ...
        if !self.value.r#member.is_empty() {
            tri!(self.with_context(&self.value.r#member, |ctx| state
                .serialize_entry("member", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(Group {
                    ...
                    r#actual: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#actual.ok_or(serde::de::Error::missing_field("actual")))
                    },
                    r#code,
                    r#name,
                    r#quantity,
