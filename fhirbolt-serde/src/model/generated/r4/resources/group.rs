...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::GroupCharacteristic>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        match self.value.r#value {
            fhirbolt_model::r4::resources::GroupCharacteristicValue::CodeableConcept(ref value) => {
                self.with_context(value, |ctx| {
                    state.serialize_entry("valueCodeableConcept", ctx)
                })?;
            }
            fhirbolt_model::r4::resources::GroupCharacteristicValue::Boolean(ref value) => {
                if self.output_json {
            ...
            fhirbolt_model::r4::resources::GroupCharacteristicValue::Quantity(ref value) => {
                self.with_context(value, |ctx| state.serialize_entry("valueQuantity", ctx))?;
            }
            fhirbolt_model::r4::resources::GroupCharacteristicValue::Range(ref value) => {
                self.with_context(value, |ctx| state.serialize_entry("valueRange", ctx))?;
            }
            fhirbolt_model::r4::resources::GroupCharacteristicValue::Reference(ref value) => {
                self.with_context(value, |ctx| state.serialize_entry("valueReference", ctx))?;
            }
            fhirbolt_model::r4::resources::GroupCharacteristicValue::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::GroupCharacteristic>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::GroupCharacteristic>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::GroupCharacteristic>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::GroupCharacteristic,
    >
{
    type Value = fhirbolt_model::r4::resources::GroupCharacteristic;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::GroupCharacteristic, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#value: Option<fhirbolt_model::r4::resources::GroupCharacteristicValue> =
                    None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ValueCodeableConcept => {
                            ...
                            r#value = Some (fhirbolt_model :: r4 :: resources :: GroupCharacteristicValue :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::ValueBoolean => {
                            if self.0.from_json {
                                let r#enum = r#value . get_or_insert (fhirbolt_model :: r4 :: resources :: GroupCharacteristicValue :: Boolean (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: GroupCharacteristicValue :: Boolean (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("valueBoolean")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("value[x]")) ; }
                            } else {
                                if r#value.is_some() {
                                    return Err(serde::de::Error::duplicate_field("valueBoolean"));
                                }
                                r#value = Some (fhirbolt_model :: r4 :: resources :: GroupCharacteristicValue :: Boolean (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Boolean > > ()) ?)) ;
                            }
                        }
                        Field::ValueBooleanPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#value . get_or_insert (fhirbolt_model :: r4 :: resources :: GroupCharacteristicValue :: Boolean (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: GroupCharacteristicValue :: Boolean (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_valueBoolean")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_value[x]")) ; }
                            } else {
                        ...
                        Field::ValueQuantity => {
                            ...
                            r#value = Some(
                                fhirbolt_model::r4::resources::GroupCharacteristicValue::Quantity(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::ValueRange => {
                            ...
                            r#value = Some(
                                fhirbolt_model::r4::resources::GroupCharacteristicValue::Range(
                                    map_access.next_value_seed(
                        ...
                        Field::ValueReference => {
                            ...
                            r#value = Some(
                                fhirbolt_model::r4::resources::GroupCharacteristicValue::Reference(
                                    map_access.next_value_seed(
                                        self.0
                ...
                Ok(fhirbolt_model::r4::resources::GroupCharacteristic {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::GroupCharacteristic>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::GroupCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::GroupCharacteristic>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::GroupCharacteristic>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::GroupCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::GroupCharacteristic>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::GroupCharacteristic>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::GroupCharacteristic>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::GroupCharacteristic>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::GroupMember>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::GroupMember>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::GroupMember>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::GroupMember>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::GroupMember>
{
    type Value = fhirbolt_model::r4::resources::GroupMember;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r4::resources::GroupMember,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r4::resources::GroupMember;
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::GroupMember, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#modifier_extension: Option<
                    Vec<Box<fhirbolt_model::r4::types::Extension>>,
                > = None;
                let mut r#entity: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#period: Option<Box<fhirbolt_model::r4::types::Period>> = None;
                ...
                Ok(fhirbolt_model::r4::resources::GroupMember {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::GroupMember>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::GroupMember>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::GroupMember>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::GroupMember>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::GroupMember>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::GroupMember>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::GroupMember>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::GroupMember>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::GroupMember>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r4::resources::Group {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4;
}
impl serde::ser::Serialize for crate::SerializationContext<&fhirbolt_model::r4::resources::Group> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::Group>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::Group>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::Group>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::Group>
{
    type Value = fhirbolt_model::r4::resources::Group;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::Group>
{
    type Value = fhirbolt_model::r4::resources::Group;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r4::resources::Group,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r4::resources::Group;
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::Group, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#actual: Option<fhirbolt_model::r4::types::Boolean> = None;
                let mut r#code: Option<Box<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#name: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#quantity: Option<fhirbolt_model::r4::types::UnsignedInt> = None;
                let mut r#managing_entity: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#characteristic: Option<
                    Vec<fhirbolt_model::r4::resources::GroupCharacteristic>,
                > = None;
                let mut r#member: Option<Vec<fhirbolt_model::r4::resources::GroupMember>> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::Characteristic => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: GroupCharacteristic > ()) ?) ;
                            }
                        }
                        Field::Member => {
                            if self.0.from_json {
                                ...
                                r#member = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: GroupMember >> ()) ?) ;
                            } else {
                                let vec = r#member.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: GroupMember > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4::resources::Group {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Box<fhirbolt_model::r4::resources::Group>>
{
    type Value = Box<fhirbolt_model::r4::resources::Group>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::Group>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Vec<fhirbolt_model::r4::resources::Group>>
{
    type Value = Vec<fhirbolt_model::r4::resources::Group>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                Vec<fhirbolt_model::r4::resources::Group>,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<fhirbolt_model::r4::resources::Group>;
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq
                    .next_element_seed(self.0.transmute::<fhirbolt_model::r4::resources::Group>())?
                {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::Group>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::Group>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::Group>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
