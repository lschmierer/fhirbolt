        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#dosage_instruction: Option<Vec<fhirbolt_model::r4::types::Dosage>> = None;
                ...
                let mut r#prior_prescription: Option<Box<fhirbolt_model::r4::types::Reference>> =
                    None;
                let mut r#detected_issue: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::DosageInstruction => {
                            if self.0.from_json {
                                ...
                                r#dosage_instruction = Some(map_access.next_value_seed(
                                    self.0.transmute::<Vec<fhirbolt_model::r4::types::Dosage>>(),
                                )?);
                            } else {
                                let vec = r#dosage_instruction.get_or_insert(Default::default());
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4::types::Dosage>(),
                                )?);
                            }
                        }
