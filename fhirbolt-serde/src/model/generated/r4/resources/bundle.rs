...
use fhirbolt_model::r4::resources::BundleLink;
...
use fhirbolt_model::r4::resources::BundleEntrySearch;
...
use fhirbolt_model::r4::resources::BundleEntryRequest;
...
use fhirbolt_model::r4::resources::BundleEntryResponse;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#outcome: Option<fhirbolt_model::r4::Resource> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4::resources::BundleEntry;
...
use fhirbolt_model::r4::resources::Bundle;
