                    ...
                    match map_access_key {
                        ...
                        Field::ProductType => {
                            if self.0.from_json {
                                ...
                                r#product_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::IntendedRoute => {
                            if self.0.from_json {
                                ...
                                r#intended_route = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
