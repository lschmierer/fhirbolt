...
use fhirbolt_model::r4::resources::MedicationKnowledgeMonograph;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeIngredient;
impl serde::ser::Serialize for SerializationContext<&MedicationKnowledgeIngredient> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::MedicationKnowledgeIngredientItem as _Enum;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeCost;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeMonitoringProgram;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeAdministrationGuidelinesDosage;
impl serde::ser::Serialize
...
use fhirbolt_model::r4::resources::MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics;
impl serde::ser::Serialize
    for SerializationContext<&MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsCharacteristic as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#characteristic : Option < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsCharacteristic > = None ;
                let mut r#value: Option<Vec<fhirbolt_model::r4::types::String>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4::resources::MedicationKnowledgeAdministrationGuidelines;
impl serde::ser::Serialize for SerializationContext<&MedicationKnowledgeAdministrationGuidelines> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::MedicationKnowledgeAdministrationGuidelinesIndication as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::Dosage => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelinesDosage >> = self . 0 . transmute () ;
                                r#dosage = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#dosage.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelinesDosage > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::PatientCharacteristics => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics >> = self . 0 . transmute () ;
                                r#patient_characteristics =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec =
                                    r#patient_characteristics.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4::resources::MedicationKnowledgeMedicineClassification;
...
use fhirbolt_model::r4::resources::MedicationKnowledgePackaging;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeDrugCharacteristic;
impl serde::ser::Serialize for SerializationContext<&MedicationKnowledgeDrugCharacteristic> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::MedicationKnowledgeDrugCharacteristicValue as _Enum;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeRegulatorySubstitution;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeRegulatorySchedule;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeRegulatoryMaxDispense;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeRegulatory;
                    ...
                    match map_access_key {
                        ...
                        Field::Substitution => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRegulatorySubstitution >> = self . 0 . transmute () ;
                                r#substitution =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#substitution.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRegulatorySubstitution > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Schedule => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRegulatorySchedule >> = self . 0 . transmute () ;
                                r#schedule = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#schedule.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRegulatorySchedule > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::MaxDispense => {
                            ...
                            let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRegulatoryMaxDispense > = self . 0 . transmute () ;
...
use fhirbolt_model::r4::resources::MedicationKnowledgeKinetics;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#area_under_curve: Option<Vec<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#lethal_dose_50: Option<Vec<fhirbolt_model::r4::types::Quantity>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::AreaUnderCurve => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4::types::Quantity>,
                                > = self.0.transmute();
                                r#area_under_curve =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::types::Quantity,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r4::resources::MedicationKnowledge;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#associated_medication: Option<Vec<fhirbolt_model::r4::types::Reference>> =
                    None;
                let mut r#product_type: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                ...
                let mut r#preparation_instruction: Option<fhirbolt_model::r4::types::Markdown> =
                    None;
                let mut r#intended_route: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                ...
                > = None;
                let mut r#contraindication: Option<Vec<fhirbolt_model::r4::types::Reference>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::RelatedMedicationKnowledge => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRelatedMedicationKnowledge >> = self . 0 . transmute () ;
                                r#related_medication_knowledge =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#related_medication_knowledge
                                    .get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRelatedMedicationKnowledge > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Ingredient => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeIngredient >> = self . 0 . transmute () ;
                                r#ingredient =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::MonitoringProgram => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeMonitoringProgram >> = self . 0 . transmute () ;
                                r#monitoring_program =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#monitoring_program.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeMonitoringProgram > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::AdministrationGuidelines => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelines >> = self . 0 . transmute () ;
                                r#administration_guidelines =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec =
                                    r#administration_guidelines.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeAdministrationGuidelines > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::MedicineClassification => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeMedicineClassification >> = self . 0 . transmute () ;
                                r#medicine_classification =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec =
                                    r#medicine_classification.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeMedicineClassification > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Packaging => {
                        ...
                        Field::DrugCharacteristic => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeDrugCharacteristic >> = self . 0 . transmute () ;
                                r#drug_characteristic =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#drug_characteristic.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeDrugCharacteristic > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Regulatory => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MedicationKnowledgeRegulatory >> = self . 0 . transmute () ;
                                r#regulatory =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
