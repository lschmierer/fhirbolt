...
use fhirbolt_model::r4::resources::MeasureGroupPopulation;
impl serde::ser::Serialize for SerializationContext<&MeasureGroupPopulation> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#criteria.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#criteria, |ctx| state
                .serialize_entry("criteria", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Criteria => {
                            ...
                            > = self.0.transmute();
                            r#criteria = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                ...
                Ok(MeasureGroupPopulation {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#criteria.ok_or(serde::de::Error::missing_field("criteria")))
                    },
                })
            }
        }
...
use fhirbolt_model::r4::resources::MeasureGroupStratifierComponent;
...
use fhirbolt_model::r4::resources::MeasureGroupStratifier;
impl serde::ser::Serialize for SerializationContext<&MeasureGroupStratifier> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#criteria.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("criteria", ctx)));
        }
                    ...
                    match map_access_key {
                        ...
                        Field::Component => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: MeasureGroupStratifierComponent >> = self . 0 . transmute () ;
                                r#component =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
...
use fhirbolt_model::r4::resources::MeasureGroup;
impl serde::ser::Serialize for SerializationContext<&MeasureGroup> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#stratifier.is_empty() {
            tri!(self.with_context(&self.value.r#stratifier, |ctx| state
                .serialize_entry("stratifier", ctx)));
        }
        state.end()
    }
}
...
use fhirbolt_model::r4::resources::MeasureSupplementalData;
...
use fhirbolt_model::r4::resources::Measure;
...
impl serde::ser::Serialize for SerializationContext<&Measure> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Measure"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r4::resources::MeasureSubject as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#disclaimer.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("disclaimer", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_disclaimer", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#disclaimer.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("disclaimer", ctx)));
        }
        if let Some(some) = self.value.r#scoring.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("scoring", ctx)));
        }
        if let Some(some) = self.value.r#composite_scoring.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("compositeScoring", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#risk_adjustment.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("riskAdjustment", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_riskAdjustment", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#risk_adjustment.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("riskAdjustment", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#rate_aggregation.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("rateAggregation", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_rateAggregation", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#rate_aggregation.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("rateAggregation", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#rationale.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("rationale", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_rationale", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#rationale.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("rationale", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#clinical_recommendation_statement.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("clinicalRecommendationStatement", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#guidance.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("guidance", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_guidance", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#guidance.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("guidance", ctx)));
        }
        ...
        if !self.value.r#supplemental_data.is_empty() {
            tri!(
                self.with_context(&self.value.r#supplemental_data, |ctx| state
                    .serialize_entry("supplementalData", ctx))
            );
        }
        state.end()
    }
                    ...
                    match map_access_key {
                        ...
                        Field::Scoring => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#scoring = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        ...
                        Field::Guidance => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::types::Markdown,
                                > = self.0.transmute();
                                r#guidance = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
