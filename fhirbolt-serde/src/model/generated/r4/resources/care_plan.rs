        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#reason_reference: Option<Vec<fhirbolt_model::r4::types::Reference>> =
                    None;
                let mut r#goal: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#outcome_reference: Option<Vec<fhirbolt_model::r4::types::Reference>> =
                    None;
                let mut r#progress: Option<Vec<fhirbolt_model::r4::types::Annotation>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::OutcomeCodeableConcept => {
                            if self.0.from_json {
                                ...
                                r#outcome_codeable_concept = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                                let vec =
                        ...
                        Field::Progress => {
                            if self.0.from_json {
                                ...
                                r#progress = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: Annotation >> ()) ?) ;
                            } else {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#replaces: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                ...
                let mut r#care_team: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#addresses: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
