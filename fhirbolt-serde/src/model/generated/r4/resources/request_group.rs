...
use fhirbolt_model::r4::resources::RequestGroupActionCondition;
...
use fhirbolt_model::r4::resources::RequestGroupActionRelatedAction;
impl serde::ser::Serialize for SerializationContext<&RequestGroupActionRelatedAction> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::RequestGroupActionRelatedActionOffset as _Enum;
...
use fhirbolt_model::r4::resources::RequestGroupAction;
impl serde::ser::Serialize for SerializationContext<&RequestGroupAction> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::RequestGroupActionTiming as _Enum;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#timing: Option<fhirbolt_model::r4::resources::RequestGroupActionTiming> =
                    None;
                let mut r#participant: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::RelatedAction => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: RequestGroupActionRelatedAction >> = self . 0 . transmute () ;
                                r#related_action =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
...
use fhirbolt_model::r4::resources::RequestGroup;
...
impl serde::ser::Serialize for SerializationContext<&RequestGroup> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "RequestGroup"));
        if self.output == crate::context::Format::Json {
