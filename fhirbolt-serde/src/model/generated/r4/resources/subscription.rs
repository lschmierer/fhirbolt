...
use fhirbolt_model::r4::resources::SubscriptionChannel;
impl serde::ser::Serialize for SerializationContext<&SubscriptionChannel> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("endpoint", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#payload.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("payload", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_payload", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#payload.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("payload", ctx)));
        }
        if self.output == crate::context::Format::Json {
...
impl serde::ser::Serialize for SerializationContext<&Box<SubscriptionChannel>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<SubscriptionChannel>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<SubscriptionChannel> {
    type Value = SubscriptionChannel;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<SubscriptionChannel>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#payload: Option<fhirbolt_model::r4::types::Code> = None;
                let mut r#header: Option<Vec<fhirbolt_model::r4::types::String>> = None;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<SubscriptionChannel>>
{
    type Value = Box<SubscriptionChannel>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<SubscriptionChannel>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<SubscriptionChannel>>
{
    type Value = Vec<SubscriptionChannel>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<SubscriptionChannel>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<SubscriptionChannel>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<SubscriptionChannel> = self.0.transmute();
...
use fhirbolt_model::r4::resources::Subscription;
...
impl serde::ser::Serialize for SerializationContext<&Subscription> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Subscription"));
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#reason.value.as_ref().map(Ok) {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#criteria.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("criteria", &some?));
            }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#error.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("error", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_error", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#error.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("error", ctx)));
        }
        if self.value.r#channel.id.as_deref() == Some("$invalid") {
            return missing_field_error("channel");
        } else {
            tri!(self.with_context(&self.value.r#channel, |ctx| state
                .serialize_entry("channel", ctx)));
        }
        state.end()
    }
}
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#reason: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#criteria: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#error: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#channel: Option<fhirbolt_model::r4::resources::SubscriptionChannel> =
                    None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::Channel => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r4::resources::SubscriptionChannel,
                            > = self.0.transmute();
                            r#channel = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
                ...
                Ok(Subscription {
                    ...
                    r#reason: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#reason.ok_or(serde::de::Error::missing_field("reason")))
                    },
                    ...
                    r#channel: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#channel.ok_or(serde::de::Error::missing_field("channel")))
                    },
                })
            }
        }
