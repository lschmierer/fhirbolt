...
use fhirbolt_model::r4::resources::ProvenanceAgent;
...
use fhirbolt_model::r4::resources::ProvenanceEntity;
...
use fhirbolt_model::r4::resources::Provenance;
...
impl serde::ser::Serialize for SerializationContext<&Provenance> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ProvenanceOccurred as _Enum;
