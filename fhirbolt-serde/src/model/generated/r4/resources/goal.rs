...
use fhirbolt_model::r4::resources::GoalTarget;
impl serde::ser::Serialize for SerializationContext<&GoalTarget> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::GoalTargetDetail as _Enum;
        ...
        {
            use fhirbolt_model::r4::resources::GoalTargetDue as _Enum;
...
use fhirbolt_model::r4::resources::Goal;
...
impl serde::ser::Serialize for SerializationContext<&Goal> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#expressed_by.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("expressedBy", ctx)));
        }
        ...
        if !self.value.r#outcome_code.is_empty() {
            tri!(self.with_context(&self.value.r#outcome_code, |ctx| state
                .serialize_entry("outcomeCode", ctx)));
        }
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#outcome_code: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::ExpressedBy => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Reference>,
                            > = self.0.transmute();
                            r#expressed_by = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Addresses => {
                            if self.0.from == crate::context::Format::Json {
