...
use fhirbolt_model::r4::resources::CoverageEligibilityResponseInsuranceItemBenefit;
    ...
    for SerializationContext<&CoverageEligibilityResponseInsuranceItemBenefit>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::CoverageEligibilityResponseInsuranceItemBenefitAllowed as _Enum;
        ...
        {
            use fhirbolt_model::r4::resources::CoverageEligibilityResponseInsuranceItemBenefitUsed as _Enum;
...
use fhirbolt_model::r4::resources::CoverageEligibilityResponseInsuranceItem;
                    ...
                    match map_access_key {
                        ...
                        Field::Benefit => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseInsuranceItemBenefit >> = self . 0 . transmute () ;
                                r#benefit = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#benefit.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseInsuranceItemBenefit > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r4::resources::CoverageEligibilityResponseInsurance;
                    ...
                    match map_access_key {
                        ...
                        Field::Item => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseInsuranceItem >> = self . 0 . transmute () ;
                                r#item = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#item.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseInsuranceItem > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4::resources::CoverageEligibilityResponseError;
...
use fhirbolt_model::r4::resources::CoverageEligibilityResponse;
...
impl serde::ser::Serialize for SerializationContext<&CoverageEligibilityResponse> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::CoverageEligibilityResponseServiced as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::Insurance => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseInsurance >> = self . 0 . transmute () ;
                                r#insurance =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#insurance.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseInsurance > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::PreAuthRef => {
                        ...
                        Field::Error => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: CoverageEligibilityResponseError >> = self . 0 . transmute () ;
