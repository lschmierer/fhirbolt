...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::SubstanceProteinSubunit>
{
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::SubstanceProteinSubunit>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::SubstanceProteinSubunit>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::SubstanceProtein>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::SubstanceProtein>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::SubstanceProtein>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::SubstanceProtein>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
