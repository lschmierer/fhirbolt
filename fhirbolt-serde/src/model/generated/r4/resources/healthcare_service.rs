...
use fhirbolt_model::r4::resources::HealthcareServiceEligibility;
impl serde::ser::Serialize for SerializationContext<&HealthcareServiceEligibility> {
...
impl serde::ser::Serialize for SerializationContext<&Box<HealthcareServiceEligibility>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<HealthcareServiceEligibility>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<HealthcareServiceEligibility>
{
    ...
    {
        struct Visitor<'a>(&'a mut DeserializationContext<HealthcareServiceEligibility>);
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<HealthcareServiceEligibility>>
{
    type Value = Box<HealthcareServiceEligibility>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<HealthcareServiceEligibility>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<HealthcareServiceEligibility>>
{
    type Value = Vec<HealthcareServiceEligibility>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<HealthcareServiceEligibility>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<HealthcareServiceEligibility>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<HealthcareServiceEligibility> =
                    self.0.transmute();
...
use fhirbolt_model::r4::resources::HealthcareServiceAvailableTime;
impl serde::ser::Serialize for SerializationContext<&HealthcareServiceAvailableTime> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "HealthcareService.availableTime", field
            )))
        }
        let mut state = tri!(serializer.serialize_map(None));
        if let Some(value) = self.value.r#id.as_ref() {
...
impl serde::ser::Serialize for SerializationContext<&Box<HealthcareServiceAvailableTime>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<HealthcareServiceAvailableTime>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<HealthcareServiceAvailableTime>
{
    ...
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<HealthcareServiceAvailableTime>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = HealthcareServiceAvailableTime;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#days_of_week: Option<Vec<fhirbolt_model::r4::types::Code>> = None;
                let mut r#all_day: Option<fhirbolt_model::r4::types::Boolean> = None;
                let mut r#available_start_time: Option<fhirbolt_model::r4::types::Time> = None;
                let mut r#available_end_time: Option<fhirbolt_model::r4::types::Time> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<HealthcareServiceAvailableTime>>
{
    type Value = Box<HealthcareServiceAvailableTime>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<HealthcareServiceAvailableTime>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<HealthcareServiceAvailableTime>>
{
    type Value = Vec<HealthcareServiceAvailableTime>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<HealthcareServiceAvailableTime>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<HealthcareServiceAvailableTime>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<HealthcareServiceAvailableTime> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r4::resources::HealthcareServiceNotAvailable;
impl serde::ser::Serialize for SerializationContext<&HealthcareServiceNotAvailable> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "HealthcareService.notAvailable", field
            )))
        }
        let mut state = tri!(serializer.serialize_map(None));
        if let Some(value) = self.value.r#id.as_ref() {
...
impl serde::ser::Serialize for SerializationContext<&Box<HealthcareServiceNotAvailable>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<HealthcareServiceNotAvailable>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<HealthcareServiceNotAvailable>
{
    ...
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<HealthcareServiceNotAvailable>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = HealthcareServiceNotAvailable;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#during: Option<Box<fhirbolt_model::r4::types::Period>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<HealthcareServiceNotAvailable>>
{
    type Value = Box<HealthcareServiceNotAvailable>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<HealthcareServiceNotAvailable>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<HealthcareServiceNotAvailable>>
{
    type Value = Vec<HealthcareServiceNotAvailable>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<HealthcareServiceNotAvailable>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<HealthcareServiceNotAvailable>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<HealthcareServiceNotAvailable> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r4::resources::HealthcareService;
impl crate::Resource for HealthcareService {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4;
}
impl serde::ser::Serialize for SerializationContext<&HealthcareService> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "HealthcareService"));
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#active.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("active", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_active", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#active.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("active", ctx)));
        }
        if let Some(some) = self.value.r#provided_by.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("providedBy", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#extra_details.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("extraDetails", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_extraDetails", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#extra_details.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("extraDetails", ctx)));
        }
        if let Some(some) = self.value.r#photo.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("photo", ctx)));
        }
        ...
        if !self.value.r#service_provision_code.is_empty() {
            tri!(
                self.with_context(&self.value.r#service_provision_code, |ctx| state
                    .serialize_entry("serviceProvisionCode", ctx))
            );
        }
        if !self.value.r#eligibility.is_empty() {
            tri!(self.with_context(&self.value.r#eligibility, |ctx| state
                .serialize_entry("eligibility", ctx)));
        }
        if !self.value.r#program.is_empty() {
            tri!(self.with_context(&self.value.r#program, |ctx| state
                .serialize_entry("program", ctx)));
        }
        ...
        if !self.value.r#communication.is_empty() {
            tri!(self.with_context(&self.value.r#communication, |ctx| state
                .serialize_entry("communication", ctx)));
        }
        if !self.value.r#referral_method.is_empty() {
            tri!(self.with_context(&self.value.r#referral_method, |ctx| state
                .serialize_entry("referralMethod", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#appointment_required.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("appointmentRequired", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_appointmentRequired", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#appointment_required.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("appointmentRequired", ctx)));
        }
        ...
        if !self.value.r#not_available.is_empty() {
            tri!(self.with_context(&self.value.r#not_available, |ctx| state
                .serialize_entry("notAvailable", ctx)));
        }
        if self.output == crate::context::Format::Json {
...
impl serde::ser::Serialize for SerializationContext<&Box<HealthcareService>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<HealthcareService>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<HealthcareService> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<HealthcareService> {
    type Value = HealthcareService;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<HealthcareService>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = HealthcareService;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#provided_by: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                ...
                let mut r#location: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#name: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#comment: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#extra_details: Option<fhirbolt_model::r4::types::Markdown> = None;
                let mut r#photo: Option<Box<fhirbolt_model::r4::types::Attachment>> = None;
                ...
                let mut r#eligibility: Option<
                    Vec<fhirbolt_model::r4::resources::HealthcareServiceEligibility>,
                > = None;
                let mut r#program: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#characteristic: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                let mut r#communication: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                let mut r#referral_method: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                let mut r#appointment_required: Option<fhirbolt_model::r4::types::Boolean> = None;
                let mut r#available_time: Option<
                    Vec<fhirbolt_model::r4::resources::HealthcareServiceAvailableTime>,
                > = None;
                let mut r#not_available: Option<
                    Vec<fhirbolt_model::r4::resources::HealthcareServiceNotAvailable>,
                > = None;
                let mut r#availability_exceptions: Option<fhirbolt_model::r4::types::String> = None;
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Active => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::types::Boolean,
                                > = self.0.transmute();
                                r#active = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::ProvidedBy => {
                            ...
                            > = self.0.transmute();
                            r#provided_by = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Category => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Photo => {
                            ...
                            > = self.0.transmute();
                            r#photo = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Telecom => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Eligibility => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<
                                        fhirbolt_model::r4::resources::HealthcareServiceEligibility,
                                    >,
                                > = self.0.transmute();
                                r#eligibility =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                        ...
                        Field::Program => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4::types::CodeableConcept>,
                                > = self.0.transmute();
                                r#program = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::AvailableTime => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: HealthcareServiceAvailableTime >> = self . 0 . transmute () ;
                                r#available_time =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#available_time.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::resources::HealthcareServiceAvailableTime,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::NotAvailable => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: HealthcareServiceNotAvailable >> = self . 0 . transmute () ;
                                r#not_available =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#not_available.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::resources::HealthcareServiceNotAvailable,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<HealthcareService>> {
    type Value = Box<HealthcareService>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<HealthcareService>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<HealthcareService>> {
    type Value = Vec<HealthcareService>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<HealthcareService>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<HealthcareService>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<HealthcareService> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
