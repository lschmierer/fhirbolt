...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#detail.as_ref() {
            match some {
                fhirbolt_model::r4::resources::PlanDefinitionGoalTargetDetail::Quantity(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailQuantity", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionGoalTargetDetail::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailRange", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionGoalTargetDetail::CodeableConcept(
                    ref value,
                ) => {
                ...
                fhirbolt_model::r4::resources::PlanDefinitionGoalTargetDetail::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::PlanDefinitionGoalTarget,
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionGoalTarget;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#detail: Option<
                    fhirbolt_model::r4::resources::PlanDefinitionGoalTargetDetail,
                > = None;
                let mut r#due: Option<Box<fhirbolt_model::r4::types::Duration>> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::DetailQuantity => {
                            ...
                            r#detail = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionGoalTargetDetail :: Quantity (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Quantity > > ()) ?)) ;
                        }
                        Field::DetailRange => {
                            if r#detail.is_some() {
                                return Err(serde::de::Error::duplicate_field("detailRange"));
                            }
                            r#detail = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionGoalTargetDetail :: Range (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Range > > ()) ?)) ;
                        }
                        Field::DetailCodeableConcept => {
                            ...
                            r#detail = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionGoalTargetDetail :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Due => {
                            if r#due.is_some() {
                ...
                Ok(fhirbolt_model::r4::resources::PlanDefinitionGoalTarget {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::PlanDefinitionGoalTarget>>(
                        ),
                )? {
                    values.push(value);
                }
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::PlanDefinitionGoal>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::PlanDefinitionGoal>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::PlanDefinitionGoal,
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionGoal;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionGoal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#start: Option<Box<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#addresses: Option<Vec<Box<fhirbolt_model::r4::types::CodeableConcept>>> =
                    None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Start => {
                            ...
                            r#start = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Addresses => {
                            if self.0.from_json {
                        ...
                        Field::Target => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionGoalTarget > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4::resources::PlanDefinitionGoal {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#category,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionGoal>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::PlanDefinitionGoal>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionGoal>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::PlanDefinitionGoal>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::PlanDefinitionGoal>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::PlanDefinitionActionCondition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::PlanDefinitionActionCondition,
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionActionCondition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionActionCondition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionCondition >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#offset.as_ref() {
            match some { fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedActionOffset :: Duration (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("offsetDuration" , ctx)) ? ; } , fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedActionOffset :: Range (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("offsetRange" , ctx)) ? ; } , fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedActionOffset :: Invalid => { return Err (serde :: ser :: Error :: custom ("offset is invalid")) } }
        }
        state.end()
    }
}
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#offset: Option<
                    fhirbolt_model::r4::resources::PlanDefinitionActionRelatedActionOffset,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::OffsetDuration => {
                            ...
                            r#offset = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedActionOffset :: Duration (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Duration > > ()) ?)) ;
                        }
                        Field::OffsetRange => {
                            if r#offset.is_some() {
                                return Err(serde::de::Error::duplicate_field("offsetRange"));
                            }
                            r#offset = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedActionOffset :: Range (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Range > > ()) ?)) ;
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedAction > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedAction >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::PlanDefinitionActionParticipant,
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionActionParticipant;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionParticipant > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionParticipant>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionParticipant >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDynamicValue > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDynamicValue >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::PlanDefinitionAction>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some {
                fhirbolt_model::r4::resources::PlanDefinitionActionSubject::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r4::resources::PlanDefinitionActionSubject::Reference(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("subjectReference", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionActionSubject::Invalid => {
        ...
        if let Some(some) = self.value.r#timing.as_ref() {
            match some {
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingAge", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingPeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Duration(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingDuration", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingRange", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingTiming", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Invalid => {
        ...
        if let Some(some) = self.value.r#definition.as_ref() {
            match some {
                fhirbolt_model::r4::resources::PlanDefinitionActionDefinition::Canonical(
                    ref value,
                ) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                ...
                fhirbolt_model::r4::resources::PlanDefinitionActionDefinition::Uri(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4::resources::PlanDefinitionActionDefinition::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::PlanDefinitionAction>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::PlanDefinitionAction>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionAction>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::PlanDefinitionAction,
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinitionAction;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinitionAction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#documentation: Option<
                    Vec<Box<fhirbolt_model::r4::types::RelatedArtifact>>,
                > = None;
                let mut r#goal_id: Option<Vec<fhirbolt_model::r4::types::Id>> = None;
                let mut r#subject: Option<
                    fhirbolt_model::r4::resources::PlanDefinitionActionSubject,
                > = None;
                let mut r#trigger: Option<Vec<Box<fhirbolt_model::r4::types::TriggerDefinition>>> =
                    None;
                let mut r#condition: Option<
                    Vec<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>,
                > = None;
                let mut r#input: Option<Vec<Box<fhirbolt_model::r4::types::DataRequirement>>> =
                    None;
                let mut r#output: Option<Vec<Box<fhirbolt_model::r4::types::DataRequirement>>> =
                    None;
                let mut r#related_action: Option<
                    Vec<fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction>,
                > = None;
                let mut r#timing: Option<
                    fhirbolt_model::r4::resources::PlanDefinitionActionTiming,
                > = None;
                ...
                let mut r#definition: Option<
                    fhirbolt_model::r4::resources::PlanDefinitionActionDefinition,
                > = None;
                let mut r#transform: Option<fhirbolt_model::r4::types::Canonical> = None;
                let mut r#dynamic_value: Option<
                    Vec<fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue>,
                > = None;
                let mut r#action: Option<Vec<fhirbolt_model::r4::resources::PlanDefinitionAction>> =
                    None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            if r#subject.is_some() {
                                return Err(serde::de::Error::duplicate_field("subjectReference"));
                            }
                            r#subject = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionSubject :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Reference > > ()) ?)) ;
                        }
                        Field::Trigger => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: TriggerDefinition > > ()) ?) ;
                            }
                        }
                        Field::Condition => {
                            if self.0.from_json {
                                ...
                                r#condition = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionCondition >> ()) ?) ;
                            } else {
                                let vec = r#condition.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionCondition > ()) ?) ;
                            }
                        }
                        Field::Input => {
                            if self.0.from_json {
                        ...
                        Field::RelatedAction => {
                            if self.0.from_json {
                                ...
                                r#related_action = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedAction >> ()) ?) ;
                            } else {
                                let vec = r#related_action.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedAction > ()) ?) ;
                            }
                        }
                        Field::TimingDateTime => {
                            if self.0.from_json {
                                let r#enum = r#timing . get_or_insert (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionTiming :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: PlanDefinitionActionTiming :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("timingDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("timing[x]")) ; }
                            } else {
                                if r#timing.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "timingDateTime",
                                ...
                                r#timing = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionTiming :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::TimingDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#timing . get_or_insert (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionTiming :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: PlanDefinitionActionTiming :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_timingDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_timing[x]")) ; }
                            } else {
                        ...
                        Field::TimingAge => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Age(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingPeriod => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingDuration => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Duration(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Box<fhirbolt_model::r4::types::Duration>>(
                                            ),
                        ...
                        Field::TimingRange => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Range(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingTiming => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::PlanDefinitionActionTiming::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Participant => {
                            if self.0.from_json {
                                ...
                                r#participant = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionParticipant >> ()) ?) ;
                            } else {
                                let vec = r#participant.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionParticipant > ()) ?) ;
                            }
                        }
                        Field::Type => {
                            if r#type.is_some() {
                        ...
                        Field::DefinitionCanonical => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("definitionCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("definition[x]")) ; }
                            } else {
                                ...
                                r#definition = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Canonical (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Canonical > > ()) ?)) ;
                            }
                        }
                        Field::DefinitionCanonicalPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Canonical (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_definitionCanonical")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_definition[x]")) ; }
                            } else {
                        ...
                        Field::DefinitionUri => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Uri (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Uri (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("definitionUri")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("definition[x]")) ; }
                            } else {
                                if r#definition.is_some() {
                                    return Err(serde::de::Error::duplicate_field("definitionUri"));
                                }
                                r#definition = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Uri (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Uri > > ()) ?)) ;
                            }
                        }
                        Field::DefinitionUriPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Uri (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDefinition :: Uri (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_definitionUri")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_definition[x]")) ; }
                            } else {
                        ...
                        Field::DynamicValue => {
                            if self.0.from_json {
                                ...
                                r#dynamic_value = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDynamicValue >> ()) ?) ;
                            } else {
                                let vec = r#dynamic_value.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDynamicValue > ()) ?) ;
                            }
                        }
                        Field::Action => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionAction > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4::resources::PlanDefinitionAction {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#prefix,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::PlanDefinitionAction>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinitionAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinitionAction>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::PlanDefinitionAction>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinitionAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::PlanDefinitionAction>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionAction>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinitionAction>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::PlanDefinitionAction>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r4::resources::PlanDefinition {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::PlanDefinition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some {
                fhirbolt_model::r4::resources::PlanDefinitionSubject::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("subjectCodeableConcept", ctx)
                ...
                fhirbolt_model::r4::resources::PlanDefinitionSubject::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("subjectReference", ctx))?;
                }
                fhirbolt_model::r4::resources::PlanDefinitionSubject::Invalid => {
                    return Err(serde::ser::Error::custom("subject is invalid"))
                }
            }
        }
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::PlanDefinition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::PlanDefinition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::PlanDefinition>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::PlanDefinition>
{
    type Value = fhirbolt_model::r4::resources::PlanDefinition;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::PlanDefinition,
    >
{
    type Value = fhirbolt_model::r4::resources::PlanDefinition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::PlanDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#subject: Option<fhirbolt_model::r4::resources::PlanDefinitionSubject> =
                    None;
                ...
                let mut r#goal: Option<Vec<fhirbolt_model::r4::resources::PlanDefinitionGoal>> =
                    None;
                let mut r#action: Option<Vec<fhirbolt_model::r4::resources::PlanDefinitionAction>> =
                    None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r4 :: resources :: PlanDefinitionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            if r#subject.is_some() {
                                return Err(serde::de::Error::duplicate_field("subjectReference"));
                            ...
                            r#subject = Some(
                                fhirbolt_model::r4::resources::PlanDefinitionSubject::Reference(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Goal => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: PlanDefinitionGoal > ()) ?) ;
                            }
                        }
                        Field::Action => {
                            if self.0.from_json {
                ...
                Ok(fhirbolt_model::r4::resources::PlanDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::PlanDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::PlanDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::PlanDefinition>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::PlanDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::PlanDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::PlanDefinition>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::PlanDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::PlanDefinition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
