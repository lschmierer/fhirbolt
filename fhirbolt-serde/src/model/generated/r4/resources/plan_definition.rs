...
use fhirbolt_model::r4::resources::PlanDefinitionGoalTarget;
impl serde::ser::Serialize for SerializationContext<&PlanDefinitionGoalTarget> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::PlanDefinitionGoalTargetDetail as _Enum;
...
use fhirbolt_model::r4::resources::PlanDefinitionGoal;
...
use fhirbolt_model::r4::resources::PlanDefinitionActionCondition;
...
use fhirbolt_model::r4::resources::PlanDefinitionActionRelatedAction;
...
use fhirbolt_model::r4::resources::PlanDefinitionActionParticipant;
...
use fhirbolt_model::r4::resources::PlanDefinitionActionDynamicValue;
...
use fhirbolt_model::r4::resources::PlanDefinitionAction;
impl serde::ser::Serialize for SerializationContext<&PlanDefinitionAction> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::PlanDefinitionActionSubject as _Enum;
        ...
        {
            use fhirbolt_model::r4::resources::PlanDefinitionActionTiming as _Enum;
        ...
        {
            use fhirbolt_model::r4::resources::PlanDefinitionActionDefinition as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::Condition => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionCondition >> = self . 0 . transmute () ;
                                r#condition =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::RelatedAction => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedAction >> = self . 0 . transmute () ;
                                r#related_action =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#related_action.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionRelatedAction > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Participant => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionParticipant >> = self . 0 . transmute () ;
                                r#participant =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::DynamicValue => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: PlanDefinitionActionDynamicValue >> = self . 0 . transmute () ;
                                r#dynamic_value =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
...
use fhirbolt_model::r4::resources::PlanDefinition;
...
impl serde::ser::Serialize for SerializationContext<&PlanDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::PlanDefinitionSubject as _Enum;
            if let Some(some) = self.value.r#subject.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
