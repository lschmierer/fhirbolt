        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#addresses: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#documentation: Option<Vec<fhirbolt_model::r4::types::RelatedArtifact>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Addresses => {
                            if self.0.from_json {
                                ...
                                r#addresses = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Documentation => {
                            if self.0.from_json {
                                ...
                                r#documentation = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: RelatedArtifact >> ()) ?) ;
                            } else {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#reason: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#documentation: Option<Vec<fhirbolt_model::r4::types::RelatedArtifact>> =
                    None;
                ...
                > = None;
                let mut r#trigger: Option<Vec<fhirbolt_model::r4::types::TriggerDefinition>> = None;
                let mut r#condition: Option<
                    Vec<fhirbolt_model::r4::resources::PlanDefinitionActionCondition>,
                > = None;
                let mut r#input: Option<Vec<fhirbolt_model::r4::types::DataRequirement>> = None;
                let mut r#output: Option<Vec<fhirbolt_model::r4::types::DataRequirement>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Code => {
                            if self.0.from_json {
                                ...
                                r#code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Reason => {
                            if self.0.from_json {
                                ...
                                r#reason = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Trigger => {
                            if self.0.from_json {
                                ...
                                r#trigger = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: TriggerDefinition >> ()) ?) ;
                            } else {
                                let vec = r#trigger.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: types :: TriggerDefinition > ()) ?) ;
                            }
                        }
                        Field::Condition => {
                            if self.0.from_json {
                        ...
                        Field::Input => {
                            if self.0.from_json {
                                ...
                                r#input = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: DataRequirement >> ()) ?) ;
                            } else {
                                let vec = r#input.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: types :: DataRequirement > ()) ?) ;
                            }
                        }
                        Field::Output => {
                            if self.0.from_json {
                                ...
                                r#output = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: DataRequirement >> ()) ?) ;
                            } else {
