...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::RiskAssessmentPrediction>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#probability.as_ref() {
            match some {
                fhirbolt_model::r4::resources::RiskAssessmentPredictionProbability::Decimal(
                    ref value,
                ) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::resources::RiskAssessmentPredictionProbability::Range(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("probabilityRange", ctx))?;
                }
                fhirbolt_model::r4::resources::RiskAssessmentPredictionProbability::Invalid => {
        ...
        if let Some(some) = self.value.r#when.as_ref() {
            match some {
                fhirbolt_model::r4::resources::RiskAssessmentPredictionWhen::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("whenPeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::RiskAssessmentPredictionWhen::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("whenRange", ctx))?;
                }
                fhirbolt_model::r4::resources::RiskAssessmentPredictionWhen::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::RiskAssessmentPrediction>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::RiskAssessmentPrediction>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::RiskAssessmentPrediction>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::RiskAssessmentPrediction,
    >
{
    type Value = fhirbolt_model::r4::resources::RiskAssessmentPrediction;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::RiskAssessmentPrediction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#probability: Option<
                    fhirbolt_model::r4::resources::RiskAssessmentPredictionProbability,
                > = None;
                let mut r#qualitative_risk: Option<
                    Box<fhirbolt_model::r4::types::CodeableConcept>,
                > = None;
                let mut r#relative_risk: Option<fhirbolt_model::r4::types::Decimal> = None;
                let mut r#when: Option<
                    fhirbolt_model::r4::resources::RiskAssessmentPredictionWhen,
                > = None;
                let mut r#rationale: Option<fhirbolt_model::r4::types::String> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ProbabilityDecimal => {
                            if self.0.from_json {
                                let r#enum = r#probability . get_or_insert (fhirbolt_model :: r4 :: resources :: RiskAssessmentPredictionProbability :: Decimal (Default :: default ())) ;
                                ...
                                r#probability = Some (fhirbolt_model :: r4 :: resources :: RiskAssessmentPredictionProbability :: Decimal (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Decimal > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::ProbabilityRange => {
                            ...
                            r#probability = Some (fhirbolt_model :: r4 :: resources :: RiskAssessmentPredictionProbability :: Range (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Range > > ()) ?)) ;
                        }
                        Field::QualitativeRisk => {
                            if r#qualitative_risk.is_some() {
                                return Err(serde::de::Error::duplicate_field("qualitativeRisk"));
                            }
                            r#qualitative_risk = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::RelativeRisk => {
                            if self.0.from_json {
                        ...
                        Field::WhenPeriod => {
                            ...
                            r#when = Some(
                                fhirbolt_model::r4::resources::RiskAssessmentPredictionWhen::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::WhenRange => {
                            ...
                            r#when = Some(
                                fhirbolt_model::r4::resources::RiskAssessmentPredictionWhen::Range(
                                    map_access.next_value_seed(
                ...
                Ok(fhirbolt_model::r4::resources::RiskAssessmentPrediction {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::RiskAssessmentPrediction>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::RiskAssessmentPrediction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::RiskAssessmentPrediction>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::RiskAssessmentPrediction>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::RiskAssessmentPrediction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::RiskAssessmentPrediction>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::RiskAssessmentPrediction>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::RiskAssessmentPrediction>>(
                        ),
                )? {
                    values.push(value);
                }
...
impl crate::Resource for fhirbolt_model::r4::resources::RiskAssessment {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::RiskAssessment>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#occurrence.as_ref() {
            match some {
                fhirbolt_model::r4::resources::RiskAssessmentOccurrence::DateTime(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4::resources::RiskAssessmentOccurrence::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrencePeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::RiskAssessmentOccurrence::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::RiskAssessment>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::RiskAssessment>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::RiskAssessment>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::RiskAssessment>
{
    type Value = fhirbolt_model::r4::resources::RiskAssessment;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::RiskAssessment,
    >
{
    type Value = fhirbolt_model::r4::resources::RiskAssessment;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::RiskAssessment, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#identifier: Option<Vec<Box<fhirbolt_model::r4::types::Identifier>>> =
                    None;
                let mut r#based_on: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                ...
                let mut r#occurrence: Option<
                    fhirbolt_model::r4::resources::RiskAssessmentOccurrence,
                > = None;
                ...
                let mut r#reason_reference: Option<Vec<Box<fhirbolt_model::r4::types::Reference>>> =
                    None;
                let mut r#basis: Option<Vec<Box<fhirbolt_model::r4::types::Reference>>> = None;
                let mut r#prediction: Option<
                    Vec<fhirbolt_model::r4::resources::RiskAssessmentPrediction>,
                > = None;
                let mut r#mitigation: Option<fhirbolt_model::r4::types::String> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::OccurrenceDateTime => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r4 :: resources :: RiskAssessmentOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: RiskAssessmentOccurrence :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("occurrenceDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("occurrence[x]")) ; }
                            } else {
                                ...
                                r#occurrence = Some (fhirbolt_model :: r4 :: resources :: RiskAssessmentOccurrence :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::OccurrenceDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r4 :: resources :: RiskAssessmentOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: RiskAssessmentOccurrence :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_occurrenceDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_occurrence[x]")) ; }
                            } else {
                        ...
                        Field::OccurrencePeriod => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4::resources::RiskAssessmentOccurrence::Period(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Box<fhirbolt_model::r4::types::Period>>(),
                                    )?,
                        ...
                        Field::Basis => {
                            if self.0.from_json {
                                ...
                                r#basis = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4 :: types :: Reference > >> ()) ?) ;
                            } else {
                        ...
                        Field::Prediction => {
                            if self.0.from_json {
                                ...
                                r#prediction = Some(map_access.next_value_seed(
                                    self.0.transmute::<Vec<
                                        fhirbolt_model::r4::resources::RiskAssessmentPrediction,
                                    >>(),
                                )?);
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: RiskAssessmentPrediction > ()) ?) ;
                            }
                        }
                        Field::Mitigation => {
                            if self.0.from_json {
                ...
                Ok(fhirbolt_model::r4::resources::RiskAssessment {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::RiskAssessment>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::RiskAssessment>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::RiskAssessment>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::RiskAssessment>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::RiskAssessment>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::RiskAssessment>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::RiskAssessment>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::RiskAssessment>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
