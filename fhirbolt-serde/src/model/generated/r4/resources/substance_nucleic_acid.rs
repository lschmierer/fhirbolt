...
use fhirbolt_model::r4::resources::SubstanceNucleicAcidSubunitLinkage;
                    ...
                    match map_access_key {
                        ...
                        Field::Connectivity => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#connectivity = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        ...
                        Field::ResidueSite => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::types::String,
                                > = self.0.transmute();
                                r#residue_site = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
...
use fhirbolt_model::r4::resources::SubstanceNucleicAcidSubunitSugar;
...
use fhirbolt_model::r4::resources::SubstanceNucleicAcidSubunit;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::FivePrime => {
                            ...
                            > = self.0.transmute();
                            r#five_prime = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::ThreePrime => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#three_prime = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Linkage => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: SubstanceNucleicAcidSubunitLinkage >> = self . 0 . transmute () ;
                                r#linkage = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                                let vec = r#linkage.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: SubstanceNucleicAcidSubunitLinkage > = self . 0 . transmute () ;
                                vec.push(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        Field::Sugar => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: SubstanceNucleicAcidSubunitSugar >> = self . 0 . transmute () ;
                                r#sugar = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
...
use fhirbolt_model::r4::resources::SubstanceNucleicAcid;
