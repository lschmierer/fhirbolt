...
use fhirbolt_model::r4::resources::ServiceRequest;
...
impl serde::ser::Serialize for SerializationContext<&ServiceRequest> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ServiceRequestQuantity as _Enum;
        ...
        {
            use fhirbolt_model::r4::resources::ServiceRequestOccurrence as _Enum;
        ...
        {
            use fhirbolt_model::r4::resources::ServiceRequestAsNeeded as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#order_detail: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                ...
                let mut r#location_code: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                let mut r#location_reference: Option<Vec<fhirbolt_model::r4::types::Reference>> =
                    None;
