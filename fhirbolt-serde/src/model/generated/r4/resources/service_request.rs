                    ...
                    match map_access_key {
                        ...
                        Field::OrderDetail => {
                            if self.0.from_json {
                                ...
                                r#order_detail = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::LocationCode => {
                            if self.0.from_json {
                                ...
                                r#location_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
