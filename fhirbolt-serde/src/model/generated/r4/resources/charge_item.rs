        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#bodysite: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                ...
                let mut r#service: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Bodysite => {
                            if self.0.from_json {
                                ...
                                r#bodysite = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
