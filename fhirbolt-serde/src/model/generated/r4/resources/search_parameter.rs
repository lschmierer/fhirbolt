...
use fhirbolt_model::r4::resources::SearchParameterComponent;
...
use fhirbolt_model::r4::resources::SearchParameter;
...
impl serde::ser::Serialize for SerializationContext<&SearchParameter> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#xpath_usage.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("xpathUsage", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_xpathUsage", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#xpath_usage.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("xpathUsage", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#derived_from: Option<fhirbolt_model::r4::types::Canonical> = None;
                ...
                let mut r#base: Option<Vec<fhirbolt_model::r4::types::Code>> = None;
                let mut r#type: Option<fhirbolt_model::r4::types::Code> = None;
                let mut r#expression: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#xpath: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#xpath_usage: Option<fhirbolt_model::r4::types::Code> = None;
                let mut r#target: Option<Vec<fhirbolt_model::r4::types::Code>> = None;
                let mut r#multiple_or: Option<fhirbolt_model::r4::types::Boolean> = None;
                let mut r#multiple_and: Option<fhirbolt_model::r4::types::Boolean> = None;
                let mut r#comparator: Option<Vec<fhirbolt_model::r4::types::Code>> = None;
                let mut r#modifier: Option<Vec<fhirbolt_model::r4::types::Code>> = None;
                let mut r#chain: Option<Vec<fhirbolt_model::r4::types::String>> = None;
                let mut r#component: Option<
                    Vec<fhirbolt_model::r4::resources::SearchParameterComponent>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::Component => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4::resources::SearchParameterComponent,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
