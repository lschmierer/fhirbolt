...
impl crate::Resource for fhirbolt_model::r4::resources::GuidanceResponse {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::GuidanceResponse>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        match self.value.r#module {
            fhirbolt_model::r4::resources::GuidanceResponseModule::Uri(ref value) => {
                if self.output_json {
            ...
            fhirbolt_model::r4::resources::GuidanceResponseModule::Canonical(ref value) => {
                if self.output_json {
                    if let Some(some) = value.value.as_ref() {
                        let some = Ok(some)?;
            ...
            fhirbolt_model::r4::resources::GuidanceResponseModule::CodeableConcept(ref value) => {
                self.with_context(value, |ctx| {
                    state.serialize_entry("moduleCodeableConcept", ctx)
                })?;
            }
            fhirbolt_model::r4::resources::GuidanceResponseModule::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::GuidanceResponse>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::GuidanceResponse>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::GuidanceResponse>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::GuidanceResponse>
{
    type Value = fhirbolt_model::r4::resources::GuidanceResponse;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::GuidanceResponse,
    >
{
    type Value = fhirbolt_model::r4::resources::GuidanceResponse;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::GuidanceResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ModuleUri => {
                            if self.0.from_json {
                                let r#enum = r#module.get_or_insert(
                                    fhirbolt_model::r4::resources::GuidanceResponseModule::Uri(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r4::resources::GuidanceResponseModule::Uri(
                                    variant,
                                ) = r#enum
                                {
                        ...
                        Field::ModuleCanonical => {
                            if self.0.from_json {
                                let r#enum = r#module . get_or_insert (fhirbolt_model :: r4 :: resources :: GuidanceResponseModule :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: GuidanceResponseModule :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("moduleCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("module[x]")) ; }
                            } else {
                                if r#module.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "moduleCanonical",
                                ...
                                r#module = Some (fhirbolt_model :: r4 :: resources :: GuidanceResponseModule :: Canonical (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Canonical > > ()) ?)) ;
                            }
                        }
                        Field::ModuleCanonicalPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#module . get_or_insert (fhirbolt_model :: r4 :: resources :: GuidanceResponseModule :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: GuidanceResponseModule :: Canonical (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_moduleCanonical")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_module[x]")) ; }
                            } else {
                        ...
                        Field::ModuleCodeableConcept => {
                            ...
                            r#module = Some (fhirbolt_model :: r4 :: resources :: GuidanceResponseModule :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Status => {
                            if self.0.from_json {
                        ...
                        Field::EvaluationMessage => {
                            if self.0.from_json {
                                ...
                                r#evaluation_message = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4 :: types :: Reference > >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r4::resources::GuidanceResponse {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::GuidanceResponse>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::GuidanceResponse>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::GuidanceResponse>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::GuidanceResponse>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::GuidanceResponse>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::GuidanceResponse>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::GuidanceResponse>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::GuidanceResponse>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
