...
use fhirbolt_model::r4::resources::InvoiceParticipant;
...
use fhirbolt_model::r4::resources::InvoiceLineItemPriceComponent;
...
use fhirbolt_model::r4::resources::InvoiceLineItem;
impl serde::ser::Serialize for SerializationContext<&InvoiceLineItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::InvoiceLineItemChargeItem as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::PriceComponent => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: InvoiceLineItemPriceComponent >> = self . 0 . transmute () ;
                                r#price_component =
                                    Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
...
use fhirbolt_model::r4::resources::Invoice;
