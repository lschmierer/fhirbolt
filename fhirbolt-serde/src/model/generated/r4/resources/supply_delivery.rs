...
use fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem;
impl serde::ser::Serialize for SerializationContext<&SupplyDeliverySuppliedItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::SupplyDeliverySuppliedItemItem as _Enum;
...
use fhirbolt_model::r4::resources::SupplyDelivery;
...
impl serde::ser::Serialize for SerializationContext<&SupplyDelivery> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#supplied_item.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("suppliedItem", ctx)));
        }
        {
            use fhirbolt_model::r4::resources::SupplyDeliveryOccurrence as _Enum;
