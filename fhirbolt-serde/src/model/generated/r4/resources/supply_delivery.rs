...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#item.as_ref() {
            match some {
                fhirbolt_model::r4::resources::SupplyDeliverySuppliedItemItem::CodeableConcept(
                    ref value,
                ) => {
                ...
                fhirbolt_model::r4::resources::SupplyDeliverySuppliedItemItem::Reference(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("itemReference", ctx))?;
                }
                fhirbolt_model::r4::resources::SupplyDeliverySuppliedItemItem::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem,
    >
{
    type Value = fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#item: Option<
                    fhirbolt_model::r4::resources::SupplyDeliverySuppliedItemItem,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ItemCodeableConcept => {
                            ...
                            r#item = Some (fhirbolt_model :: r4 :: resources :: SupplyDeliverySuppliedItemItem :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::ItemReference => {
                            if r#item.is_some() {
                                return Err(serde::de::Error::duplicate_field("itemReference"));
                            }
                            r#item = Some (fhirbolt_model :: r4 :: resources :: SupplyDeliverySuppliedItemItem :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: Reference > > ()) ?)) ;
                        }
                        Field::Unknown(key) => {
                ...
                Ok(fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::SupplyDeliverySuppliedItem>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: SupplyDeliverySuppliedItem >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl crate::Resource for fhirbolt_model::r4::resources::SupplyDelivery {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::SupplyDelivery>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#occurrence.as_ref() {
            match some {
                fhirbolt_model::r4::resources::SupplyDeliveryOccurrence::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::resources::SupplyDeliveryOccurrence::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrencePeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::SupplyDeliveryOccurrence::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrenceTiming", ctx))?;
                }
                fhirbolt_model::r4::resources::SupplyDeliveryOccurrence::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::SupplyDelivery>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::SupplyDelivery>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::SupplyDelivery>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::SupplyDelivery>
{
    type Value = fhirbolt_model::r4::resources::SupplyDelivery;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::SupplyDelivery,
    >
{
    type Value = fhirbolt_model::r4::resources::SupplyDelivery;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::SupplyDelivery, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#occurrence: Option<
                    fhirbolt_model::r4::resources::SupplyDeliveryOccurrence,
                > = None;
                let mut r#supplier: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::SuppliedItem => {
                            ...
                            r#supplied_item = Some (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: SupplyDeliverySuppliedItem > ()) ?) ;
                        }
                        Field::OccurrenceDateTime => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r4 :: resources :: SupplyDeliveryOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: SupplyDeliveryOccurrence :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("occurrenceDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("occurrence[x]")) ; }
                            } else {
                                ...
                                r#occurrence = Some (fhirbolt_model :: r4 :: resources :: SupplyDeliveryOccurrence :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::OccurrencePeriod => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4::resources::SupplyDeliveryOccurrence::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::OccurrenceTiming => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4::resources::SupplyDeliveryOccurrence::Timing(
                                    map_access.next_value_seed(
                                        self.0
                ...
                Ok(fhirbolt_model::r4::resources::SupplyDelivery {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::SupplyDelivery>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::SupplyDelivery>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::SupplyDelivery>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::SupplyDelivery>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::SupplyDelivery>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::SupplyDelivery>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::SupplyDelivery>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::SupplyDelivery>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
