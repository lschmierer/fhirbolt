...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::ConditionStage>
{
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::ConditionStage>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::ConditionStage>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::ConditionStage>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::ConditionStage,
    >
{
    type Value = fhirbolt_model::r4::resources::ConditionStage;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::ConditionStage, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#summary: Option<Box<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#assessment: Option<Vec<Box<fhirbolt_model::r4::types::Reference>>> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Summary => {
                            ...
                            r#summary = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Assessment => {
                            if self.0.from_json {
                                ...
                                r#assessment = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4 :: types :: Reference > >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r4::resources::ConditionStage {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::ConditionStage>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::ConditionStage>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::ConditionStage>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::ConditionStage>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::ConditionStage>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::ConditionStage>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::ConditionStage>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::ConditionStage>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::ConditionStage>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::ConditionEvidence>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::ConditionEvidence>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::ConditionEvidence>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::ConditionEvidence>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::ConditionEvidence,
    >
{
    type Value = fhirbolt_model::r4::resources::ConditionEvidence;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::ConditionEvidence, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                Ok(fhirbolt_model::r4::resources::ConditionEvidence {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4::resources::ConditionEvidence>,
    >
{
    type Value = Box<fhirbolt_model::r4::resources::ConditionEvidence>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::ConditionEvidence>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::ConditionEvidence>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::ConditionEvidence>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::ConditionEvidence>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::ConditionEvidence>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::ConditionEvidence>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::ConditionEvidence>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r4::resources::Condition {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::Condition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#onset.as_ref() {
            match some {
                fhirbolt_model::r4::resources::ConditionOnset::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::resources::ConditionOnset::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("onsetAge", ctx))?;
                }
                fhirbolt_model::r4::resources::ConditionOnset::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("onsetPeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::ConditionOnset::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("onsetRange", ctx))?;
                }
                fhirbolt_model::r4::resources::ConditionOnset::String(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4::resources::ConditionOnset::Invalid => {
        ...
        if let Some(some) = self.value.r#abatement.as_ref() {
            match some {
                fhirbolt_model::r4::resources::ConditionAbatement::DateTime(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4::resources::ConditionAbatement::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("abatementAge", ctx))?;
                }
                fhirbolt_model::r4::resources::ConditionAbatement::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("abatementPeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::ConditionAbatement::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("abatementRange", ctx))?;
                }
                fhirbolt_model::r4::resources::ConditionAbatement::String(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4::resources::ConditionAbatement::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::Condition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::Condition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::Condition>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::Condition>
{
    type Value = fhirbolt_model::r4::resources::Condition;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r4::resources::Condition>
{
    type Value = fhirbolt_model::r4::resources::Condition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r4::resources::Condition,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r4::resources::Condition;
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::Condition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#onset: Option<fhirbolt_model::r4::resources::ConditionOnset> = None;
                let mut r#abatement: Option<fhirbolt_model::r4::resources::ConditionAbatement> =
                    None;
                ...
                let mut r#stage: Option<Vec<fhirbolt_model::r4::resources::ConditionStage>> = None;
                let mut r#evidence: Option<Vec<fhirbolt_model::r4::resources::ConditionEvidence>> =
                    None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Severity => {
                            ...
                            r#severity = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Code => {
                            if r#code.is_some() {
                                return Err(serde::de::Error::duplicate_field("code"));
                        ...
                        Field::OnsetDateTime => {
                            if self.0.from_json {
                                let r#enum = r#onset.get_or_insert(
                                    fhirbolt_model::r4::resources::ConditionOnset::DateTime(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r4::resources::ConditionOnset::DateTime(
                                    variant,
                                ) = r#enum
                                {
                                ...
                                r#onset = Some (fhirbolt_model :: r4 :: resources :: ConditionOnset :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::OnsetAge => {
                            ...
                            r#onset = Some(fhirbolt_model::r4::resources::ConditionOnset::Age(
                                map_access.next_value_seed(
                        ...
                        Field::OnsetPeriod => {
                            ...
                            r#onset = Some(fhirbolt_model::r4::resources::ConditionOnset::Period(
                                map_access.next_value_seed(
                        ...
                        Field::OnsetRange => {
                            ...
                            r#onset = Some(fhirbolt_model::r4::resources::ConditionOnset::Range(
                                map_access.next_value_seed(
                        ...
                        Field::OnsetString => {
                            if self.0.from_json {
                                let r#enum = r#onset.get_or_insert(
                                    fhirbolt_model::r4::resources::ConditionOnset::String(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r4::resources::ConditionOnset::String(
                                    variant,
                                ) = r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#onset = Some (fhirbolt_model :: r4 :: resources :: ConditionOnset :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: String > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::AbatementDateTime => {
                            if self.0.from_json {
                                let r#enum = r#abatement.get_or_insert(
                                    fhirbolt_model::r4::resources::ConditionAbatement::DateTime(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r4::resources::ConditionAbatement::DateTime(
                                    variant,
                                ) = r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#abatement = Some (fhirbolt_model :: r4 :: resources :: ConditionAbatement :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::AbatementAge => {
                            ...
                            r#abatement =
                                Some(fhirbolt_model::r4::resources::ConditionAbatement::Age(
                                    map_access.next_value_seed(
                                        self.0.transmute::<Box<fhirbolt_model::r4::types::Age>>(),
                                    )?,
                                ));
                        ...
                        Field::AbatementPeriod => {
                            ...
                            r#abatement =
                                Some(fhirbolt_model::r4::resources::ConditionAbatement::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::AbatementRange => {
                            ...
                            r#abatement =
                                Some(fhirbolt_model::r4::resources::ConditionAbatement::Range(
                                    map_access.next_value_seed(
                                        self.0.transmute::<Box<fhirbolt_model::r4::types::Range>>(),
                                    )?,
                                ));
                        ...
                        Field::AbatementString => {
                            if self.0.from_json {
                                let r#enum = r#abatement.get_or_insert(
                                    fhirbolt_model::r4::resources::ConditionAbatement::String(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r4::resources::ConditionAbatement::String(
                                    variant,
                                ) = r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#abatement = Some (fhirbolt_model :: r4 :: resources :: ConditionAbatement :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: String > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::Stage => {
                            if self.0.from_json {
                                ...
                                r#stage = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: ConditionStage >> ()) ?) ;
                            } else {
                                let vec = r#stage.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: ConditionStage > ()) ?) ;
                            }
                        }
                        Field::Evidence => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: ConditionEvidence > ()) ?) ;
                            }
                        }
                        Field::Note => {
                            if self.0.from_json {
                ...
                Ok(fhirbolt_model::r4::resources::Condition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::Condition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::Condition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::Condition>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::Condition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::Condition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::Condition>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::Condition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::Condition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
