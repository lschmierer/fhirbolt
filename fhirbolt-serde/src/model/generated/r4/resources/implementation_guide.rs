...
use fhirbolt_model::r4::resources::ImplementationGuideDependsOn;
...
use fhirbolt_model::r4::resources::ImplementationGuideGlobal;
...
use fhirbolt_model::r4::resources::ImplementationGuideDefinitionGrouping;
...
use fhirbolt_model::r4::resources::ImplementationGuideDefinitionResource;
impl serde::ser::Serialize for SerializationContext<&ImplementationGuideDefinitionResource> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ImplementationGuideDefinitionResourceExample as _Enum;
            if let Some(some) = self.value.r#example.as_ref() {
                match some {
                    _Enum::Boolean(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("exampleBoolean", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_exampleBoolean", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("exampleBoolean", ctx)));
                        }
                    }
                    _Enum::Canonical(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("exampleCanonical", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_exampleCanonical", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("exampleCanonical", ctx)));
                        }
                    }
                    ...
                    match map_access_key {
                        ...
                        Field::ExampleBoolean => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#example = Some(_Enum::Boolean(tri!(
                        ...
                        Field::ExampleCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#example = Some(_Enum::Canonical(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
...
use fhirbolt_model::r4::resources::ImplementationGuideDefinitionPage;
impl serde::ser::Serialize for SerializationContext<&ImplementationGuideDefinitionPage> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ImplementationGuideDefinitionPageName as _Enum;
            match self.value.r#name {
                _Enum::Url(ref value) => {
                    if self.output == crate::context::Format::Json {
                        if let Some(some) = value.value.as_ref().map(Ok) {
                            tri!(state.serialize_entry("nameUrl", &some?));
                        }
                        if value.id.is_some() || !value.extension.is_empty() {
                            use super::super::serde_helpers::PrimitiveElement;
                            let primitive_element = PrimitiveElement {
                            ...
                            tri!(self.with_context(&primitive_element, |ctx| state
                                .serialize_entry("_nameUrl", ctx)));
                        }
                    } else {
                        tri!(self.with_context(value, |ctx| state.serialize_entry("nameUrl", ctx)));
                    }
                }
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::NameReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::Reference>,
                            > = self.0.transmute();
                            r#name = Some(_Enum::Reference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::Title => {
                        ...
                        Field::Page => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionPage >> = self . 0 . transmute () ;
                                r#page = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#page.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionPage > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
                ...
                Ok(ImplementationGuideDefinitionPage {
                    ...
                    r#name: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#name.ok_or(serde::de::Error::missing_field("name[x]")))
                    },
...
use fhirbolt_model::r4::resources::ImplementationGuideDefinitionParameter;
...
use fhirbolt_model::r4::resources::ImplementationGuideDefinitionTemplate;
...
use fhirbolt_model::r4::resources::ImplementationGuideDefinition;
                    ...
                    match map_access_key {
                        ...
                        Field::Grouping => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionGrouping >> = self . 0 . transmute () ;
                                r#grouping = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#grouping.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionGrouping > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Resource => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionResource >> = self . 0 . transmute () ;
                                r#resource = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#resource.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionResource > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Page => {
                        ...
                        Field::Parameter => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionParameter >> = self . 0 . transmute () ;
                                r#parameter =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#parameter.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionParameter > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Template => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionTemplate >> = self . 0 . transmute () ;
                                r#template = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#template.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: ImplementationGuideDefinitionTemplate > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4::resources::ImplementationGuideManifestResource;
impl serde::ser::Serialize for SerializationContext<&ImplementationGuideManifestResource> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ImplementationGuideManifestResourceExample as _Enum;
            if let Some(some) = self.value.r#example.as_ref() {
                match some {
                    _Enum::Boolean(ref value) => {
                        if self.output == crate::context::Format::Json {
...
use fhirbolt_model::r4::resources::ImplementationGuideManifestPage;
...
use fhirbolt_model::r4::resources::ImplementationGuideManifest;
                    ...
                    match map_access_key {
                        ...
                        Field::Resource => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideManifestResource >> = self . 0 . transmute () ;
                                r#resource = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#resource.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: ImplementationGuideManifestResource > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Page => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: ImplementationGuideManifestPage >> = self . 0 . transmute () ;
                                r#page = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#page.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
...
use fhirbolt_model::r4::resources::ImplementationGuide;
