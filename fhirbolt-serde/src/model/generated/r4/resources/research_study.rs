        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#protocol: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                ...
                let mut r#focus: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                ...
                > = None;
                let mut r#keyword: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#location: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#description: Option<fhirbolt_model::r4::types::Markdown> = None;
                let mut r#enrollment: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Focus => {
                            if self.0.from_json {
                                ...
                                r#focus = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Keyword => {
                            if self.0.from_json {
                                ...
                                r#keyword = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Location => {
                            if self.0.from_json {
                                ...
                                r#location = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
