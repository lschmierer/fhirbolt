...
use fhirbolt_model::r4::resources::TaskRestriction;
...
use fhirbolt_model::r4::resources::TaskInput;
impl serde::ser::Serialize for SerializationContext<&TaskInput> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::TaskInputValue as _Enum;
...
use fhirbolt_model::r4::resources::TaskOutput;
impl serde::ser::Serialize for SerializationContext<&TaskOutput> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::TaskOutputValue as _Enum;
            match self.value.r#value {
                _Enum::Base64Binary(ref value) => {
                    if self.output == crate::context::Format::Json {
                        if let Some(some) = value.value.as_ref().map(Ok) {
...
use fhirbolt_model::r4::resources::Task;
...
impl serde::ser::Serialize for SerializationContext<&Task> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Task"));
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#business_status.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("businessStatus", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#execution_period.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("executionPeriod", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#reason_code.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("reasonCode", ctx)));
        }
        if let Some(some) = self.value.r#reason_reference.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("reasonReference", ctx)));
        }
                    ...
                    match map_access_key {
                        ...
                        Field::ReasonCode => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#reason_code = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
