...
use fhirbolt_model::r4::resources::ContractContentDefinition;
...
use fhirbolt_model::r4::resources::ContractTermSecurityLabel;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#category: Option<Vec<fhirbolt_model::r4::types::Coding>> = None;
                let mut r#control: Option<Vec<fhirbolt_model::r4::types::Coding>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4::resources::ContractTermOfferParty;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#reference: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
...
use fhirbolt_model::r4::resources::ContractTermOfferAnswer;
impl serde::ser::Serialize for SerializationContext<&ContractTermOfferAnswer> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractTermOfferAnswerValue as _Enum;
...
use fhirbolt_model::r4::resources::ContractTermOffer;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#decision_mode: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
...
use fhirbolt_model::r4::resources::ContractTermAssetContext;
...
use fhirbolt_model::r4::resources::ContractTermAssetValuedItem;
impl serde::ser::Serialize for SerializationContext<&ContractTermAssetValuedItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractTermAssetValuedItemEntity as _Enum;
...
use fhirbolt_model::r4::resources::ContractTermAsset;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#type_reference: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#subtype: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                ...
                let mut r#period_type: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                let mut r#period: Option<Vec<fhirbolt_model::r4::types::Period>> = None;
                let mut r#use_period: Option<Vec<fhirbolt_model::r4::types::Period>> = None;
                let mut r#text: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#link_id: Option<Vec<fhirbolt_model::r4::types::String>> = None;
                let mut r#answer: Option<
                    Vec<fhirbolt_model::r4::resources::ContractTermOfferAnswer>,
...
use fhirbolt_model::r4::resources::ContractTermActionSubject;
...
use fhirbolt_model::r4::resources::ContractTermAction;
impl serde::ser::Serialize for SerializationContext<&ContractTermAction> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractTermActionOccurrence as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#requester: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
...
use fhirbolt_model::r4::resources::ContractTerm;
impl serde::ser::Serialize for SerializationContext<&ContractTerm> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractTermTopic as _Enum;
            if let Some(some) = self.value.r#topic.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
...
use fhirbolt_model::r4::resources::ContractSigner;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#signature: Option<Vec<fhirbolt_model::r4::types::Signature>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4::resources::ContractFriendly;
impl serde::ser::Serialize for SerializationContext<&ContractFriendly> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractFriendlyContent as _Enum;
...
use fhirbolt_model::r4::resources::ContractLegal;
impl serde::ser::Serialize for SerializationContext<&ContractLegal> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractLegalContent as _Enum;
            match self.value.r#content {
                _Enum::Attachment(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("contentAttachment", ctx)));
...
use fhirbolt_model::r4::resources::ContractRule;
impl serde::ser::Serialize for SerializationContext<&ContractRule> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractRuleContent as _Enum;
            match self.value.r#content {
                _Enum::Attachment(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("contentAttachment", ctx)));
...
use fhirbolt_model::r4::resources::Contract;
...
impl serde::ser::Serialize for SerializationContext<&Contract> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::ContractTopic as _Enum;
            if let Some(some) = self.value.r#topic.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
        ...
        {
            use fhirbolt_model::r4::resources::ContractLegallyBinding as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#authority: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#domain: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#site: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
                ...
                let mut r#type: Option<Box<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#sub_type: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
