...
use fhirbolt_model::r4::resources::DeviceUseStatement;
impl crate::Resource for DeviceUseStatement {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4;
}
impl serde::ser::Serialize for SerializationContext<&DeviceUseStatement> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        tri!(state.serialize_entry("resourceType", "DeviceUseStatement"));
        ...
        {
            use fhirbolt_model::r4::resources::DeviceUseStatementTiming as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#recorded_on.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("recordedOn", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_recordedOn", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#recorded_on.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("recordedOn", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<DeviceUseStatement>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<DeviceUseStatement>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<DeviceUseStatement> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<DeviceUseStatement> {
    type Value = DeviceUseStatement;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<DeviceUseStatement>);
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<DeviceUseStatement>> {
    type Value = Box<DeviceUseStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<DeviceUseStatement>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<DeviceUseStatement>> {
    type Value = Vec<DeviceUseStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<DeviceUseStatement>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<DeviceUseStatement>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<DeviceUseStatement> = self.0.transmute();
