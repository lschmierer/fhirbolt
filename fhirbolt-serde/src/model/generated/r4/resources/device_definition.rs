                    ...
                    match map_access_key {
                        ...
                        Field::Description => {
                            if self.0.from_json {
                                ...
                                r#description = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::ValueQuantity => {
                            if self.0.from_json {
                                ...
                                r#value_quantity = Some(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Vec<fhirbolt_model::r4::types::Quantity>>(
                                            ),
                                    )?,
                                );
                            } else {
                                ...
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4::types::Quantity>(),
                                )?);
                            }
                        }
                        Field::ValueCode => {
                            if self.0.from_json {
                                ...
                                r#value_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Safety => {
                            if self.0.from_json {
                                ...
                                r#safety = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::ShelfLifeStorage => {
                            if self.0.from_json {
                                ...
                                r#shelf_life_storage = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: ProductShelfLife >> ()) ?) ;
                            } else {
                                let vec = r#shelf_life_storage.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: types :: ProductShelfLife > ()) ?) ;
                            }
                        }
                        ...
                        Field::LanguageCode => {
                            if self.0.from_json {
                                ...
                                r#language_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Contact => {
                            if self.0.from_json {
                                ...
                                r#contact = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: ContactPoint >> ()) ?) ;
                            } else {
