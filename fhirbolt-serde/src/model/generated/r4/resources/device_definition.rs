...
use fhirbolt_model::r4::resources::DeviceDefinitionUdiDeviceIdentifier;
...
use fhirbolt_model::r4::resources::DeviceDefinitionDeviceName;
...
use fhirbolt_model::r4::resources::DeviceDefinitionSpecialization;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#system_type: Option<fhirbolt_model::r4::types::String> = None;
...
use fhirbolt_model::r4::resources::DeviceDefinitionCapability;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#description: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
...
use fhirbolt_model::r4::resources::DeviceDefinitionProperty;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4::types::Extension>> =
                    None;
                let mut r#type: Option<Box<fhirbolt_model::r4::types::CodeableConcept>> = None;
                let mut r#value_quantity: Option<Vec<fhirbolt_model::r4::types::Quantity>> = None;
                let mut r#value_code: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
...
use fhirbolt_model::r4::resources::DeviceDefinitionMaterial;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#alternate: Option<fhirbolt_model::r4::types::Boolean> = None;
...
use fhirbolt_model::r4::resources::DeviceDefinition;
...
impl serde::ser::Serialize for SerializationContext<&DeviceDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::DeviceDefinitionManufacturer as _Enum;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#manufacturer: Option<
                    fhirbolt_model::r4::resources::DeviceDefinitionManufacturer,
                > = None;
                ...
                > = None;
                let mut r#version: Option<Vec<fhirbolt_model::r4::types::String>> = None;
                let mut r#safety: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> = None;
                ...
                > = None;
                let mut r#language_code: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
                ...
                let mut r#contact: Option<Vec<fhirbolt_model::r4::types::ContactPoint>> = None;
                let mut r#url: Option<fhirbolt_model::r4::types::Uri> = None;
                let mut r#online_information: Option<fhirbolt_model::r4::types::Uri> = None;
                ...
                let mut r#parent_device: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::UdiDeviceIdentifier => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: DeviceDefinitionUdiDeviceIdentifier >> = self . 0 . transmute () ;
                                r#udi_device_identifier =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#udi_device_identifier.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4 :: resources :: DeviceDefinitionUdiDeviceIdentifier > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Specialization => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4 :: resources :: DeviceDefinitionSpecialization >> = self . 0 . transmute () ;
                                r#specialization =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
