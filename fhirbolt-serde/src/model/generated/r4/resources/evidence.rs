...
use fhirbolt_model::r4::resources::Evidence;
...
impl serde::ser::Serialize for SerializationContext<&Evidence> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#exposure_background.id.as_deref() == Some("$invalid") {
            ...
            tri!(
                self.with_context(&self.value.r#exposure_background, |ctx| state
                    .serialize_entry("exposureBackground", ctx))
            );
        }
        if !self.value.r#exposure_variant.is_empty() {
            tri!(
                self.with_context(&self.value.r#exposure_variant, |ctx| state
                    .serialize_entry("exposureVariant", ctx))
            );
        }
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#exposure_background: Option<Box<fhirbolt_model::r4::types::Reference>> =
                    None;
                let mut r#exposure_variant: Option<Vec<fhirbolt_model::r4::types::Reference>> =
                    None;
                let mut r#outcome: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
