...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::ActivityDefinitionParticipant>
{
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4::resources::ActivityDefinitionParticipant;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::ActivityDefinitionParticipant, V::Error>
            where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::ActivityDefinitionParticipant>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: ActivityDefinitionParticipant >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::ActivityDefinitionDynamicValue>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: resources :: ActivityDefinitionDynamicValue >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4::resources::ActivityDefinition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some {
                fhirbolt_model::r4::resources::ActivityDefinitionSubject::CodeableConcept(
                    ref value,
                ) => {
                ...
                fhirbolt_model::r4::resources::ActivityDefinitionSubject::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("subjectReference", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionSubject::Invalid => {
        ...
        if let Some(some) = self.value.r#timing.as_ref() {
            match some {
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingTiming", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingAge", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingPeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingRange", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Duration(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingDuration", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Invalid => {
        ...
        if let Some(some) = self.value.r#product.as_ref() {
            match some {
                fhirbolt_model::r4::resources::ActivityDefinitionProduct::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("productReference", ctx))?;
                }
                fhirbolt_model::r4::resources::ActivityDefinitionProduct::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r4::resources::ActivityDefinitionProduct::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4::resources::ActivityDefinition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4::resources::ActivityDefinition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4::resources::ActivityDefinition>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<
        fhirbolt_model::r4::resources::ActivityDefinition,
    >
{
    type Value = fhirbolt_model::r4::resources::ActivityDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4::resources::ActivityDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r4 :: resources :: ActivityDefinitionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            ...
                            r#subject = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionSubject::Reference(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingTiming => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingDateTime => {
                            if self.0.from_json {
                                let r#enum = r#timing . get_or_insert (fhirbolt_model :: r4 :: resources :: ActivityDefinitionTiming :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: ActivityDefinitionTiming :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("timingDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("timing[x]")) ; }
                            } else {
                                if r#timing.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "timingDateTime",
                                ...
                                r#timing = Some (fhirbolt_model :: r4 :: resources :: ActivityDefinitionTiming :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::TimingDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#timing . get_or_insert (fhirbolt_model :: r4 :: resources :: ActivityDefinitionTiming :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4 :: resources :: ActivityDefinitionTiming :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_timingDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_timing[x]")) ; }
                            } else {
                        ...
                        Field::TimingAge => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Age(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingPeriod => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingRange => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Range(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingDuration => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionTiming::Duration(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Participant => {
                            if self.0.from_json {
                                ...
                                r#participant = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: ActivityDefinitionParticipant >> ()) ?) ;
                            } else {
                                let vec = r#participant.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: ActivityDefinitionParticipant > ()) ?) ;
                            }
                        }
                        Field::ProductReference => {
                            ...
                            r#product = Some(
                                fhirbolt_model::r4::resources::ActivityDefinitionProduct::Reference(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Box<fhirbolt_model::r4::types::Reference>>(
                                            ),
                        ...
                        Field::ProductCodeableConcept => {
                            ...
                            r#product = Some (fhirbolt_model :: r4 :: resources :: ActivityDefinitionProduct :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Quantity => {
                        ...
                        Field::SpecimenRequirement => {
                            if self.0.from_json {
                                ...
                                r#specimen_requirement = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4 :: types :: Reference > >> ()) ?) ;
                            } else {
                        ...
                        Field::ObservationRequirement => {
                            if self.0.from_json {
                                ...
                                r#observation_requirement = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4 :: types :: Reference > >> ()) ?) ;
                            } else {
                                let vec =
                        ...
                        Field::ObservationResultRequirement => {
                            if self.0.from_json {
                                ...
                                r#observation_result_requirement = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4 :: types :: Reference > >> ()) ?) ;
                            } else {
                        ...
                        Field::DynamicValue => {
                            if self.0.from_json {
                                ...
                                r#dynamic_value = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: resources :: ActivityDefinitionDynamicValue >> ()) ?) ;
                            } else {
                                let vec = r#dynamic_value.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4 :: resources :: ActivityDefinitionDynamicValue > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4::resources::ActivityDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4::resources::ActivityDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4::resources::ActivityDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4::resources::ActivityDefinition>,
    >
{
    type Value = Vec<fhirbolt_model::r4::resources::ActivityDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4::resources::ActivityDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4::resources::ActivityDefinition>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4::resources::ActivityDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4::resources::ActivityDefinition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
