                    ...
                    match map_access_key {
                        ...
                        Field::Manifestation => {
                            if self.0.from_json {
                                ...
                                r#manifestation = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
...
impl crate::Resource for fhirbolt_model::r4::resources::AllergyIntolerance {
    ...
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#onset.as_ref() {
            match some {
                fhirbolt_model::r4::resources::AllergyIntoleranceOnset::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4::resources::AllergyIntoleranceOnset::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("onsetAge", ctx))?;
                }
                fhirbolt_model::r4::resources::AllergyIntoleranceOnset::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("onsetPeriod", ctx))?;
                }
                fhirbolt_model::r4::resources::AllergyIntoleranceOnset::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("onsetRange", ctx))?;
                }
                fhirbolt_model::r4::resources::AllergyIntoleranceOnset::String(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4::resources::AllergyIntoleranceOnset::Invalid => {
