...
use fhirbolt_model::r4::resources::AllergyIntoleranceReaction;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#manifestation: Option<Vec<fhirbolt_model::r4::types::CodeableConcept>> =
                    None;
...
use fhirbolt_model::r4::resources::AllergyIntolerance;
...
impl serde::ser::Serialize for SerializationContext<&AllergyIntolerance> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::AllergyIntoleranceOnset as _Enum;
            if let Some(some) = self.value.r#onset.as_ref() {
                match some {
