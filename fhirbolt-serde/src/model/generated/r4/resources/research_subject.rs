...
use fhirbolt_model::r4::resources::ResearchSubject;
...
impl serde::ser::Serialize for SerializationContext<&ResearchSubject> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#individual.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#individual, |ctx| state
                .serialize_entry("individual", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#assigned_arm.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("assignedArm", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_assignedArm", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#assigned_arm.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("assignedArm", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#actual_arm.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("actualArm", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_actualArm", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#actual_arm.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("actualArm", ctx)));
        }
        if let Some(some) = self.value.r#consent.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("consent", ctx)));
        }
        state.end()
    }
}
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#study: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#individual: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#assigned_arm: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#actual_arm: Option<fhirbolt_model::r4::types::String> = None;
                let mut r#consent: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                ...
                Ok(ResearchSubject {
                    ...
                    r#individual: if self.0.config.mode
                        == crate::context::de::DeserializationMode::Lax
                    {
                        r#individual.unwrap_or(Default::default())
                    } else {
                        tri!(r#individual.ok_or(serde::de::Error::missing_field("individual")))
                    },
                    r#assigned_arm,
                    r#actual_arm,
                    r#consent,
