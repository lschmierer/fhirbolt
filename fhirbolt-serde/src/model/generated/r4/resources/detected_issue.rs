...
use fhirbolt_model::r4::resources::DetectedIssueEvidence;
...
use fhirbolt_model::r4::resources::DetectedIssueMitigation;
...
use fhirbolt_model::r4::resources::DetectedIssue;
...
impl serde::ser::Serialize for SerializationContext<&DetectedIssue> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4::resources::DetectedIssueIdentified as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#author: Option<Box<fhirbolt_model::r4::types::Reference>> = None;
                let mut r#implicated: Option<Vec<fhirbolt_model::r4::types::Reference>> = None;
