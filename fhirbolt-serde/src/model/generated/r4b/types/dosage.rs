...
use fhirbolt_model::r4b::types::DosageDoseAndRate;
impl serde::ser::Serialize for SerializationContext<&DosageDoseAndRate> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::types::DosageDoseAndRateDose as _Enum;
        ...
        {
            use fhirbolt_model::r4b::types::DosageDoseAndRateRate as _Enum;
...
use fhirbolt_model::r4b::types::Dosage;
impl serde::ser::Serialize for SerializationContext<&Dosage> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::types::DosageAsNeeded as _Enum;
