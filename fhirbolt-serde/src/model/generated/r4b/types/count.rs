...
impl serde::ser::Serialize for crate::SerializationContext<&fhirbolt_model::r4b::types::Count> {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::types::Count>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::types::Count>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::types::Count>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
