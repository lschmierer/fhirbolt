...
use fhirbolt_model::r4b::types::DataRequirementCodeFilter;
...
use fhirbolt_model::r4b::types::DataRequirementDateFilter;
impl serde::ser::Serialize for SerializationContext<&DataRequirementDateFilter> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::types::DataRequirementDateFilterValue as _Enum;
...
use fhirbolt_model::r4b::types::DataRequirementSort;
...
use fhirbolt_model::r4b::types::DataRequirement;
impl serde::ser::Serialize for SerializationContext<&DataRequirement> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::types::DataRequirementSubject as _Enum;
