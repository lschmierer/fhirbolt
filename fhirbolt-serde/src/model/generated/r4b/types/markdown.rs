...
use fhirbolt_model::r4b::types::Markdown;
impl serde::ser::Serialize for SerializationContext<&Markdown> {
...
impl serde::ser::Serialize for SerializationContext<&Box<Markdown>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<Markdown>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Markdown> {
    type Value = Markdown;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Markdown>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Markdown;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("Markdown")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<Markdown, V::Error>
            where
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Value => {
                            ...
                            r#value = Some(tri!(map_access.next_value()));
                        }
                        Field::Unknown(key) => {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<Markdown>> {
    type Value = Box<Markdown>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<Markdown>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<Markdown>> {
    type Value = Vec<Markdown>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<Markdown>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<Markdown>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<Markdown> = self.0.transmute();
