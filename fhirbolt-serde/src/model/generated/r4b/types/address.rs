...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r4b::types::Address>
{
        ...
        S: serde::ser::Serializer,
    {
            ...
            if !self.value.r#line.is_empty() {
                ...
                if requires_elements {
                    ...
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_line", ctx)
                    })?;
                }
            }
        } else {
            if !self.value.r#line.is_empty() {
                self.with_context(&self.value.r#line, |ctx| state.serialize_entry("line", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#city.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_city", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#city.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("city", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#district.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_district", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#district.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("district", ctx))?;
            }
        }
        if self.output_json {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#postal_code.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_postalCode", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#postal_code.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("postalCode", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#country.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_country", ctx)
                    })?;
                }
            }
        } else {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r4b::types::Address>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r4b::types::Address>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<Box<fhirbolt_model::r4b::types::Address>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r4b::types::Address>
{
    type Value = fhirbolt_model::r4b::types::Address;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<fhirbolt_model::r4b::types::Address>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::types::Address, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#line: Option<Vec<fhirbolt_model::r4b::types::String>> = None;
                let mut r#city: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#district: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#state: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#postal_code: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#country: Option<fhirbolt_model::r4b::types::String> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::City => {
                            if self.0.from_json {
                                ...
                                r#city = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::String>(),
                                )?);
                            }
                        }
                        ...
                        Field::District => {
                            if self.0.from_json {
                                ...
                                r#district = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::String>(),
                                )?);
                            }
                        }
                        ...
                        Field::PostalCode => {
                            if self.0.from_json {
                                ...
                                r#postal_code = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::String>(),
                                )?);
                            }
                        }
                        ...
                        Field::Country => {
                            if self.0.from_json {
                                ...
                                r#country = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::String>(),
                                )?);
                            }
                        }
                ...
                Ok(fhirbolt_model::r4b::types::Address {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Box<fhirbolt_model::r4b::types::Address>>
{
    type Value = Box<fhirbolt_model::r4b::types::Address>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::types::Address>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Vec<fhirbolt_model::r4b::types::Address>>
{
    type Value = Vec<fhirbolt_model::r4b::types::Address>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq
                    .next_element_seed(self.0.transmute::<fhirbolt_model::r4b::types::Address>())?
                {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::types::Address>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::types::Address>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
