...
use fhirbolt_model::r4b::resources::MessageHeaderDestination;
impl serde::ser::Serialize for SerializationContext<&MessageHeaderDestination> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#endpoint.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("endpoint", &some?));
            }
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#receiver: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                ...
                Ok(MessageHeaderDestination {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#endpoint.ok_or(serde::de::Error::missing_field("endpoint")))
                    },
                    r#receiver,
                })
            }
...
use fhirbolt_model::r4b::resources::MessageHeaderSource;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#name: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#software: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#version: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#contact: Option<Box<fhirbolt_model::r4b::types::ContactPoint>> = None;
                let mut r#endpoint: Option<fhirbolt_model::r4b::types::Url> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
...
use fhirbolt_model::r4b::resources::MessageHeaderResponse;
impl serde::ser::Serialize for SerializationContext<&MessageHeaderResponse> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#identifier.value.as_ref().map(Ok) {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#identifier: Option<fhirbolt_model::r4b::types::Id> = None;
                let mut r#code: Option<fhirbolt_model::r4b::types::Code> = None;
                let mut r#details: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4b::resources::MessageHeader;
...
impl serde::ser::Serialize for SerializationContext<&MessageHeader> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::MessageHeaderEvent as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#event: Option<fhirbolt_model::r4b::resources::MessageHeaderEvent> = None;
                let mut r#destination: Option<
                    Vec<fhirbolt_model::r4b::resources::MessageHeaderDestination>,
                > = None;
                ...
                let mut r#source: Option<fhirbolt_model::r4b::resources::MessageHeaderSource> =
                    None;
                ...
                let mut r#response: Option<fhirbolt_model::r4b::resources::MessageHeaderResponse> =
                    None;
                let mut r#focus: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Destination => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::MessageHeaderDestination,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Source => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r4b::resources::MessageHeaderSource,
                            > = self.0.transmute();
                        ...
                        Field::Response => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r4b::resources::MessageHeaderResponse,
                            > = self.0.transmute();
