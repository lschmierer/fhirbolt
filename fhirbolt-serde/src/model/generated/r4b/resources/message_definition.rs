...
use fhirbolt_model::r4b::resources::MessageDefinitionFocus;
...
use fhirbolt_model::r4b::resources::MessageDefinitionAllowedResponse;
...
use fhirbolt_model::r4b::resources::MessageDefinition;
...
impl serde::ser::Serialize for SerializationContext<&MessageDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::MessageDefinitionEvent as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::AllowedResponse => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: MessageDefinitionAllowedResponse >> = self . 0 . transmute () ;
                                r#allowed_response =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#allowed_response.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: MessageDefinitionAllowedResponse > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Graph => {
