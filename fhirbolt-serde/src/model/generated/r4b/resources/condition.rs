                    ...
                    match map_access_key {
                        ...
                        Field::Assessment => {
                            if self.0.from_json {
                                ...
                                r#assessment = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::BodySite => {
                            if self.0.from_json {
                                ...
                                r#body_site = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
