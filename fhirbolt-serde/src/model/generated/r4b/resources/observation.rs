...
use fhirbolt_model::r4b::resources::ObservationReferenceRange;
...
use fhirbolt_model::r4b::resources::ObservationComponent;
impl serde::ser::Serialize for SerializationContext<&ObservationComponent> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ObservationComponentValue as _Enum;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#data_absent_reason: Option<
                    Box<fhirbolt_model::r4b::types::CodeableConcept>,
                > = None;
                let mut r#interpretation: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
...
use fhirbolt_model::r4b::resources::Observation;
...
impl serde::ser::Serialize for SerializationContext<&Observation> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ObservationEffective as _Enum;
        ...
        {
            use fhirbolt_model::r4b::resources::ObservationValue as _Enum;
            if let Some(some) = self.value.r#value.as_ref() {
                match some {
                    _Enum::Quantity(ref value) => {
                        tri!(self.with_context(value, |ctx| state
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#reference_range: Option<
                    Vec<fhirbolt_model::r4b::resources::ObservationReferenceRange>,
                > = None;
                let mut r#has_member: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
