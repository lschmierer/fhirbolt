                    ...
                    match map_access_key {
                        ...
                        Field::AppliesTo => {
                            if self.0.from_json {
                                ...
                                r#applies_to = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Interpretation => {
                            if self.0.from_json {
                                ...
                                r#interpretation = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::HasMember => {
                            if self.0.from_json {
                                ...
                                r#has_member = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
