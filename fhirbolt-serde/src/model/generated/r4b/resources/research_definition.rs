...
use fhirbolt_model::r4b::resources::ResearchDefinition;
impl crate::Resource for ResearchDefinition {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize for SerializationContext<&ResearchDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                ...
                "ResearchDefinition", field
            )))
        }
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "ResearchDefinition"));
        ...
        {
            use fhirbolt_model::r4b::resources::ResearchDefinitionSubject as _Enum;
...
impl serde::ser::Serialize for SerializationContext<&Box<ResearchDefinition>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ResearchDefinition>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<ResearchDefinition> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ResearchDefinition> {
    type Value = ResearchDefinition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ResearchDefinition>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#subject: Option<
                    fhirbolt_model::r4b::resources::ResearchDefinitionSubject,
                > = None;
                ...
                let mut r#population: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#exposure: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#exposure_alternative: Option<Box<fhirbolt_model::r4b::types::Reference>> =
                    None;
                let mut r#outcome: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ResearchDefinition>> {
    type Value = Box<ResearchDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ResearchDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ResearchDefinition>> {
    type Value = Vec<ResearchDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ResearchDefinition>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ResearchDefinition>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<ResearchDefinition> = self.0.transmute();
