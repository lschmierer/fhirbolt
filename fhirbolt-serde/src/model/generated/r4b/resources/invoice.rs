...
use fhirbolt_model::r4b::resources::InvoiceParticipant;
...
use fhirbolt_model::r4b::resources::InvoiceLineItemPriceComponent;
impl serde::ser::Serialize for SerializationContext<&InvoiceLineItemPriceComponent> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<InvoiceLineItemPriceComponent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<InvoiceLineItemPriceComponent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<InvoiceLineItemPriceComponent>
{
    ...
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<InvoiceLineItemPriceComponent>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = InvoiceLineItemPriceComponent;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<InvoiceLineItemPriceComponent>>
{
    type Value = Box<InvoiceLineItemPriceComponent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<InvoiceLineItemPriceComponent>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<InvoiceLineItemPriceComponent>>
{
    type Value = Vec<InvoiceLineItemPriceComponent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<InvoiceLineItemPriceComponent>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<InvoiceLineItemPriceComponent>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<InvoiceLineItemPriceComponent> =
                    self.0.transmute();
                while let Some(value) = seq.next_element_seed(&mut *_context)? {
                    values.push(value);
                }
...
use fhirbolt_model::r4b::resources::InvoiceLineItem;
impl serde::ser::Serialize for SerializationContext<&InvoiceLineItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::InvoiceLineItemChargeItem as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::ChargeItemReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#charge_item = Some(_Enum::Reference(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::ChargeItemCodeableConcept => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#charge_item = Some(_Enum::CodeableConcept(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::PriceComponent => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: InvoiceLineItemPriceComponent >> = self . 0 . transmute () ;
                                r#price_component =
                                    Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
...
use fhirbolt_model::r4b::resources::Invoice;
                    ...
                    match map_access_key {
                        ...
                        Field::LineItem => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#line_item = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::TotalNet => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Money>,
                            > = self.0.transmute();
                            r#total_net = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::TotalGross => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Money>,
                            > = self.0.transmute();
                            r#total_gross = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::PaymentTerms => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#payment_terms = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
