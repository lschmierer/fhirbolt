...
use fhirbolt_model::r4b::resources::Media;
...
impl serde::ser::Serialize for SerializationContext<&Media> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        tri!(state.serialize_entry("resourceType", "Media"));
        ...
        if let Some(some) = self.value.r#modality.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("modality", ctx)));
        }
        if let Some(some) = self.value.r#view.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("view", ctx)));
        }
        ...
        {
            use fhirbolt_model::r4b::resources::MediaCreated as _Enum;
            if let Some(some) = self.value.r#created.as_ref() {
                match some {
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("createdDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_createdDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("createdDateTime", ctx)));
                        }
                    }
                    _Enum::Period(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("createdPeriod", ctx)));
                    }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#device_name.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("deviceName", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_deviceName", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#device_name.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("deviceName", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#height.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("height", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#width.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("width", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#frames.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("frames", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_frames", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#frames.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("frames", ctx)));
        }
        if self.output == crate::context::Format::Json {
                    ...
                    match map_access_key {
                        ...
                        Field::View => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#view = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Subject => {
                        ...
                        Field::CreatedDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#created = Some(_Enum::DateTime(tri!(
                        ...
                        Field::CreatedPeriod => {
                            ...
                            > = self.0.transmute();
                            r#created = Some(_Enum::Period(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::Issued => {
                        ...
                        Field::Frames => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::types::PositiveInt,
                                > = self.0.transmute();
                                r#frames = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
