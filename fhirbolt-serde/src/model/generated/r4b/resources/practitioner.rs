...
use fhirbolt_model::r4b::resources::PractitionerQualification;
...
use fhirbolt_model::r4b::resources::Practitioner;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#qualification: Option<
                    Vec<fhirbolt_model::r4b::resources::PractitionerQualification>,
                > = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Qualification => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::PractitionerQualification,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
