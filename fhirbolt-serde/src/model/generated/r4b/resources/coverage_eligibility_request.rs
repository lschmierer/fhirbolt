...
use fhirbolt_model::r4b::resources::CoverageEligibilityRequestSupportingInfo;
...
use fhirbolt_model::r4b::resources::CoverageEligibilityRequestInsurance;
...
use fhirbolt_model::r4b::resources::CoverageEligibilityRequestItemDiagnosis;
impl serde::ser::Serialize for SerializationContext<&CoverageEligibilityRequestItemDiagnosis> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::CoverageEligibilityRequestItemDiagnosisDiagnosis as _Enum;
...
use fhirbolt_model::r4b::resources::CoverageEligibilityRequestItem;
                    ...
                    match map_access_key {
                        ...
                        Field::Diagnosis => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestItemDiagnosis >> = self . 0 . transmute () ;
                                r#diagnosis = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                                let vec = r#diagnosis.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestItemDiagnosis > = self . 0 . transmute () ;
                                vec.push(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        Field::Detail => {
...
use fhirbolt_model::r4b::resources::CoverageEligibilityRequest;
...
impl serde::ser::Serialize for SerializationContext<&CoverageEligibilityRequest> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::CoverageEligibilityRequestServiced as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::SupportingInfo => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestSupportingInfo >> = self . 0 . transmute () ;
                                r#supporting_info =
                                    Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                                let vec = r#supporting_info.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestSupportingInfo > = self . 0 . transmute () ;
                                vec.push(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        Field::Insurance => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestInsurance >> = self . 0 . transmute () ;
                                r#insurance = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                                let vec = r#insurance.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestInsurance > = self . 0 . transmute () ;
                                vec.push(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        Field::Item => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CoverageEligibilityRequestItem >> = self . 0 . transmute () ;
