                    ...
                    match map_access_key {
                        ...
                        Field::ReferralRequest => {
                            if self.0.from_json {
                                ...
                                r#referral_request = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::Team => {
                            if self.0.from_json {
                                ...
                                r#team = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
