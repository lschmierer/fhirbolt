...
use fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic;
impl serde::ser::Serialize for SerializationContext<&ResearchElementDefinitionCharacteristic> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristicDefinition as _Enum;
            match self.value.r#definition {
                ...
                _Enum::DataRequirement(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("definitionDataRequirement", ctx)));
                }
                _Enum::Invalid => {
        ...
        if !self.value.r#usage_context.is_empty() {
            tri!(self.with_context(&self.value.r#usage_context, |ctx| state
                .serialize_entry("usageContext", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#study_effective_description.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("studyEffectiveDescription", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_studyEffectiveDescription", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#study_effective_description.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("studyEffectiveDescription", ctx)));
        }
        {
            use fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristicStudyEffective as _Enum;
            if let Some(some) = self.value.r#study_effective.as_ref() {
                match some {
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("studyEffectiveDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_studyEffectiveDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("studyEffectiveDateTime", ctx)));
                        }
                    }
                    _Enum::Period(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("studyEffectivePeriod", ctx)));
                    }
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("studyEffectiveDuration", ctx)));
                    }
                    _Enum::Timing(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("studyEffectiveTiming", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        if let Some(some) = self.value.r#study_effective_time_from_start.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("studyEffectiveTimeFromStart", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#study_effective_group_measure.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("studyEffectiveGroupMeasure", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_studyEffectiveGroupMeasure", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#study_effective_group_measure.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("studyEffectiveGroupMeasure", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#participant_effective_description.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("participantEffectiveDescription", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_participantEffectiveDescription", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#participant_effective_description.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("participantEffectiveDescription", ctx)));
        }
        {
            use fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristicParticipantEffective as _Enum;
            if let Some(some) = self.value.r#participant_effective.as_ref() {
                match some {
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("participantEffectiveDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_participantEffectiveDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("participantEffectiveDateTime", ctx)));
                        }
                    }
                    _Enum::Period(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("participantEffectivePeriod", ctx)));
                    }
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("participantEffectiveDuration", ctx)));
                    }
                    _Enum::Timing(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("participantEffectiveTiming", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        if let Some(some) = self.value.r#participant_effective_time_from_start.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("participantEffectiveTimeFromStart", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#participant_effective_group_measure.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("participantEffectiveGroupMeasure", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_participantEffectiveGroupMeasure", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#participant_effective_group_measure.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("participantEffectiveGroupMeasure", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<ResearchElementDefinitionCharacteristic>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ResearchElementDefinitionCharacteristic>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ResearchElementDefinitionCharacteristic>
{
    ...
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ResearchElementDefinitionCharacteristic>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::DefinitionCodeableConcept => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#definition = Some(_Enum::CodeableConcept(tri!(
                        ...
                        Field::DefinitionExpression => {
                            ...
                            > = self.0.transmute();
                            r#definition = Some(_Enum::Expression(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefinitionDataRequirement => {
                            ...
                            > = self.0.transmute();
                            r#definition = Some(_Enum::DataRequirement(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::UsageContext => {
                        ...
                        Field::StudyEffectiveDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#study_effective = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::StudyEffectivePeriod => {
                            ...
                            > = self.0.transmute();
                            r#study_effective = Some(_Enum::Period(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::StudyEffectiveDuration => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Duration>,
                            > = self.0.transmute();
                            r#study_effective = Some(_Enum::Duration(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::StudyEffectiveTiming => {
                            ...
                            > = self.0.transmute();
                            r#study_effective = Some(_Enum::Timing(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        ...
                        Field::ParticipantEffectiveDateTime => {
                            use fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristicParticipantEffective as _Enum;
                            if self.0.from == crate::context::Format::Json {
                                let r#enum = r#participant_effective
                                    .get_or_insert(_Enum::DateTime(Default::default()));
                                if let _Enum::DateTime(variant) = r#enum {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                ...
                                let _context: &mut DeserializationContext<
                                    Box<fhirbolt_model::r4b::types::DateTime>,
                                > = self.0.transmute();
                                r#participant_effective = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::ParticipantEffectivePeriod => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Period>,
                            > = self.0.transmute();
                            r#participant_effective = Some(_Enum::Period(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::ParticipantEffectiveDuration => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Duration>,
                            > = self.0.transmute();
                            r#participant_effective = Some(_Enum::Duration(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::ParticipantEffectiveTiming => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Timing>,
                            > = self.0.transmute();
                            r#participant_effective = Some(_Enum::Timing(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                ...
                Ok(ResearchElementDefinitionCharacteristic {
                    r#id,
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#definition.ok_or(serde::de::Error::missing_field("definition[x]")))
                    },
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ResearchElementDefinitionCharacteristic>>
{
    type Value = Box<ResearchElementDefinitionCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ResearchElementDefinitionCharacteristic>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ResearchElementDefinitionCharacteristic>>
{
    type Value = Vec<ResearchElementDefinitionCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<ResearchElementDefinitionCharacteristic>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ResearchElementDefinitionCharacteristic>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<ResearchElementDefinitionCharacteristic> =
                    self.0.transmute();
...
use fhirbolt_model::r4b::resources::ResearchElementDefinition;
impl crate::Resource for ResearchElementDefinition {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize for SerializationContext<&ResearchElementDefinition> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "ResearchElementDefinition"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r4b::resources::ResearchElementDefinitionSubject as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#comment.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("comment", &values));
                }
        ...
        } else if !self.value.r#comment.is_empty() {
            tri!(self.with_context(&self.value.r#comment, |ctx| state
                .serialize_entry("comment", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#variable_type.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("variableType", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_variableType", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#variable_type.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("variableType", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<ResearchElementDefinition>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ResearchElementDefinition>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<ResearchElementDefinition> {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ResearchElementDefinition>
{
    type Value = ResearchElementDefinition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ResearchElementDefinition>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ResearchElementDefinition;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    ...
                    match map_access_key {
                        ...
                        Field::Characteristic => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristic >> = self . 0 . transmute () ;
                                r#characteristic =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#characteristic.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristic > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ResearchElementDefinition>>
{
    type Value = Box<ResearchElementDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ResearchElementDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ResearchElementDefinition>>
{
    type Value = Vec<ResearchElementDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ResearchElementDefinition>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ResearchElementDefinition>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ResearchElementDefinition> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
