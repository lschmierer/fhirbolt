...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                ...
                "ResearchElementDefinition.characteristic", field
            )))
        }
        ...
        match self . value . r#definition { fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: CodeableConcept (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("definitionCodeableConcept" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Canonical (ref value) => { if self . output_json { if let Some (some) = value . value . as_ref () { let some = Ok (some) ? ; state . serialize_entry ("definitionCanonical" , & some) ? ; } if value . id . is_some () || ! value . extension . is_empty () { let primitive_element = super :: super :: serde_helpers :: PrimitiveElement { id : value . id . as_ref () , extension : & value . extension , } ; self . with_context (& primitive_element , | ctx | state . serialize_entry ("_definitionCanonical" , ctx)) ? ; } } else { self . with_context (value , | ctx | state . serialize_entry ("definitionCanonical" , ctx)) ? ; } } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Expression (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("definitionExpression" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: DataRequirement (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("definitionDataRequirement" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Invalid => { return Err (serde :: ser :: Error :: custom ("definition is a required field")) } }
        ...
        if let Some(some) = self.value.r#study_effective.as_ref() {
            match some { fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: DateTime (ref value) => { if self . output_json { if let Some (some) = value . value . as_ref () { let some = Ok (some) ? ; state . serialize_entry ("studyEffectiveDateTime" , & some) ? ; } if value . id . is_some () || ! value . extension . is_empty () { let primitive_element = super :: super :: serde_helpers :: PrimitiveElement { id : value . id . as_ref () , extension : & value . extension , } ; self . with_context (& primitive_element , | ctx | state . serialize_entry ("_studyEffectiveDateTime" , ctx)) ? ; } } else { self . with_context (value , | ctx | state . serialize_entry ("studyEffectiveDateTime" , ctx)) ? ; } } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Period (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("studyEffectivePeriod" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Duration (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("studyEffectiveDuration" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Timing (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("studyEffectiveTiming" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Invalid => { return Err (serde :: ser :: Error :: custom ("study_effective is invalid")) } }
        }
        ...
        if let Some(some) = self.value.r#participant_effective.as_ref() {
            match some { fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: DateTime (ref value) => { if self . output_json { if let Some (some) = value . value . as_ref () { let some = Ok (some) ? ; state . serialize_entry ("participantEffectiveDateTime" , & some) ? ; } if value . id . is_some () || ! value . extension . is_empty () { let primitive_element = super :: super :: serde_helpers :: PrimitiveElement { id : value . id . as_ref () , extension : & value . extension , } ; self . with_context (& primitive_element , | ctx | state . serialize_entry ("_participantEffectiveDateTime" , ctx)) ? ; } } else { self . with_context (value , | ctx | state . serialize_entry ("participantEffectiveDateTime" , ctx)) ? ; } } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Period (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("participantEffectivePeriod" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Duration (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("participantEffectiveDuration" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Timing (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("participantEffectiveTiming" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Invalid => { return Err (serde :: ser :: Error :: custom ("participant_effective is invalid")) } }
        }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#definition : Option < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition > = None ;
                let mut r#usage_context: Option<Vec<fhirbolt_model::r4b::types::UsageContext>> =
                    None;
                let mut r#exclude: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#unit_of_measure: Option<
                    Box<fhirbolt_model::r4b::types::CodeableConcept>,
                > = None;
                let mut r#study_effective_description: Option<fhirbolt_model::r4b::types::String> =
                    None;
                let mut r#study_effective : Option < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective > = None ;
                let mut r#study_effective_time_from_start: Option<
                    Box<fhirbolt_model::r4b::types::Duration>,
                > = None;
                let mut r#study_effective_group_measure: Option<fhirbolt_model::r4b::types::Code> =
                    None;
                let mut r#participant_effective_description: Option<
                    fhirbolt_model::r4b::types::String,
                > = None;
                let mut r#participant_effective : Option < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective > = None ;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::DefinitionCodeableConcept => {
                            ...
                            r#definition = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::DefinitionCanonical => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("definitionCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("definition[x]")) ; }
                            } else {
                                if r#definition.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "definitionCanonical",
                                ...
                                r#definition = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Canonical (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Canonical > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::DefinitionExpression => {
                            ...
                            r#definition = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: Expression (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Expression > > ()) ?)) ;
                        }
                        Field::DefinitionDataRequirement => {
                            ...
                            r#definition = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicDefinition :: DataRequirement (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DataRequirement > > ()) ?)) ;
                        }
                        Field::UsageContext => {
                            if self.0.from_json {
                                ...
                                r#usage_context = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: UsageContext >> ()) ?) ;
                            } else {
                        ...
                        Field::UnitOfMeasure => {
                            ...
                            r#unit_of_measure = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        ...
                        Field::StudyEffectiveDateTime => {
                            if self.0.from_json {
                                let r#enum = r#study_effective . get_or_insert (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("studyEffectiveDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("studyEffective[x]")) ; }
                            } else {
                                ...
                                r#study_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::StudyEffectiveDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#study_effective . get_or_insert (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_studyEffectiveDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_studyEffective[x]")) ; }
                            } else {
                        ...
                        Field::StudyEffectivePeriod => {
                            ...
                            r#study_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Period (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Period > > ()) ?)) ;
                        }
                        Field::StudyEffectiveDuration => {
                            ...
                            r#study_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Duration (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Duration > > ()) ?)) ;
                        }
                        Field::StudyEffectiveTiming => {
                            ...
                            r#study_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicStudyEffective :: Timing (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Timing > > ()) ?)) ;
                        }
                        ...
                        Field::ParticipantEffectiveDateTime => {
                            if self.0.from_json {
                                let r#enum = r#participant_effective . get_or_insert (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("participantEffectiveDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("participantEffective[x]")) ; }
                            } else {
                                ...
                                r#participant_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::ParticipantEffectivePeriod => {
                            ...
                            r#participant_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Period (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Period > > ()) ?)) ;
                        }
                        Field::ParticipantEffectiveDuration => {
                            ...
                            r#participant_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Duration (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Duration > > ()) ?)) ;
                        }
                        Field::ParticipantEffectiveTiming => {
                            ...
                            r#participant_effective = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristicParticipantEffective :: Timing (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Timing > > ()) ?)) ;
                        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::ResearchElementDefinitionCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristic > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
...
impl crate::Resource for fhirbolt_model::r4b::resources::ResearchElementDefinition {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r4b::resources::ResearchElementDefinition,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "ResearchElementDefinition", field
            )))
        }
        let mut state = serializer.serialize_map(None)?;
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some { fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionSubject :: CodeableConcept (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("subjectCodeableConcept" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionSubject :: Reference (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("subjectReference" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionSubject :: Invalid => { return Err (serde :: ser :: Error :: custom ("subject is invalid")) } }
        }
        if self.output_json {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::ResearchElementDefinition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::ResearchElementDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::ResearchElementDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#subject: Option<
                    fhirbolt_model::r4b::resources::ResearchElementDefinitionSubject,
                > = None;
                ...
                let mut r#comment: Option<Vec<fhirbolt_model::r4b::types::String>> = None;
                ...
                let mut r#variable_type: Option<fhirbolt_model::r4b::types::Code> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            if r#subject.is_some() {
                                return Err(serde::de::Error::duplicate_field("subjectReference"));
                            }
                            r#subject = Some (fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionSubject :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Reference > > ()) ?)) ;
                        }
                        Field::Date => {
                            if self.0.from_json {
                        ...
                        Field::Characteristic => {
                            if self.0.from_json {
                                ...
                                r#characteristic = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristic >> ()) ?) ;
                            } else {
                                let vec = r#characteristic.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: ResearchElementDefinitionCharacteristic > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4b::resources::ResearchElementDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::ResearchElementDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::ResearchElementDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::ResearchElementDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::ResearchElementDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
