...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r4b::resources::BodyStructure>
{
                    ...
                    match map_access_key {
                        ...
                        Field::LocationQualifier => {
                            if self.0.from_json {
                                ...
                                r#location_qualifier = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Image => {
                            if self.0.from_json {
                                ...
                                r#image = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Attachment >> ()) ?) ;
                            } else {
