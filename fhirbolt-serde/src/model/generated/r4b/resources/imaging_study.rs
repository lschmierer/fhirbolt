                    ...
                    match map_access_key {
                        ...
                        Field::Interpreter => {
                            if self.0.from_json {
                                ...
                                r#interpreter = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::ProcedureCode => {
                            if self.0.from_json {
                                ...
                                r#procedure_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
