...
use fhirbolt_model::r4b::resources::ImagingStudySeriesPerformer;
impl serde::ser::Serialize for SerializationContext<&ImagingStudySeriesPerformer> {
...
impl serde::ser::Serialize for SerializationContext<&Box<ImagingStudySeriesPerformer>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ImagingStudySeriesPerformer>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ImagingStudySeriesPerformer>
{
    ...
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ImagingStudySeriesPerformer>);
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ImagingStudySeriesPerformer>>
{
    type Value = Box<ImagingStudySeriesPerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ImagingStudySeriesPerformer>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ImagingStudySeriesPerformer>>
{
    type Value = Vec<ImagingStudySeriesPerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ImagingStudySeriesPerformer>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ImagingStudySeriesPerformer>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<ImagingStudySeriesPerformer> =
                    self.0.transmute();
...
use fhirbolt_model::r4b::resources::ImagingStudySeriesInstance;
impl serde::ser::Serialize for SerializationContext<&ImagingStudySeriesInstance> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#uid.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("uid", &some?));
            }
            ...
            tri!(self.with_context(&self.value.r#uid, |ctx| state.serialize_entry("uid", ctx)));
        }
        if self.value.r#sop_class.id.as_deref() == Some("$invalid") {
            return missing_field_error("sopClass");
        } else {
            tri!(self.with_context(&self.value.r#sop_class, |ctx| state
                .serialize_entry("sopClass", ctx)));
        }
        if self.output == crate::context::Format::Json {
...
impl serde::ser::Serialize for SerializationContext<&Box<ImagingStudySeriesInstance>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ImagingStudySeriesInstance>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ImagingStudySeriesInstance>
{
    ...
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ImagingStudySeriesInstance>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ImagingStudySeriesInstance;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#uid: Option<fhirbolt_model::r4b::types::Id> = None;
                let mut r#sop_class: Option<Box<fhirbolt_model::r4b::types::Coding>> = None;
                let mut r#number: Option<fhirbolt_model::r4b::types::UnsignedInt> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Uid => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#uid = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::SopClass => {
                            ...
                            > = self.0.transmute();
                            r#sop_class = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Number => {
                            if self.0.from == crate::context::Format::Json {
                ...
                Ok(ImagingStudySeriesInstance {
                    ...
                    r#uid: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#uid.ok_or(serde::de::Error::missing_field("uid")))
                    },
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#sop_class.ok_or(serde::de::Error::missing_field("sopClass")))
                    },
                    r#number,
                    r#title,
                })
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ImagingStudySeriesInstance>>
{
    type Value = Box<ImagingStudySeriesInstance>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ImagingStudySeriesInstance>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ImagingStudySeriesInstance>>
{
    type Value = Vec<ImagingStudySeriesInstance>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ImagingStudySeriesInstance>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ImagingStudySeriesInstance>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ImagingStudySeriesInstance> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r4b::resources::ImagingStudySeries;
impl serde::ser::Serialize for SerializationContext<&ImagingStudySeries> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#number_of_instances.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("numberOfInstances", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_numberOfInstances", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#number_of_instances.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("numberOfInstances", ctx)));
        }
        ...
        if let Some(some) = self.value.r#laterality.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("laterality", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#started.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("started", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_started", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#started.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("started", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<ImagingStudySeries>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ImagingStudySeries>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ImagingStudySeries> {
    type Value = ImagingStudySeries;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ImagingStudySeries>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ImagingStudySeries;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#uid: Option<fhirbolt_model::r4b::types::Id> = None;
                let mut r#number: Option<fhirbolt_model::r4b::types::UnsignedInt> = None;
                let mut r#modality: Option<Box<fhirbolt_model::r4b::types::Coding>> = None;
                let mut r#description: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#number_of_instances: Option<fhirbolt_model::r4b::types::UnsignedInt> =
                    None;
                let mut r#endpoint: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#body_site: Option<Box<fhirbolt_model::r4b::types::Coding>> = None;
                let mut r#laterality: Option<Box<fhirbolt_model::r4b::types::Coding>> = None;
                let mut r#specimen: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#started: Option<fhirbolt_model::r4b::types::DateTime> = None;
                let mut r#performer: Option<
                    Vec<fhirbolt_model::r4b::resources::ImagingStudySeriesPerformer>,
                > = None;
                let mut r#instance: Option<
                    Vec<fhirbolt_model::r4b::resources::ImagingStudySeriesInstance>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::Laterality => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Coding>,
                            > = self.0.transmute();
                            r#laterality = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Specimen => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Started => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#started = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Performer => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<
                                        fhirbolt_model::r4b::resources::ImagingStudySeriesPerformer,
                                    >,
                                > = self.0.transmute();
                                r#performer =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                        ...
                        Field::Instance => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::ImagingStudySeriesInstance,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(ImagingStudySeries {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#modality.ok_or(serde::de::Error::missing_field("modality")))
                    },
                    r#description,
                    r#number_of_instances,
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ImagingStudySeries>> {
    type Value = Box<ImagingStudySeries>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ImagingStudySeries>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ImagingStudySeries>> {
    type Value = Vec<ImagingStudySeries>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ImagingStudySeries>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ImagingStudySeries>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ImagingStudySeries> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r4b::resources::ImagingStudy;
impl crate::Resource for ImagingStudy {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize for SerializationContext<&ImagingStudy> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "ImagingStudy"));
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#number_of_series.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("numberOfSeries", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_numberOfSeries", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#number_of_series.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("numberOfSeries", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#number_of_instances.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
        ...
        if let Some(some) = self.value.r#procedure_reference.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("procedureReference", ctx)));
        }
        if !self.value.r#procedure_code.is_empty() {
            tri!(self.with_context(&self.value.r#procedure_code, |ctx| state
                .serialize_entry("procedureCode", ctx)));
        }
        ...
        if !self.value.r#series.is_empty() {
            tri!(self.with_context(&self.value.r#series, |ctx| state
                .serialize_entry("series", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<ImagingStudy>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ImagingStudy>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<ImagingStudy> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ImagingStudy> {
    type Value = ImagingStudy;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ImagingStudy>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ImagingStudy;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modality: Option<Vec<fhirbolt_model::r4b::types::Coding>> = None;
                ...
                let mut r#referrer: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#interpreter: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#endpoint: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#number_of_series: Option<fhirbolt_model::r4b::types::UnsignedInt> = None;
                let mut r#number_of_instances: Option<fhirbolt_model::r4b::types::UnsignedInt> =
                    None;
                let mut r#procedure_reference: Option<Box<fhirbolt_model::r4b::types::Reference>> =
                    None;
                let mut r#procedure_code: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                ...
                let mut r#description: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#series: Option<Vec<fhirbolt_model::r4b::resources::ImagingStudySeries>> =
                    None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ImagingStudy>> {
    type Value = Box<ImagingStudy>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ImagingStudy>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ImagingStudy>> {
    type Value = Vec<ImagingStudy>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ImagingStudy>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ImagingStudy>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ImagingStudy> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
