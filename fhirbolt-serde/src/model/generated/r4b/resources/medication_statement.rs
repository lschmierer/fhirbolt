...
impl crate::Resource for fhirbolt_model::r4b::resources::MedicationStatement {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r4b::resources::MedicationStatement,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        match self.value.r#medication {
            fhirbolt_model::r4b::resources::MedicationStatementMedication::CodeableConcept(
                ref value,
            ) => {
            ...
            fhirbolt_model::r4b::resources::MedicationStatementMedication::Reference(ref value) => {
                self.with_context(value, |ctx| {
                    state.serialize_entry("medicationReference", ctx)
                })?;
            }
            fhirbolt_model::r4b::resources::MedicationStatementMedication::Invalid => {
        ...
        if let Some(some) = self.value.r#effective.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::MedicationStatementEffective::DateTime(
                    ref value,
                ) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4b::resources::MedicationStatementEffective::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("effectivePeriod", ctx))?;
                }
                fhirbolt_model::r4b::resources::MedicationStatementEffective::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::MedicationStatement>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::MedicationStatement;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::MedicationStatement, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::MedicationCodeableConcept => {
                            ...
                            r#medication = Some (fhirbolt_model :: r4b :: resources :: MedicationStatementMedication :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::MedicationReference => {
                            ...
                            r#medication = Some (fhirbolt_model :: r4b :: resources :: MedicationStatementMedication :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Reference > > ()) ?)) ;
                        }
                        Field::Subject => {
                        ...
                        Field::EffectiveDateTime => {
                            if self.0.from_json {
                                let r#enum = r#effective . get_or_insert (fhirbolt_model :: r4b :: resources :: MedicationStatementEffective :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: MedicationStatementEffective :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("effectiveDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("effective[x]")) ; }
                            } else {
                                ...
                                r#effective = Some (fhirbolt_model :: r4b :: resources :: MedicationStatementEffective :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::EffectiveDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#effective . get_or_insert (fhirbolt_model :: r4b :: resources :: MedicationStatementEffective :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: MedicationStatementEffective :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_effectiveDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_effective[x]")) ; }
                            } else {
                        ...
                        Field::EffectivePeriod => {
                            ...
                            r#effective = Some (fhirbolt_model :: r4b :: resources :: MedicationStatementEffective :: Period (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Period > > ()) ?)) ;
                        }
                        Field::DateAsserted => {
                            if self.0.from_json {
                        ...
                        Field::DerivedFrom => {
                            if self.0.from_json {
                                ...
                                r#derived_from = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r4b::resources::MedicationStatement {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::MedicationStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::MedicationStatement>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::MedicationStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::MedicationStatement>(),
                )? {
                    values.push(value);
                }
                Ok(values)
