...
use fhirbolt_model::r4b::resources::VerificationResultPrimarySource;
...
use fhirbolt_model::r4b::resources::VerificationResultAttestation;
...
use fhirbolt_model::r4b::resources::VerificationResultValidator;
...
use fhirbolt_model::r4b::resources::VerificationResult;
                    ...
                    match map_access_key {
                        ...
                        Field::PrimarySource => {
                            if self.0.from_json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: VerificationResultPrimarySource >> = self . 0 . transmute () ;
                                r#primary_source =
                                    Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
