...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &fhirbolt_model::r4b::resources::VerificationResultPrimarySource,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#communication_method.is_empty() {
            self.with_context(&self.value.r#communication_method, |ctx| {
                state.serialize_entry("communicationMethod", ctx)
            })?;
        }
        if let Some(some) = self.value.r#validation_status.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("validationStatus", ctx))?;
        }
        if self.output_json {
            if let Some(some) = self.value.r#validation_date.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_validationDate", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#validation_date.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("validationDate", ctx))?;
            }
        }
        if let Some(some) = self.value.r#can_push_updates.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("canPushUpdates", ctx))?;
        }
        if !self.value.r#push_type_available.is_empty() {
            self.with_context(&self.value.r#push_type_available, |ctx| {
                state.serialize_entry("pushTypeAvailable", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::VerificationResultPrimarySource;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::VerificationResultPrimarySource, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#validation_date: Option<fhirbolt_model::r4b::types::DateTime> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ValidationStatus => {
                            ...
                            r#validation_status = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::ValidationDate => {
                            if self.0.from_json {
                                ...
                                r#validation_date = Some(map_access.next_value_seed(
                        ...
                        Field::CanPushUpdates => {
                            ...
                            r#can_push_updates = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: VerificationResultPrimarySource > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::VerificationResultPrimarySource>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: VerificationResultPrimarySource >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::VerificationResultAttestation>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
        ...
        if self.output_json {
            if let Some(some) = self.value.r#source_identity_certificate.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_sourceIdentityCertificate", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#source_identity_certificate.as_ref() {
                self.with_context(some, |ctx| {
                    state.serialize_entry("sourceIdentityCertificate", ctx)
                })?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#proxy_identity_certificate.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_proxyIdentityCertificate", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#proxy_identity_certificate.as_ref() {
                self.with_context(some, |ctx| {
                    state.serialize_entry("proxyIdentityCertificate", ctx)
                })?;
            }
        }
        if let Some(some) = self.value.r#proxy_signature.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("proxySignature", ctx))?;
        }
        if let Some(some) = self.value.r#source_signature.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("sourceSignature", ctx))?;
        }
        state.end()
    }
}
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::VerificationResultAttestation>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::VerificationResultAttestation>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::VerificationResultAttestation>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::VerificationResultAttestation,
    >
{
    type Value = fhirbolt_model::r4b::resources::VerificationResultAttestation;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::VerificationResultAttestation, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#source_identity_certificate: Option<fhirbolt_model::r4b::types::String> =
                    None;
                let mut r#proxy_identity_certificate: Option<fhirbolt_model::r4b::types::String> =
                    None;
                let mut r#proxy_signature: Option<Box<fhirbolt_model::r4b::types::Signature>> =
                    None;
                let mut r#source_signature: Option<Box<fhirbolt_model::r4b::types::Signature>> =
                    None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::CommunicationMethod => {
                            ...
                            r#communication_method = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Date => {
                            if self.0.from_json {
                        ...
                        Field::SourceIdentityCertificate => {
                            if self.0.from_json {
                                ...
                                r#source_identity_certificate = Some(map_access.next_value_seed(
                        ...
                        Field::ProxyIdentityCertificate => {
                            if self.0.from_json {
                                ...
                                r#proxy_identity_certificate = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::String>(),
                                )?);
                            }
                        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::VerificationResultAttestation>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::VerificationResultAttestation>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::VerificationResultAttestation>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::VerificationResultAttestation>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::VerificationResultAttestation>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: VerificationResultAttestation >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::VerificationResultValidator>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
        ...
        if self.output_json {
            if let Some(some) = self.value.r#identity_certificate.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_identityCertificate", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#identity_certificate.as_ref() {
                self.with_context(some, |ctx| {
                    state.serialize_entry("identityCertificate", ctx)
                })?;
            }
        }
        if let Some(some) = self.value.r#attestation_signature.as_ref() {
            self.with_context(some, |ctx| {
                state.serialize_entry("attestationSignature", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::VerificationResultValidator>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::VerificationResultValidator>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::VerificationResultValidator>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::VerificationResultValidator,
    >
{
    type Value = fhirbolt_model::r4b::resources::VerificationResultValidator;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::VerificationResultValidator, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#identity_certificate: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#attestation_signature: Option<
                    ...
                    match map_access_key {
                        ...
                        Field::IdentityCertificate => {
                            if self.0.from_json {
                                ...
                                r#identity_certificate = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::String>(),
                                )?);
                            }
                        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::VerificationResultValidator>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::VerificationResultValidator>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::VerificationResultValidator>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::VerificationResultValidator>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::VerificationResultValidator>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: VerificationResultValidator >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl crate::Resource for fhirbolt_model::r4b::resources::VerificationResult {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4B;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::VerificationResult>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
            ...
            if !self.value.r#target_location.is_empty() {
                ...
                if requires_elements {
                    ...
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_targetLocation", ctx)
                    })?;
                }
            }
        } else {
            if !self.value.r#target_location.is_empty() {
                self.with_context(&self.value.r#target_location, |ctx| {
                    state.serialize_entry("targetLocation", ctx)
                })?;
            }
        }
        if let Some(some) = self.value.r#need.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("need", ctx))?;
        }
        if self.output_json {
        ...
        if let Some(some) = self.value.r#validation_type.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("validationType", ctx))?;
        }
        if !self.value.r#validation_process.is_empty() {
            self.with_context(&self.value.r#validation_process, |ctx| {
                state.serialize_entry("validationProcess", ctx)
            })?;
        }
        ...
        if self.output_json {
            if let Some(some) = self.value.r#last_performed.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_lastPerformed", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#last_performed.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("lastPerformed", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#next_scheduled.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_nextScheduled", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#next_scheduled.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("nextScheduled", ctx))?;
            }
        }
        if let Some(some) = self.value.r#failure_action.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("failureAction", ctx))?;
        }
        if !self.value.r#primary_source.is_empty() {
            self.with_context(&self.value.r#primary_source, |ctx| {
                state.serialize_entry("primarySource", ctx)
            })?;
        }
        if let Some(some) = self.value.r#attestation.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("attestation", ctx))?;
        }
        if !self.value.r#validator.is_empty() {
            self.with_context(&self.value.r#validator, |ctx| {
                state.serialize_entry("validator", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::VerificationResult>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::VerificationResult>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::resources::VerificationResult>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::VerificationResult,
    >
{
    type Value = fhirbolt_model::r4b::resources::VerificationResult;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::VerificationResult, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#modifier_extension: Option<
                    Vec<Box<fhirbolt_model::r4b::types::Extension>>,
                > = None;
                let mut r#target: Option<Vec<Box<fhirbolt_model::r4b::types::Reference>>> = None;
                let mut r#target_location: Option<Vec<fhirbolt_model::r4b::types::String>> = None;
                let mut r#need: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                ...
                let mut r#validation_type: Option<
                    Box<fhirbolt_model::r4b::types::CodeableConcept>,
                > = None;
                let mut r#validation_process: Option<
                    Vec<Box<fhirbolt_model::r4b::types::CodeableConcept>>,
                > = None;
                let mut r#frequency: Option<Box<fhirbolt_model::r4b::types::Timing>> = None;
                let mut r#last_performed: Option<fhirbolt_model::r4b::types::DateTime> = None;
                let mut r#next_scheduled: Option<fhirbolt_model::r4b::types::Date> = None;
                let mut r#failure_action: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Target => {
                            if self.0.from_json {
                                ...
                                r#target = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4b :: types :: Reference > >> ()) ?) ;
                            } else {
                        ...
                        Field::Need => {
                            ...
                            r#need = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Status => {
                            if self.0.from_json {
                        ...
                        Field::ValidationType => {
                            ...
                            r#validation_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        ...
                        Field::LastPerformed => {
                            if self.0.from_json {
                                ...
                                r#last_performed = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::DateTime>(),
                                )?);
                            }
                        }
                        ...
                        Field::NextScheduled => {
                            if self.0.from_json {
                                ...
                                r#next_scheduled = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r4b::types::Date>(),
                                )?);
                            }
                        }
                        ...
                        Field::FailureAction => {
                            ...
                            r#failure_action = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::PrimarySource => {
                            if self.0.from_json {
                                ...
                                r#primary_source = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: resources :: VerificationResultPrimarySource >> ()) ?) ;
                            } else {
                                let vec = r#primary_source.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: VerificationResultPrimarySource > ()) ?) ;
                            }
                        }
                        Field::Attestation => {
                            ...
                            r#attestation = Some (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: VerificationResultAttestation > ()) ?) ;
                        }
                        Field::Validator => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: VerificationResultValidator > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4b::resources::VerificationResult {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::VerificationResult>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::VerificationResult>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4b::resources::VerificationResult>,
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::VerificationResult>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::VerificationResult>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::resources::VerificationResult>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::VerificationResult>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::VerificationResult>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
