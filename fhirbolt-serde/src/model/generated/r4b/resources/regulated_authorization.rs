        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#region: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                let mut r#status: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                ...
                let mut r#intended_use: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#basis: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Region => {
                            if self.0.from_json {
                                ...
                                r#region = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Basis => {
                            if self.0.from_json {
                                ...
                                r#basis = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
