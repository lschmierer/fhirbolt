...
use fhirbolt_model::r4b::resources::ProvenanceAgent;
...
use fhirbolt_model::r4b::resources::ProvenanceEntity;
...
use fhirbolt_model::r4b::resources::Provenance;
...
impl serde::ser::Serialize for SerializationContext<&Provenance> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ProvenanceOccurred as _Enum;
