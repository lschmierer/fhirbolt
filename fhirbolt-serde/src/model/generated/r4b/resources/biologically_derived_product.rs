...
impl serde::ser::Serialize for SerializationContext<&BiologicallyDerivedProductProcessing> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#additive.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("additive", ctx)));
        }
        {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#temperature.as_ref() {
                if let Some(some) = some.value.as_ref().map(|v| {
                    ...
                    tri!(state.serialize_entry("temperature", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_temperature", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#temperature.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("temperature", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#scale.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("scale", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_scale", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#scale.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("scale", ctx)));
        }
                    ...
                    match map_access_key {
                        ...
                        Field::Scale => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#scale = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
impl serde::ser::Serialize for SerializationContext<&BiologicallyDerivedProduct> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "BiologicallyDerivedProduct"));
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#product_category.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("productCategory", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_productCategory", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#product_category.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("productCategory", ctx)));
        }
        if let Some(some) = self.value.r#product_code.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("productCode", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#quantity.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("quantity", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if let Some(some) = self.value.r#manipulation.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("manipulation", ctx)));
        }
        if !self.value.r#storage.is_empty() {
            tri!(self.with_context(&self.value.r#storage, |ctx| state
                .serialize_entry("storage", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::ProductCode => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#product_code = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Status => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Manipulation => {
                            ...
                            r#manipulation = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Storage => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                r#storage = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
