...
use fhirbolt_model::r4b::resources::AllergyIntoleranceReaction;
...
use fhirbolt_model::r4b::resources::AllergyIntolerance;
...
impl serde::ser::Serialize for SerializationContext<&AllergyIntolerance> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::AllergyIntoleranceOnset as _Enum;
            if let Some(some) = self.value.r#onset.as_ref() {
                match some {
        ...
        if let Some(some) = self.value.r#asserter.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("asserter", ctx)));
        }
        if self.output == crate::context::Format::Json {
                    ...
                    match map_access_key {
                        ...
                        Field::Asserter => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#asserter = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
