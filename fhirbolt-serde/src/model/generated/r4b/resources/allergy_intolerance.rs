        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#substance: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#manifestation: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Manifestation => {
                            if self.0.from_json {
                                ...
                                r#manifestation = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
