...
use fhirbolt_model::r4b::resources::TestReportParticipant;
...
use fhirbolt_model::r4b::resources::TestReportSetupActionOperation;
...
use fhirbolt_model::r4b::resources::TestReportSetupActionAssert;
...
use fhirbolt_model::r4b::resources::TestReportSetupAction;
...
use fhirbolt_model::r4b::resources::TestReportSetup;
...
use fhirbolt_model::r4b::resources::TestReportTestAction;
...
use fhirbolt_model::r4b::resources::TestReportTest;
...
use fhirbolt_model::r4b::resources::TestReportTeardownAction;
...
use fhirbolt_model::r4b::resources::TestReportTeardown;
...
use fhirbolt_model::r4b::resources::TestReport;
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::TestScript => {
                            ...
                            > = self.0.transmute();
                            r#test_script = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Result => {
                            if self.0.from == crate::context::Format::Json {
                                let some = r#result.get_or_insert(Default::default());
