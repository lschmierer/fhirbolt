...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r4b::resources::DiagnosticReport>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#results_interpreter: Option<Vec<fhirbolt_model::r4b::types::Reference>> =
                    None;
                let mut r#specimen: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#result: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#imaging_study: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                ...
                > = None;
                let mut r#presented_form: Option<Vec<fhirbolt_model::r4b::types::Attachment>> =
                    None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::ResultsInterpreter => {
                            if self.0.from_json {
                                ...
                                r#results_interpreter = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::Result => {
                            if self.0.from_json {
                                ...
                                r#result = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::ImagingStudy => {
                            if self.0.from_json {
                                ...
                                r#imaging_study = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::ConclusionCode => {
                            if self.0.from_json {
                                ...
                                r#conclusion_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::PresentedForm => {
                            if self.0.from_json {
                                ...
                                r#presented_form = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Attachment >> ()) ?) ;
                            } else {
