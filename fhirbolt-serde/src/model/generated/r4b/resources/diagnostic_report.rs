...
use fhirbolt_model::r4b::resources::DiagnosticReportMedia;
...
use fhirbolt_model::r4b::resources::DiagnosticReport;
...
impl serde::ser::Serialize for SerializationContext<&DiagnosticReport> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::DiagnosticReportEffective as _Enum;
        ...
        if !self.value.r#imaging_study.is_empty() {
            tri!(self.with_context(&self.value.r#imaging_study, |ctx| state
                .serialize_entry("imagingStudy", ctx)));
        }
