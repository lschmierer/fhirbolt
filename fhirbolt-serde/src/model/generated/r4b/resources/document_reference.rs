...
use fhirbolt_model::r4b::resources::DocumentReferenceRelatesTo;
...
use fhirbolt_model::r4b::resources::DocumentReferenceContent;
...
use fhirbolt_model::r4b::resources::DocumentReferenceContext;
impl serde::ser::Serialize for SerializationContext<&DocumentReferenceContext> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#source_patient_info.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("sourcePatientInfo", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<DocumentReferenceContext>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<DocumentReferenceContext>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<DocumentReferenceContext>
{
    ...
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<DocumentReferenceContext>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = DocumentReferenceContext;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#event: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                ...
                let mut r#source_patient_info: Option<Box<fhirbolt_model::r4b::types::Reference>> =
                    None;
                let mut r#related: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<DocumentReferenceContext>>
{
    type Value = Box<DocumentReferenceContext>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<DocumentReferenceContext>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<DocumentReferenceContext>>
{
    type Value = Vec<DocumentReferenceContext>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<DocumentReferenceContext>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<DocumentReferenceContext>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<DocumentReferenceContext> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r4b::resources::DocumentReference;
...
impl serde::ser::Serialize for SerializationContext<&DocumentReference> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#master_identifier.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("masterIdentifier", ctx)));
        }
        ...
        if let Some(some) = self.value.r#authenticator.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("authenticator", ctx)));
        }
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#security_label: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
