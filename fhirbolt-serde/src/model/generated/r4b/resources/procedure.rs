...
use fhirbolt_model::r4b::resources::ProcedurePerformer;
...
use fhirbolt_model::r4b::resources::ProcedureFocalDevice;
impl serde::ser::Serialize for SerializationContext<&ProcedureFocalDevice> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#manipulated.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#manipulated, |ctx| state
                .serialize_entry("manipulated", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::Manipulated => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#manipulated = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
                ...
                Ok(ProcedureFocalDevice {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#manipulated.ok_or(serde::de::Error::missing_field("manipulated")))
                    },
                })
            }
        }
...
use fhirbolt_model::r4b::resources::Procedure;
...
impl serde::ser::Serialize for SerializationContext<&Procedure> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Procedure"));
        ...
        {
            use fhirbolt_model::r4b::resources::ProcedurePerformed as _Enum;
        ...
        if !self.value.r#report.is_empty() {
            tri!(self.with_context(&self.value.r#report, |ctx| state
                .serialize_entry("report", ctx)));
        }
        if !self.value.r#complication.is_empty() {
            tri!(self.with_context(&self.value.r#complication, |ctx| state
                .serialize_entry("complication", ctx)));
        }
        if !self.value.r#complication_detail.is_empty() {
            tri!(
                self.with_context(&self.value.r#complication_detail, |ctx| state
                    .serialize_entry("complicationDetail", ctx))
            );
        }
        if !self.value.r#follow_up.is_empty() {
            tri!(self.with_context(&self.value.r#follow_up, |ctx| state
                .serialize_entry("followUp", ctx)));
        }
        if !self.value.r#note.is_empty() {
            tri!(self.with_context(&self.value.r#note, |ctx| state.serialize_entry("note", ctx)));
        }
        if !self.value.r#focal_device.is_empty() {
            tri!(self.with_context(&self.value.r#focal_device, |ctx| state
                .serialize_entry("focalDevice", ctx)));
        }
        if !self.value.r#used_reference.is_empty() {
            tri!(self.with_context(&self.value.r#used_reference, |ctx| state
                .serialize_entry("usedReference", ctx)));
        }
        if !self.value.r#used_code.is_empty() {
            tri!(self.with_context(&self.value.r#used_code, |ctx| state
                .serialize_entry("usedCode", ctx)));
        }
        state.end()
    }
}
                        ...
                        Field::Report => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4b::types::Reference>,
                                > = self.0.transmute();
                                r#report = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
