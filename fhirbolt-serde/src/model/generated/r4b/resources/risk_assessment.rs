...
use fhirbolt_model::r4b::resources::RiskAssessmentPrediction;
impl serde::ser::Serialize for SerializationContext<&RiskAssessmentPrediction> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::RiskAssessmentPredictionProbability as _Enum;
        ...
        {
            use fhirbolt_model::r4b::resources::RiskAssessmentPredictionWhen as _Enum;
...
use fhirbolt_model::r4b::resources::RiskAssessment;
...
impl serde::ser::Serialize for SerializationContext<&RiskAssessment> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::RiskAssessmentOccurrence as _Enum;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#reason_reference: Option<Vec<fhirbolt_model::r4b::types::Reference>> =
                    None;
                let mut r#basis: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
