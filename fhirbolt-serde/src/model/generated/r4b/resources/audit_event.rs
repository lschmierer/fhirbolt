...
use fhirbolt_model::r4b::resources::AuditEventAgentNetwork;
...
use fhirbolt_model::r4b::resources::AuditEventAgent;
                        ...
                        Field::AltId => {
                            if self.0.from_json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::types::String,
                                > = self.0.transmute();
                                r#alt_id = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
...
use fhirbolt_model::r4b::resources::AuditEventSource;
...
use fhirbolt_model::r4b::resources::AuditEventEntityDetail;
...
use fhirbolt_model::r4b::resources::AuditEventEntity;
                    ...
                    match map_access_key {
                        ...
                        Field::Lifecycle => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Coding>,
                            > = self.0.transmute();
                            r#lifecycle = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::SecurityLabel => {
                            if self.0.from_json {
...
use fhirbolt_model::r4b::resources::AuditEvent;
                        ...
                        Field::OutcomeDesc => {
                            if self.0.from_json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::types::String,
                                > = self.0.transmute();
                                r#outcome_desc = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
