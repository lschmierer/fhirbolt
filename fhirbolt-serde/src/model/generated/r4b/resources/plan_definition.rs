        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#addresses: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Addresses => {
                            if self.0.from_json {
                                ...
                                r#addresses = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Documentation => {
                            if self.0.from_json {
                                ...
                                r#documentation = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: RelatedArtifact >> ()) ?) ;
                            } else {
                                let vec = r#documentation.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: types :: RelatedArtifact > ()) ?) ;
                            }
                        }
                        Field::Target => {
                            if self.0.from_json {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#trigger: Option<Vec<fhirbolt_model::r4b::types::TriggerDefinition>> =
                    None;
                let mut r#condition: Option<
                    Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>,
                > = None;
                let mut r#input: Option<Vec<fhirbolt_model::r4b::types::DataRequirement>> = None;
                let mut r#output: Option<Vec<fhirbolt_model::r4b::types::DataRequirement>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Reason => {
                            if self.0.from_json {
                                ...
                                r#reason = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Trigger => {
                            if self.0.from_json {
                                ...
                                r#trigger = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: TriggerDefinition >> ()) ?) ;
                            } else {
                                let vec = r#trigger.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: types :: TriggerDefinition > ()) ?) ;
                            }
                        }
                        Field::Condition => {
                            if self.0.from_json {
                        ...
                        Field::Input => {
                            if self.0.from_json {
                                ...
                                r#input = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: DataRequirement >> ()) ?) ;
                            } else {
                                let vec = r#input.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: types :: DataRequirement > ()) ?) ;
                            }
                        }
                        Field::Output => {
                            if self.0.from_json {
                                ...
                                r#output = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: DataRequirement >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Topic => {
                            if self.0.from_json {
                                ...
                                r#topic = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Author => {
                            if self.0.from_json {
                                ...
                                r#author = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: ContactDetail >> ()) ?) ;
                            } else {
                        ...
                        Field::Editor => {
                            if self.0.from_json {
                                ...
                                r#editor = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: ContactDetail >> ()) ?) ;
                            } else {
                        ...
                        Field::Reviewer => {
                            if self.0.from_json {
                                ...
                                r#reviewer = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: ContactDetail >> ()) ?) ;
                            } else {
                        ...
                        Field::Endorser => {
                            if self.0.from_json {
                                ...
                                r#endorser = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: ContactDetail >> ()) ?) ;
                            } else {
                        ...
                        Field::RelatedArtifact => {
                            if self.0.from_json {
                                ...
                                r#related_artifact = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: RelatedArtifact >> ()) ?) ;
                            } else {
