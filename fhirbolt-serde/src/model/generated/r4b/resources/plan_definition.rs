...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#detail.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::PlanDefinitionGoalTargetDetail::Quantity(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailQuantity", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionGoalTargetDetail::Range(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailRange", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionGoalTargetDetail::CodeableConcept(
                    ref value,
                ) => {
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionGoalTargetDetail::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget,
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#detail: Option<
                    fhirbolt_model::r4b::resources::PlanDefinitionGoalTargetDetail,
                > = None;
                let mut r#due: Option<Box<fhirbolt_model::r4b::types::Duration>> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Measure => {
                            ...
                            r#measure = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::DetailQuantity => {
                            if r#detail.is_some() {
                                return Err(serde::de::Error::duplicate_field("detailQuantity"));
                            }
                            r#detail = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionGoalTargetDetail :: Quantity (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Quantity > > ()) ?)) ;
                        }
                        Field::DetailRange => {
                            if r#detail.is_some() {
                                return Err(serde::de::Error::duplicate_field("detailRange"));
                            }
                            r#detail = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionGoalTargetDetail :: Range (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Range > > ()) ?)) ;
                        }
                        Field::DetailCodeableConcept => {
                            ...
                            r#detail = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionGoalTargetDetail :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Due => {
                            if r#due.is_some() {
                ...
                Ok(fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>,
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>,
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoalTarget>>(
                        ),
                )? {
                    values.push(value);
                }
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::PlanDefinitionGoal>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoal>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::PlanDefinitionGoal,
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionGoal;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionGoal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#start: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                let mut r#addresses: Option<Vec<Box<fhirbolt_model::r4b::types::CodeableConcept>>> =
                    None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Description => {
                            ...
                            r#description = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Priority => {
                        ...
                        Field::Start => {
                            ...
                            r#start = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Addresses => {
                            if self.0.from_json {
                        ...
                        Field::Target => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionGoalTarget > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4b::resources::PlanDefinitionGoal {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#category,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>,
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionGoal>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoal>,
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoal>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::PlanDefinitionGoal>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::PlanDefinitionGoal>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::PlanDefinitionActionCondition,
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionActionCondition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionCondition >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#offset.as_ref() {
            match some { fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedActionOffset :: Duration (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("offsetDuration" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedActionOffset :: Range (ref value) => { self . with_context (value , | ctx | state . serialize_entry ("offsetRange" , ctx)) ? ; } , fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedActionOffset :: Invalid => { return Err (serde :: ser :: Error :: custom ("offset is invalid")) } }
        }
        state.end()
    }
}
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#offset: Option<
                    fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedActionOffset,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::OffsetDuration => {
                            ...
                            r#offset = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedActionOffset :: Duration (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Duration > > ()) ?)) ;
                        }
                        Field::OffsetRange => {
                            if r#offset.is_some() {
                                return Err(serde::de::Error::duplicate_field("offsetRange"));
                            }
                            r#offset = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedActionOffset :: Range (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Range > > ()) ?)) ;
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedAction > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedAction >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionParticipant > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionParticipant>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionParticipant >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Box<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::SerializationContext<
        &Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDynamicValue > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionActionDynamicValue>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDynamicValue >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::PlanDefinitionAction>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::PlanDefinitionActionSubject::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionActionSubject::Reference(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| state.serialize_entry("subjectReference", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionActionSubject::Canonical(
                    ref value,
                ) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionActionSubject::Invalid => {
        ...
        if let Some(some) = self.value.r#timing.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::DateTime(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingAge", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingPeriod", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Duration(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingDuration", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingRange", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingTiming", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Invalid => {
        ...
        if let Some(some) = self.value.r#definition.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::PlanDefinitionActionDefinition::Canonical(
                    ref value,
                ) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionActionDefinition::Uri(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionActionDefinition::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::PlanDefinitionAction>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::PlanDefinitionAction,
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinitionAction;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinitionAction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#documentation: Option<
                    Vec<Box<fhirbolt_model::r4b::types::RelatedArtifact>>,
                > = None;
                let mut r#goal_id: Option<Vec<fhirbolt_model::r4b::types::Id>> = None;
                let mut r#subject: Option<
                    fhirbolt_model::r4b::resources::PlanDefinitionActionSubject,
                > = None;
                let mut r#trigger: Option<Vec<Box<fhirbolt_model::r4b::types::TriggerDefinition>>> =
                    None;
                let mut r#condition: Option<
                    Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionCondition>,
                > = None;
                let mut r#input: Option<Vec<Box<fhirbolt_model::r4b::types::DataRequirement>>> =
                    None;
                let mut r#output: Option<Vec<Box<fhirbolt_model::r4b::types::DataRequirement>>> =
                    None;
                let mut r#related_action: Option<
                    Vec<fhirbolt_model::r4b::resources::PlanDefinitionActionRelatedAction>,
                > = None;
                let mut r#timing: Option<
                    fhirbolt_model::r4b::resources::PlanDefinitionActionTiming,
                > = None;
                ...
                let mut r#definition: Option<
                    fhirbolt_model::r4b::resources::PlanDefinitionActionDefinition,
                > = None;
                ...
                let mut r#action: Option<
                    Vec<fhirbolt_model::r4b::resources::PlanDefinitionAction>,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            if r#subject.is_some() {
                                return Err(serde::de::Error::duplicate_field("subjectReference"));
                            }
                            r#subject = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionSubject :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Reference > > ()) ?)) ;
                        }
                        Field::SubjectCanonical => {
                            if self.0.from_json {
                                let r#enum = r#subject . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionSubject :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionSubject :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("subjectCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("subject[x]")) ; }
                            } else {
                                if r#subject.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "subjectCanonical",
                        ...
                        Field::Trigger => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: TriggerDefinition > > ()) ?) ;
                            }
                        }
                        Field::Condition => {
                            if self.0.from_json {
                                ...
                                r#condition = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionCondition >> ()) ?) ;
                            } else {
                                let vec = r#condition.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionCondition > ()) ?) ;
                            }
                        }
                        Field::Input => {
                            if self.0.from_json {
                        ...
                        Field::RelatedAction => {
                            if self.0.from_json {
                                ...
                                r#related_action = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedAction >> ()) ?) ;
                            } else {
                                let vec = r#related_action.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionRelatedAction > ()) ?) ;
                            }
                        }
                        Field::TimingDateTime => {
                            if self.0.from_json {
                                let r#enum = r#timing . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionTiming :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionTiming :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("timingDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("timing[x]")) ; }
                            } else {
                                if r#timing.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "timingDateTime",
                                ...
                                r#timing = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionTiming :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::TimingDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#timing . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionTiming :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionTiming :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_timingDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_timing[x]")) ; }
                            } else {
                        ...
                        Field::TimingAge => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Age(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingPeriod => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingDuration => {
                            ...
                            r#timing = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionTiming :: Duration (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Duration > > ()) ?)) ;
                        }
                        Field::TimingRange => {
                            if r#timing.is_some() {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Range(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingTiming => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r4b::resources::PlanDefinitionActionTiming::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Participant => {
                            if self.0.from_json {
                                ...
                                r#participant = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionParticipant >> ()) ?) ;
                            } else {
                                let vec = r#participant.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionParticipant > ()) ?) ;
                            }
                        }
                        Field::Type => {
                            if r#type.is_some() {
                        ...
                        Field::DefinitionCanonical => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("definitionCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("definition[x]")) ; }
                            } else {
                                ...
                                r#definition = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Canonical (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Canonical > > ()) ?)) ;
                            }
                        }
                        Field::DefinitionCanonicalPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Canonical (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_definitionCanonical")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_definition[x]")) ; }
                            } else {
                        ...
                        Field::DefinitionUri => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Uri (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Uri (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("definitionUri")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("definition[x]")) ; }
                            } else {
                                if r#definition.is_some() {
                                    return Err(serde::de::Error::duplicate_field("definitionUri"));
                                }
                                r#definition = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Uri (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Uri > > ()) ?)) ;
                            }
                        }
                        Field::DefinitionUriPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#definition . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Uri (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDefinition :: Uri (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_definitionUri")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_definition[x]")) ; }
                            } else {
                        ...
                        Field::DynamicValue => {
                            if self.0.from_json {
                                ...
                                r#dynamic_value = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDynamicValue >> ()) ?) ;
                            } else {
                                let vec = r#dynamic_value.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionActionDynamicValue > ()) ?) ;
                            }
                        }
                        Field::Action => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionAction > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r4b::resources::PlanDefinitionAction {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#prefix,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>,
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinitionAction>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinitionAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::PlanDefinitionAction>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::PlanDefinitionAction>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r4b::resources::PlanDefinition {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4B;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::PlanDefinition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::PlanDefinitionSubject::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("subjectCodeableConcept", ctx)
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionSubject::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("subjectReference", ctx))?;
                }
                fhirbolt_model::r4b::resources::PlanDefinitionSubject::Canonical(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                            state.serialize_entry("subjectCanonical", &some)?;
                ...
                fhirbolt_model::r4b::resources::PlanDefinitionSubject::Invalid => {
                    return Err(serde::ser::Error::custom("subject is invalid"))
                }
            }
        }
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::PlanDefinition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::PlanDefinition>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::resources::PlanDefinition>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4b::resources::PlanDefinition>
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinition;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::PlanDefinition,
    >
{
    type Value = fhirbolt_model::r4b::resources::PlanDefinition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::PlanDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#subject: Option<fhirbolt_model::r4b::resources::PlanDefinitionSubject> =
                    None;
                ...
                let mut r#goal: Option<Vec<fhirbolt_model::r4b::resources::PlanDefinitionGoal>> =
                    None;
                let mut r#action: Option<
                    Vec<fhirbolt_model::r4b::resources::PlanDefinitionAction>,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            if r#subject.is_some() {
                                return Err(serde::de::Error::duplicate_field("subjectReference"));
                            }
                            r#subject = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Reference > > ()) ?)) ;
                        }
                        Field::SubjectCanonical => {
                            if self.0.from_json {
                                let r#enum = r#subject . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("subjectCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("subject[x]")) ; }
                            } else {
                                if r#subject.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "subjectCanonical",
                                ...
                                r#subject = Some (fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: Canonical (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Canonical > > ()) ?)) ;
                            }
                        }
                        Field::SubjectCanonicalPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#subject . get_or_insert (fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: PlanDefinitionSubject :: Canonical (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_subjectCanonical")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_subject[x]")) ; }
                            } else {
                                return unknown_field_error("subjectCanonical");
                            }
                        }
                        ...
                        Field::Goal => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: PlanDefinitionGoal > ()) ?) ;
                            }
                        }
                        Field::Action => {
                            if self.0.from_json {
                ...
                Ok(fhirbolt_model::r4b::resources::PlanDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::PlanDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::PlanDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4b::resources::PlanDefinition>,
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::PlanDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::PlanDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::resources::PlanDefinition>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::PlanDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::PlanDefinition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
