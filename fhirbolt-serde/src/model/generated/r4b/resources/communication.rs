                    ...
                    match map_access_key {
                        ...
                        Field::InResponseTo => {
                            if self.0.from_json {
                                ...
                                r#in_response_to = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::Medium => {
                            if self.0.from_json {
                                ...
                                r#medium = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::About => {
                            if self.0.from_json {
                                ...
                                r#about = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
