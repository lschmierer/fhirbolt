...
use fhirbolt_model::r4b::resources::CommunicationPayload;
impl serde::ser::Serialize for SerializationContext<&CommunicationPayload> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::CommunicationPayloadContent as _Enum;
...
use fhirbolt_model::r4b::resources::Communication;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#in_response_to: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                ...
                let mut r#medium: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                ...
                let mut r#about: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
