...
use fhirbolt_model::r4b::resources::PatientCommunication;
...
use fhirbolt_model::r4b::resources::PatientLink;
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::Other => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#other = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Type => {
                            if self.0.from == crate::context::Format::Json {
                ...
                Ok(PatientLink {
                    ...
                    r#other: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#other.ok_or(serde::de::Error::missing_field("other")))
                    },
...
use fhirbolt_model::r4b::resources::Patient;
...
impl serde::ser::Serialize for SerializationContext<&Patient> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Patient"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r4b::resources::PatientDeceased as _Enum;
        ...
        if let Some(some) = self.value.r#marital_status.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("maritalStatus", ctx)));
        }
        {
            use fhirbolt_model::r4b::resources::PatientMultipleBirth as _Enum;
            if let Some(some) = self.value.r#multiple_birth.as_ref() {
                match some {
                    _Enum::Boolean(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("multipleBirthBoolean", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_multipleBirthBoolean", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("multipleBirthBoolean", ctx)));
                        }
                    }
                    _Enum::Integer(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("multipleBirthInteger", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_multipleBirthInteger", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("multipleBirthInteger", ctx)));
                        }
                    }
                    _Enum::Invalid => {
        ...
        if !self.value.r#general_practitioner.is_empty() {
            tri!(
                self.with_context(&self.value.r#general_practitioner, |ctx| state
                    .serialize_entry("generalPractitioner", ctx))
            );
        }
