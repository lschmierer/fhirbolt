...
use fhirbolt_model::r4b::resources::MedicationDispensePerformer;
...
use fhirbolt_model::r4b::resources::MedicationDispenseSubstitution;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#responsible_party: Option<Vec<fhirbolt_model::r4b::types::Reference>> =
                    None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
...
use fhirbolt_model::r4b::resources::MedicationDispense;
...
impl serde::ser::Serialize for SerializationContext<&MedicationDispense> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::MedicationDispenseMedication as _Enum;
