...
use fhirbolt_model::r4b::resources::CapabilityStatementSoftware;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#release_date: Option<fhirbolt_model::r4b::types::DateTime> = None;
...
use fhirbolt_model::r4b::resources::CapabilityStatementImplementation;
...
use fhirbolt_model::r4b::resources::CapabilityStatementRestSecurity;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#cors: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#service: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> = None;
...
use fhirbolt_model::r4b::resources::CapabilityStatementRestResourceInteraction;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#documentation: Option<fhirbolt_model::r4b::types::Markdown> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4b::resources::CapabilityStatementRestResourceSearchParam;
...
use fhirbolt_model::r4b::resources::CapabilityStatementRestResourceOperation;
...
use fhirbolt_model::r4b::resources::CapabilityStatementRestResource;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#supported_profile: Option<Vec<fhirbolt_model::r4b::types::Canonical>> =
                    None;
                let mut r#documentation: Option<fhirbolt_model::r4b::types::Markdown> = None;
                let mut r#interaction: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestResourceInteraction>,
                > = None;
                let mut r#versioning: Option<fhirbolt_model::r4b::types::Code> = None;
                let mut r#read_history: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#update_create: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#conditional_create: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#conditional_read: Option<fhirbolt_model::r4b::types::Code> = None;
                let mut r#conditional_update: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#conditional_delete: Option<fhirbolt_model::r4b::types::Code> = None;
                let mut r#reference_policy: Option<Vec<fhirbolt_model::r4b::types::Code>> = None;
                let mut r#search_include: Option<Vec<fhirbolt_model::r4b::types::String>> = None;
                let mut r#search_rev_include: Option<Vec<fhirbolt_model::r4b::types::String>> =
                    None;
                let mut r#search_param: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestResourceSearchParam>,
                > = None;
                let mut r#operation: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestResourceOperation>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::Interaction => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResourceInteraction >> = self . 0 . transmute () ;
                                r#interaction =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#interaction.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResourceInteraction > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Versioning => {
                        ...
                        Field::SearchParam => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResourceSearchParam >> = self . 0 . transmute () ;
                                r#search_param =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#search_param.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResourceSearchParam > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Operation => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResourceOperation >> = self . 0 . transmute () ;
                                r#operation =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#operation.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResourceOperation > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4b::resources::CapabilityStatementRestInteraction;
...
use fhirbolt_model::r4b::resources::CapabilityStatementRest;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#security: Option<
                    fhirbolt_model::r4b::resources::CapabilityStatementRestSecurity,
                > = None;
                let mut r#resource: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestResource>,
                > = None;
                let mut r#interaction: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestInteraction>,
                > = None;
                let mut r#search_param: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestResourceSearchParam>,
                > = None;
                let mut r#operation: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRestResourceOperation>,
                > = None;
                let mut r#compartment: Option<Vec<fhirbolt_model::r4b::types::Canonical>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::Resource => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestResource >> = self . 0 . transmute () ;
                                r#resource = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#resource.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::CapabilityStatementRestResource,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Interaction => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestInteraction >> = self . 0 . transmute () ;
                                r#interaction =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#interaction.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CapabilityStatementRestInteraction > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::SearchParam => {
...
use fhirbolt_model::r4b::resources::CapabilityStatementMessagingEndpoint;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#protocol: Option<Box<fhirbolt_model::r4b::types::Coding>> = None;
                let mut r#address: Option<fhirbolt_model::r4b::types::Url> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
...
use fhirbolt_model::r4b::resources::CapabilityStatementMessagingSupportedMessage;
...
use fhirbolt_model::r4b::resources::CapabilityStatementMessaging;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#endpoint: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementMessagingEndpoint>,
                > = None;
                let mut r#reliable_cache: Option<fhirbolt_model::r4b::types::UnsignedInt> = None;
                let mut r#documentation: Option<fhirbolt_model::r4b::types::Markdown> = None;
                let mut r#supported_message : Option < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementMessagingSupportedMessage > > = None ;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::Endpoint => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementMessagingEndpoint >> = self . 0 . transmute () ;
                                r#endpoint = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#endpoint.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CapabilityStatementMessagingEndpoint > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::ReliableCache => {
                        ...
                        Field::SupportedMessage => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementMessagingSupportedMessage >> = self . 0 . transmute () ;
                                r#supported_message =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#supported_message.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CapabilityStatementMessagingSupportedMessage > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4b::resources::CapabilityStatementDocument;
...
use fhirbolt_model::r4b::resources::CapabilityStatement;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#instantiates: Option<Vec<fhirbolt_model::r4b::types::Canonical>> = None;
                let mut r#imports: Option<Vec<fhirbolt_model::r4b::types::Canonical>> = None;
                let mut r#software: Option<
                    fhirbolt_model::r4b::resources::CapabilityStatementSoftware,
                > = None;
                let mut r#implementation: Option<
                    fhirbolt_model::r4b::resources::CapabilityStatementImplementation,
                > = None;
                let mut r#fhir_version: Option<fhirbolt_model::r4b::types::Code> = None;
                let mut r#format: Option<Vec<fhirbolt_model::r4b::types::Code>> = None;
                let mut r#patch_format: Option<Vec<fhirbolt_model::r4b::types::Code>> = None;
                let mut r#implementation_guide: Option<Vec<fhirbolt_model::r4b::types::Canonical>> =
                    None;
                let mut r#rest: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementRest>,
                > = None;
                let mut r#messaging: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementMessaging>,
                > = None;
                let mut r#document: Option<
                    Vec<fhirbolt_model::r4b::resources::CapabilityStatementDocument>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::Rest => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::CapabilityStatementRest,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Messaging => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CapabilityStatementMessaging >> = self . 0 . transmute () ;
                                r#messaging =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#messaging.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::CapabilityStatementMessaging,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Document => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<
                                        fhirbolt_model::r4b::resources::CapabilityStatementDocument,
                                    >,
                                > = self.0.transmute();
