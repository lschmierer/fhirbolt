...
use fhirbolt_model::r4b::resources::ResearchStudyArm;
impl serde::ser::Serialize for SerializationContext<&ResearchStudyArm> {
...
impl serde::ser::Serialize for SerializationContext<&Box<ResearchStudyArm>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ResearchStudyArm>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ResearchStudyArm> {
    type Value = ResearchStudyArm;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ResearchStudyArm>);
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ResearchStudyArm>> {
    type Value = Box<ResearchStudyArm>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ResearchStudyArm>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ResearchStudyArm>> {
    type Value = Vec<ResearchStudyArm>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ResearchStudyArm>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ResearchStudyArm>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<ResearchStudyArm> = self.0.transmute();
...
use fhirbolt_model::r4b::resources::ResearchStudyObjective;
...
use fhirbolt_model::r4b::resources::ResearchStudy;
                    ...
                    match map_access_key {
                        ...
                        Field::Enrollment => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4b::types::Reference>,
                                > = self.0.transmute();
                                r#enrollment = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Sponsor => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#sponsor = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        ...
                        Field::ReasonStopped => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#reason_stopped = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Note => {
                            if self.0.from == crate::context::Format::Json {
                                if r#note.is_some() {
                        ...
                        Field::Arm => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#arm = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Objective => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4b::resources::ResearchStudyObjective>,
                                > = self.0.transmute();
                                r#objective = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
