...
impl crate::Resource for fhirbolt_model::r4b::resources::ServiceRequest {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r4b::resources::ServiceRequest>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#quantity.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Quantity(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("quantityQuantity", ctx))?;
                }
                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Ratio(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("quantityRatio", ctx))?;
                }
                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("quantityRange", ctx))?;
                }
                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Invalid => {
        ...
        if let Some(some) = self.value.r#occurrence.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::ServiceRequestOccurrence::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4b::resources::ServiceRequestOccurrence::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrencePeriod", ctx))?;
                }
                fhirbolt_model::r4b::resources::ServiceRequestOccurrence::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrenceTiming", ctx))?;
                }
                fhirbolt_model::r4b::resources::ServiceRequestOccurrence::Invalid => {
        ...
        if let Some(some) = self.value.r#as_needed.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::ServiceRequestAsNeeded::Boolean(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r4b::resources::ServiceRequestAsNeeded::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r4b::resources::ServiceRequestAsNeeded::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r4b::resources::ServiceRequest>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4b::resources::ServiceRequest>
{
    type Value = fhirbolt_model::r4b::resources::ServiceRequest;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r4b::resources::ServiceRequest,
    >
{
    type Value = fhirbolt_model::r4b::resources::ServiceRequest;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::ServiceRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#requisition: Option<Box<fhirbolt_model::r4b::types::Identifier>> = None;
                ...
                let mut r#order_detail: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#quantity: Option<fhirbolt_model::r4b::resources::ServiceRequestQuantity> =
                    None;
                ...
                let mut r#occurrence: Option<
                    fhirbolt_model::r4b::resources::ServiceRequestOccurrence,
                > = None;
                let mut r#as_needed: Option<
                    fhirbolt_model::r4b::resources::ServiceRequestAsNeeded,
                > = None;
                ...
                let mut r#location_code: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#location_reference: Option<Vec<fhirbolt_model::r4b::types::Reference>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::OrderDetail => {
                            if self.0.from_json {
                                ...
                                r#order_detail = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::QuantityQuantity => {
                            ...
                            r#quantity = Some(
                                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Quantity(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::QuantityRatio => {
                            ...
                            r#quantity = Some(
                                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Ratio(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::QuantityRange => {
                            ...
                            r#quantity = Some(
                                fhirbolt_model::r4b::resources::ServiceRequestQuantity::Range(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::OccurrenceDateTime => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r4b :: resources :: ServiceRequestOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: ServiceRequestOccurrence :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("occurrenceDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("occurrence[x]")) ; }
                            } else {
                                ...
                                r#occurrence = Some (fhirbolt_model :: r4b :: resources :: ServiceRequestOccurrence :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::OccurrenceDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r4b :: resources :: ServiceRequestOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r4b :: resources :: ServiceRequestOccurrence :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_occurrenceDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_occurrence[x]")) ; }
                            } else {
                        ...
                        Field::OccurrencePeriod => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4b::resources::ServiceRequestOccurrence::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::OccurrenceTiming => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4b::resources::ServiceRequestOccurrence::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::AsNeededBoolean => {
                            if self.0.from_json {
                                let r#enum = r#as_needed.get_or_insert(
                                    fhirbolt_model::r4b::resources::ServiceRequestAsNeeded::Boolean(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model :: r4b :: resources :: ServiceRequestAsNeeded :: Boolean (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("asNeededBoolean")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("asNeeded[x]")) ; }
                            } else {
                                ...
                                r#as_needed = Some (fhirbolt_model :: r4b :: resources :: ServiceRequestAsNeeded :: Boolean (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Boolean > > ()) ?)) ;
                            }
                        }
                        Field::AsNeededBooleanPrimitiveElement => {
                            if self.0.from_json {
                                ...
                                if let fhirbolt_model :: r4b :: resources :: ServiceRequestAsNeeded :: Boolean (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_asNeededBoolean")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_asNeeded[x]")) ; }
                            } else {
                        ...
                        Field::AsNeededCodeableConcept => {
                            ...
                            r#as_needed = Some (fhirbolt_model :: r4b :: resources :: ServiceRequestAsNeeded :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::AuthoredOn => {
                            if self.0.from_json {
                        ...
                        Field::LocationCode => {
                            if self.0.from_json {
                                ...
                                r#location_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::LocationReference => {
                            if self.0.from_json {
                                ...
                                r#location_reference = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::Specimen => {
                            if self.0.from_json {
                                ...
                                r#specimen = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r4b::resources::ServiceRequest {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::ServiceRequest>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::ServiceRequest>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::ServiceRequest>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::ServiceRequest>(),
                )? {
                    values.push(value);
                }
                Ok(values)
