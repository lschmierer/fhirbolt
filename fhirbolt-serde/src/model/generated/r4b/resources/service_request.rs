...
use fhirbolt_model::r4b::resources::ServiceRequest;
...
impl serde::ser::Serialize for SerializationContext<&ServiceRequest> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ServiceRequestQuantity as _Enum;
        ...
        {
            use fhirbolt_model::r4b::resources::ServiceRequestOccurrence as _Enum;
        ...
        {
            use fhirbolt_model::r4b::resources::ServiceRequestAsNeeded as _Enum;
        ...
        if !self.value.r#location_code.is_empty() {
            tri!(self.with_context(&self.value.r#location_code, |ctx| state
                .serialize_entry("locationCode", ctx)));
        }
        if !self.value.r#location_reference.is_empty() {
            tri!(
                self.with_context(&self.value.r#location_reference, |ctx| state
