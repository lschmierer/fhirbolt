...
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::ChargeItemPerformer>
{
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::ChargeItemPerformer>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r4b::resources::ChargeItemPerformer;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::ChargeItemPerformer, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(fhirbolt_model::r4b::resources::ChargeItemPerformer {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>,
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::ChargeItemPerformer>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::ChargeItemPerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::ChargeItemPerformer>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::ChargeItemPerformer>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r4b::resources::ChargeItem {
    const FHIR_RELEASE: crate::FhirRelease = crate::FhirRelease::R4B;
}
impl serde::ser::Serialize
    for crate::SerializationContext<&fhirbolt_model::r4b::resources::ChargeItem>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#occurrence.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::ChargeItemOccurrence::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r4b::resources::ChargeItemOccurrence::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrencePeriod", ctx))?;
                }
                fhirbolt_model::r4b::resources::ChargeItemOccurrence::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrenceTiming", ctx))?;
                }
                fhirbolt_model::r4b::resources::ChargeItemOccurrence::Invalid => {
        ...
        if let Some(some) = self.value.r#product.as_ref() {
            match some {
                fhirbolt_model::r4b::resources::ChargeItemProduct::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("productReference", ctx))?;
                }
                fhirbolt_model::r4b::resources::ChargeItemProduct::CodeableConcept(ref value) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("productCodeableConcept", ctx)
                    })?;
                }
                fhirbolt_model::r4b::resources::ChargeItemProduct::Invalid => {
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Box<fhirbolt_model::r4b::resources::ChargeItem>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<fhirbolt_model::r4b::resources::ChargeItem>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::SerializationContext<&Vec<Box<fhirbolt_model::r4b::resources::ChargeItem>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4b::resources::ChargeItem>
{
    type Value = fhirbolt_model::r4b::resources::ChargeItem;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r4b::resources::ChargeItem>
{
    type Value = fhirbolt_model::r4b::resources::ChargeItem;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r4b::resources::ChargeItem,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r4b::resources::ChargeItem;
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::ChargeItem, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#bodysite: Option<Vec<Box<fhirbolt_model::r4b::types::CodeableConcept>>> =
                    None;
                ...
                let mut r#reason: Option<Vec<Box<fhirbolt_model::r4b::types::CodeableConcept>>> =
                    None;
                let mut r#service: Option<Vec<Box<fhirbolt_model::r4b::types::Reference>>> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::OccurrenceDateTime => {
                            if self.0.from_json {
                                let r#enum = r#occurrence.get_or_insert(
                                    fhirbolt_model::r4b::resources::ChargeItemOccurrence::DateTime(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model :: r4b :: resources :: ChargeItemOccurrence :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("occurrenceDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("occurrence[x]")) ; }
                            } else {
                                ...
                                r#occurrence = Some (fhirbolt_model :: r4b :: resources :: ChargeItemOccurrence :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::OccurrencePeriod => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4b::resources::ChargeItemOccurrence::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::OccurrenceTiming => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r4b::resources::ChargeItemOccurrence::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Performer => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r4b :: resources :: ChargeItemPerformer > ()) ?) ;
                            }
                        }
                        ...
                        Field::Service => {
                            if self.0.from_json {
                                ...
                                r#service = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r4b :: types :: Reference > >> ()) ?) ;
                            } else {
                        ...
                        Field::ProductReference => {
                            ...
                            r#product = Some (fhirbolt_model :: r4b :: resources :: ChargeItemProduct :: Reference (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: Reference > > ()) ?)) ;
                        }
                        Field::ProductCodeableConcept => {
                            ...
                            r#product = Some (fhirbolt_model :: r4b :: resources :: ChargeItemProduct :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r4b :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Account => {
                            if self.0.from_json {
                ...
                Ok(fhirbolt_model::r4b::resources::ChargeItem {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::ChargeItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::ChargeItem>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4b::resources::ChargeItem>,
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::ChargeItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::ChargeItem>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r4b::resources::ChargeItem>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r4b::resources::ChargeItem>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r4b::resources::ChargeItem>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
