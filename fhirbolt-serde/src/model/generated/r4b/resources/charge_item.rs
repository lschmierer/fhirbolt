                    ...
                    match map_access_key {
                        ...
                        Field::Bodysite => {
                            if self.0.from_json {
                                ...
                                r#bodysite = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Service => {
                            if self.0.from_json {
                                ...
                                r#service = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::Account => {
                            if self.0.from_json {
                                ...
                                r#account = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
