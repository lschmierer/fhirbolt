...
use fhirbolt_model::r4b::resources::HealthcareServiceEligibility;
...
use fhirbolt_model::r4b::resources::HealthcareServiceAvailableTime;
...
use fhirbolt_model::r4b::resources::HealthcareServiceNotAvailable;
...
use fhirbolt_model::r4b::resources::HealthcareService;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#provided_by: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                ...
                let mut r#extra_details: Option<fhirbolt_model::r4b::types::Markdown> = None;
                ...
                let mut r#eligibility: Option<
                    Vec<fhirbolt_model::r4b::resources::HealthcareServiceEligibility>,
                > = None;
                let mut r#program: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                let mut r#characteristic: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#communication: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#referral_method: Option<
                    Vec<fhirbolt_model::r4b::types::CodeableConcept>,
                > = None;
                let mut r#appointment_required: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#available_time: Option<
                    Vec<fhirbolt_model::r4b::resources::HealthcareServiceAvailableTime>,
                > = None;
                let mut r#not_available: Option<
                    Vec<fhirbolt_model::r4b::resources::HealthcareServiceNotAvailable>,
                > = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Eligibility => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: HealthcareServiceEligibility >> = self . 0 . transmute () ;
                                r#eligibility =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#eligibility.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::HealthcareServiceEligibility,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::AvailableTime => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: HealthcareServiceAvailableTime >> = self . 0 . transmute () ;
                                r#available_time =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#available_time.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::HealthcareServiceAvailableTime,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::NotAvailable => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: HealthcareServiceNotAvailable >> = self . 0 . transmute () ;
                                r#not_available =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#not_available.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::HealthcareServiceNotAvailable,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
