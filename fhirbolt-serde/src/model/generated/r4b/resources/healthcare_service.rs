                    ...
                    match map_access_key {
                        ...
                        Field::Specialty => {
                            if self.0.from_json {
                                ...
                                r#specialty = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Location => {
                            if self.0.from_json {
                                ...
                                r#location = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                        ...
                        Field::ServiceProvisionCode => {
                            if self.0.from_json {
                                ...
                                r#service_provision_code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                                let vec =
                        ...
                        Field::Program => {
                            if self.0.from_json {
                                ...
                                r#program = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Characteristic => {
                            if self.0.from_json {
                                ...
                                r#characteristic = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Communication => {
                            if self.0.from_json {
                                ...
                                r#communication = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::ReferralMethod => {
                            if self.0.from_json {
                                ...
                                r#referral_method = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: CodeableConcept >> ()) ?) ;
                            } else {
