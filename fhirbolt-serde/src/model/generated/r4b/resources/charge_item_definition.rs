...
use fhirbolt_model::r4b::resources::ChargeItemDefinitionApplicability;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#language: Option<fhirbolt_model::r4b::types::String> = None;
...
use fhirbolt_model::r4b::resources::ChargeItemDefinitionPropertyGroupPriceComponent;
...
use fhirbolt_model::r4b::resources::ChargeItemDefinitionPropertyGroup;
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#applicability: Option<
                    Vec<fhirbolt_model::r4b::resources::ChargeItemDefinitionApplicability>,
                > = None;
                let mut r#price_component : Option < Vec < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionPropertyGroupPriceComponent > > = None ;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::Applicability => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionApplicability >> = self . 0 . transmute () ;
                                r#applicability =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#applicability.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionApplicability > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::PriceComponent => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionPropertyGroupPriceComponent >> = self . 0 . transmute () ;
                                r#price_component =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#price_component.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionPropertyGroupPriceComponent > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4b::resources::ChargeItemDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#derived_from_uri: Option<Vec<fhirbolt_model::r4b::types::Uri>> = None;
                let mut r#part_of: Option<Vec<fhirbolt_model::r4b::types::Canonical>> = None;
                ...
                let mut r#code: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                let mut r#instance: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#applicability: Option<
                    Vec<fhirbolt_model::r4b::resources::ChargeItemDefinitionApplicability>,
                > = None;
                let mut r#property_group: Option<
                    Vec<fhirbolt_model::r4b::resources::ChargeItemDefinitionPropertyGroup>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::PropertyGroup => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionPropertyGroup >> = self . 0 . transmute () ;
                                r#property_group =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#property_group.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: ChargeItemDefinitionPropertyGroup > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
