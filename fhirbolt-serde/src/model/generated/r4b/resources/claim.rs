...
use fhirbolt_model::r4b::resources::ClaimRelated;
...
use fhirbolt_model::r4b::resources::ClaimPayee;
...
use fhirbolt_model::r4b::resources::ClaimCareTeam;
...
use fhirbolt_model::r4b::resources::ClaimSupportingInfo;
impl serde::ser::Serialize for SerializationContext<&ClaimSupportingInfo> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ClaimSupportingInfoTiming as _Enum;
        ...
        {
            use fhirbolt_model::r4b::resources::ClaimSupportingInfoValue as _Enum;
...
use fhirbolt_model::r4b::resources::ClaimDiagnosis;
...
use fhirbolt_model::r4b::resources::ClaimProcedure;
impl serde::ser::Serialize for SerializationContext<&ClaimProcedure> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ClaimProcedureProcedure as _Enum;
...
use fhirbolt_model::r4b::resources::ClaimInsurance;
...
use fhirbolt_model::r4b::resources::ClaimAccident;
impl serde::ser::Serialize for SerializationContext<&ClaimAccident> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ClaimAccidentLocation as _Enum;
...
use fhirbolt_model::r4b::resources::ClaimItemDetailSubDetail;
...
use fhirbolt_model::r4b::resources::ClaimItemDetail;
...
use fhirbolt_model::r4b::resources::ClaimItem;
impl serde::ser::Serialize for SerializationContext<&ClaimItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ClaimItemServiced as _Enum;
        ...
        {
            use fhirbolt_model::r4b::resources::ClaimItemLocation as _Enum;
            if let Some(some) = self.value.r#location.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
...
use fhirbolt_model::r4b::resources::Claim;
...
impl serde::ser::Serialize for SerializationContext<&Claim> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#priority.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#priority, |ctx| state
                .serialize_entry("priority", ctx)));
        }
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(Claim {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#priority.ok_or(serde::de::Error::missing_field("priority")))
                    },
                    r#funds_reserve,
