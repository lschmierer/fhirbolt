...
use fhirbolt_model::r4b::resources::DeviceUdiCarrier;
impl serde::ser::Serialize for SerializationContext<&DeviceUdiCarrier> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        } else if let Some(some) = self.value.r#device_identifier.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("deviceIdentifier", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        } else if let Some(some) = self.value.r#issuer.as_ref() {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#carrier_aidc: Option<fhirbolt_model::r4b::types::Base64Binary> = None;
                let mut r#carrier_hrf: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#entry_type: Option<fhirbolt_model::r4b::types::Code> = None;
...
use fhirbolt_model::r4b::resources::DeviceDeviceName;
impl serde::ser::Serialize for SerializationContext<&DeviceDeviceName> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<DeviceDeviceName>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<DeviceDeviceName>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<DeviceDeviceName> {
    type Value = DeviceDeviceName;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<DeviceDeviceName>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = DeviceDeviceName;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<DeviceDeviceName>> {
    type Value = Box<DeviceDeviceName>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<DeviceDeviceName>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<DeviceDeviceName>> {
    type Value = Vec<DeviceDeviceName>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<DeviceDeviceName>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<DeviceDeviceName>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<DeviceDeviceName> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r4b::resources::DeviceSpecialization;
impl serde::ser::Serialize for SerializationContext<&DeviceSpecialization> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<DeviceSpecialization>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<DeviceSpecialization>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<DeviceSpecialization> {
    type Value = DeviceSpecialization;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<DeviceSpecialization>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = DeviceSpecialization;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r4b::types::Extension>> =
                    None;
                let mut r#system_type: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::SystemType => {
                            ...
                            > = self.0.transmute();
                            r#system_type = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Version => {
                            if self.0.from == crate::context::Format::Json {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<DeviceSpecialization>>
{
    type Value = Box<DeviceSpecialization>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<DeviceSpecialization>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<DeviceSpecialization>>
{
    type Value = Vec<DeviceSpecialization>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<DeviceSpecialization>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<DeviceSpecialization>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<DeviceSpecialization> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r4b::resources::DeviceVersion;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#component: Option<Box<fhirbolt_model::r4b::types::Identifier>> = None;
...
use fhirbolt_model::r4b::resources::DeviceProperty;
...
use fhirbolt_model::r4b::resources::Device;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#distinct_identifier.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("distinctIdentifier", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_distinctIdentifier", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#distinct_identifier.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("distinctIdentifier", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#patient.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("patient", ctx)));
        }
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#definition: Option<Box<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#udi_carrier: Option<
                    Vec<fhirbolt_model::r4b::resources::DeviceUdiCarrier>,
                > = None;
                ...
                let mut r#status_reason: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#distinct_identifier: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#manufacturer: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#manufacture_date: Option<fhirbolt_model::r4b::types::DateTime> = None;
                let mut r#expiration_date: Option<fhirbolt_model::r4b::types::DateTime> = None;
                let mut r#lot_number: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#serial_number: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#device_name: Option<
                    Vec<fhirbolt_model::r4b::resources::DeviceDeviceName>,
                > = None;
                let mut r#model_number: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#part_number: Option<fhirbolt_model::r4b::types::String> = None;
                let mut r#type: Option<Box<fhirbolt_model::r4b::types::CodeableConcept>> = None;
                let mut r#specialization: Option<
                    Vec<fhirbolt_model::r4b::resources::DeviceSpecialization>,
                > = None;
                let mut r#version: Option<Vec<fhirbolt_model::r4b::resources::DeviceVersion>> =
                    None;
                let mut r#property: Option<Vec<fhirbolt_model::r4b::resources::DeviceProperty>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::UdiCarrier => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::DeviceUdiCarrier,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::DeviceName => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::DeviceDeviceName,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Specialization => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::DeviceSpecialization,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Version => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4b::resources::DeviceVersion>,
                                > = self.0.transmute();
                                r#version = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#version.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::DeviceVersion,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
