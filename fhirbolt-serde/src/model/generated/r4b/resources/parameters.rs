...
use fhirbolt_model::r4b::resources::ParametersParameter;
impl serde::ser::Serialize for SerializationContext<&ParametersParameter> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::ParametersParameterValue as _Enum;
...
use fhirbolt_model::r4b::resources::Parameters;
