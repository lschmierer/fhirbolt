...
use fhirbolt_model::r4b::resources::CoverageClass;
...
use fhirbolt_model::r4b::resources::CoverageCostToBeneficiaryException;
...
use fhirbolt_model::r4b::resources::CoverageCostToBeneficiary;
impl serde::ser::Serialize for SerializationContext<&CoverageCostToBeneficiary> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r4b::resources::CoverageCostToBeneficiaryValue as _Enum;
        ...
        if !self.value.r#exception.is_empty() {
            tri!(self.with_context(&self.value.r#exception, |ctx| state
                .serialize_entry("exception", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::Exception => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CoverageCostToBeneficiaryException >> = self . 0 . transmute () ;
                                r#exception =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#exception.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r4b :: resources :: CoverageCostToBeneficiaryException > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r4b::resources::Coverage;
...
impl serde::ser::Serialize for SerializationContext<&Coverage> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Coverage"));
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#policy_holder.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("policyHolder", ctx)));
        }
        if let Some(some) = self.value.r#subscriber.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("subscriber", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#subscriber_id.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("subscriberId", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_subscriberId", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#subscriber_id.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("subscriberId", ctx)));
        }
        if self.value.r#beneficiary.id.as_deref() == Some("$invalid") {
            return missing_field_error("beneficiary");
        } else {
            tri!(self.with_context(&self.value.r#beneficiary, |ctx| state
                .serialize_entry("beneficiary", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#dependent.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("dependent", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_dependent", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#dependent.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("dependent", ctx)));
        }
        ...
        if !self.value.r#payor.is_empty() {
            tri!(self.with_context(&self.value.r#payor, |ctx| state
                .serialize_entry("payor", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#order.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("order", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#network.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("network", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if !self.value.r#cost_to_beneficiary.is_empty() {
            tri!(
                self.with_context(&self.value.r#cost_to_beneficiary, |ctx| state
                    .serialize_entry("costToBeneficiary", ctx))
            );
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#subrogation.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("subrogation", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_subrogation", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#subrogation.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("subrogation", ctx)));
        }
        if !self.value.r#contract.is_empty() {
            tri!(self.with_context(&self.value.r#contract, |ctx| state
                .serialize_entry("contract", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::Subscriber => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#subscriber = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::SubscriberId => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Beneficiary => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r4b::types::Reference>,
                            > = self.0.transmute();
                            r#beneficiary = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Dependent => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Payor => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#payor = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Contract => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r4b::types::Reference>,
                                > = self.0.transmute();
                                r#contract = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                ...
                Ok(Coverage {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#beneficiary.ok_or(serde::de::Error::missing_field("beneficiary")))
                    },
                    r#dependent,
                    r#relationship,
                    r#period,
