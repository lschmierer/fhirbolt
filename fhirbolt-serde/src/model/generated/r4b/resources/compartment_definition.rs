...
use fhirbolt_model::r4b::resources::CompartmentDefinitionResource;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#param: Option<Vec<fhirbolt_model::r4b::types::String>> = None;
...
use fhirbolt_model::r4b::resources::CompartmentDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#code: Option<fhirbolt_model::r4b::types::Code> = None;
                let mut r#search: Option<fhirbolt_model::r4b::types::Boolean> = None;
                let mut r#resource: Option<
                    Vec<fhirbolt_model::r4b::resources::CompartmentDefinitionResource>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::Resource => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r4b :: resources :: CompartmentDefinitionResource >> = self . 0 . transmute () ;
                                r#resource = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#resource.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r4b::resources::CompartmentDefinitionResource,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
