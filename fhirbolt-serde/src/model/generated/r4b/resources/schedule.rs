...
impl crate::Resource for fhirbolt_model::r4b::resources::Schedule {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R4B;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r4b::resources::Schedule>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#planning_horizon.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("planningHorizon", ctx))?;
        }
        if self.output_json {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r4b::resources::Schedule>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r4b::resources::Schedule>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r4b::resources::Schedule>
{
    type Value = fhirbolt_model::r4b::resources::Schedule;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r4b::resources::Schedule>
{
    type Value = fhirbolt_model::r4b::resources::Schedule;
        ...
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r4b::resources::Schedule,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r4b::resources::Schedule, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#specialty: Option<Vec<fhirbolt_model::r4b::types::CodeableConcept>> =
                    None;
                let mut r#actor: Option<Vec<fhirbolt_model::r4b::types::Reference>> = None;
                let mut r#planning_horizon: Option<Box<fhirbolt_model::r4b::types::Period>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Actor => {
                            if self.0.from_json {
                                ...
                                r#actor = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r4b :: types :: Reference >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r4b::resources::Schedule {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r4b::resources::Schedule>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r4b::resources::Schedule>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r4b::resources::Schedule>,
    >
{
    type Value = Vec<fhirbolt_model::r4b::resources::Schedule>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r4b::resources::Schedule>(),
                )? {
                    values.push(value);
                }
                Ok(values)
