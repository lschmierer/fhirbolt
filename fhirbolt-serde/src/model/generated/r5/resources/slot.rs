...
use fhirbolt_model::r5::resources::Slot;
impl crate::Resource for Slot {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&Slot> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        tri!(state.serialize_entry("resourceType", "Slot"));
        ...
        if !self.value.r#appointment_type.is_empty() {
            tri!(
                self.with_context(&self.value.r#appointment_type, |ctx| state
                    .serialize_entry("appointmentType", ctx))
            );
        }
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#end.value.as_ref().map(Ok) {
            ...
            tri!(self.with_context(&self.value.r#end, |ctx| state.serialize_entry("end", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#overbooked.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("overbooked", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_overbooked", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#overbooked.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("overbooked", ctx)));
        }
        if self.output == crate::context::Format::Json {
...
impl serde::ser::Serialize for SerializationContext<&Box<Slot>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<Slot>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<Slot> {
    type Value = Slot;
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Slot> {
    type Value = Slot;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Slot>);
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(Slot {
                    ...
                    r#end: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#end.ok_or(serde::de::Error::missing_field("end")))
                    },
                    r#overbooked,
                    r#comment,
                })
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<Slot>> {
    type Value = Box<Slot>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<Slot>> {
    type Value = Vec<Slot>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<Slot>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<Slot>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<Slot> = self.0.transmute();
