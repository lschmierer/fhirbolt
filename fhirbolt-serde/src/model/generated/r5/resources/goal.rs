...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::GoalTarget>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#detail.as_ref() {
            match some {
                fhirbolt_model::r5::resources::GoalTargetDetail::Quantity(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailQuantity", ctx))?;
                }
                fhirbolt_model::r5::resources::GoalTargetDetail::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailRange", ctx))?;
                }
                fhirbolt_model::r5::resources::GoalTargetDetail::CodeableConcept(ref value) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("detailCodeableConcept", ctx)
                    })?;
                }
                fhirbolt_model::r5::resources::GoalTargetDetail::String(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::GoalTargetDetail::Boolean(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::GoalTargetDetail::Integer(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::GoalTargetDetail::Ratio(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("detailRatio", ctx))?;
                }
                fhirbolt_model::r5::resources::GoalTargetDetail::Invalid => {
        ...
        if let Some(some) = self.value.r#due.as_ref() {
            match some {
                fhirbolt_model::r5::resources::GoalTargetDue::Date(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::GoalTargetDue::Duration(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("dueDuration", ctx))?;
                }
                fhirbolt_model::r5::resources::GoalTargetDue::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::resources::GoalTarget>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::resources::GoalTarget>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::GoalTarget>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::GoalTarget>
{
    type Value = fhirbolt_model::r5::resources::GoalTarget;
        ...
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r5::resources::GoalTarget,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::GoalTarget, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#detail: Option<fhirbolt_model::r5::resources::GoalTargetDetail> = None;
                let mut r#due: Option<fhirbolt_model::r5::resources::GoalTargetDue> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::DetailQuantity => {
                            ...
                            r#detail =
                                Some(fhirbolt_model::r5::resources::GoalTargetDetail::Quantity(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::DetailRange => {
                            ...
                            r#detail =
                                Some(fhirbolt_model::r5::resources::GoalTargetDetail::Range(
                                    map_access.next_value_seed(
                        ...
                        Field::DetailCodeableConcept => {
                            ...
                            r#detail = Some (fhirbolt_model :: r5 :: resources :: GoalTargetDetail :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::DetailString => {
                            if self.0.from_json {
                                let r#enum = r#detail.get_or_insert(
                                    fhirbolt_model::r5::resources::GoalTargetDetail::String(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::resources::GoalTargetDetail::String(
                                    variant,
                                ) = r#enum
                                {
                                ...
                                r#detail = Some (fhirbolt_model :: r5 :: resources :: GoalTargetDetail :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: String > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::DetailBoolean => {
                            if self.0.from_json {
                                let r#enum = r#detail.get_or_insert(
                                    fhirbolt_model::r5::resources::GoalTargetDetail::Boolean(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::resources::GoalTargetDetail::Boolean(
                                    variant,
                                ) = r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#detail = Some (fhirbolt_model :: r5 :: resources :: GoalTargetDetail :: Boolean (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Boolean > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::DetailInteger => {
                            if self.0.from_json {
                                let r#enum = r#detail.get_or_insert(
                                    fhirbolt_model::r5::resources::GoalTargetDetail::Integer(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::resources::GoalTargetDetail::Integer(
                                    variant,
                                ) = r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#detail = Some (fhirbolt_model :: r5 :: resources :: GoalTargetDetail :: Integer (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Integer > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::DetailRatio => {
                            ...
                            r#detail =
                                Some(fhirbolt_model::r5::resources::GoalTargetDetail::Ratio(
                                    map_access.next_value_seed(
                        ...
                        Field::DueDate => {
                            if self.0.from_json {
                                let r#enum = r#due.get_or_insert(
                                    fhirbolt_model::r5::resources::GoalTargetDue::Date(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::resources::GoalTargetDue::Date(variant) =
                                    r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#due = Some(fhirbolt_model::r5::resources::GoalTargetDue::Date(
                                    map_access.next_value_seed(
                        ...
                        Field::DueDuration => {
                            ...
                            r#due = Some(fhirbolt_model::r5::resources::GoalTargetDue::Duration(
                                map_access.next_value_seed(
                                    self.0
                ...
                Ok(fhirbolt_model::r5::resources::GoalTarget {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Box<fhirbolt_model::r5::resources::GoalTarget>,
    >
{
    type Value = Box<fhirbolt_model::r5::resources::GoalTarget>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::GoalTarget>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r5::resources::GoalTarget>,
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::GoalTarget>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::GoalTarget>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::GoalTarget>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::GoalTarget>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r5::resources::Goal {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::Goal>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#continuous.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                    state.serialize_entry("continuous", &some)?;
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    let primitive_element = super::super::serde_helpers::PrimitiveElement {
                        id: some.id.as_ref(),
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_continuous", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#continuous.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("continuous", ctx))?;
            }
        }
        ...
        if let Some(some) = self.value.r#start.as_ref() {
            match some {
                fhirbolt_model::r5::resources::GoalStart::Date(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::GoalStart::CodeableConcept(ref value) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("startCodeableConcept", ctx)
                    })?;
                }
                fhirbolt_model::r5::resources::GoalStart::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::resources::Goal>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::resources::Goal>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<Box<fhirbolt_model::r5::resources::Goal>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Goal>
{
    type Value = fhirbolt_model::r5::resources::Goal;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Goal>
{
    type Value = fhirbolt_model::r5::resources::Goal;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
    ...
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Goal>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r5::resources::Goal;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::Goal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#identifier: Option<Vec<Box<fhirbolt_model::r5::types::Identifier>>> =
                    None;
                let mut r#lifecycle_status: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#achievement_status: Option<
                    Box<fhirbolt_model::r5::types::CodeableConcept>,
                > = None;
                let mut r#category: Option<Vec<Box<fhirbolt_model::r5::types::CodeableConcept>>> =
                    None;
                let mut r#continuous: Option<fhirbolt_model::r5::types::Boolean> = None;
                ...
                let mut r#start: Option<fhirbolt_model::r5::resources::GoalStart> = None;
                let mut r#target: Option<Vec<fhirbolt_model::r5::resources::GoalTarget>> = None;
                let mut r#status_date: Option<fhirbolt_model::r5::types::Date> = None;
                let mut r#status_reason: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#source: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#addresses: Option<Vec<Box<fhirbolt_model::r5::types::Reference>>> = None;
                let mut r#note: Option<Vec<Box<fhirbolt_model::r5::types::Annotation>>> = None;
                let mut r#outcome: Option<Vec<Box<fhirbolt_model::r5::types::CodeableReference>>> =
                    None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::AchievementStatus => {
                            ...
                            r#achievement_status = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Category => {
                            if self.0.from_json {
                        ...
                        Field::Continuous => {
                            if self.0.from_json {
                                let some = r#continuous.get_or_insert(Default::default());
                                if some.value.is_some() {
                                    return Err(serde::de::Error::duplicate_field("continuous"));
                                }
                                let value: _ = map_access.next_value()?;
                                some.value = Some(value);
                            } else {
                                if r#continuous.is_some() {
                                    return Err(serde::de::Error::duplicate_field("continuous"));
                                }
                                r#continuous = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Boolean>(),
                                )?);
                            }
                        }
                        Field::ContinuousPrimitiveElement => {
                            if self.0.from_json {
                                let some = r#continuous.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field("_continuous"));
                                }
                                let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ;
                                some.id = id;
                                some.extension = extension;
                            } else {
                                return unknown_field_error("continuous");
                            }
                        }
                        Field::Priority => {
                        ...
                        Field::StartDate => {
                            if self.0.from_json {
                                let r#enum = r#start.get_or_insert(
                                    fhirbolt_model::r5::resources::GoalStart::Date(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::resources::GoalStart::Date(variant) =
                                    r#enum
                                {
                                    if variant.value.is_some() {
                                ...
                                r#start = Some(fhirbolt_model::r5::resources::GoalStart::Date(
                                    map_access.next_value_seed(
                                        self.0.transmute::<Box<fhirbolt_model::r5::types::Date>>(),
                                    )?,
                                ));
                        ...
                        Field::StartCodeableConcept => {
                            ...
                            r#start = Some (fhirbolt_model :: r5 :: resources :: GoalStart :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Target => {
                            if self.0.from_json {
                                if r#target.is_some() {
                                ...
                                r#target = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: GoalTarget >> ()) ?) ;
                            } else {
                        ...
                        Field::Addresses => {
                            if self.0.from_json {
                                ...
                                r#addresses = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r5 :: types :: Reference > >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r5::resources::Goal {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Box<fhirbolt_model::r5::resources::Goal>>
{
    type Value = Box<fhirbolt_model::r5::resources::Goal>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::Goal>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Vec<fhirbolt_model::r5::resources::Goal>>
{
    type Value = Vec<fhirbolt_model::r5::resources::Goal>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                Vec<fhirbolt_model::r5::resources::Goal>,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<fhirbolt_model::r5::resources::Goal>;
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq
                    .next_element_seed(self.0.transmute::<fhirbolt_model::r5::resources::Goal>())?
                {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r5::resources::Goal>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::Goal>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::Goal>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
