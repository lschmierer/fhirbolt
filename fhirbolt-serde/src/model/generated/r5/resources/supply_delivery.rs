...
use fhirbolt_model::r5::resources::SupplyDeliverySuppliedItem;
impl serde::ser::Serialize for SerializationContext<&SupplyDeliverySuppliedItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::SupplyDeliverySuppliedItemItem as _Enum;
            if let Some(some) = self.value.r#item.as_ref() {
                match some {
                    ...
                    _Enum::Reference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("itemReference", ctx)));
                    }
...
use fhirbolt_model::r5::resources::SupplyDelivery;
...
impl serde::ser::Serialize for SerializationContext<&SupplyDelivery> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "SupplyDelivery"));
        ...
        if !self.value.r#supplied_item.is_empty() {
            tri!(self.with_context(&self.value.r#supplied_item, |ctx| state
                .serialize_entry("suppliedItem", ctx)));
        }
        {
            use fhirbolt_model::r5::resources::SupplyDeliveryOccurrence as _Enum;
        ...
        if let Some(some) = self.value.r#supplier.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("supplier", ctx)));
        }
