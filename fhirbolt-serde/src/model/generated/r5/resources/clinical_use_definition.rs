                    ...
                    match map_access_key {
                        ...
                        Field::Comorbidity => {
                            if self.0.from_json {
                                ...
                                r#comorbidity = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Management => {
                            if self.0.from_json {
                                ...
                                r#management = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
