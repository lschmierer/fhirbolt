...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::EvidenceVariableDefinition,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                ...
                "Evidence.variableDefinition", field
            )))
        }
        ...
        if let Some(some) = self.value.r#intended.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("intended", ctx))?;
        }
        if let Some(some) = self.value.r#directness_match.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("directnessMatch", ctx))?;
        }
        state.end()
    }
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceVariableDefinition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceVariableDefinition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceVariableDefinition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceVariableDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::EvidenceVariableDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#variable_role: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                let mut r#observed: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#intended: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#directness_match: Option<
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::VariableRole => {
                            ...
                            r#variable_role = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Observed => {
                        ...
                        Field::DirectnessMatch => {
                            if r#directness_match.is_some() {
                                return Err(serde::de::Error::duplicate_field("directnessMatch"));
                            }
                            r#directness_match = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Unknown(key) => {
                ...
                Ok(fhirbolt_model::r5::resources::EvidenceVariableDefinition {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#description,
                    r#note: r#note.unwrap_or(vec![]),
                    r#variable_role: if self.0.config.mode
                        == crate::context::de::DeserializationMode::Lax
                    {
                        r#variable_role.unwrap_or(Default::default())
                    } else {
                        r#variable_role.ok_or(serde::de::Error::missing_field("variableRole"))?
                    },
                    r#observed,
                    r#intended,
                    r#directness_match,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceVariableDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::EvidenceVariableDefinition>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceVariableDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::EvidenceVariableDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::EvidenceVariableDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: EvidenceVariableDefinition >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::EvidenceStatisticSampleSize,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "Evidence.statistic.sampleSize", field
            )))
        }
        let mut state = serializer.serialize_map(None)?;
        if let Some(value) = self.value.r#id.as_ref() {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#number_of_studies.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_numberOfStudies", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#number_of_studies.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("numberOfStudies", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#number_of_participants.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_numberOfParticipants", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#number_of_participants.as_ref() {
                self.with_context(some, |ctx| {
                    state.serialize_entry("numberOfParticipants", ctx)
                })?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#known_data_count.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_knownDataCount", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#known_data_count.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("knownDataCount", ctx))?;
            }
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceStatisticSampleSize;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#description: Option<fhirbolt_model::r5::types::Markdown> = None;
                let mut r#note: Option<Vec<Box<fhirbolt_model::r5::types::Annotation>>> = None;
                let mut r#number_of_studies: Option<fhirbolt_model::r5::types::UnsignedInt> = None;
                let mut r#number_of_participants: Option<fhirbolt_model::r5::types::UnsignedInt> =
                    None;
                let mut r#known_data_count: Option<fhirbolt_model::r5::types::UnsignedInt> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::NumberOfStudies => {
                            if self.0.from_json {
                                ...
                                r#number_of_studies = Some(map_access.next_value_seed(
                        ...
                        Field::NumberOfParticipants => {
                            if self.0.from_json {
                                ...
                                r#number_of_participants = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::UnsignedInt>(),
                                )?);
                            }
                        }
                        ...
                        Field::KnownDataCount => {
                            if self.0.from_json {
                                ...
                                r#known_data_count = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::UnsignedInt>(),
                                )?);
                            }
                        }
                ...
                Ok(fhirbolt_model::r5::resources::EvidenceStatisticSampleSize {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#description,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticSampleSize>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: EvidenceStatisticSampleSize >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "Evidence.statistic.attributeEstimate", field
            )))
        }
        let mut state = serializer.serialize_map(None)?;
        if let Some(value) = self.value.r#id.as_ref() {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#level.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = some
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_level", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#level.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("level", ctx))?;
            }
        }
        if let Some(some) = self.value.r#range.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("range", ctx))?;
        }
        if !self.value.r#attribute_estimate.is_empty() {
            self.with_context(&self.value.r#attribute_estimate, |ctx| {
                state.serialize_entry("attributeEstimate", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#level: Option<fhirbolt_model::r5::types::Decimal> = None;
                let mut r#range: Option<Box<fhirbolt_model::r5::types::Range>> = None;
                let mut r#attribute_estimate: Option<
                    Vec<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Level => {
                            if self.0.from_json {
                                ...
                                r#level = Some(map_access.next_value_seed(
                        ...
                        Field::AttributeEstimate => {
                            if self.0.from_json {
                                ...
                                r#attribute_estimate = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: EvidenceStatisticAttributeEstimate >> ()) ?) ;
                            } else {
                                let vec = r#attribute_estimate.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticAttributeEstimate > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticAttributeEstimate > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: EvidenceStatisticAttributeEstimate >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "Evidence.statistic.modelCharacteristic.variable", field
            )))
        }
        let mut state = serializer.serialize_map(None)?;
        if let Some(value) = self.value.r#id.as_ref() {
        ...
        if !self.value.r#value_category.is_empty() {
            self.with_context(&self.value.r#value_category, |ctx| {
                state.serialize_entry("valueCategory", ctx)
            })?;
        }
        ...
        if !self.value.r#value_range.is_empty() {
            self.with_context(&self.value.r#value_range, |ctx| {
                state.serialize_entry("valueRange", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<
                    Vec<Box<fhirbolt_model::r5::types::Extension>>,
                > = None;
                let mut r#variable_definition: Option<Box<fhirbolt_model::r5::types::Reference>> =
                    None;
                let mut r#handling: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#value_category: Option<
                    Vec<Box<fhirbolt_model::r5::types::CodeableConcept>>,
                > = None;
                let mut r#value_quantity: Option<Vec<Box<fhirbolt_model::r5::types::Quantity>>> =
                    None;
                let mut r#value_range: Option<Vec<Box<fhirbolt_model::r5::types::Range>>> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::ValueCategory => {
                            if self.0.from_json {
                                if r#value_category.is_some() {
                                    return Err(serde::de::Error::duplicate_field("valueCategory"));
                                }
                                r#value_category =
                                    Some(
                                        map_access.next_value_seed(
                        ...
                        Field::ValueQuantity => {
                            if self.0.from_json {
                                ...
                                r#value_quantity = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r5 :: types :: Quantity > >> ()) ?) ;
                            } else {
                        ...
                        Field::ValueRange => {
                            if self.0.from_json {
                                ...
                                r#value_range = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r5 :: types :: Range > >> ()) ?) ;
                            } else {
                ...
                Ok(
                    fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable {
                        ...
                        r#extension: r#extension.unwrap_or(vec![]),
                        r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        r#variable_definition: if self.0.config.mode
                            == crate::context::de::DeserializationMode::Lax
                        {
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristicVariable > () . deserialize (deserializer) . map (Box :: new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristicVariable>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristicVariable > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "Evidence.statistic.modelCharacteristic", field
            )))
        }
        let mut state = serializer.serialize_map(None)?;
        if let Some(value) = self.value.r#id.as_ref() {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                    ...
                    match map_access_key {
                        ...
                        Field::Variable => {
                            if self.0.from_json {
                                ...
                                r#variable = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristicVariable >> ()) ?) ;
                            } else {
                                let vec = r#variable.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristicVariable > ()) ?) ;
                            }
                        }
                        Field::AttributeEstimate => {
                            if self.0.from_json {
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristic > ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::EvidenceStatistic>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#statistic_type.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("statisticType", ctx))?;
        }
        ...
        if self.output_json {
            if let Some(some) = self.value.r#number_of_events.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_numberOfEvents", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#number_of_events.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("numberOfEvents", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#number_affected.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_numberAffected", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#number_affected.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("numberAffected", ctx))?;
            }
        }
        ...
        if !self.value.r#model_characteristic.is_empty() {
            self.with_context(&self.value.r#model_characteristic, |ctx| {
                state.serialize_entry("modelCharacteristic", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceStatistic>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceStatistic>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceStatistic>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r5::resources::EvidenceStatistic,
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceStatistic;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::EvidenceStatistic, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#description: Option<fhirbolt_model::r5::types::Markdown> = None;
                let mut r#note: Option<Vec<Box<fhirbolt_model::r5::types::Annotation>>> = None;
                let mut r#statistic_type: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                let mut r#category: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#quantity: Option<Box<fhirbolt_model::r5::types::Quantity>> = None;
                let mut r#number_of_events: Option<fhirbolt_model::r5::types::UnsignedInt> = None;
                let mut r#number_affected: Option<fhirbolt_model::r5::types::UnsignedInt> = None;
                let mut r#sample_size: Option<
                    fhirbolt_model::r5::resources::EvidenceStatisticSampleSize,
                > = None;
                let mut r#attribute_estimate: Option<
                    Vec<fhirbolt_model::r5::resources::EvidenceStatisticAttributeEstimate>,
                > = None;
                let mut r#model_characteristic: Option<
                    Vec<fhirbolt_model::r5::resources::EvidenceStatisticModelCharacteristic>,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::StatisticType => {
                            ...
                            r#statistic_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Category => {
                        ...
                        Field::NumberOfEvents => {
                            if self.0.from_json {
                                ...
                                r#number_of_events = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::UnsignedInt>(),
                                )?);
                            }
                        }
                        ...
                        Field::NumberAffected => {
                            if self.0.from_json {
                                ...
                                r#number_affected = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::UnsignedInt>(),
                                )?);
                            }
                        }
                        ...
                        Field::SampleSize => {
                            ...
                            r#sample_size = Some (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticSampleSize > ()) ?) ;
                        }
                        Field::AttributeEstimate => {
                            if self.0.from_json {
                                if r#attribute_estimate.is_some() {
                        ...
                        Field::ModelCharacteristic => {
                            if self.0.from_json {
                                ...
                                r#model_characteristic = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristic >> ()) ?) ;
                            } else {
                                let vec = r#model_characteristic.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatisticModelCharacteristic > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::EvidenceStatistic {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#description,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceStatistic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::EvidenceStatistic>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceStatistic>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::EvidenceStatistic>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::EvidenceStatistic>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::EvidenceStatistic>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::EvidenceCertainty>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#rating.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("rating", ctx))?;
        }
        if self.output_json {
            if let Some(some) = self.value.r#rater.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_rater", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#rater.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("rater", ctx))?;
            }
        }
        if !self.value.r#subcomponent.is_empty() {
            self.with_context(&self.value.r#subcomponent, |ctx| {
                state.serialize_entry("subcomponent", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::EvidenceCertainty>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::EvidenceCertainty>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::EvidenceCertainty>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r5::resources::EvidenceCertainty,
    >
{
    type Value = fhirbolt_model::r5::resources::EvidenceCertainty;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::EvidenceCertainty, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#note: Option<Vec<Box<fhirbolt_model::r5::types::Annotation>>> = None;
                let mut r#type: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#rating: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#rater: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#subcomponent: Option<
                    Vec<fhirbolt_model::r5::resources::EvidenceCertainty>,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Rating => {
                            ...
                            r#rating = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Rater => {
                            if self.0.from_json {
                                ...
                                r#rater = Some(map_access.next_value_seed(
                        ...
                        Field::Subcomponent => {
                            if self.0.from_json {
                                if r#subcomponent.is_some() {
                                    return Err(serde::de::Error::duplicate_field("subcomponent"));
                                }
                                r#subcomponent =
                                    Some(
                                        map_access.next_value_seed(
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceCertainty > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::EvidenceCertainty {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#description,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::EvidenceCertainty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::EvidenceCertainty>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::EvidenceCertainty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::EvidenceCertainty>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::EvidenceCertainty>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::EvidenceCertainty>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r5::resources::Evidence {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::Evidence>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#version_algorithm.as_ref() {
            match some {
                fhirbolt_model::r5::resources::EvidenceVersionAlgorithm::String(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::EvidenceVersionAlgorithm::Coding(ref value) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("versionAlgorithmCoding", ctx)
                    })?;
                }
                fhirbolt_model::r5::resources::EvidenceVersionAlgorithm::Invalid => {
        ...
        if let Some(some) = self.value.r#cite_as.as_ref() {
            match some {
                fhirbolt_model::r5::resources::EvidenceCiteAs::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("citeAsReference", ctx))?;
                }
                fhirbolt_model::r5::resources::EvidenceCiteAs::Markdown(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::EvidenceCiteAs::Invalid => {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#assertion.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_assertion", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#assertion.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("assertion", ctx))?;
            }
        }
        if !self.value.r#note.is_empty() {
            self.with_context(&self.value.r#note, |ctx| state.serialize_entry("note", ctx))?;
        }
        if !self.value.r#variable_definition.is_empty() {
            self.with_context(&self.value.r#variable_definition, |ctx| {
                state.serialize_entry("variableDefinition", ctx)
            })?;
        }
        if let Some(some) = self.value.r#synthesis_type.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("synthesisType", ctx))?;
        }
        ...
        if !self.value.r#statistic.is_empty() {
            self.with_context(&self.value.r#statistic, |ctx| {
                state.serialize_entry("statistic", ctx)
            })?;
        }
        if !self.value.r#certainty.is_empty() {
            self.with_context(&self.value.r#certainty, |ctx| {
                state.serialize_entry("certainty", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::resources::Evidence>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::resources::Evidence>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::Evidence>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Evidence>
{
    type Value = fhirbolt_model::r5::resources::Evidence;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Evidence>
{
    type Value = fhirbolt_model::r5::resources::Evidence;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r5::resources::Evidence,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r5::resources::Evidence;
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::Evidence, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#version_algorithm: Option<
                    fhirbolt_model::r5::resources::EvidenceVersionAlgorithm,
                > = None;
                let mut r#name: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#title: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#cite_as: Option<fhirbolt_model::r5::resources::EvidenceCiteAs> = None;
                ...
                > = None;
                let mut r#description: Option<fhirbolt_model::r5::types::Markdown> = None;
                let mut r#assertion: Option<fhirbolt_model::r5::types::Markdown> = None;
                let mut r#note: Option<Vec<Box<fhirbolt_model::r5::types::Annotation>>> = None;
                let mut r#variable_definition: Option<
                    Vec<fhirbolt_model::r5::resources::EvidenceVariableDefinition>,
                > = None;
                let mut r#synthesis_type: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                let mut r#study_design: Option<
                    Vec<Box<fhirbolt_model::r5::types::CodeableConcept>>,
                > = None;
                let mut r#statistic: Option<Vec<fhirbolt_model::r5::resources::EvidenceStatistic>> =
                    None;
                let mut r#certainty: Option<Vec<fhirbolt_model::r5::resources::EvidenceCertainty>> =
                    None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::VersionAlgorithmString => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm.get_or_insert(
                                    fhirbolt_model::r5::resources::EvidenceVersionAlgorithm::String(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model :: r5 :: resources :: EvidenceVersionAlgorithm :: String (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithmString")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithm[x]")) ; }
                            } else {
                                ...
                                r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: EvidenceVersionAlgorithm :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: String > > ()) ?)) ;
                            }
                        }
                        Field::VersionAlgorithmStringPrimitiveElement => {
                            if self.0.from_json {
                                ...
                                if let fhirbolt_model :: r5 :: resources :: EvidenceVersionAlgorithm :: String (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithmString")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithm[x]")) ; }
                            } else {
                        ...
                        Field::VersionAlgorithmCoding => {
                            ...
                            r#version_algorithm = Some(
                                fhirbolt_model::r5::resources::EvidenceVersionAlgorithm::Coding(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::CiteAsReference => {
                            ...
                            r#cite_as =
                                Some(fhirbolt_model::r5::resources::EvidenceCiteAs::Reference(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Box<fhirbolt_model::r5::types::Reference>>(
                                            ),
                        ...
                        Field::CiteAsMarkdown => {
                            if self.0.from_json {
                                let r#enum = r#cite_as.get_or_insert(
                                    fhirbolt_model::r5::resources::EvidenceCiteAs::Markdown(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::resources::EvidenceCiteAs::Markdown(
                                    variant,
                                ) = r#enum
                                {
                                ...
                                r#cite_as = Some (fhirbolt_model :: r5 :: resources :: EvidenceCiteAs :: Markdown (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Markdown > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::Assertion => {
                            if self.0.from_json {
                                ...
                                r#assertion = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Markdown>(),
                                )?);
                            }
                        }
                        Field::AssertionPrimitiveElement => {
                            if self.0.from_json {
                                let some = r#assertion.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field("_assertion"));
                                }
                                let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ;
                                some.id = id;
                                some.extension = extension;
                        ...
                        Field::VariableDefinition => {
                            if self.0.from_json {
                                ...
                                let vec = r#variable_definition.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceVariableDefinition > ()) ?) ;
                            }
                        }
                        Field::SynthesisType => {
                            ...
                            r#synthesis_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::StudyDesign => {
                            if self.0.from_json {
                        ...
                        Field::Statistic => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: EvidenceStatistic > ()) ?) ;
                            }
                        }
                        Field::Certainty => {
                            if self.0.from_json {
                ...
                Ok(fhirbolt_model::r5::resources::Evidence {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::Evidence>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::Evidence>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r5::resources::Evidence>,
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::Evidence>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::Evidence>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::Evidence>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::Evidence>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
