...
use fhirbolt_model::r5::resources::DeviceMetricCalibration;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#state: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#time: Option<fhirbolt_model::r5::types::Instant> = None;
...
use fhirbolt_model::r5::resources::DeviceMetric;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#measurement_frequency.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("measurementFrequency", ctx)));
        }
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#operational_status: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#color: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#category: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#measurement_frequency: Option<Box<fhirbolt_model::r5::types::Quantity>> =
                    None;
                let mut r#calibration: Option<
                    Vec<fhirbolt_model::r5::resources::DeviceMetricCalibration>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::MeasurementFrequency => {
                            if r#measurement_frequency.is_some() {
                                return Err(serde::de::Error::duplicate_field(
                                    "measurementFrequency",
                                ));
                            }
