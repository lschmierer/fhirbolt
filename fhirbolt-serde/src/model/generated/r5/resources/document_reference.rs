        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#context: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#event: Option<Vec<fhirbolt_model::r5::types::CodeableReference>> = None;
                let mut r#body_site: Option<Vec<fhirbolt_model::r5::types::CodeableReference>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Event => {
                            if self.0.from_json {
                                ...
                                r#event = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                        ...
                        Field::BodySite => {
                            if self.0.from_json {
                                ...
                                r#body_site = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
