                    ...
                    match map_access_key {
                        ...
                        Field::PerformedActivity => {
                            if self.0.from_json {
                                ...
                                r#performed_activity = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                        ...
                        Field::Progress => {
                            if self.0.from_json {
                                ...
                                r#progress = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: Annotation >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Addresses => {
                            if self.0.from_json {
                                ...
                                r#addresses = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
