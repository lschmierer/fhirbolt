...
use fhirbolt_model::r5::resources::BiologicallyDerivedProductDispensePerformer;
impl serde::ser::Serialize for SerializationContext<&BiologicallyDerivedProductDispensePerformer> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                ...
                "BiologicallyDerivedProductDispense.performer", field
            )))
        }
...
impl serde::ser::Serialize
    for SerializationContext<&Box<BiologicallyDerivedProductDispensePerformer>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for SerializationContext<&Vec<BiologicallyDerivedProductDispensePerformer>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<BiologicallyDerivedProductDispensePerformer>
{
    type Value = BiologicallyDerivedProductDispensePerformer;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<BiologicallyDerivedProductDispensePerformer>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = BiologicallyDerivedProductDispensePerformer;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("BiologicallyDerivedProductDispensePerformer")
            }
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<BiologicallyDerivedProductDispensePerformer, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(BiologicallyDerivedProductDispensePerformer {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<BiologicallyDerivedProductDispensePerformer>>
{
    type Value = Box<BiologicallyDerivedProductDispensePerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BiologicallyDerivedProductDispensePerformer>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<BiologicallyDerivedProductDispensePerformer>>
{
    type Value = Vec<BiologicallyDerivedProductDispensePerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<BiologicallyDerivedProductDispensePerformer>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BiologicallyDerivedProductDispensePerformer>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
...
use fhirbolt_model::r5::resources::BiologicallyDerivedProductDispense;
impl crate::Resource for BiologicallyDerivedProductDispense {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&BiologicallyDerivedProductDispense> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                "missing required field `{}.{}`",
                "BiologicallyDerivedProductDispense", field
            )))
        }
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "BiologicallyDerivedProductDispense"));
        ...
        if let Some(some) = self.value.r#origin_relationship_type.as_ref() {
            tri!(self.with_context(some, |ctx| state
                .serialize_entry("originRelationshipType", ctx)));
        }
        ...
        if let Some(some) = self.value.r#match_status.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("matchStatus", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#prepared_date.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("preparedDate", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_preparedDate", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#prepared_date.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("preparedDate", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#when_handed_over.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("whenHandedOver", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_whenHandedOver", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#when_handed_over.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("whenHandedOver", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<BiologicallyDerivedProductDispense>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<BiologicallyDerivedProductDispense>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for DeserializationContext<BiologicallyDerivedProductDispense>
{
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<BiologicallyDerivedProductDispense>
{
    type Value = BiologicallyDerivedProductDispense;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<BiologicallyDerivedProductDispense>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = BiologicallyDerivedProductDispense;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("BiologicallyDerivedProductDispense")
            }
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<BiologicallyDerivedProductDispense, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#origin_relationship_type: Option<
                    Box<fhirbolt_model::r5::types::CodeableConcept>,
                > = None;
                let mut r#product: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#patient: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#match_status: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                let mut r#performer: Option<
                    Vec<fhirbolt_model::r5::resources::BiologicallyDerivedProductDispensePerformer>,
                > = None;
                ...
                let mut r#usage_instruction: Option<fhirbolt_model::r5::types::String> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                            let value: std::borrow::Cow<str> = tri!(map_access.next_value());
                            if value != "BiologicallyDerivedProductDispense" {
                        ...
                        Field::OriginRelationshipType => {
                            if r#origin_relationship_type.is_some() {
                                return Err(serde::de::Error::duplicate_field(
                                    "originRelationshipType",
                                ));
                            }
                        ...
                        Field::MatchStatus => {
                            if r#match_status.is_some() {
                                return Err(serde::de::Error::duplicate_field("matchStatus"));
                            }
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#match_status = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Performer => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: BiologicallyDerivedProductDispensePerformer >> = self . 0 . transmute () ;
                                r#performer =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#performer.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: BiologicallyDerivedProductDispensePerformer > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Location => {
                ...
                Ok(BiologicallyDerivedProductDispense {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<BiologicallyDerivedProductDispense>>
{
    type Value = Box<BiologicallyDerivedProductDispense>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BiologicallyDerivedProductDispense>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<BiologicallyDerivedProductDispense>>
{
    type Value = Vec<BiologicallyDerivedProductDispense>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<BiologicallyDerivedProductDispense>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BiologicallyDerivedProductDispense>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<BiologicallyDerivedProductDispense> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
