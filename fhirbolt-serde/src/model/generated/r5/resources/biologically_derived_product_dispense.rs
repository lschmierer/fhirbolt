...
impl serde::ser::Serialize for SerializationContext<&BiologicallyDerivedProductDispense> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = serializer.serialize_map(None)?;
        state.serialize_entry("resourceType", "BiologicallyDerivedProductDispense")?;
                    ...
                    match map_access_key {
                        ...
                        Field::MatchStatus => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#match_status = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Performer => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::PreparedDate => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#prepared_date = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
