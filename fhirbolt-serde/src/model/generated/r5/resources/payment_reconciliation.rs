                    ...
                    _Enum::String(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("targetItemString", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_targetItemString", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("targetItemString", ctx)));
                        }
                    }
                    _Enum::Identifier(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("targetItemIdentifier", ctx)));
                    }
                    _Enum::PositiveInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("targetItemPositiveInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_targetItemPositiveInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("targetItemPositiveInt", ctx)));
                        }
                    }
                    _Enum::Invalid => {
                    ...
                    match map_access_key {
                        ...
                        Field::TargetItemString => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#target_item = Some(_Enum::String(tri!(
                        ...
                        Field::TargetItemIdentifier => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Identifier>,
                            > = self.0.transmute();
                            r#target_item = Some(_Enum::Identifier(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::TargetItemPositiveInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#target_item = Some(_Enum::PositiveInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
...
impl serde::ser::Serialize for SerializationContext<&PaymentReconciliation> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#issuer_type.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("issuerType", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#card_brand.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("cardBrand", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_cardBrand", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#card_brand.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("cardBrand", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#account_number.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("accountNumber", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_accountNumber", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#account_number.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("accountNumber", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#processor.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("processor", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_processor", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#processor.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("processor", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#reference_number.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("referenceNumber", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_referenceNumber", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#reference_number.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("referenceNumber", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#authorization.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("authorization", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_authorization", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#authorization.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("authorization", ctx)));
        }
        if let Some(some) = self.value.r#tendered_amount.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("tenderedAmount", ctx)));
        }
        if let Some(some) = self.value.r#returned_amount.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("returnedAmount", ctx)));
        }
        ...
        if !self.value.r#allocation.is_empty() {
            tri!(self.with_context(&self.value.r#allocation, |ctx| state
                .serialize_entry("allocation", ctx)));
        }
                    ...
                    match map_access_key {
                        ...
                        Field::IssuerType => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#issuer_type = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::PaymentIssuer => {
