        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#instance_reference.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("instanceReference", &some?));
            }
                ...
                || !self.value.r#instance_reference.extension.is_empty()
            {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_instanceReference", ctx)));
            }
        } else if self.value.r#instance_reference.id.as_deref() == Some("$invalid") {
            return missing_field_error("instanceReference");
        } else {
            tri!(
                self.with_context(&self.value.r#instance_reference, |ctx| state
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#version_reference.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("versionReference", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_versionReference", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#version_reference.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("versionReference", ctx)));
        }
        state.end()
    }
}
...
impl serde::ser::Serialize for SerializationContext<&ExampleScenarioInstance> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.value.r#structure_type.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#structure_type, |ctx| state
                .serialize_entry("structureType", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#structure_version.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("structureVersion", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_structureVersion", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#structure_version.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("structureVersion", ctx)));
        }
        {
                    ...
                    _Enum::Canonical(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("structureProfileCanonical", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_structureProfileCanonical", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("structureProfileCanonical", ctx)));
                        }
                    }
                    _Enum::Uri(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("structureProfileUri", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_structureProfileUri", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("structureProfileUri", ctx)));
                        }
                    }
                    _Enum::Invalid => {
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::StructureProfileCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#structure_profile = Some(_Enum::Canonical(tri!(
                        ...
                        Field::StructureProfileUri => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#structure_profile = Some(_Enum::Uri(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                ...
                Ok(ExampleScenarioInstance {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#structure_type
                            .ok_or(serde::de::Error::missing_field("structureType")))
                    },
                    r#structure_version,
                    r#structure_profile,
                    r#title: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
...
impl serde::ser::Serialize for SerializationContext<&ExampleScenarioProcessStep> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#process.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("process", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#workflow.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("workflow", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("workflow", ctx)));
        }
                    ...
                    match map_access_key {
                        ...
                        Field::Workflow => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#workflow = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
