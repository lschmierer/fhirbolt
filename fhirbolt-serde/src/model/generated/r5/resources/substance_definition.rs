                    ...
                    match map_access_key {
                        ...
                        Field::File => {
                            if self.0.from_json {
                                ...
                                r#file = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: Attachment >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Technique => {
                            if self.0.from_json {
                                ...
                                r#technique = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Domain => {
                            if self.0.from_json {
                                ...
                                r#domain = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::CountryOfOrigin => {
                            if self.0.from_json {
                                ...
                                r#country_of_origin = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Grade => {
                            if self.0.from_json {
                                ...
                                r#grade = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
