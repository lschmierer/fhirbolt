                        ...
                        Field::Timing => {
                            if self.0.from_json {
                                ...
                                r#timing = Some(map_access.next_value_seed(
                                    self.0.transmute::<Vec<fhirbolt_model::r5::types::Timing>>(),
                                )?);
                            } else {
                                let vec = r#timing.get_or_insert(Default::default());
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Timing>(),
                                )?);
                            }
                        }
                        Field::AsNeeded => {
                    ...
                    match map_access_key {
                        ...
                        Field::FluidConsistencyType => {
                            if self.0.from_json {
                                ...
                                r#fluid_consistency_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                                let vec =
                    ...
                    match map_access_key {
                        ...
                        Field::DeliveryDevice => {
                            if self.0.from_json {
                                ...
                                r#delivery_device = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Performer => {
                            if self.0.from_json {
                                ...
                                r#performer = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                        ...
                        Field::FoodPreferenceModifier => {
                            if self.0.from_json {
                                ...
                                r#food_preference_modifier = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                                let vec =
                        ...
                        Field::ExcludeFoodModifier => {
                            if self.0.from_json {
                                ...
                                r#exclude_food_modifier = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
