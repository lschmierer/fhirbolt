...
use fhirbolt_model::r5::resources::ProvenanceAgent;
impl serde::ser::Serialize for SerializationContext<&ProvenanceAgent> {
...
impl serde::ser::Serialize for SerializationContext<&Box<ProvenanceAgent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ProvenanceAgent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ProvenanceAgent> {
    type Value = ProvenanceAgent;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ProvenanceAgent>);
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ProvenanceAgent>> {
    type Value = Box<ProvenanceAgent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ProvenanceAgent>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ProvenanceAgent>> {
    type Value = Vec<ProvenanceAgent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ProvenanceAgent>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ProvenanceAgent>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<ProvenanceAgent> = self.0.transmute();
...
use fhirbolt_model::r5::resources::ProvenanceEntity;
impl serde::ser::Serialize for SerializationContext<&ProvenanceEntity> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#role.value.as_ref().map(Ok) {
        ...
        if self.value.r#what.id.as_deref() == Some("$invalid") {
            ...
            tri!(self.with_context(&self.value.r#what, |ctx| state.serialize_entry("what", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<ProvenanceEntity>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ProvenanceEntity>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ProvenanceEntity> {
    type Value = ProvenanceEntity;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ProvenanceEntity>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ProvenanceEntity;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#agent: Option<Vec<fhirbolt_model::r5::resources::ProvenanceAgent>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                ...
                Ok(ProvenanceEntity {
                    ...
                    r#what: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#what.ok_or(serde::de::Error::missing_field("what")))
                    },
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ProvenanceEntity>> {
    type Value = Box<ProvenanceEntity>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ProvenanceEntity>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ProvenanceEntity>> {
    type Value = Vec<ProvenanceEntity>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ProvenanceEntity>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ProvenanceEntity>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ProvenanceEntity> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::Provenance;
impl crate::Resource for Provenance {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&Provenance> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Provenance"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::ProvenanceOccurred as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("recorded", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#activity.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("activity", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<Provenance>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<Provenance>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<Provenance> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Provenance> {
    type Value = Provenance;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Provenance>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Provenance;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#occurred: Option<fhirbolt_model::r5::resources::ProvenanceOccurred> =
                    None;
                ...
                let mut r#authorization: Option<Vec<fhirbolt_model::r5::types::CodeableReference>> =
                    None;
                ...
                let mut r#agent: Option<Vec<fhirbolt_model::r5::resources::ProvenanceAgent>> = None;
                let mut r#entity: Option<Vec<fhirbolt_model::r5::resources::ProvenanceEntity>> =
                    None;
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<Provenance>> {
    type Value = Box<Provenance>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<Provenance>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<Provenance>> {
    type Value = Vec<Provenance>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<Provenance>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<Provenance>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<Provenance> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
