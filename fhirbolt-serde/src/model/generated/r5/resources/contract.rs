...
use fhirbolt_model::r5::resources::ContractContentDefinition;
...
use fhirbolt_model::r5::resources::ContractTermSecurityLabel;
...
use fhirbolt_model::r5::resources::ContractTermOfferParty;
...
use fhirbolt_model::r5::resources::ContractTermOfferAnswer;
impl serde::ser::Serialize for SerializationContext<&ContractTermOfferAnswer> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractTermOfferAnswerValue as _Enum;
...
use fhirbolt_model::r5::resources::ContractTermOffer;
...
use fhirbolt_model::r5::resources::ContractTermAssetContext;
...
use fhirbolt_model::r5::resources::ContractTermAssetValuedItem;
impl serde::ser::Serialize for SerializationContext<&ContractTermAssetValuedItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractTermAssetValuedItemEntity as _Enum;
...
use fhirbolt_model::r5::resources::ContractTermAsset;
...
use fhirbolt_model::r5::resources::ContractTermActionSubject;
...
use fhirbolt_model::r5::resources::ContractTermAction;
impl serde::ser::Serialize for SerializationContext<&ContractTermAction> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractTermActionOccurrence as _Enum;
...
use fhirbolt_model::r5::resources::ContractTerm;
impl serde::ser::Serialize for SerializationContext<&ContractTerm> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractTermTopic as _Enum;
            if let Some(some) = self.value.r#topic.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
...
use fhirbolt_model::r5::resources::ContractSigner;
                    ...
                    match map_access_key {
                        ...
                        Field::Signature => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::types::Signature>,
                                > = self.0.transmute();
                                r#signature =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Signature,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r5::resources::ContractFriendly;
impl serde::ser::Serialize for SerializationContext<&ContractFriendly> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractFriendlyContent as _Enum;
...
use fhirbolt_model::r5::resources::ContractLegal;
impl serde::ser::Serialize for SerializationContext<&ContractLegal> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractLegalContent as _Enum;
            match self.value.r#content {
                _Enum::Attachment(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("contentAttachment", ctx)));
...
use fhirbolt_model::r5::resources::ContractRule;
impl serde::ser::Serialize for SerializationContext<&ContractRule> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractRuleContent as _Enum;
            match self.value.r#content {
                _Enum::Attachment(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("contentAttachment", ctx)));
...
use fhirbolt_model::r5::resources::Contract;
...
impl serde::ser::Serialize for SerializationContext<&Contract> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ContractTopic as _Enum;
            if let Some(some) = self.value.r#topic.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
        ...
        {
            use fhirbolt_model::r5::resources::ContractLegallyBinding as _Enum;
