        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#category: Option<Vec<fhirbolt_model::r5::types::Coding>> = None;
                let mut r#control: Option<Vec<fhirbolt_model::r5::types::Coding>> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::Control => {
                            if self.0.from_json {
                                ...
                                r#control = Some(map_access.next_value_seed(
                                    self.0.transmute::<Vec<fhirbolt_model::r5::types::Coding>>(),
                                )?);
                            } else {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#decision_mode: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::DecisionMode => {
                            if self.0.from_json {
                                ...
                                r#decision_mode = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Code => {
                            if self.0.from_json {
                                ...
                                r#code = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#type_reference: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#subtype: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> = None;
                ...
                let mut r#period_type: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                let mut r#period: Option<Vec<fhirbolt_model::r5::types::Period>> = None;
                let mut r#use_period: Option<Vec<fhirbolt_model::r5::types::Period>> = None;
                let mut r#text: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#link_id: Option<Vec<fhirbolt_model::r5::types::String>> = None;
                let mut r#answer: Option<
                    Vec<fhirbolt_model::r5::resources::ContractTermOfferAnswer>,
                    ...
                    match map_access_key {
                        ...
                        Field::Subtype => {
                            if self.0.from_json {
                                ...
                                r#subtype = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::PeriodType => {
                            if self.0.from_json {
                                ...
                                r#period_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::UsePeriod => {
                            if self.0.from_json {
                                ...
                                r#use_period = Some(map_access.next_value_seed(
                                    self.0.transmute::<Vec<fhirbolt_model::r5::types::Period>>(),
                                )?);
                            } else {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                > = None;
                let mut r#requester: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#requester_link_id: Option<Vec<fhirbolt_model::r5::types::String>> = None;
                let mut r#performer_type: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::PerformerType => {
                            if self.0.from_json {
                                ...
                                r#performer_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#signature: Option<Vec<fhirbolt_model::r5::types::Signature>> = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::Signature => {
                            if self.0.from_json {
                                ...
                                r#signature = Some(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Vec<fhirbolt_model::r5::types::Signature>>(
                                            ),
                                    )?,
                                );
                            } else {
                                ...
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Signature>(),
                                )?);
                            }
                        }
                        Field::Unknown(key) => {
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#authority: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#domain: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                ...
                let mut r#type: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#sub_type: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::SubType => {
                            if self.0.from_json {
                                ...
                                r#sub_type = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
