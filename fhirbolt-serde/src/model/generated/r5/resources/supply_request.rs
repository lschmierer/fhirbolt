...
use fhirbolt_model::r5::resources::SupplyRequestParameter;
impl serde::ser::Serialize for SerializationContext<&SupplyRequestParameter> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::SupplyRequestParameterValue as _Enum;
...
use fhirbolt_model::r5::resources::SupplyRequest;
...
impl serde::ser::Serialize for SerializationContext<&SupplyRequest> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#deliver_for.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("deliverFor", ctx)));
        }
        ...
        {
            use fhirbolt_model::r5::resources::SupplyRequestOccurrence as _Enum;
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::DeliverFor => {
                            ...
                            > = self.0.transmute();
                            r#deliver_for = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Item => {
                            if r#item.is_some() {
