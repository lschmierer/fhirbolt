...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::DeviceRequestParameter,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#value.as_ref() {
            match some {
                fhirbolt_model::r5::resources::DeviceRequestParameterValue::CodeableConcept(
                    ref value,
                ) => {
                ...
                fhirbolt_model::r5::resources::DeviceRequestParameterValue::Quantity(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("valueQuantity", ctx))?;
                }
                fhirbolt_model::r5::resources::DeviceRequestParameterValue::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("valueRange", ctx))?;
                }
                fhirbolt_model::r5::resources::DeviceRequestParameterValue::Boolean(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::DeviceRequestParameterValue::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::DeviceRequestParameter>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::DeviceRequestParameter>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::DeviceRequestParameter>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::DeviceRequestParameter;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::DeviceRequestParameter, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#value: Option<
                    fhirbolt_model::r5::resources::DeviceRequestParameterValue,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ValueCodeableConcept => {
                            ...
                            r#value = Some (fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::ValueQuantity => {
                            if r#value.is_some() {
                                return Err(serde::de::Error::duplicate_field("valueQuantity"));
                            }
                            r#value = Some (fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: Quantity (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Quantity > > ()) ?)) ;
                        }
                        Field::ValueRange => {
                            if r#value.is_some() {
                            ...
                            r#value = Some(
                                fhirbolt_model::r5::resources::DeviceRequestParameterValue::Range(
                                    map_access.next_value_seed(
                        ...
                        Field::ValueBoolean => {
                            if self.0.from_json {
                                let r#enum = r#value . get_or_insert (fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: Boolean (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: Boolean (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("valueBoolean")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("value[x]")) ; }
                            } else {
                                if r#value.is_some() {
                                    return Err(serde::de::Error::duplicate_field("valueBoolean"));
                                }
                                r#value = Some (fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: Boolean (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Boolean > > ()) ?)) ;
                            }
                        }
                        Field::ValueBooleanPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#value . get_or_insert (fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: Boolean (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: DeviceRequestParameterValue :: Boolean (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_valueBoolean")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_value[x]")) ; }
                            } else {
                ...
                Ok(fhirbolt_model::r5::resources::DeviceRequestParameter {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::DeviceRequestParameter>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::DeviceRequestParameter>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::DeviceRequestParameter>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::DeviceRequestParameter>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::DeviceRequestParameter>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::DeviceRequestParameter>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r5::resources::DeviceRequest {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::DeviceRequest>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#occurrence.as_ref() {
            match some {
                fhirbolt_model::r5::resources::DeviceRequestOccurrence::DateTime(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::DeviceRequestOccurrence::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrencePeriod", ctx))?;
                }
                fhirbolt_model::r5::resources::DeviceRequestOccurrence::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrenceTiming", ctx))?;
                }
                fhirbolt_model::r5::resources::DeviceRequestOccurrence::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::DeviceRequest>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::DeviceRequest>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::DeviceRequest>
{
    type Value = fhirbolt_model::r5::resources::DeviceRequest;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r5::resources::DeviceRequest,
    >
{
    type Value = fhirbolt_model::r5::resources::DeviceRequest;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::DeviceRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#occurrence: Option<
                    fhirbolt_model::r5::resources::DeviceRequestOccurrence,
                > = None;
                ...
                let mut r#performer: Option<Box<fhirbolt_model::r5::types::CodeableReference>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Parameter => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: DeviceRequestParameter > ()) ?) ;
                            }
                        }
                        Field::Subject => {
                        ...
                        Field::OccurrenceDateTime => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r5 :: resources :: DeviceRequestOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: DeviceRequestOccurrence :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("occurrenceDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("occurrence[x]")) ; }
                            } else {
                                ...
                                r#occurrence = Some (fhirbolt_model :: r5 :: resources :: DeviceRequestOccurrence :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::OccurrenceDateTimePrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#occurrence . get_or_insert (fhirbolt_model :: r5 :: resources :: DeviceRequestOccurrence :: DateTime (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: DeviceRequestOccurrence :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_occurrenceDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_occurrence[x]")) ; }
                            } else {
                        ...
                        Field::OccurrencePeriod => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r5::resources::DeviceRequestOccurrence::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::OccurrenceTiming => {
                            ...
                            r#occurrence = Some(
                                fhirbolt_model::r5::resources::DeviceRequestOccurrence::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Performer => {
                            ...
                            r#performer = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableReference > > ()) ?) ;
                        }
                        Field::Reason => {
                            if self.0.from_json {
                                if r#reason.is_some() {
                ...
                Ok(fhirbolt_model::r5::resources::DeviceRequest {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::DeviceRequest>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::DeviceRequest>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::DeviceRequest>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::DeviceRequest>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::DeviceRequest>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::DeviceRequest>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
