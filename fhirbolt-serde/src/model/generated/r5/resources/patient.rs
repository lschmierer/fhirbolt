                    ...
                    match map_access_key {
                        ...
                        Field::Relationship => {
                            if self.0.from_json {
                                ...
                                r#relationship = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Telecom => {
                            if self.0.from_json {
                                ...
                                r#telecom = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: ContactPoint >> ()) ?) ;
                            } else {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#communication: Option<
                    Vec<fhirbolt_model::r5::resources::PatientCommunication>,
                > = None;
                let mut r#general_practitioner: Option<Vec<fhirbolt_model::r5::types::Reference>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Name => {
                            if self.0.from_json {
                                ...
                                r#name = Some(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Vec<fhirbolt_model::r5::types::HumanName>>(
                                            ),
                                    )?,
                                );
                            } else {
                                ...
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::HumanName>(),
                                )?);
                            }
                        }
                        Field::Telecom => {
                        ...
                        Field::Address => {
                            if self.0.from_json {
                                ...
                                r#address = Some(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Vec<fhirbolt_model::r5::types::Address>>(),
                                    )?,
                                );
                            } else {
                                let vec = r#address.get_or_insert(Default::default());
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Address>(),
                                )?);
                            }
                        }
                        Field::MaritalStatus => {
                        ...
                        Field::Photo => {
                            if self.0.from_json {
                                ...
                                r#photo = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: Attachment >> ()) ?) ;
                            } else {
