                ...
                match some {
                    _Enum::Ratio(ref value) => {
                        self.with_context(value, |ctx| {
                            state.serialize_entry("strengthRatio", ctx)
                        })?;
                    }
                    ...
                    _Enum::Quantity(ref value) => {
                        self.with_context(value, |ctx| {
                            state.serialize_entry("strengthQuantity", ctx)
                        })?;
                    }
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::StrengthCodeableConcept => {
                            ...
                            > = self.0.transmute();
                            r#strength = Some(_Enum::CodeableConcept(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                    ...
                    match map_access_key {
                        ...
                        Field::TotalVolume => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Quantity>,
                            > = self.0.transmute();
                            r#total_volume = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Ingredient => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Batch => {
                            ...
                            > = self.0.transmute();
                            r#batch = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Definition => {
