...
use fhirbolt_model::r5::resources::ChargeItemDefinitionApplicability;
impl serde::ser::Serialize for SerializationContext<&ChargeItemDefinitionApplicability> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#related_artifact.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("relatedArtifact", ctx)));
        }
        state.end()
    }
}
...
use fhirbolt_model::r5::resources::ChargeItemDefinitionPropertyGroup;
                    ...
                    match map_access_key {
                        ...
                        Field::Applicability => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ChargeItemDefinitionApplicability >> = self . 0 . transmute () ;
                                r#applicability =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#applicability.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: ChargeItemDefinitionApplicability > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r5::resources::ChargeItemDefinition;
...
impl serde::ser::Serialize for SerializationContext<&ChargeItemDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ChargeItemDefinitionVersionAlgorithm as _Enum;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#instance: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#applicability: Option<
                    Vec<fhirbolt_model::r5::resources::ChargeItemDefinitionApplicability>,
                > = None;
                    ...
                    match map_access_key {
                        ...
                        Field::PropertyGroup => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ChargeItemDefinitionPropertyGroup >> = self . 0 . transmute () ;
                                r#property_group =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#property_group.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: ChargeItemDefinitionPropertyGroup > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
