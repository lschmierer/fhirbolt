                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Observation => {
                            ...
                            > = self.0.transmute();
                            r#observation = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Type => {
                            if self.0.from == crate::context::Format::Json {
                ...
                Ok(ObservationTriggeredBy {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#observation.ok_or(serde::de::Error::missing_field("observation")))
                    },
...
impl serde::ser::Serialize for SerializationContext<&ObservationReferenceRange> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#normal_value.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("normalValue", ctx)));
        }
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::NormalValue => {
                            ...
                            > = self.0.transmute();
                            r#normal_value = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Type => {
                            if r#type.is_some() {
                                return Err(serde::de::Error::duplicate_field("type"));
...
impl serde::ser::Serialize for SerializationContext<&Observation> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        }
        {
            ...
            if let Some(some) = self.value.r#instantiates.as_ref() {
                match some {
                    ...
                    _Enum::Reference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("instantiatesReference", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        if !self.value.r#triggered_by.is_empty() {
            tri!(self.with_context(&self.value.r#triggered_by, |ctx| state
                .serialize_entry("triggeredBy", ctx)));
        }
                    ...
                    match map_access_key {
                        ...
                        Field::InstantiatesCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#instantiates = Some(_Enum::Canonical(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::InstantiatesReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#instantiates = Some(_Enum::Reference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::BasedOn => {
