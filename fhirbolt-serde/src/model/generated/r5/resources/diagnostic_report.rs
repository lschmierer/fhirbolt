...
use fhirbolt_model::r5::resources::DiagnosticReportSupportingInfo;
impl serde::ser::Serialize for SerializationContext<&DiagnosticReportSupportingInfo> {
...
impl serde::ser::Serialize for SerializationContext<&Box<DiagnosticReportSupportingInfo>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<DiagnosticReportSupportingInfo>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<DiagnosticReportSupportingInfo>
{
    type Value = DiagnosticReportSupportingInfo;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<DiagnosticReportSupportingInfo>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<DiagnosticReportSupportingInfo, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(DiagnosticReportSupportingInfo {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<DiagnosticReportSupportingInfo>>
{
    type Value = Box<DiagnosticReportSupportingInfo>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<DiagnosticReportSupportingInfo>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<DiagnosticReportSupportingInfo>>
{
    type Value = Vec<DiagnosticReportSupportingInfo>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<DiagnosticReportSupportingInfo>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<DiagnosticReportSupportingInfo>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<DiagnosticReportSupportingInfo> =
                    self.0.transmute();
...
use fhirbolt_model::r5::resources::DiagnosticReportMedia;
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(DiagnosticReportMedia {
                    ...
                    r#link: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#link.ok_or(serde::de::Error::missing_field("link")))
                    },
                })
            }
        }
...
use fhirbolt_model::r5::resources::DiagnosticReport;
...
impl serde::ser::Serialize for SerializationContext<&DiagnosticReport> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "DiagnosticReport"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::DiagnosticReportEffective as _Enum;
            if let Some(some) = self.value.r#effective.as_ref() {
                match some {
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("effectiveDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_effectiveDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("effectiveDateTime", ctx)));
                        }
                    }
                    _Enum::Period(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("effectivePeriod", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        if !self.value.r#results_interpreter.is_empty() {
            tri!(
                self.with_context(&self.value.r#results_interpreter, |ctx| state
                    .serialize_entry("resultsInterpreter", ctx))
            );
        }
        ...
        if !self.value.r#media.is_empty() {
            tri!(self.with_context(&self.value.r#media, |ctx| state
                .serialize_entry("media", ctx)));
        }
        if let Some(some) = self.value.r#composition.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("composition", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#conclusion.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("conclusion", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_conclusion", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#conclusion.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("conclusion", ctx)));
        }
        if !self.value.r#conclusion_code.is_empty() {
            tri!(self.with_context(&self.value.r#conclusion_code, |ctx| state
                .serialize_entry("conclusionCode", ctx)));
        }
        if !self.value.r#presented_form.is_empty() {
            tri!(self.with_context(&self.value.r#presented_form, |ctx| state
                .serialize_entry("presentedForm", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::EffectiveDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#effective = Some(_Enum::DateTime(tri!(
                        ...
                        Field::EffectivePeriod => {
                            ...
                            > = self.0.transmute();
                            r#effective = Some(_Enum::Period(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::Issued => {
                        ...
                        Field::SupportingInfo => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: DiagnosticReportSupportingInfo >> = self . 0 . transmute () ;
                                r#supporting_info =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Composition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#composition = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Conclusion => {
                            if self.0.from == crate::context::Format::Json {
