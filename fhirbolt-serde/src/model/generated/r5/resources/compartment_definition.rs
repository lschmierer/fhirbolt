...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::CompartmentDefinitionResource,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                ...
                "CompartmentDefinition.resource", field
            )))
        }
        ...
        if self.output_json {
            if !self.value.r#param.is_empty() {
                let values = self
                    .value
                    .r#param
                    .iter()
                ...
                if requires_elements {
                    ...
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_param", ctx)
                    })?;
                }
            }
        } else {
            if !self.value.r#param.is_empty() {
                self.with_context(&self.value.r#param, |ctx| {
                    state.serialize_entry("param", ctx)
                })?;
            }
        }
        if self.output_json {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#start_param.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                    state.serialize_entry("startParam", &some)?;
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    let primitive_element = super::super::serde_helpers::PrimitiveElement {
                        id: some.id.as_ref(),
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_startParam", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#start_param.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("startParam", ctx))?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#end_param.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                    state.serialize_entry("endParam", &some)?;
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    let primitive_element = super::super::serde_helpers::PrimitiveElement {
                        id: some.id.as_ref(),
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_endParam", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#end_param.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("endParam", ctx))?;
            }
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::CompartmentDefinitionResource>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::CompartmentDefinitionResource>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::CompartmentDefinitionResource>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::CompartmentDefinitionResource;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::CompartmentDefinitionResource, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                enum Field {
                    ...
                    StartParamPrimitiveElement,
                    #[serde(rename = "endParam")]
                    EndParam,
                    #[serde(rename = "_endParam")]
                    EndParamPrimitiveElement,
                ...
                let mut r#param: Option<Vec<fhirbolt_model::r5::types::String>> = None;
                let mut r#documentation: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#start_param: Option<fhirbolt_model::r5::types::Uri> = None;
                let mut r#end_param: Option<fhirbolt_model::r5::types::Uri> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Param => {
                            if self.0.from_json {
                                ...
                                let vec = r#param.get_or_insert(Default::default());
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::String>(),
                                )?);
                            }
                        }
                        Field::ParamPrimitiveElement => {
                            if self.0.from_json {
                                let elements: Vec<
                                ...
                                return unknown_field_error("param");
                            }
                        }
                        Field::Documentation => {
                            if self.0.from_json {
                        ...
                        Field::StartParam => {
                            if self.0.from_json {
                                let some = r#start_param.get_or_insert(Default::default());
                                if some.value.is_some() {
                                    return Err(serde::de::Error::duplicate_field("startParam"));
                                }
                                let value: _ = map_access.next_value()?;
                                some.value = Some(value);
                            } else {
                                if r#start_param.is_some() {
                                    return Err(serde::de::Error::duplicate_field("startParam"));
                                }
                                r#start_param = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Uri>(),
                                )?);
                            }
                        }
                        Field::StartParamPrimitiveElement => {
                            if self.0.from_json {
                                let some = r#start_param.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field("_startParam"));
                                }
                                let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ;
                                some.id = id;
                                some.extension = extension;
                            } else {
                                return unknown_field_error("startParam");
                            }
                        }
                        Field::EndParam => {
                            if self.0.from_json {
                                let some = r#end_param.get_or_insert(Default::default());
                                if some.value.is_some() {
                                    return Err(serde::de::Error::duplicate_field("endParam"));
                                }
                                let value: _ = map_access.next_value()?;
                                some.value = Some(value);
                            } else {
                                if r#end_param.is_some() {
                                    return Err(serde::de::Error::duplicate_field("endParam"));
                                }
                                r#end_param = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Uri>(),
                                )?);
                            }
                        }
                        Field::EndParamPrimitiveElement => {
                            if self.0.from_json {
                                let some = r#end_param.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field("_endParam"));
                                }
                                let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ;
                                some.id = id;
                                some.extension = extension;
                            } else {
                                return unknown_field_error("endParam");
                            }
                        }
                        Field::Unknown(key) => {
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::CompartmentDefinitionResource>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::CompartmentDefinitionResource>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::CompartmentDefinitionResource>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::CompartmentDefinitionResource>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::CompartmentDefinitionResource>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: CompartmentDefinitionResource >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl crate::Resource for fhirbolt_model::r5::resources::CompartmentDefinition {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::CompartmentDefinition,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#version_algorithm.as_ref() {
            match some {
                fhirbolt_model::r5::resources::CompartmentDefinitionVersionAlgorithm::String(
                    ref value,
                ) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::CompartmentDefinitionVersionAlgorithm::Coding(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r5::resources::CompartmentDefinitionVersionAlgorithm::Invalid => {
        ...
        if self.output_json {
            if self.value.r#search.id.as_deref() == Some("$invalid") {
                return missing_field_error("search");
            }
            if let Some(some) = self.value.r#search.value.as_ref() {
                let some = Ok(some)?;
                state.serialize_entry("search", &some)?;
            }
            if self.value.r#search.id.is_some() || !self.value.r#search.extension.is_empty() {
                let primitive_element = super::super::serde_helpers::PrimitiveElement {
                    id: self.value.r#search.id.as_ref(),
                    extension: &self.value.r#search.extension,
                };
                self.with_context(&primitive_element, |ctx| {
                    state.serialize_entry("_search", ctx)
                })?;
            }
        } else {
            if self.value.r#search.id.as_deref() == Some("$invalid") {
            ...
            self.with_context(&self.value.r#search, |ctx| {
                state.serialize_entry("search", ctx)
            })?;
        }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::CompartmentDefinition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::CompartmentDefinition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::CompartmentDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::CompartmentDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#version_algorithm: Option<
                    fhirbolt_model::r5::resources::CompartmentDefinitionVersionAlgorithm,
                > = None;
                ...
                let mut r#code: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#search: Option<fhirbolt_model::r5::types::Boolean> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        Field::ResourceType => {
                            ...
                            if value != "CompartmentDefinition" {
                        ...
                        Field::VersionAlgorithmString => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: CompartmentDefinitionVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: CompartmentDefinitionVersionAlgorithm :: String (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithmString")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithm[x]")) ; }
                            } else {
                                ...
                                r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: CompartmentDefinitionVersionAlgorithm :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: String > > ()) ?)) ;
                            }
                        }
                        Field::VersionAlgorithmStringPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: CompartmentDefinitionVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: CompartmentDefinitionVersionAlgorithm :: String (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithmString")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithm[x]")) ; }
                            } else {
                        ...
                        Field::VersionAlgorithmCoding => {
                            ...
                            r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: CompartmentDefinitionVersionAlgorithm :: Coding (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Coding > > ()) ?)) ;
                        }
                        Field::Name => {
                            if self.0.from_json {
                        ...
                        Field::Search => {
                            if self.0.from_json {
                                ...
                                r#search = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Boolean>(),
                                )?);
                            }
                        }
                        Field::SearchPrimitiveElement => {
                            if self.0.from_json {
                                let some = r#search.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                ...
                                return unknown_field_error("search");
                            }
                        }
                        Field::Resource => {
                            if self.0.from_json {
                                ...
                                r#resource = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: CompartmentDefinitionResource >> ()) ?) ;
                            } else {
                                let vec = r#resource.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: CompartmentDefinitionResource > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::CompartmentDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
                    ...
                    r#search: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        r#search.unwrap_or(Default::default())
                    } else {
                        r#search.ok_or(serde::de::Error::missing_field("search"))?
                    },
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::CompartmentDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::CompartmentDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::CompartmentDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::CompartmentDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::CompartmentDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
