...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::RequirementsStatement,
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output_json {
            if !self.value.r#conformance.is_empty() {
                let values = self
                    .value
                    .r#conformance
                    .iter()
                ...
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("conformance", &values)?;
                }
                ...
                if requires_elements {
                    ...
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_conformance", ctx)
                    })?;
                }
            }
        } else {
            if !self.value.r#conformance.is_empty() {
                self.with_context(&self.value.r#conformance, |ctx| {
                    state.serialize_entry("conformance", ctx)
                })?;
            }
        }
        if self.output_json {
            if let Some(some) = self.value.r#conditionality.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
                    state.serialize_entry("conditionality", &some)?;
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    let primitive_element = super::super::serde_helpers::PrimitiveElement {
                        id: some.id.as_ref(),
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_conditionality", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#conditionality.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("conditionality", ctx))?;
            }
        }
        if self.output_json {
            if self.value.r#requirement.id.as_deref() == Some("$invalid") {
                return missing_field_error("requirement");
            }
            if let Some(some) = self.value.r#requirement.value.as_ref() {
                let some = Ok(some)?;
                state.serialize_entry("requirement", &some)?;
            }
            if self.value.r#requirement.id.is_some()
                || !self.value.r#requirement.extension.is_empty()
            {
                let primitive_element = super::super::serde_helpers::PrimitiveElement {
                    id: self.value.r#requirement.id.as_ref(),
                    extension: &self.value.r#requirement.extension,
                };
                self.with_context(&primitive_element, |ctx| {
        ...
        if self.output_json {
            if let Some(some) = self.value.r#derived_from.as_ref() {
                if let Some(some) = some.value.as_ref() {
                    let some = Ok(some)?;
            ...
            if let Some(some) = self.value.r#derived_from.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("derivedFrom", ctx))?;
            }
        }
        if self.output_json {
        ...
        if self.output_json {
            if !self.value.r#satisfied_by.is_empty() {
                let values = self
                    .value
                    .r#satisfied_by
                    .iter()
                    ...
                    .collect::<Result<Vec<_>, _>>()?;
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("satisfiedBy", &values)?;
                }
                let requires_elements = self
                    .value
                    .r#satisfied_by
                ...
                if requires_elements {
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_satisfiedBy", ctx)
                    })?;
                }
            }
        } else {
            if !self.value.r#satisfied_by.is_empty() {
                self.with_context(&self.value.r#satisfied_by, |ctx| {
                    state.serialize_entry("satisfiedBy", ctx)
                })?;
            }
        }
        if self.output_json {
            if !self.value.r#reference.is_empty() {
                let values = self
                    ...
                    .collect::<Result<Vec<_>, _>>()?;
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("reference", &values)?;
                }
                let requires_elements = self
                    .value
                    .r#reference
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::RequirementsStatement>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::RequirementsStatement>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::RequirementsStatement>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::RequirementsStatement;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("RequirementsStatement")
            }
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::RequirementsStatement, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                enum Field {
                    ...
                    ConformancePrimitiveElement,
                    #[serde(rename = "conditionality")]
                    Conditionality,
                    #[serde(rename = "_conditionality")]
                    ConditionalityPrimitiveElement,
                ...
                let mut r#conformance: Option<Vec<fhirbolt_model::r5::types::Code>> = None;
                let mut r#conditionality: Option<fhirbolt_model::r5::types::Boolean> = None;
                let mut r#requirement: Option<fhirbolt_model::r5::types::Markdown> = None;
                let mut r#derived_from: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#parent: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#satisfied_by: Option<Vec<fhirbolt_model::r5::types::Url>> = None;
                let mut r#reference: Option<Vec<fhirbolt_model::r5::types::Url>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Conformance => {
                            if self.0.from_json {
                                ...
                                let vec = r#conformance.get_or_insert(
                                ...
                                let vec = r#conformance.get_or_insert(Default::default());
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Code>(),
                                )?);
                            }
                        }
                        Field::ConformancePrimitiveElement => {
                            if self.0.from_json {
                                let elements: Vec<
                                ...
                                if vec
                                    ...
                                    .any(|e| e.id.is_some() || !e.extension.is_empty())
                                {
                                    return Err(serde::de::Error::duplicate_field("_conformance"));
                                }
                                ...
                                return unknown_field_error("conformance");
                            }
                        }
                        Field::Conditionality => {
                            if self.0.from_json {
                                let some = r#conditionality.get_or_insert(Default::default());
                                if some.value.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "conditionality",
                                    ));
                                ...
                                if r#conditionality.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "conditionality",
                                    ));
                                }
                                r#conditionality = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Boolean>(),
                                )?);
                            }
                        }
                        Field::ConditionalityPrimitiveElement => {
                            if self.0.from_json {
                                let some = r#conditionality.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field(
                                ...
                                return unknown_field_error("conditionality");
                            }
                        }
                        Field::Requirement => {
                            if self.0.from_json {
                        ...
                        Field::Parent => {
                            if self.0.from_json {
                                let some = r#parent.get_or_insert(Default::default());
                                if some.value.is_some() {
                                ...
                                r#parent = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::String>(),
                                )?);
                            }
                        }
                        ...
                        Field::SatisfiedBy => {
                            if self.0.from_json {
                                let values: Vec<Option<_>> = map_access.next_value()?;
                                let vec = r#satisfied_by.get_or_insert(
                                    std::iter::repeat(Default::default())
                                        .take(values.len())
                                        .collect::<Vec<_>>(),
                                );
                                ...
                                if vec.iter().any(|v| v.value.is_some()) {
                                    return Err(serde::de::Error::duplicate_field("satisfiedBy"));
                                }
                                for (i, value) in values.into_iter().enumerate() {
                                    if let Some(value) = value {
                                        vec[i].value = Some(value);
                                ...
                                let vec = r#satisfied_by.get_or_insert(Default::default());
                                vec.push(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Url>(),
                                )?);
                            }
                        }
                        Field::SatisfiedByPrimitiveElement => {
                            if self.0.from_json {
                                let elements: Vec<
                                    Option<super::super::serde_helpers::PrimitiveElementOwned>,
                                > =
                                ...
                                if vec
                                    ...
                                    .any(|e| e.id.is_some() || !e.extension.is_empty())
                                {
                                    return Err(serde::de::Error::duplicate_field("_satisfiedBy"));
                                }
                                for (i, element) in elements.into_iter().enumerate() {
                                    if let Some(element) = element {
                                        vec[i].id = element.id;
                                ...
                                return unknown_field_error("satisfiedBy");
                            }
                        }
                        Field::Reference => {
                            if self.0.from_json {
                                let values: Vec<Option<_>> = map_access.next_value()?;
                                let vec = r#reference.get_or_insert(
                                    std::iter::repeat(Default::default())
                                        .take(values.len())
                                        .collect::<Vec<_>>(),
                                );
                ...
                Ok(fhirbolt_model::r5::resources::RequirementsStatement {
                    r#id,
                    ...
                    r#label,
                    r#conformance: r#conformance.unwrap_or(vec![]),
                    r#conditionality,
                    r#requirement: if self.0.config.mode
                        == crate::context::de::DeserializationMode::Lax
                    {
                        r#requirement.unwrap_or(Default::default())
                    } else {
                        r#requirement.ok_or(serde::de::Error::missing_field("requirement"))?
                    },
                    r#derived_from,
                    r#parent,
                    r#satisfied_by: r#satisfied_by.unwrap_or(vec![]),
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::RequirementsStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::RequirementsStatement>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::RequirementsStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::RequirementsStatement>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::RequirementsStatement>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::RequirementsStatement>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r5::resources::Requirements {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::Requirements>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = serializer.serialize_map(None)?;
        state.serialize_entry("resourceType", "Requirements")?;
        if let Some(value) = self.value.r#id.as_ref() {
            state.serialize_entry("id", value)?;
        }
        ...
        if let Some(some) = self.value.r#version_algorithm.as_ref() {
            match some {
                fhirbolt_model::r5::resources::RequirementsVersionAlgorithm::String(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::RequirementsVersionAlgorithm::Coding(ref value) => {
                    self.with_context(value, |ctx| {
                        state.serialize_entry("versionAlgorithmCoding", ctx)
                    })?;
                }
                fhirbolt_model::r5::resources::RequirementsVersionAlgorithm::Invalid => {
        ...
        if self.output_json {
            if !self.value.r#actor.is_empty() {
                let values = self
                    ...
                    .collect::<Result<Vec<_>, _>>()?;
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("actor", &values)?;
                }
                let requires_elements = self
                    .value
                    .r#actor
                ...
                if requires_elements {
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_actor", ctx)
                    })?;
                }
            }
        } else {
        ...
        if !self.value.r#statement.is_empty() {
            self.with_context(&self.value.r#statement, |ctx| {
                state.serialize_entry("statement", ctx)
            })?;
        }
        state.end()
    }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::resources::Requirements>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::resources::Requirements>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::Requirements>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Requirements>
{
    type Value = fhirbolt_model::r5::resources::Requirements;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::Requirements>
{
    type Value = fhirbolt_model::r5::resources::Requirements;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r5::resources::Requirements,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r5::resources::Requirements;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("Requirements")
            }
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::Requirements, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#version_algorithm: Option<
                    fhirbolt_model::r5::resources::RequirementsVersionAlgorithm,
                > = None;
                ...
                let mut r#reference: Option<Vec<fhirbolt_model::r5::types::Url>> = None;
                let mut r#actor: Option<Vec<fhirbolt_model::r5::types::Canonical>> = None;
                let mut r#statement: Option<
                    Vec<fhirbolt_model::r5::resources::RequirementsStatement>,
                > = None;
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::VersionAlgorithmString => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: RequirementsVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: RequirementsVersionAlgorithm :: String (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithmString")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithm[x]")) ; }
                            } else {
                        ...
                        Field::VersionAlgorithmCoding => {
                            ...
                            r#version_algorithm = Some(
                                fhirbolt_model::r5::resources::RequirementsVersionAlgorithm::Coding(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::ActorPrimitiveElement => {
                            if self.0.from_json {
                                ...
                                if vec
                                    ...
                                    .any(|e| e.id.is_some() || !e.extension.is_empty())
                                {
                                    return Err(serde::de::Error::duplicate_field("_actor"));
                                }
                                for (i, element) in elements.into_iter().enumerate() {
                                    if let Some(element) = element {
                                        vec[i].id = element.id;
                                ...
                                return unknown_field_error("actor");
                            }
                        }
                        Field::Statement => {
                            if self.0.from_json {
                                if r#statement.is_some() {
                                ...
                                let vec = r#statement.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: RequirementsStatement > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::Requirements {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
                    ...
                    r#statement: r#statement.unwrap_or(vec![]),
                })
            }
        }
        deserializer.deserialize_map(Visitor(self))
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::Requirements>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::Requirements>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r5::resources::Requirements>,
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::Requirements>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::Requirements>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::Requirements>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::Requirements>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
