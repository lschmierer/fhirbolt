...
use fhirbolt_model::r5::resources::RequirementsStatement;
impl serde::ser::Serialize for SerializationContext<&RequirementsStatement> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#conformance.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("conformance", &values));
                }
                ...
                if requires_elements {
                    ...
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_conformance", ctx)));
                }
            }
        } else if !self.value.r#conformance.is_empty() {
            tri!(self.with_context(&self.value.r#conformance, |ctx| state
                .serialize_entry("conformance", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#conditionality.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("conditionality", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_conditionality", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#conditionality.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("conditionality", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if self.value.r#requirement.id.as_deref() == Some("$invalid") {
                return missing_field_error("requirement");
            }
            if let Some(some) = self.value.r#requirement.value.as_ref().map(Ok) {
        ...
        } else if self.value.r#requirement.id.as_deref() == Some("$invalid") {
            return missing_field_error("requirement");
        } else {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#derived_from.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("derivedFrom", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        } else if let Some(some) = self.value.r#derived_from.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("derivedFrom", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#parent.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("parent", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        } else if let Some(some) = self.value.r#parent.as_ref() {
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#satisfied_by.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("satisfiedBy", &values));
                }
                let requires_elements = self
                    .value
                    .r#satisfied_by
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_satisfiedBy", ctx)));
                }
            }
        } else if !self.value.r#satisfied_by.is_empty() {
            tri!(self.with_context(&self.value.r#satisfied_by, |ctx| state
                .serialize_entry("satisfiedBy", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#reference.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("reference", &values));
                }
                let requires_elements = self
                    .value
                    .r#reference
        ...
        } else if !self.value.r#reference.is_empty() {
...
impl serde::ser::Serialize for SerializationContext<&Box<RequirementsStatement>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequirementsStatement>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<RequirementsStatement> {
    type Value = RequirementsStatement;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequirementsStatement>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequirementsStatement;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("RequirementsStatement")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<RequirementsStatement, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(RequirementsStatement {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#requirement.ok_or(serde::de::Error::missing_field("requirement")))
                    },
                    r#derived_from,
                    r#parent,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequirementsStatement>>
{
    type Value = Box<RequirementsStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequirementsStatement>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequirementsStatement>>
{
    type Value = Vec<RequirementsStatement>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<RequirementsStatement>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequirementsStatement>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<RequirementsStatement> =
                    self.0.transmute();
...
use fhirbolt_model::r5::resources::Requirements;
impl crate::Resource for Requirements {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&Requirements> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Requirements"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::RequirementsVersionAlgorithm as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#actor.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("actor", &values));
                }
                let requires_elements = self
                    .value
                    .r#actor
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_actor", ctx)));
                }
            }
        } else if !self.value.r#actor.is_empty() {
            tri!(self.with_context(&self.value.r#actor, |ctx| state
                .serialize_entry("actor", ctx)));
        }
        if !self.value.r#statement.is_empty() {
            tri!(self.with_context(&self.value.r#statement, |ctx| state
                .serialize_entry("statement", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<Requirements>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<Requirements>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<Requirements> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Requirements> {
    type Value = Requirements;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Requirements>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Requirements;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("Requirements")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<Requirements, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<Requirements>> {
    type Value = Box<Requirements>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<Requirements>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<Requirements>> {
    type Value = Vec<Requirements>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<Requirements>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<Requirements>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<Requirements> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
