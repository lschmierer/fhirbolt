                    ...
                    match map_access_key {
                        ...
                        Field::Designation => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                r#designation = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Op => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Code,
                                > = self.0.transmute();
                                r#op = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                    ...
                    match map_access_key {
                        ...
                        Field::Concept => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                r#concept = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Include => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::resources::ValueSetComposeInclude>,
                                > = self.0.transmute();
                                r#include = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::SubProperty => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                r#sub_property = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Contains => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::resources::ValueSetExpansionContains>,
                                > = self.0.transmute();
                                r#contains = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Next => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Uri,
                                > = self.0.transmute();
                                r#next = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        ...
                        Field::Timestamp => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#timestamp = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        ...
                        Field::Offset => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer,
                                > = self.0.transmute();
                                r#offset = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::Immutable => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#immutable = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        ...
                        Field::Compose => {
                            ...
                            > = self.0.transmute();
                            r#compose = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Expansion => {
