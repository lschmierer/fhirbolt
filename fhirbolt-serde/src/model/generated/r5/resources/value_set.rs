...
use fhirbolt_model::r5::resources::ValueSetComposeIncludeConceptDesignation;
impl serde::ser::Serialize for SerializationContext<&ValueSetComposeIncludeConceptDesignation> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#additional_use.is_empty() {
            tri!(self.with_context(&self.value.r#additional_use, |ctx| state
                .serialize_entry("additionalUse", ctx)));
        }
        if self.output == crate::context::Format::Json {
...
use fhirbolt_model::r5::resources::ValueSetComposeIncludeConcept;
                    ...
                    match map_access_key {
                        ...
                        Field::Designation => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ValueSetComposeIncludeConceptDesignation >> = self . 0 . transmute () ;
                                r#designation =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#designation.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: ValueSetComposeIncludeConceptDesignation > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
...
use fhirbolt_model::r5::resources::ValueSetComposeIncludeFilter;
...
use fhirbolt_model::r5::resources::ValueSetComposeInclude;
                    ...
                    match map_access_key {
                        ...
                        Field::Concept => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ValueSetComposeIncludeConcept >> = self . 0 . transmute () ;
...
use fhirbolt_model::r5::resources::ValueSetCompose;
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#property.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("property", &values));
                }
                let requires_elements = self
                    .value
                    .r#property
...
use fhirbolt_model::r5::resources::ValueSetExpansionParameter;
impl serde::ser::Serialize for SerializationContext<&ValueSetExpansionParameter> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ValueSetExpansionParameterValue as _Enum;
...
use fhirbolt_model::r5::resources::ValueSetExpansionProperty;
impl serde::ser::Serialize for SerializationContext<&ValueSetExpansionProperty> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#uri.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_uri", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#uri.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("uri", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<ValueSetExpansionProperty>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ValueSetExpansionProperty>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ValueSetExpansionProperty>
{
    type Value = ValueSetExpansionProperty;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ValueSetExpansionProperty>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ValueSetExpansionProperty;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("ValueSetExpansionProperty")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<ValueSetExpansionProperty, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ValueSetExpansionProperty>>
{
    type Value = Box<ValueSetExpansionProperty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ValueSetExpansionProperty>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ValueSetExpansionProperty>>
{
    type Value = Vec<ValueSetExpansionProperty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ValueSetExpansionProperty>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ValueSetExpansionProperty>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ValueSetExpansionProperty> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::ValueSetExpansionContainsPropertySubProperty;
impl serde::ser::Serialize for SerializationContext<&ValueSetExpansionContainsPropertySubProperty> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ValueSetExpansionContainsPropertySubPropertyValue as _Enum;
...
impl serde::ser::Serialize
    for SerializationContext<&Box<ValueSetExpansionContainsPropertySubProperty>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for SerializationContext<&Vec<ValueSetExpansionContainsPropertySubProperty>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ValueSetExpansionContainsPropertySubProperty>
{
    type Value = ValueSetExpansionContainsPropertySubProperty;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<ValueSetExpansionContainsPropertySubProperty>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ValueSetExpansionContainsPropertySubProperty;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<ValueSetExpansionContainsPropertySubProperty, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                Ok(ValueSetExpansionContainsPropertySubProperty {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#code: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ValueSetExpansionContainsPropertySubProperty>>
{
    type Value = Box<ValueSetExpansionContainsPropertySubProperty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ValueSetExpansionContainsPropertySubProperty>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ValueSetExpansionContainsPropertySubProperty>>
{
    type Value = Vec<ValueSetExpansionContainsPropertySubProperty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<ValueSetExpansionContainsPropertySubProperty>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ValueSetExpansionContainsPropertySubProperty>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
...
use fhirbolt_model::r5::resources::ValueSetExpansionContainsProperty;
impl serde::ser::Serialize for SerializationContext<&ValueSetExpansionContainsProperty> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ValueSetExpansionContainsPropertyValue as _Enum;
            match self.value.r#value {
                _Enum::Code(ref value) => {
                    if self.output == crate::context::Format::Json {
                        if let Some(some) = value.value.as_ref().map(Ok) {
        ...
        if !self.value.r#sub_property.is_empty() {
            tri!(self.with_context(&self.value.r#sub_property, |ctx| state
                .serialize_entry("subProperty", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<ValueSetExpansionContainsProperty>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ValueSetExpansionContainsProperty>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ValueSetExpansionContainsProperty>
{
    type Value = ValueSetExpansionContainsProperty;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ValueSetExpansionContainsProperty>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ValueSetExpansionContainsProperty;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<ValueSetExpansionContainsProperty, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                    ...
                    match map_access_key {
                        ...
                        Field::SubProperty => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ValueSetExpansionContainsPropertySubProperty >> = self . 0 . transmute () ;
                                r#sub_property =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#sub_property.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: ValueSetExpansionContainsPropertySubProperty > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
                ...
                Ok(ValueSetExpansionContainsProperty {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#code: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ValueSetExpansionContainsProperty>>
{
    type Value = Box<ValueSetExpansionContainsProperty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ValueSetExpansionContainsProperty>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ValueSetExpansionContainsProperty>>
{
    type Value = Vec<ValueSetExpansionContainsProperty>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ValueSetExpansionContainsProperty>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ValueSetExpansionContainsProperty>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ValueSetExpansionContainsProperty> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::ValueSetExpansionContains;
                    ...
                    match map_access_key {
                        ...
                        Field::Property => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ValueSetExpansionContainsProperty >> = self . 0 . transmute () ;
                                r#property = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#property.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: ValueSetExpansionContainsProperty > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Contains => {
...
use fhirbolt_model::r5::resources::ValueSetExpansion;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#next.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("next", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_next", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#next.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("next", ctx)));
        }
        if self.output == crate::context::Format::Json {
                        ...
                        Field::Next => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Uri,
                                > = self.0.transmute();
                                r#next = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r5::resources::ValueSetScope;
impl serde::ser::Serialize for SerializationContext<&ValueSetScope> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#inclusion_criteria.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("inclusionCriteria", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_inclusionCriteria", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#inclusion_criteria.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("inclusionCriteria", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#exclusion_criteria.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("exclusionCriteria", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_exclusionCriteria", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#exclusion_criteria.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("exclusionCriteria", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<ValueSetScope>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ValueSetScope>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ValueSetScope> {
    type Value = ValueSetScope;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ValueSetScope>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ValueSetScope;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("ValueSetScope")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<ValueSetScope, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ValueSetScope>> {
    type Value = Box<ValueSetScope>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ValueSetScope>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ValueSetScope>> {
    type Value = Vec<ValueSetScope>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ValueSetScope>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ValueSetScope>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ValueSetScope> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::ValueSet;
...
impl serde::ser::Serialize for SerializationContext<&ValueSet> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ValueSetVersionAlgorithm as _Enum;
