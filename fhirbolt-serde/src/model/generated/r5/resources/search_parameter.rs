...
use fhirbolt_model::r5::resources::SearchParameterComponent;
impl serde::ser::Serialize for SerializationContext<&SearchParameterComponent> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        fn missing_field_error<T, E: serde::ser::Error>(field: &str) -> Result<T, E> {
            Err(E::custom(format!(
                ...
                "SearchParameter.component", field
            )))
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<SearchParameterComponent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<SearchParameterComponent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<SearchParameterComponent>
{
    ...
    {
        struct Visitor<'a>(&'a mut DeserializationContext<SearchParameterComponent>);
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(SearchParameterComponent {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#expression.ok_or(serde::de::Error::missing_field("expression")))
                    },
                })
            }
        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<SearchParameterComponent>>
{
    type Value = Box<SearchParameterComponent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<SearchParameterComponent>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<SearchParameterComponent>>
{
    type Value = Vec<SearchParameterComponent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<SearchParameterComponent>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<SearchParameterComponent>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<SearchParameterComponent> =
                    self.0.transmute();
...
use fhirbolt_model::r5::resources::SearchParameter;
impl crate::Resource for SearchParameter {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&SearchParameter> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "SearchParameter"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::SearchParameterVersionAlgorithm as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#base.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("base", &values));
                }
        ...
        } else if !self.value.r#base.is_empty() {
            tri!(self.with_context(&self.value.r#base, |ctx| state.serialize_entry("base", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#processing_mode.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("processingMode", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_processingMode", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#processing_mode.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("processingMode", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#constraint.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("constraint", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_constraint", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#constraint.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("constraint", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#target.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("target", &values));
                }
                let requires_elements = self
                    .value
                    .r#target
        ...
        } else if !self.value.r#target.is_empty() {
            tri!(self.with_context(&self.value.r#target, |ctx| state
                .serialize_entry("target", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#multiple_or.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("multipleOr", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_multipleOr", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#multiple_or.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("multipleOr", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#multiple_and.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("multipleAnd", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_multipleAnd", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#multiple_and.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("multipleAnd", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#chain.is_empty() {
                let values = tri!(self
                    .value
                    .r#chain
                    .iter()
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("chain", &values));
                }
                let requires_elements = self
                    .value
                    .r#chain
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_chain", ctx)));
                }
            }
        } else if !self.value.r#chain.is_empty() {
            tri!(self.with_context(&self.value.r#chain, |ctx| state
                .serialize_entry("chain", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<SearchParameter>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<SearchParameter>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<SearchParameter> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<SearchParameter> {
    type Value = SearchParameter;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<SearchParameter>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = SearchParameter;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                enum Field {
                    ...
                    ProcessingModePrimitiveElement,
                    #[serde(rename = "constraint")]
                    Constraint,
                    #[serde(rename = "_constraint")]
                    ConstraintPrimitiveElement,
                    #[serde(rename = "target")]
                    Target,
                ...
                let mut r#version_algorithm: Option<
                    fhirbolt_model::r5::resources::SearchParameterVersionAlgorithm,
                > = None;
                let mut r#name: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#title: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#derived_from: Option<fhirbolt_model::r5::types::Canonical> = None;
                ...
                let mut r#base: Option<Vec<fhirbolt_model::r5::types::Code>> = None;
                let mut r#type: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#expression: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#processing_mode: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#constraint: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#target: Option<Vec<fhirbolt_model::r5::types::Code>> = None;
                let mut r#multiple_or: Option<fhirbolt_model::r5::types::Boolean> = None;
                let mut r#multiple_and: Option<fhirbolt_model::r5::types::Boolean> = None;
                ...
                let mut r#chain: Option<Vec<fhirbolt_model::r5::types::String>> = None;
                let mut r#component: Option<
                    Vec<fhirbolt_model::r5::resources::SearchParameterComponent>,
                > = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::ProcessingMode => {
                            if self.0.from == crate::context::Format::Json {
                                let some = r#processing_mode.get_or_insert(Default::default());
                                if some.value.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "processingMode",
                                    ));
                        ...
                        Field::ProcessingModePrimitiveElement => {
                            if self.0.from == crate::context::Format::Json {
                                let some = r#processing_mode.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field(
                                ...
                                return unknown_field_error("processingMode");
                            }
                        }
                        Field::Constraint => {
                            if self.0.from == crate::context::Format::Json {
                                let some = r#constraint.get_or_insert(Default::default());
                                if some.value.is_some() {
                        ...
                        Field::ConstraintPrimitiveElement => {
                            if self.0.from == crate::context::Format::Json {
                                let some = r#constraint.get_or_insert(Default::default());
                                if some.id.is_some() || !some.extension.is_empty() {
                                    return Err(serde::de::Error::duplicate_field("_constraint"));
                                }
                                use super::super::serde_helpers::PrimitiveElementOwned;
                                let _context: &mut DeserializationContext<PrimitiveElementOwned> =
                                    self.0.transmute();
                                ...
                                return unknown_field_error("constraint");
                            }
                        }
                        Field::Target => {
                            if self.0.from == crate::context::Format::Json {
                        ...
                        Field::Component => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::resources::SearchParameterComponent,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<SearchParameter>> {
    type Value = Box<SearchParameter>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<SearchParameter>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<SearchParameter>> {
    type Value = Vec<SearchParameter>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<SearchParameter>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<SearchParameter>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<SearchParameter> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
