...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationActionCondition>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationActionCondition>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationActionCondition>
{
    type Value = RequestOrchestrationActionCondition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationActionCondition>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<RequestOrchestrationActionCondition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Expression => {
                            ...
                            > = self.0.transmute();
                            r#expression = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                ...
                Ok(RequestOrchestrationActionCondition {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationActionCondition>>
{
    type Value = Box<RequestOrchestrationActionCondition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationActionCondition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationActionCondition>>
{
    type Value = Vec<RequestOrchestrationActionCondition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<RequestOrchestrationActionCondition>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationActionCondition>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<RequestOrchestrationActionCondition> =
                    self.0.transmute();
...
use fhirbolt_model::r5::resources::RequestOrchestrationActionInput;
impl serde::ser::Serialize for SerializationContext<&RequestOrchestrationActionInput> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#requirement.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("requirement", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#related_data.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("relatedData", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_relatedData", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#related_data.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("relatedData", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationActionInput>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationActionInput>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationActionInput>
{
    type Value = RequestOrchestrationActionInput;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationActionInput>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestrationActionInput;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<RequestOrchestrationActionInput, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Requirement => {
                            ...
                            > = self.0.transmute();
                            r#requirement = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::RelatedData => {
                            if self.0.from == crate::context::Format::Json {
                ...
                Ok(RequestOrchestrationActionInput {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#title,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationActionInput>>
{
    type Value = Box<RequestOrchestrationActionInput>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationActionInput>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationActionInput>>
{
    type Value = Vec<RequestOrchestrationActionInput>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<RequestOrchestrationActionInput>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationActionInput>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestrationActionInput> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::RequestOrchestrationActionOutput;
impl serde::ser::Serialize for SerializationContext<&RequestOrchestrationActionOutput> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationActionOutput>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationActionOutput>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationActionOutput>
{
    type Value = RequestOrchestrationActionOutput;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationActionOutput>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestrationActionOutput;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<RequestOrchestrationActionOutput, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                Ok(RequestOrchestrationActionOutput {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#title,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationActionOutput>>
{
    type Value = Box<RequestOrchestrationActionOutput>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationActionOutput>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationActionOutput>>
{
    type Value = Vec<RequestOrchestrationActionOutput>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<RequestOrchestrationActionOutput>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationActionOutput>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestrationActionOutput> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::RequestOrchestrationActionRelatedAction;
impl serde::ser::Serialize for SerializationContext<&RequestOrchestrationActionRelatedAction> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            tri!(self.with_context(&self.value.r#target_id, |ctx| state
                .serialize_entry("targetId", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#relationship.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("relationship", &some?));
            }
                ...
                || !self.value.r#relationship.extension.is_empty()
            {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_relationship", ctx)));
            }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#end_relationship.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("endRelationship", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_endRelationship", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#end_relationship.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("endRelationship", ctx)));
        }
        {
            use fhirbolt_model::r5::resources::RequestOrchestrationActionRelatedActionOffset as _Enum;
            if let Some(some) = self.value.r#offset.as_ref() {
                match some {
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("offsetDuration", ctx)));
                    }
                    _Enum::Range(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("offsetRange", ctx)));
                    }
...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationActionRelatedAction>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationActionRelatedAction>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationActionRelatedAction>
{
    type Value = RequestOrchestrationActionRelatedAction;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationActionRelatedAction>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestrationActionRelatedAction;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<RequestOrchestrationActionRelatedAction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::OffsetDuration => {
                            ...
                            > = self.0.transmute();
                            r#offset = Some(_Enum::Duration(tri!(
                ...
                Ok(RequestOrchestrationActionRelatedAction {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#target_id.ok_or(serde::de::Error::missing_field("targetId")))
                    },
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationActionRelatedAction>>
{
    type Value = Box<RequestOrchestrationActionRelatedAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationActionRelatedAction>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationActionRelatedAction>>
{
    type Value = Vec<RequestOrchestrationActionRelatedAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<RequestOrchestrationActionRelatedAction>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationActionRelatedAction>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestrationActionRelatedAction> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::RequestOrchestrationActionParticipant;
impl serde::ser::Serialize for SerializationContext<&RequestOrchestrationActionParticipant> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#type_canonical.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("typeCanonical", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_typeCanonical", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#type_canonical.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("typeCanonical", ctx)));
        }
        if let Some(some) = self.value.r#type_reference.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("typeReference", ctx)));
        }
        ...
        {
            use fhirbolt_model::r5::resources::RequestOrchestrationActionParticipantActor as _Enum;
            if let Some(some) = self.value.r#actor.as_ref() {
                match some {
                    _Enum::Canonical(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("actorCanonical", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_actorCanonical", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("actorCanonical", ctx)));
                        }
                    }
                    _Enum::Reference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("actorReference", ctx)));
                    }
                    _Enum::Invalid => return Err(serde::ser::Error::custom("actor is invalid")),
                }
            }
        }
        state.end()
...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationActionParticipant>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationActionParticipant>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationActionParticipant>
{
    type Value = RequestOrchestrationActionParticipant;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationActionParticipant>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestrationActionParticipant;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<RequestOrchestrationActionParticipant, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::ActorCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                let r#enum =
                                    r#actor.get_or_insert(_Enum::Canonical(Default::default()));
                                if let _Enum::Canonical(variant) = r#enum {
                                    ...
                                    return Err(serde::de::Error::duplicate_field("actor[x]"));
                                }
                            } else {
                                if r#actor.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                        ...
                        Field::ActorCanonicalPrimitiveElement => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                if let _Enum::Canonical(variant) = r#enum {
                                    ...
                                    return Err(serde::de::Error::duplicate_field("_actor[x]"));
                                }
                            } else {
                        ...
                        Field::ActorReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#actor = Some(_Enum::Reference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::Unknown(key) => {
                ...
                Ok(RequestOrchestrationActionParticipant {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#type,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationActionParticipant>>
{
    type Value = Box<RequestOrchestrationActionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationActionParticipant>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationActionParticipant>>
{
    type Value = Vec<RequestOrchestrationActionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<RequestOrchestrationActionParticipant>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationActionParticipant>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestrationActionParticipant> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::RequestOrchestrationActionDynamicValue;
impl serde::ser::Serialize for SerializationContext<&RequestOrchestrationActionDynamicValue> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationActionDynamicValue>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationActionDynamicValue>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationActionDynamicValue>
{
    type Value = RequestOrchestrationActionDynamicValue;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationActionDynamicValue>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestrationActionDynamicValue;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<RequestOrchestrationActionDynamicValue, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                Ok(RequestOrchestrationActionDynamicValue {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#path,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationActionDynamicValue>>
{
    type Value = Box<RequestOrchestrationActionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationActionDynamicValue>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationActionDynamicValue>>
{
    type Value = Vec<RequestOrchestrationActionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut DeserializationContext<Vec<RequestOrchestrationActionDynamicValue>>,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationActionDynamicValue>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestrationActionDynamicValue> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::RequestOrchestrationAction;
impl serde::ser::Serialize for SerializationContext<&RequestOrchestrationAction> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#prefix.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("prefix", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_prefix", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#prefix.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("prefix", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#title.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#text_equivalent.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("textEquivalent", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_textEquivalent", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#text_equivalent.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("textEquivalent", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if !self.value.r#documentation.is_empty() {
            tri!(self.with_context(&self.value.r#documentation, |ctx| state
                .serialize_entry("documentation", ctx)));
        }
        if !self.value.r#goal.is_empty() {
            tri!(self.with_context(&self.value.r#goal, |ctx| state.serialize_entry("goal", ctx)));
        }
        ...
        if !self.value.r#input.is_empty() {
            tri!(self.with_context(&self.value.r#input, |ctx| state
                .serialize_entry("input", ctx)));
        }
        if !self.value.r#output.is_empty() {
            tri!(self.with_context(&self.value.r#output, |ctx| state
                .serialize_entry("output", ctx)));
        }
        if !self.value.r#related_action.is_empty() {
            tri!(self.with_context(&self.value.r#related_action, |ctx| state
                .serialize_entry("relatedAction", ctx)));
        }
        {
            use fhirbolt_model::r5::resources::RequestOrchestrationActionTiming as _Enum;
            if let Some(some) = self.value.r#timing.as_ref() {
                match some {
                    ...
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("timingDuration", ctx)));
                    }
                    _Enum::Range(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("timingRange", ctx)));
                    }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#grouping_behavior.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("groupingBehavior", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_groupingBehavior", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#grouping_behavior.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("groupingBehavior", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#selection_behavior.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("selectionBehavior", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_selectionBehavior", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#selection_behavior.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("selectionBehavior", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#required_behavior.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("requiredBehavior", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_requiredBehavior", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#required_behavior.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("requiredBehavior", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#precheck_behavior.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("precheckBehavior", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_precheckBehavior", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#precheck_behavior.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("precheckBehavior", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#cardinality_behavior.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("cardinalityBehavior", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
            ...
            if let Some(some) = self.value.r#definition.as_ref() {
                match some {
                    ...
                    _Enum::Uri(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("definitionUri", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#transform.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("transform", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_transform", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#transform.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("transform", ctx)));
        }
        if !self.value.r#dynamic_value.is_empty() {
            tri!(self.with_context(&self.value.r#dynamic_value, |ctx| state
                .serialize_entry("dynamicValue", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestrationAction>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestrationAction>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<RequestOrchestrationAction>
{
    type Value = RequestOrchestrationAction;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestrationAction>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestrationAction;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("RequestOrchestrationAction")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<RequestOrchestrationAction, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                    ...
                    match map_access_key {
                        ...
                        Field::Prefix => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#prefix = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Goal => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#goal = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Condition => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionCondition >> = self . 0 . transmute () ;
                                r#condition =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#condition.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionCondition > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Input => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionInput >> = self . 0 . transmute () ;
                                r#input = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Output => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionOutput >> = self . 0 . transmute () ;
                                r#output = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::RelatedAction => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionRelatedAction >> = self . 0 . transmute () ;
                                r#related_action =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#related_action.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionRelatedAction > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::TimingDuration => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Duration>,
                            > = self.0.transmute();
                            r#timing = Some(_Enum::Duration(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::TimingRange => {
                        ...
                        Field::Participant => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionParticipant >> = self . 0 . transmute () ;
                                r#participant =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#participant.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionParticipant > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Type => {
                        ...
                        Field::DynamicValue => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionDynamicValue >> = self . 0 . transmute () ;
                                r#dynamic_value =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#dynamic_value.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: RequestOrchestrationActionDynamicValue > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Action => {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestrationAction>>
{
    type Value = Box<RequestOrchestrationAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestrationAction>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestrationAction>>
{
    type Value = Vec<RequestOrchestrationAction>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<RequestOrchestrationAction>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestrationAction>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestrationAction> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::resources::RequestOrchestration;
impl crate::Resource for RequestOrchestration {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&RequestOrchestration> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "RequestOrchestration"));
        if self.output == crate::context::Format::Json {
...
impl serde::ser::Serialize for SerializationContext<&Box<RequestOrchestration>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<RequestOrchestration>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<RequestOrchestration> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<RequestOrchestration> {
    type Value = RequestOrchestration;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<RequestOrchestration>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = RequestOrchestration;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("RequestOrchestration")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<RequestOrchestration, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<RequestOrchestration>>
{
    type Value = Box<RequestOrchestration>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<RequestOrchestration>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<RequestOrchestration>>
{
    type Value = Vec<RequestOrchestration>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<RequestOrchestration>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<RequestOrchestration>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<RequestOrchestration> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
