...
use fhirbolt_model::r5::resources::SubstanceReferenceInformationGene;
...
use fhirbolt_model::r5::resources::SubstanceReferenceInformationGeneElement;
...
use fhirbolt_model::r5::resources::SubstanceReferenceInformationTarget;
impl serde::ser::Serialize for SerializationContext<&SubstanceReferenceInformationTarget> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::SubstanceReferenceInformationTargetAmount as _Enum;
...
use fhirbolt_model::r5::resources::SubstanceReferenceInformation;
                    ...
                    match map_access_key {
                        ...
                        Field::Gene => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: SubstanceReferenceInformationGene >> = self . 0 . transmute () ;
                                r#gene = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#gene.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: SubstanceReferenceInformationGene > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::GeneElement => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: SubstanceReferenceInformationGeneElement >> = self . 0 . transmute () ;
                                r#gene_element =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#gene_element.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: SubstanceReferenceInformationGeneElement > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Target => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: SubstanceReferenceInformationTarget >> = self . 0 . transmute () ;
                                r#target = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#target.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: resources :: SubstanceReferenceInformationTarget > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Unknown(key) => {
