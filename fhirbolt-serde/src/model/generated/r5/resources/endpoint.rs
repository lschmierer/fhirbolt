...
use fhirbolt_model::r5::resources::EndpointPayload;
impl serde::ser::Serialize for SerializationContext<&EndpointPayload> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#mime_type.is_empty() {
                let values = tri!(self
                    .value
                    .r#mime_type
                    .iter()
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("mimeType", &values));
                }
                ...
                if requires_elements {
                    ...
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_mimeType", ctx)));
                }
            }
        } else if !self.value.r#mime_type.is_empty() {
            tri!(self.with_context(&self.value.r#mime_type, |ctx| state
                .serialize_entry("mimeType", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<EndpointPayload>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<EndpointPayload>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<EndpointPayload> {
    type Value = EndpointPayload;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<EndpointPayload>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = EndpointPayload;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("EndpointPayload")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<EndpointPayload, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#mime_type: Option<Vec<fhirbolt_model::r5::types::Code>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::MimeType => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let vec = r#mime_type.get_or_insert(
                                ...
                                let vec = r#mime_type.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                        ...
                        Field::MimeTypePrimitiveElement => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                if vec
                                    ...
                                    .any(|e| e.id.is_some() || !e.extension.is_empty())
                                {
                                    return Err(serde::de::Error::duplicate_field("_mimeType"));
                                }
                                ...
                                return unknown_field_error("mimeType");
                            }
                        }
                        Field::Unknown(key) => {
                ...
                Ok(EndpointPayload {
                    ...
                    r#mime_type: r#mime_type.unwrap_or(vec![]),
                })
            }
        }
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<EndpointPayload>> {
    type Value = Box<EndpointPayload>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<EndpointPayload>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<EndpointPayload>> {
    type Value = Vec<EndpointPayload>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<EndpointPayload>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<EndpointPayload>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<EndpointPayload> = self.0.transmute();
...
use fhirbolt_model::r5::resources::Endpoint;
impl crate::Resource for Endpoint {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&Endpoint> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Endpoint"));
        if self.output == crate::context::Format::Json {
        ...
        if !self.value.r#connection_type.is_empty() {
            tri!(self.with_context(&self.value.r#connection_type, |ctx| state
                .serialize_entry("connectionType", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if !self.value.r#environment_type.is_empty() {
            tri!(
                self.with_context(&self.value.r#environment_type, |ctx| state
                    .serialize_entry("environmentType", ctx))
            );
        }
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#header.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("header", &values));
                }
                let requires_elements = self
                    .value
                    .r#header
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_header", ctx)));
                }
            }
        } else if !self.value.r#header.is_empty() {
            tri!(self.with_context(&self.value.r#header, |ctx| state
                .serialize_entry("header", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<Endpoint>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<Endpoint>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<Endpoint> {
    type Value = Endpoint;
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Endpoint> {
    type Value = Endpoint;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Endpoint>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Endpoint;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#connection_type: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                ...
                let mut r#environment_type: Option<
                    Vec<fhirbolt_model::r5::types::CodeableConcept>,
                > = None;
                ...
                let mut r#payload: Option<Vec<fhirbolt_model::r5::resources::EndpointPayload>> =
                    None;
                let mut r#address: Option<fhirbolt_model::r5::types::Url> = None;
                let mut r#header: Option<Vec<fhirbolt_model::r5::types::String>> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::ConnectionType => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let vec = r#connection_type.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::CodeableConcept,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                        ...
                        Field::EnvironmentType => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let vec = r#environment_type.get_or_insert(Default::default());
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::CodeableConcept,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                ...
                Ok(Endpoint {
                    ...
                    r#connection_type: r#connection_type.unwrap_or(vec![]),
                    r#name,
                    r#description,
                    r#environment_type: r#environment_type.unwrap_or(vec![]),
                    r#managing_organization,
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<Endpoint>> {
    type Value = Box<Endpoint>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<Endpoint>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<Endpoint>> {
    type Value = Vec<Endpoint>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<Endpoint>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<Endpoint>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<Endpoint> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
