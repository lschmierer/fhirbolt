...
use fhirbolt_model::r5::resources::OrganizationQualification;
impl serde::ser::Serialize for SerializationContext<&OrganizationQualification> {
...
impl serde::ser::Serialize for SerializationContext<&Box<OrganizationQualification>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<OrganizationQualification>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<OrganizationQualification>
{
    type Value = OrganizationQualification;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<OrganizationQualification>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = OrganizationQualification;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("OrganizationQualification")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<OrganizationQualification, V::Error>
            where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<OrganizationQualification>>
{
    type Value = Box<OrganizationQualification>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<OrganizationQualification>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<OrganizationQualification>>
{
    type Value = Vec<OrganizationQualification>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<OrganizationQualification>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<OrganizationQualification>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<OrganizationQualification> =
                    self.0.transmute();
...
use fhirbolt_model::r5::resources::Organization;
...
impl serde::ser::Serialize for SerializationContext<&Organization> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Organization"));
