...
use fhirbolt_model::r5::resources::StructureDefinitionMapping;
...
use fhirbolt_model::r5::resources::StructureDefinitionContext;
...
use fhirbolt_model::r5::resources::StructureDefinitionSnapshot;
...
use fhirbolt_model::r5::resources::StructureDefinitionDifferential;
...
use fhirbolt_model::r5::resources::StructureDefinition;
...
impl serde::ser::Serialize for SerializationContext<&StructureDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "StructureDefinition"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::StructureDefinitionVersionAlgorithm as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("fhirVersion", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#context_invariant.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("contextInvariant", &values));
                }
                ...
                if requires_elements {
                    ...
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_contextInvariant", ctx)));
                }
            }
        } else if !self.value.r#context_invariant.is_empty() {
            tri!(
                self.with_context(&self.value.r#context_invariant, |ctx| state
                    .serialize_entry("contextInvariant", ctx))
            );
        }
        if self.output == crate::context::Format::Json {
            if self.value.r#type.id.as_deref() == Some("$invalid") {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#base_definition.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("baseDefinition", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_baseDefinition", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#base_definition.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("baseDefinition", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#derivation.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("derivation", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_derivation", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#derivation.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("derivation", ctx)));
        }
        if let Some(some) = self.value.r#snapshot.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("snapshot", ctx)));
        }
        if let Some(some) = self.value.r#differential.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("differential", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::Snapshot => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::resources::StructureDefinitionSnapshot,
                            > = self.0.transmute();
                            r#snapshot = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Differential => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::resources::StructureDefinitionDifferential,
                            > = self.0.transmute();
                            r#differential = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
                ...
                Ok(StructureDefinition {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#abstract.ok_or(serde::de::Error::missing_field("abstract")))
                    },
