...
use fhirbolt_model::r5::resources::FormularyItem;
impl crate::Resource for FormularyItem {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&FormularyItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        tri!(state.serialize_entry("resourceType", "FormularyItem"));
...
impl serde::ser::Serialize for SerializationContext<&Box<FormularyItem>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<FormularyItem>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<FormularyItem> {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<FormularyItem> {
    type Value = FormularyItem;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<FormularyItem>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = FormularyItem;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("FormularyItem")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<FormularyItem, V::Error>
            where
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<FormularyItem>> {
    type Value = Box<FormularyItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<FormularyItem>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<FormularyItem>> {
    type Value = Vec<FormularyItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<FormularyItem>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<FormularyItem>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<FormularyItem> = self.0.transmute();
