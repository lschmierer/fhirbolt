                    ...
                    match map_access_key {
                        ...
                        Field::Addresses => {
                            if self.0.from_json {
                                ...
                                r#addresses = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Documentation => {
                            if self.0.from_json {
                                ...
                                r#documentation = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: RelatedArtifact >> ()) ?) ;
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Trigger => {
                            if self.0.from_json {
                                ...
                                r#trigger = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: TriggerDefinition >> ()) ?) ;
                            } else {
                                let vec = r#trigger.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: types :: TriggerDefinition > ()) ?) ;
                            }
                        }
                        Field::Condition => {
                            if self.0.from_json {
