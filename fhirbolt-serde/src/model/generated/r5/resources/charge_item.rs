...
use fhirbolt_model::r5::resources::ChargeItemPerformer;
...
use fhirbolt_model::r5::resources::ChargeItem;
...
impl serde::ser::Serialize for SerializationContext<&ChargeItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ChargeItemOccurrence as _Enum;
                    ...
                    match map_access_key {
                        ...
                        Field::OverrideReason => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#override_reason = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Enterer => {
