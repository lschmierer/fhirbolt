...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::ChargeItemPerformer,
    >
{
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::ChargeItemPerformer>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::ChargeItemPerformer>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::ChargeItemPerformer;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::ChargeItemPerformer, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(fhirbolt_model::r5::resources::ChargeItemPerformer {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::ChargeItemPerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::ChargeItemPerformer>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::ChargeItemPerformer>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::ChargeItemPerformer>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r5::resources::ChargeItem {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::ChargeItem>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#occurrence.as_ref() {
            match some {
                fhirbolt_model::r5::resources::ChargeItemOccurrence::DateTime(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::ChargeItemOccurrence::Period(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrencePeriod", ctx))?;
                }
                fhirbolt_model::r5::resources::ChargeItemOccurrence::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("occurrenceTiming", ctx))?;
                }
                fhirbolt_model::r5::resources::ChargeItemOccurrence::Invalid => {
        ...
        if let Some(some) = self.value.r#unit_price_component.as_ref() {
            self.with_context(some, |ctx| state.serialize_entry("unitPriceComponent", ctx))?;
        }
        if let Some(some) = self.value.r#total_price_component.as_ref() {
            self.with_context(some, |ctx| {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::resources::ChargeItem>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::resources::ChargeItem>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::ChargeItem>
{
    type Value = fhirbolt_model::r5::resources::ChargeItem;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::ChargeItem>
{
    type Value = fhirbolt_model::r5::resources::ChargeItem;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(
            &'a mut crate::context::de::DeserializationContext<
                fhirbolt_model::r5::resources::ChargeItem,
            >,
        );
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = fhirbolt_model::r5::resources::ChargeItem;
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::ChargeItem, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#definition_uri: Option<Vec<fhirbolt_model::r5::types::Uri>> = None;
                let mut r#definition_canonical: Option<Vec<fhirbolt_model::r5::types::Canonical>> =
                    None;
                ...
                let mut r#occurrence: Option<fhirbolt_model::r5::resources::ChargeItemOccurrence> =
                    None;
                ...
                let mut r#requesting_organization: Option<
                    Box<fhirbolt_model::r5::types::Reference>,
                > = None;
                let mut r#cost_center: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#quantity: Option<Box<fhirbolt_model::r5::types::Quantity>> = None;
                let mut r#bodysite: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#unit_price_component: Option<
                    Box<fhirbolt_model::r5::types::MonetaryComponent>,
                > = None;
                let mut r#total_price_component: Option<
                    Box<fhirbolt_model::r5::types::MonetaryComponent>,
                > = None;
                let mut r#override_reason: Option<Box<fhirbolt_model::r5::types::CodeableConcept>> =
                    None;
                let mut r#enterer: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#entered_date: Option<fhirbolt_model::r5::types::DateTime> = None;
                let mut r#reason: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#service: Option<Vec<fhirbolt_model::r5::types::CodeableReference>> = None;
                let mut r#product: Option<Vec<fhirbolt_model::r5::types::CodeableReference>> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::OccurrenceDateTime => {
                            if self.0.from_json {
                                let r#enum = r#occurrence.get_or_insert(
                                    fhirbolt_model::r5::resources::ChargeItemOccurrence::DateTime(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model :: r5 :: resources :: ChargeItemOccurrence :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("occurrenceDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("occurrence[x]")) ; }
                            } else {
                                ...
                                r#occurrence = Some (fhirbolt_model :: r5 :: resources :: ChargeItemOccurrence :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        ...
                        Field::OccurrencePeriod => {
                            ...
                            r#occurrence =
                                Some(fhirbolt_model::r5::resources::ChargeItemOccurrence::Period(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::OccurrenceTiming => {
                            ...
                            r#occurrence =
                                Some(fhirbolt_model::r5::resources::ChargeItemOccurrence::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::Performer => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: ChargeItemPerformer > ()) ?) ;
                            }
                        }
                        ...
                        Field::Bodysite => {
                            if self.0.from_json {
                                ...
                                r#bodysite = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::UnitPriceComponent => {
                            if r#unit_price_component.is_some() {
                                return Err(serde::de::Error::duplicate_field(
                                    "unitPriceComponent",
                                ));
                            }
                            r#unit_price_component = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: MonetaryComponent > > ()) ?) ;
                        }
                        Field::TotalPriceComponent => {
                            ...
                            r#total_price_component = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: MonetaryComponent > > ()) ?) ;
                        }
                        Field::OverrideReason => {
                            if r#override_reason.is_some() {
                                return Err(serde::de::Error::duplicate_field("overrideReason"));
                            }
                            r#override_reason = Some (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?) ;
                        }
                        Field::Enterer => {
                        ...
                        Field::Service => {
                            if self.0.from_json {
                                ...
                                r#service = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                        ...
                        Field::Product => {
                            if self.0.from_json {
                                ...
                                r#product = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r5::resources::ChargeItem {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::ChargeItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::ChargeItem>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<fhirbolt_model::r5::resources::ChargeItem>,
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::ChargeItem>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::ChargeItem>(),
                )? {
                    values.push(value);
                }
                Ok(values)
