                    ...
                    match map_access_key {
                        ...
                        Field::StatusReason => {
                            if self.0.from_json {
                                ...
                                r#status_reason = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::SubPotentReason => {
                            if self.0.from_json {
                                ...
                                r#sub_potent_reason = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
                        ...
                        Field::Device => {
                            if self.0.from_json {
                                ...
                                r#device = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableReference >> ()) ?) ;
                            } else {
