    ...
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output_json {
            ...
            if let Some(some) = self.value.r#node_id.value.as_ref() {
                let some = Ok(some)?;
                state.serialize_entry("nodeId", &some)?;
            }
            if self.value.r#node_id.id.is_some() || !self.value.r#node_id.extension.is_empty() {
                ...
                self.with_context(&primitive_element, |ctx| {
                    state.serialize_entry("_nodeId", ctx)
                })?;
            }
        } else {
            if self.value.r#node_id.id.as_deref() == Some("$invalid") {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::GraphDefinitionNode>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::GraphDefinitionNode>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::GraphDefinitionNode;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::GraphDefinitionNode, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::NodeId => {
                            if self.0.from_json {
                                ...
                                r#node_id = Some(map_access.next_value_seed(
                ...
                Ok(fhirbolt_model::r5::resources::GraphDefinitionNode {
                    r#id,
                    ...
                    r#node_id: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        r#node_id.ok_or(serde::de::Error::missing_field("nodeId"))?
                    },
                    r#description,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::GraphDefinitionNode>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::GraphDefinitionNode>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::GraphDefinitionNode>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::GraphDefinitionNode>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::GraphDefinitionNode>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::GraphDefinitionNode>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
    ...
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output_json {
            ...
            if let Some(some) = self.value.r#rule.value.as_ref() {
                let some = Ok(some)?;
            ...
            if self.value.r#rule.id.is_some() || !self.value.r#rule.extension.is_empty() {
                ...
                self.with_context(&primitive_element, |ctx| {
                    state.serialize_entry("_rule", ctx)
                })?;
            }
        } else {
            if self.value.r#rule.id.as_deref() == Some("$invalid") {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                    ...
                    match map_access_key {
                        ...
                        Field::Rule => {
                            if self.0.from_json {
                                ...
                                r#rule = Some(map_access.next_value_seed(
                                    self.0.transmute::<fhirbolt_model::r5::types::Code>(),
                                )?);
                            }
                        }
                ...
                Ok(
                    fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment {
                        ...
                        r#rule: if self.0.config.mode
                            == crate::context::de::DeserializationMode::Lax
                        {
                            r#rule.unwrap_or(Default::default())
                        } else {
                            r#rule.ok_or(serde::de::Error::missing_field("rule"))?
                        },
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::GraphDefinitionLinkCompartment>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: GraphDefinitionLinkCompartment >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
    ...
    >
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output_json {
            ...
            if let Some(some) = self.value.r#source_id.value.as_ref() {
                let some = Ok(some)?;
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::GraphDefinitionLink>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::GraphDefinitionLink>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::GraphDefinitionLink;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::GraphDefinitionLink, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                    ...
                    match map_access_key {
                        ...
                        Field::Compartment => {
                            if self.0.from_json {
                                ...
                                r#compartment = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: GraphDefinitionLinkCompartment >> ()) ?) ;
                            } else {
                                let vec = r#compartment.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: GraphDefinitionLinkCompartment > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::GraphDefinitionLink {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#modifier_extension: r#modifier_extension.unwrap_or(vec![]),
                    r#description,
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        r#source_id.ok_or(serde::de::Error::missing_field("sourceId"))?
                    },
                    r#path,
                    r#slice_name,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::GraphDefinitionLink>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::GraphDefinitionLink>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::GraphDefinitionLink>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::GraphDefinitionLink>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::GraphDefinitionLink>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::GraphDefinitionLink>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl crate::Resource for fhirbolt_model::r5::resources::GraphDefinition {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::resources::GraphDefinition>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#version_algorithm.as_ref() {
            match some {
                fhirbolt_model::r5::resources::GraphDefinitionVersionAlgorithm::String(
                    ref value,
                ) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::GraphDefinitionVersionAlgorithm::Coding(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r5::resources::GraphDefinitionVersionAlgorithm::Invalid => {
        ...
        if !self.value.r#node.is_empty() {
            self.with_context(&self.value.r#node, |ctx| state.serialize_entry("node", ctx))?;
        }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::GraphDefinition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::GraphDefinition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    for crate::context::de::DeserializationContext<fhirbolt_model::r5::resources::GraphDefinition>
{
    type Value = fhirbolt_model::r5::resources::GraphDefinition;
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        fhirbolt_model::r5::resources::GraphDefinition,
    >
{
    type Value = fhirbolt_model::r5::resources::GraphDefinition;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::GraphDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::VersionAlgorithmString => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: GraphDefinitionVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: GraphDefinitionVersionAlgorithm :: String (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithmString")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithm[x]")) ; }
                            } else {
                                ...
                                r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: GraphDefinitionVersionAlgorithm :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: String > > ()) ?)) ;
                            }
                        }
                        Field::VersionAlgorithmStringPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: GraphDefinitionVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: GraphDefinitionVersionAlgorithm :: String (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithmString")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithm[x]")) ; }
                            } else {
                        ...
                        Field::VersionAlgorithmCoding => {
                            ...
                            r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: GraphDefinitionVersionAlgorithm :: Coding (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Coding > > ()) ?)) ;
                        }
                        Field::Name => {
                            if self.0.from_json {
                        ...
                        Field::Node => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: GraphDefinitionNode > ()) ?) ;
                            }
                        }
                        Field::Link => {
                            if self.0.from_json {
                                ...
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: GraphDefinitionLink > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::GraphDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::GraphDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::GraphDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::GraphDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::GraphDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::GraphDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::GraphDefinition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
