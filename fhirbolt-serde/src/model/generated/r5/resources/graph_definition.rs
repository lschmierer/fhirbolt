                    ...
                    match map_access_key {
                        ...
                        Field::NodeId => {
                            if self.0.from_json {
                                ...
                                > = self.0.transmute();
                                r#node_id = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                    ...
                    match map_access_key {
                        ...
                        Field::Compartment => {
                            if self.0.from_json {
                                ...
                                r#compartment = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::Node => {
                            if self.0.from_json {
                                ...
                                > = self.0.transmute();
                                r#node = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
