        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#region_type.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("regionType", &some?));
            }
                ...
                || !self.value.r#region_type.extension.is_empty()
            {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_regionType", ctx)));
            }
        } else if self.value.r#region_type.id.as_deref() == Some("$invalid") {
            return missing_field_error("regionType");
        } else {
            tri!(self.with_context(&self.value.r#region_type, |ctx| state
                .serialize_entry("regionType", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#coordinate.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("coordinate", &values));
                }
                ...
                if requires_elements {
                    ...
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_coordinate", ctx)));
                }
            }
        } else if !self.value.r#coordinate.is_empty() {
            tri!(self.with_context(&self.value.r#coordinate, |ctx| state
                .serialize_entry("coordinate", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ImagingSelectionInstanceImageRegion2D {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#region_type.ok_or(serde::de::Error::missing_field("regionType")))
                    },
...
impl serde::ser::Serialize for SerializationContext<&ImagingSelectionInstance> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#sop_class.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("sopClass", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#subset.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("subset", &values));
                }
                let requires_elements = self
                    .value
                    .r#subset
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_subset", ctx)));
                }
            }
        } else if !self.value.r#subset.is_empty() {
            tri!(self.with_context(&self.value.r#subset, |ctx| state
                .serialize_entry("subset", ctx)));
        }
        if !self.value.r#image_region_2_d.is_empty() {
            tri!(
                self.with_context(&self.value.r#image_region_2_d, |ctx| state
                    .serialize_entry("imageRegion2D", ctx))
            );
        }
        if !self.value.r#image_region_3_d.is_empty() {
            tri!(
                self.with_context(&self.value.r#image_region_3_d, |ctx| state
                    .serialize_entry("imageRegion3D", ctx))
            );
        }
        state.end()
    }
...
impl serde::ser::Serialize for SerializationContext<&ImagingSelection> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "ImagingSelection"));
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#study_uid.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("studyUid", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_studyUid", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#study_uid.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("studyUid", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#series_uid.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("seriesUid", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_seriesUid", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#series_uid.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("seriesUid", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#series_number.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("seriesNumber", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_seriesNumber", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#series_number.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("seriesNumber", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#frame_of_reference_uid.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("frameOfReferenceUid", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
