...
use fhirbolt_model::r5::resources::EpisodeOfCareStatusHistory;
...
use fhirbolt_model::r5::resources::EpisodeOfCareReason;
impl serde::ser::Serialize for SerializationContext<&EpisodeOfCareReason> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<EpisodeOfCareReason>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<EpisodeOfCareReason>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<EpisodeOfCareReason> {
    type Value = EpisodeOfCareReason;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<EpisodeOfCareReason>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = EpisodeOfCareReason;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("EpisodeOfCareReason")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<EpisodeOfCareReason, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<EpisodeOfCareReason>>
{
    type Value = Box<EpisodeOfCareReason>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<EpisodeOfCareReason>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<EpisodeOfCareReason>>
{
    type Value = Vec<EpisodeOfCareReason>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<EpisodeOfCareReason>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<EpisodeOfCareReason>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<EpisodeOfCareReason> = self.0.transmute();
                while let Some(value) = seq.next_element_seed(&mut *_context)? {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::EpisodeOfCareDiagnosis;
...
use fhirbolt_model::r5::resources::EpisodeOfCare;
                    ...
                    match map_access_key {
                        ...
                        Field::CareManager => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#care_manager = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::CareTeam => {
                            if self.0.from == crate::context::Format::Json {
