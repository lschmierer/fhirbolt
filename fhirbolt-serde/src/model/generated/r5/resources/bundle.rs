...
use fhirbolt_model::r5::resources::BundleLink;
impl serde::ser::Serialize for SerializationContext<&BundleLink> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#relation.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("relation", &some?));
            }
            if self.value.r#relation.id.is_some() || !self.value.r#relation.extension.is_empty() {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_relation", ctx)));
            }
        } else if self.value.r#relation.id.as_deref() == Some("$invalid") {
            return missing_field_error("relation");
        } else {
...
impl serde::ser::Serialize for SerializationContext<&Box<BundleLink>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<BundleLink>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<BundleLink> {
    type Value = BundleLink;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<BundleLink>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r5::types::Extension>> =
                    None;
                let mut r#relation: Option<fhirbolt_model::r5::types::Code> = None;
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<BundleLink>> {
    type Value = Box<BundleLink>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BundleLink>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<BundleLink>> {
    type Value = Vec<BundleLink>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<BundleLink>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BundleLink>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                let _context: &mut DeserializationContext<BundleLink> = self.0.transmute();
...
use fhirbolt_model::r5::resources::BundleEntrySearch;
impl serde::ser::Serialize for SerializationContext<&BundleEntrySearch> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<BundleEntrySearch>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<BundleEntrySearch>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<BundleEntrySearch> {
    type Value = BundleEntrySearch;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<BundleEntrySearch>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = BundleEntrySearch;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<BundleEntrySearch>> {
    type Value = Box<BundleEntrySearch>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BundleEntrySearch>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<BundleEntrySearch>> {
    type Value = Vec<BundleEntrySearch>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<BundleEntrySearch>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BundleEntrySearch>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<BundleEntrySearch> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::BundleEntryRequest;
impl serde::ser::Serialize for SerializationContext<&BundleEntryRequest> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if self.value.r#method.id.as_deref() == Some("$invalid") {
                return missing_field_error("method");
            }
            if let Some(some) = self.value.r#method.value.as_ref().map(Ok) {
        ...
        } else if self.value.r#method.id.as_deref() == Some("$invalid") {
            return missing_field_error("method");
        } else {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#if_none_match.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("ifNoneMatch", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_ifNoneMatch", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#if_none_match.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("ifNoneMatch", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#if_modified_since.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("ifModifiedSince", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_ifModifiedSince", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#if_modified_since.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("ifModifiedSince", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#if_match.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("ifMatch", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_ifMatch", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#if_match.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("ifMatch", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#if_none_exist.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("ifNoneExist", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_ifNoneExist", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#if_none_exist.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("ifNoneExist", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<BundleEntryRequest>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<BundleEntryRequest>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<BundleEntryRequest> {
    type Value = BundleEntryRequest;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<BundleEntryRequest>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = BundleEntryRequest;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#url: Option<fhirbolt_model::r5::types::Uri> = None;
                let mut r#if_none_match: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#if_modified_since: Option<fhirbolt_model::r5::types::Instant> = None;
                let mut r#if_match: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#if_none_exist: Option<fhirbolt_model::r5::types::String> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::IfMatch => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#if_match = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(BundleEntryRequest {
                    ...
                    r#method: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#method.ok_or(serde::de::Error::missing_field("method")))
                    },
                    r#url: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        r#url.unwrap_or(Default::default())
                    } else {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<BundleEntryRequest>> {
    type Value = Box<BundleEntryRequest>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BundleEntryRequest>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<BundleEntryRequest>> {
    type Value = Vec<BundleEntryRequest>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<BundleEntryRequest>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BundleEntryRequest>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<BundleEntryRequest> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::BundleEntryResponse;
impl serde::ser::Serialize for SerializationContext<&BundleEntryResponse> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#location.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("location", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_location", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#location.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("location", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#etag.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("etag", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_etag", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#etag.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("etag", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#last_modified.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("lastModified", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_lastModified", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#last_modified.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("lastModified", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<BundleEntryResponse>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<BundleEntryResponse>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<BundleEntryResponse> {
    type Value = BundleEntryResponse;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<BundleEntryResponse>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = BundleEntryResponse;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r5::types::Extension>> =
                    None;
                let mut r#status: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#location: Option<fhirbolt_model::r5::types::Uri> = None;
                let mut r#etag: Option<fhirbolt_model::r5::types::String> = None;
                let mut r#last_modified: Option<fhirbolt_model::r5::types::Instant> = None;
                let mut r#outcome: Option<fhirbolt_model::r5::Resource> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                            if r#id.is_some() {
                        ...
                        Field::Etag => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#etag = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<BundleEntryResponse>>
{
    type Value = Box<BundleEntryResponse>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BundleEntryResponse>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<BundleEntryResponse>>
{
    type Value = Vec<BundleEntryResponse>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<BundleEntryResponse>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BundleEntryResponse>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<BundleEntryResponse> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::BundleEntry;
impl serde::ser::Serialize for SerializationContext<&BundleEntry> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#full_url.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("fullUrl", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_fullUrl", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#full_url.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("fullUrl", ctx)));
        }
        ...
        if let Some(some) = self.value.r#search.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("search", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Box<BundleEntry>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<BundleEntry>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<BundleEntry> {
    type Value = BundleEntry;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<BundleEntry>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = BundleEntry;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#modifier_extension: Option<Vec<fhirbolt_model::r5::types::Extension>> =
                    None;
                let mut r#link: Option<Vec<fhirbolt_model::r5::resources::BundleLink>> = None;
                let mut r#full_url: Option<fhirbolt_model::r5::types::Uri> = None;
                let mut r#resource: Option<fhirbolt_model::r5::Resource> = None;
                let mut r#search: Option<fhirbolt_model::r5::resources::BundleEntrySearch> = None;
                let mut r#request: Option<fhirbolt_model::r5::resources::BundleEntryRequest> = None;
                let mut r#response: Option<fhirbolt_model::r5::resources::BundleEntryResponse> =
                    None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::Id => {
                        ...
                        Field::FullUrl => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Uri,
                                > = self.0.transmute();
                                r#full_url = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Search => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::resources::BundleEntrySearch,
                            > = self.0.transmute();
                            r#search = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Request => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::resources::BundleEntryRequest,
                            > = self.0.transmute();
                        ...
                        Field::Response => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::resources::BundleEntryResponse,
                            > = self.0.transmute();
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<BundleEntry>> {
    type Value = Box<BundleEntry>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<BundleEntry>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<BundleEntry>> {
    type Value = Vec<BundleEntry>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<BundleEntry>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<BundleEntry>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<BundleEntry> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::Bundle;
impl crate::Resource for Bundle {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize for SerializationContext<&Bundle> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Bundle"));
        if self.output == crate::context::Format::Json {
        ...
        } else if let Some(some) = self.value.r#timestamp.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("timestamp", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if let Some(some) = self.value.r#signature.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("signature", ctx)));
        }
        if let Some(some) = self.value.r#issues.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("issues", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<Bundle>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<Bundle>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for DeserializationContext<Bundle> {
    type Value = Bundle;
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Bundle> {
    type Value = Bundle;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Bundle>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Bundle;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#total: Option<fhirbolt_model::r5::types::UnsignedInt> = None;
                let mut r#link: Option<Vec<fhirbolt_model::r5::resources::BundleLink>> = None;
                let mut r#entry: Option<Vec<fhirbolt_model::r5::resources::BundleEntry>> = None;
                let mut r#signature: Option<Box<fhirbolt_model::r5::types::Signature>> = None;
                let mut r#issues: Option<fhirbolt_model::r5::Resource> = None;
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        Field::ResourceType => {
                        ...
                        Field::Signature => {
                            ...
                            > = self.0.transmute();
                            r#signature = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Issues => {
                            if r#issues.is_some() {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::Resource,
                            > = self.0.transmute();
                            r#issues = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<Bundle>> {
    type Value = Box<Bundle>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<Bundle>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<Bundle>> {
    type Value = Vec<Bundle>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<Bundle>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<Bundle>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<Bundle> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
