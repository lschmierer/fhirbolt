                    ...
                    match map_access_key {
                        ...
                        Field::PermittedUnit => {
                            if self.0.from_json {
                                ...
                                r#permitted_unit = Some(map_access.next_value_seed(
                    ...
                    match map_access_key {
                        ...
                        Field::Subject => {
                            if self.0.from_json {
                                ...
                                r#subject = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
