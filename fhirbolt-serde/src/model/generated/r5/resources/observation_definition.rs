        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#range_category.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("rangeCategory", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_rangeCategory", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#range_category.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("rangeCategory", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#valid_coded_value_set.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("validCodedValueSet", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_validCodedValueSet", ctx)));
                }
            }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#normal_coded_value_set.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("normalCodedValueSet", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_normalCodedValueSet", ctx)));
                }
            }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#abnormal_coded_value_set.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("abnormalCodedValueSet", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_abnormalCodedValueSet", ctx)));
                }
            }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#critical_coded_value_set.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("criticalCodedValueSet", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_criticalCodedValueSet", ctx)));
                }
            }
...
impl serde::ser::Serialize for SerializationContext<&ObservationDefinitionComponent> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#permitted_unit.is_empty() {
            tri!(self.with_context(&self.value.r#permitted_unit, |ctx| state
                .serialize_entry("permittedUnit", ctx)));
        }
        if !self.value.r#qualified_value.is_empty() {
            tri!(self.with_context(&self.value.r#qualified_value, |ctx| state
                .serialize_entry("qualifiedValue", ctx)));
        }
        state.end()
    }
}
