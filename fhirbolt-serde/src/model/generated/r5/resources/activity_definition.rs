...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::ActivityDefinitionParticipant,
    >
{
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::ActivityDefinitionParticipant;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::ActivityDefinitionParticipant, V::Error>
            where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::ActivityDefinitionParticipant>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: ActivityDefinitionParticipant >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Box<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>(
                        ),
                )? {
                    values.push(value);
                }
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            {
                let mut values = Vec::new();
                while let Some (value) = seq . next_element_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: resources :: ActivityDefinitionDynamicValue >> ()) ? { values . push (value) ; }
                Ok(values)
            }
        }
        deserializer.deserialize_seq(Visitor(self))
...
impl crate::Resource for fhirbolt_model::r5::resources::ActivityDefinition {
    const FHIR_RELEASE: fhirbolt_shared::FhirRelease = fhirbolt_shared::FhirReleases::R5;
}
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &fhirbolt_model::r5::resources::ActivityDefinition,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#version_algorithm.as_ref() {
            match some {
                fhirbolt_model::r5::resources::ActivityDefinitionVersionAlgorithm::String(
                    ref value,
                ) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionVersionAlgorithm::Coding(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionVersionAlgorithm::Invalid => {
        ...
        if let Some(some) = self.value.r#subject.as_ref() {
            match some {
                fhirbolt_model::r5::resources::ActivityDefinitionSubject::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionSubject::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("subjectReference", ctx))?;
                }
                fhirbolt_model::r5::resources::ActivityDefinitionSubject::Canonical(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionSubject::Invalid => {
        ...
        if let Some(some) = self.value.r#timing.as_ref() {
            match some {
                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingTiming", ctx))?;
                }
                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Age(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingAge", ctx))?;
                }
                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Range(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingRange", ctx))?;
                }
                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Duration(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingDuration", ctx))?;
                }
                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Invalid => {
        ...
        if let Some(some) = self.value.r#as_needed.as_ref() {
            match some {
                fhirbolt_model::r5::resources::ActivityDefinitionAsNeeded::Boolean(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionAsNeeded::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionAsNeeded::Invalid => {
        ...
        if let Some(some) = self.value.r#product.as_ref() {
            match some {
                fhirbolt_model::r5::resources::ActivityDefinitionProduct::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("productReference", ctx))?;
                }
                fhirbolt_model::r5::resources::ActivityDefinitionProduct::CodeableConcept(
                    ref value,
                ) => {
                    self.with_context(value, |ctx| {
                ...
                fhirbolt_model::r5::resources::ActivityDefinitionProduct::Invalid => {
        ...
        if self.output_json {
            if !self.value.r#specimen_requirement.is_empty() {
                let values = self
                    ...
                    .collect::<Result<Vec<_>, _>>()?;
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("specimenRequirement", &values)?;
                }
                let requires_elements = self
                    .value
                    .r#specimen_requirement
                ...
                if requires_elements {
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_specimenRequirement", ctx)
                    })?;
                }
            }
        } else {
        ...
        if self.output_json {
            if !self.value.r#observation_requirement.is_empty() {
                let values = self
                    ...
                    .collect::<Result<Vec<_>, _>>()?;
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("observationRequirement", &values)?;
                }
                let requires_elements = self
                    .value
                    .r#observation_requirement
                ...
                if requires_elements {
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_observationRequirement", ctx)
                    })?;
                }
            }
        } else {
        ...
        if self.output_json {
            if !self.value.r#observation_result_requirement.is_empty() {
                let values = self
                    ...
                    .collect::<Result<Vec<_>, _>>()?;
                if values.iter().any(|v| v.is_some()) {
                    state.serialize_entry("observationResultRequirement", &values)?;
                }
                let requires_elements = self
                    .value
                    .r#observation_result_requirement
                ...
                if requires_elements {
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    self.with_context(&primitive_elements, |ctx| {
                        state.serialize_entry("_observationResultRequirement", ctx)
                    })?;
                }
            }
        } else {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<fhirbolt_model::r5::resources::ActivityDefinition>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::resources::ActivityDefinition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::resources::ActivityDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::resources::ActivityDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                ...
                let mut r#version_algorithm: Option<
                    fhirbolt_model::r5::resources::ActivityDefinitionVersionAlgorithm,
                > = None;
                ...
                let mut r#subject: Option<
                    fhirbolt_model::r5::resources::ActivityDefinitionSubject,
                > = None;
                ...
                let mut r#timing: Option<fhirbolt_model::r5::resources::ActivityDefinitionTiming> =
                    None;
                let mut r#as_needed: Option<
                    fhirbolt_model::r5::resources::ActivityDefinitionAsNeeded,
                > = None;
                ...
                let mut r#product: Option<
                    fhirbolt_model::r5::resources::ActivityDefinitionProduct,
                > = None;
                let mut r#quantity: Option<Box<fhirbolt_model::r5::types::Quantity>> = None;
                let mut r#dosage: Option<Vec<Box<fhirbolt_model::r5::types::Dosage>>> = None;
                let mut r#body_site: Option<Vec<Box<fhirbolt_model::r5::types::CodeableConcept>>> =
                    None;
                let mut r#specimen_requirement: Option<Vec<fhirbolt_model::r5::types::Canonical>> =
                    None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::VersionAlgorithmString => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: ActivityDefinitionVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: ActivityDefinitionVersionAlgorithm :: String (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithmString")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("versionAlgorithm[x]")) ; }
                            } else {
                                ...
                                r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: ActivityDefinitionVersionAlgorithm :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: String > > ()) ?)) ;
                            }
                        }
                        Field::VersionAlgorithmStringPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#version_algorithm . get_or_insert (fhirbolt_model :: r5 :: resources :: ActivityDefinitionVersionAlgorithm :: String (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: ActivityDefinitionVersionAlgorithm :: String (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithmString")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_versionAlgorithm[x]")) ; }
                            } else {
                        ...
                        Field::VersionAlgorithmCoding => {
                            ...
                            r#version_algorithm = Some (fhirbolt_model :: r5 :: resources :: ActivityDefinitionVersionAlgorithm :: Coding (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Coding > > ()) ?)) ;
                        }
                        Field::Name => {
                            if self.0.from_json {
                        ...
                        Field::SubjectCodeableConcept => {
                            ...
                            r#subject = Some (fhirbolt_model :: r5 :: resources :: ActivityDefinitionSubject :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::SubjectReference => {
                            ...
                            r#subject = Some(
                                fhirbolt_model::r5::resources::ActivityDefinitionSubject::Reference(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Box<fhirbolt_model::r5::types::Reference>>(
                                            ),
                        ...
                        Field::SubjectCanonical => {
                            if self.0.from_json {
                                let r#enum = r#subject . get_or_insert (fhirbolt_model :: r5 :: resources :: ActivityDefinitionSubject :: Canonical (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: ActivityDefinitionSubject :: Canonical (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("subjectCanonical")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("subject[x]")) ; }
                            } else {
                                if r#subject.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "subjectCanonical",
                        ...
                        Field::TimingTiming => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingAge => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Age(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingRange => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Range(
                                    map_access.next_value_seed(
                        ...
                        Field::TimingDuration => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r5::resources::ActivityDefinitionTiming::Duration(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::AsNeededBoolean => {
                            if self.0.from_json {
                                let r#enum = r#as_needed . get_or_insert (fhirbolt_model :: r5 :: resources :: ActivityDefinitionAsNeeded :: Boolean (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: ActivityDefinitionAsNeeded :: Boolean (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("asNeededBoolean")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("asNeeded[x]")) ; }
                            } else {
                                ...
                                r#as_needed = Some (fhirbolt_model :: r5 :: resources :: ActivityDefinitionAsNeeded :: Boolean (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: Boolean > > ()) ?)) ;
                            }
                        }
                        Field::AsNeededBooleanPrimitiveElement => {
                            if self.0.from_json {
                                let r#enum = r#as_needed . get_or_insert (fhirbolt_model :: r5 :: resources :: ActivityDefinitionAsNeeded :: Boolean (Default :: default ())) ;
                                if let fhirbolt_model :: r5 :: resources :: ActivityDefinitionAsNeeded :: Boolean (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_asNeededBoolean")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_asNeeded[x]")) ; }
                            } else {
                        ...
                        Field::AsNeededCodeableConcept => {
                            ...
                            r#as_needed = Some (fhirbolt_model :: r5 :: resources :: ActivityDefinitionAsNeeded :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Location => {
                        ...
                        Field::Participant => {
                            if self.0.from_json {
                                ...
                                r#participant = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: ActivityDefinitionParticipant >> ()) ?) ;
                            } else {
                                let vec = r#participant.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: ActivityDefinitionParticipant > ()) ?) ;
                            }
                        }
                        Field::ProductReference => {
                            ...
                            r#product = Some(
                                fhirbolt_model::r5::resources::ActivityDefinitionProduct::Reference(
                                    map_access.next_value_seed(
                                        self.0
                                            .transmute::<Box<fhirbolt_model::r5::types::Reference>>(
                                            ),
                        ...
                        Field::ProductCodeableConcept => {
                            ...
                            r#product = Some (fhirbolt_model :: r5 :: resources :: ActivityDefinitionProduct :: CodeableConcept (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: CodeableConcept > > ()) ?)) ;
                        }
                        Field::Quantity => {
                        ...
                        Field::Dosage => {
                            if self.0.from_json {
                                ...
                                r#dosage = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r5 :: types :: Dosage > >> ()) ?) ;
                            } else {
                        ...
                        Field::SpecimenRequirement => {
                            if self.0.from_json {
                                let values: Vec<Option<_>> = map_access.next_value()?;
                                let vec = r#specimen_requirement.get_or_insert(
                                    std::iter::repeat(Default::default())
                                        .take(values.len())
                                        .collect::<Vec<_>>(),
                                );
                        ...
                        Field::SpecimenRequirementPrimitiveElement => {
                            if self.0.from_json {
                                let elements: Vec<
                                    Option<super::super::serde_helpers::PrimitiveElementOwned>,
                                > =
                                ...
                                return unknown_field_error("specimenRequirement");
                            }
                        }
                        Field::ObservationRequirement => {
                            if self.0.from_json {
                                let values: Vec<Option<_>> = map_access.next_value()?;
                                let vec = r#observation_requirement.get_or_insert(
                                    std::iter::repeat(Default::default())
                                        .take(values.len())
                                        .collect::<Vec<_>>(),
                                );
                        ...
                        Field::ObservationRequirementPrimitiveElement => {
                            if self.0.from_json {
                                let elements: Vec<
                                    Option<super::super::serde_helpers::PrimitiveElementOwned>,
                                > =
                                ...
                                return unknown_field_error("observationRequirement");
                            }
                        }
                        Field::ObservationResultRequirement => {
                            if self.0.from_json {
                                let values: Vec<Option<_>> = map_access.next_value()?;
                                let vec = r#observation_result_requirement.get_or_insert(
                                    std::iter::repeat(Default::default())
                                        .take(values.len())
                                        .collect::<Vec<_>>(),
                                );
                        ...
                        Field::ObservationResultRequirementPrimitiveElement => {
                            if self.0.from_json {
                                let elements: Vec<
                                    Option<super::super::serde_helpers::PrimitiveElementOwned>,
                                > =
                                ...
                                return unknown_field_error("observationResultRequirement");
                            }
                        }
                        Field::Transform => {
                            if self.0.from_json {
                        ...
                        Field::DynamicValue => {
                            if self.0.from_json {
                                ...
                                r#dynamic_value = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: resources :: ActivityDefinitionDynamicValue >> ()) ?) ;
                            } else {
                                let vec = r#dynamic_value.get_or_insert(Default::default());
                                vec . push (map_access . next_value_seed (self . 0 . transmute :: < fhirbolt_model :: r5 :: resources :: ActivityDefinitionDynamicValue > ()) ?) ;
                            }
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                ...
                Ok(fhirbolt_model::r5::resources::ActivityDefinition {
                    r#id,
                    r#meta,
                    r#implicit_rules,
                    r#language,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::resources::ActivityDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::resources::ActivityDefinition>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::resources::ActivityDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::resources::ActivityDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::resources::ActivityDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::resources::ActivityDefinition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
