...
use fhirbolt_model::r5::resources::ActivityDefinitionParticipant;
...
use fhirbolt_model::r5::resources::ActivityDefinitionDynamicValue;
...
use fhirbolt_model::r5::resources::ActivityDefinition;
...
impl serde::ser::Serialize for SerializationContext<&ActivityDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "ActivityDefinition"));
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::ActivityDefinitionVersionAlgorithm as _Enum;
        ...
        {
            use fhirbolt_model::r5::resources::ActivityDefinitionSubject as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("kind", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("intent", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        {
            use fhirbolt_model::r5::resources::ActivityDefinitionTiming as _Enum;
        ...
        {
            use fhirbolt_model::r5::resources::ActivityDefinitionAsNeeded as _Enum;
        ...
        {
            use fhirbolt_model::r5::resources::ActivityDefinitionProduct as _Enum;
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#specimen_requirement.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("specimenRequirement", &values));
                }
                let requires_elements = self
                    .value
                    .r#specimen_requirement
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_specimenRequirement", ctx)));
                }
            }
        } else if !self.value.r#specimen_requirement.is_empty() {
            tri!(
                self.with_context(&self.value.r#specimen_requirement, |ctx| state
                    .serialize_entry("specimenRequirement", ctx))
            );
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#observation_requirement.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("observationRequirement", &values));
                }
                let requires_elements = self
                    .value
                    .r#observation_requirement
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_observationRequirement", ctx)));
                }
            }
        } else if !self.value.r#observation_requirement.is_empty() {
            tri!(
                self.with_context(&self.value.r#observation_requirement, |ctx| state
                    .serialize_entry("observationRequirement", ctx))
            );
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#observation_result_requirement.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("observationResultRequirement", &values));
                }
                let requires_elements = self
                    .value
                    .r#observation_result_requirement
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_observationResultRequirement", ctx)));
                }
            }
        } else if !self.value.r#observation_result_requirement.is_empty() {
            tri!(
                self.with_context(&self.value.r#observation_result_requirement, |ctx| state
                    .serialize_entry("observationResultRequirement", ctx))
            );
        }
        if self.output == crate::context::Format::Json {
                    ...
                    match map_access_key {
                        ...
                        Field::Participant => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ActivityDefinitionParticipant >> = self . 0 . transmute () ;
                                r#participant =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::DynamicValue => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: ActivityDefinitionDynamicValue >> = self . 0 . transmute () ;
                                r#dynamic_value =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
