...
use fhirbolt_model::r5::resources::VerificationResultPrimarySource;
                    ...
                    match map_access_key {
                        ...
                        Field::ValidationStatus => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#validation_status = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        ...
                        Field::CanPushUpdates => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#can_push_updates = Some(map_access.next_value_seed(&mut *_context)?);
                        }
...
use fhirbolt_model::r5::resources::VerificationResultAttestation;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::ProxySignature => {
                            ...
                            > = self.0.transmute();
                            r#proxy_signature = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::SourceSignature => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Signature>,
                            > = self.0.transmute();
                            r#source_signature = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
...
use fhirbolt_model::r5::resources::VerificationResultValidator;
...
use fhirbolt_model::r5::resources::VerificationResult;
                    ...
                    match map_access_key {
                        ...
                        Field::Need => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#need = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Status => {
                            if self.0.from_json {
                        ...
                        Field::ValidationType => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#validation_type = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        ...
                        Field::Frequency => {
                            ...
                            > = self.0.transmute();
                            r#frequency = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::LastPerformed => {
                            if self.0.from_json {
                        ...
                        Field::FailureAction => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#failure_action = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::PrimarySource => {
                            if self.0.from_json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: resources :: VerificationResultPrimarySource >> = self . 0 . transmute () ;
                                r#primary_source =
                                    Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                        ...
                        Field::Attestation => {
                            ...
                            let _context: &mut DeserializationContext<
                                fhirbolt_model::r5::resources::VerificationResultAttestation,
                            > = self.0.transmute();
                            r#attestation = Some(map_access.next_value_seed(&mut *_context)?);
                        }
                        Field::Validator => {
                            if self.0.from_json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::resources::VerificationResultValidator>,
                                > = self.0.transmute();
                                r#validator = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
