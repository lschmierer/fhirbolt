...
use fhirbolt_model::r5::resources::Library;
...
impl serde::ser::Serialize for SerializationContext<&Library> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        tri!(state.serialize_entry("resourceType", "Library"));
        ...
        {
            use fhirbolt_model::r5::resources::LibraryVersionAlgorithm as _Enum;
        ...
        {
            use fhirbolt_model::r5::resources::LibrarySubject as _Enum;
        ...
        if !self.value.r#data_requirement.is_empty() {
            tri!(
                self.with_context(&self.value.r#data_requirement, |ctx| state
                    .serialize_entry("dataRequirement", ctx))
            );
        }
                    ...
                    match map_access_key {
                        ...
                        Field::Parameter => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::types::ParameterDefinition>,
                                > = self.0.transmute();
                                r#parameter =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::ParameterDefinition,
                                > = self.0.transmute();
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
