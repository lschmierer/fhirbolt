...
impl serde::ser::Serialize for SerializationContext<&ConsentVerification> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#verification_type.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("verificationType", ctx)));
        }
        if let Some(some) = self.value.r#verified_by.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("verifiedBy", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#verification_date.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("verificationDate", &values));
                }
            ...
            tri!(
                self.with_context(&self.value.r#verification_date, |ctx| state
                    .serialize_entry("verificationDate", ctx))
            );
        }
        state.end()
    }
                    ...
                    match map_access_key {
                        ...
                        Field::VerifiedBy => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#verified_by = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::VerifiedWith => {
...
impl serde::ser::Serialize for SerializationContext<&ConsentProvision> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#document_type.is_empty() {
            tri!(self.with_context(&self.value.r#document_type, |ctx| state
                .serialize_entry("documentType", ctx)));
        }
...
impl serde::ser::Serialize for SerializationContext<&Consent> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#grantor.is_empty() {
            tri!(self.with_context(&self.value.r#grantor, |ctx| state
                .serialize_entry("grantor", ctx)));
        }
        if !self.value.r#grantee.is_empty() {
            tri!(self.with_context(&self.value.r#grantee, |ctx| state
                .serialize_entry("grantee", ctx)));
        }
        if !self.value.r#manager.is_empty() {
            tri!(self.with_context(&self.value.r#manager, |ctx| state
                .serialize_entry("manager", ctx)));
        }
        if !self.value.r#controller.is_empty() {
            tri!(self.with_context(&self.value.r#controller, |ctx| state
                .serialize_entry("controller", ctx)));
        }
        if !self.value.r#source_attachment.is_empty() {
            tri!(
                self.with_context(&self.value.r#source_attachment, |ctx| state
                    .serialize_entry("sourceAttachment", ctx))
            );
        }
        if !self.value.r#source_reference.is_empty() {
            tri!(
                self.with_context(&self.value.r#source_reference, |ctx| state
                    .serialize_entry("sourceReference", ctx))
            );
        }
        if !self.value.r#regulatory_basis.is_empty() {
            tri!(
                self.with_context(&self.value.r#regulatory_basis, |ctx| state
                    .serialize_entry("regulatoryBasis", ctx))
            );
        }
        if let Some(some) = self.value.r#policy_basis.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("policyBasis", ctx)));
        }
        if !self.value.r#policy_text.is_empty() {
            tri!(self.with_context(&self.value.r#policy_text, |ctx| state
                .serialize_entry("policyText", ctx)));
        }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#decision.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("decision", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    match map_access_key {
                        ...
                        Field::Grantor => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#grantor = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Grantee => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::types::Reference>,
                                > = self.0.transmute();
                                r#grantee = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Manager => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::types::Reference>,
                                > = self.0.transmute();
                                r#manager = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::PolicyBasis => {
                            ...
                            > = self.0.transmute();
                            r#policy_basis = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::PolicyText => {
                            if self.0.from == crate::context::Format::Json {
