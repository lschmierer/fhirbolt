        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#medium: Option<Vec<fhirbolt_model::r5::types::CodeableConcept>> = None;
                let mut r#subject: Option<Box<fhirbolt_model::r5::types::Reference>> = None;
                let mut r#about: Option<Vec<fhirbolt_model::r5::types::Reference>> = None;
                ...
                let mut r#information_provider: Option<Vec<fhirbolt_model::r5::types::Reference>> =
                    None;
                    ...
                    match map_access_key {
                        ...
                        Field::Medium => {
                            if self.0.from_json {
                                ...
                                r#medium = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < fhirbolt_model :: r5 :: types :: CodeableConcept >> ()) ?) ;
                            } else {
