        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#responsibility.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("responsibility", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_responsibility", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#responsibility.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("responsibility", ctx)));
        }
        state.end()
    }
}
...
impl serde::ser::Serialize for SerializationContext<&Coverage> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#payment_by.is_empty() {
            tri!(self.with_context(&self.value.r#payment_by, |ctx| state
                .serialize_entry("paymentBy", ctx)));
        }
        if let Some(some) = self.value.r#type.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("type", ctx)));
        }
        ...
        if !self.value.r#subscriber_id.is_empty() {
            tri!(self.with_context(&self.value.r#subscriber_id, |ctx| state
                .serialize_entry("subscriberId", ctx)));
        }
        ...
        if let Some(some) = self.value.r#insurance_plan.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("insurancePlan", ctx)));
        }
        state.end()
    }
}
