...
use fhirbolt_model::r5::resources::ClaimRelated;
...
use fhirbolt_model::r5::resources::ClaimPayee;
...
use fhirbolt_model::r5::resources::ClaimEvent;
impl serde::ser::Serialize for SerializationContext<&ClaimEvent> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ClaimEventWhen as _Enum;
...
impl serde::ser::Serialize for SerializationContext<&Box<ClaimEvent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ClaimEvent>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ClaimEvent> {
    type Value = ClaimEvent;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ClaimEvent>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ClaimEvent;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("ClaimEvent")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<ClaimEvent, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ClaimEvent>> {
    type Value = Box<ClaimEvent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ClaimEvent>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ClaimEvent>> {
    type Value = Vec<ClaimEvent>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ClaimEvent>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ClaimEvent>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ClaimEvent> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::ClaimCareTeam;
impl serde::ser::Serialize for SerializationContext<&ClaimCareTeam> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#specialty.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("specialty", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::Specialty => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#specialty = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Unknown(key) => {
                            if self.0.config.mode == crate::context::de::DeserializationMode::Strict
                            {
...
use fhirbolt_model::r5::resources::ClaimSupportingInfo;
impl serde::ser::Serialize for SerializationContext<&ClaimSupportingInfo> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ClaimSupportingInfoTiming as _Enum;
        ...
        {
            use fhirbolt_model::r5::resources::ClaimSupportingInfoValue as _Enum;
...
use fhirbolt_model::r5::resources::ClaimDiagnosis;
impl serde::ser::Serialize for SerializationContext<&ClaimDiagnosis> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ClaimDiagnosisDiagnosis as _Enum;
...
use fhirbolt_model::r5::resources::ClaimProcedure;
impl serde::ser::Serialize for SerializationContext<&ClaimProcedure> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ClaimProcedureProcedure as _Enum;
...
use fhirbolt_model::r5::resources::ClaimInsurance;
...
use fhirbolt_model::r5::resources::ClaimAccident;
impl serde::ser::Serialize for SerializationContext<&ClaimAccident> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ClaimAccidentLocation as _Enum;
...
use fhirbolt_model::r5::resources::ClaimItemBodySite;
impl serde::ser::Serialize for SerializationContext<&ClaimItemBodySite> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Box<ClaimItemBodySite>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ClaimItemBodySite>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<ClaimItemBodySite> {
    type Value = ClaimItemBodySite;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ClaimItemBodySite>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ClaimItemBodySite;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("ClaimItemBodySite")
            }
            fn visit_map<V>(self, mut map_access: V) -> Result<ClaimItemBodySite, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
...
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Box<ClaimItemBodySite>> {
    type Value = Box<ClaimItemBodySite>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ClaimItemBodySite>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de> for &mut DeserializationContext<Vec<ClaimItemBodySite>> {
    type Value = Vec<ClaimItemBodySite>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ClaimItemBodySite>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ClaimItemBodySite>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ClaimItemBodySite> = self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
                Ok(values)
...
use fhirbolt_model::r5::resources::ClaimItemDetailSubDetail;
impl serde::ser::Serialize for SerializationContext<&ClaimItemDetailSubDetail> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#patient_paid.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("patientPaid", ctx)));
        }
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::PatientPaid => {
                            ...
                            > = self.0.transmute();
                            r#patient_paid = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Quantity => {
...
use fhirbolt_model::r5::resources::ClaimItemDetail;
...
use fhirbolt_model::r5::resources::ClaimItem;
impl serde::ser::Serialize for SerializationContext<&ClaimItem> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::resources::ClaimItemServiced as _Enum;
        ...
        {
            use fhirbolt_model::r5::resources::ClaimItemLocation as _Enum;
            if let Some(some) = self.value.r#location.as_ref() {
                match some {
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
...
use fhirbolt_model::r5::resources::Claim;
...
impl serde::ser::Serialize for SerializationContext<&Claim> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let mut state = tri!(serializer.serialize_map(None));
        tri!(state.serialize_entry("resourceType", "Claim"));
        if self.output == crate::context::Format::Json {
