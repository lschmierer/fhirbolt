...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::types::Annotation>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#author.as_ref() {
            match some {
                fhirbolt_model::r5::types::AnnotationAuthor::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("authorReference", ctx))?;
                }
                fhirbolt_model::r5::types::AnnotationAuthor::String(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::types::AnnotationAuthor::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::types::Annotation>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::types::Annotation>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<Box<fhirbolt_model::r5::types::Annotation>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::types::Annotation>
{
    type Value = fhirbolt_model::r5::types::Annotation;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::types::Annotation, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#author: Option<fhirbolt_model::r5::types::AnnotationAuthor> = None;
                ...
                while let Some(map_access_key) = map_access.next_key()? {
                    match map_access_key {
                        ...
                        Field::AuthorReference => {
                            ...
                            r#author =
                                Some(fhirbolt_model::r5::types::AnnotationAuthor::Reference(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::AuthorString => {
                            if self.0.from_json {
                                let r#enum = r#author.get_or_insert(
                                    fhirbolt_model::r5::types::AnnotationAuthor::String(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::types::AnnotationAuthor::String(
                                    variant,
                                ) = r#enum
                                {
                                ...
                                r#author = Some (fhirbolt_model :: r5 :: types :: AnnotationAuthor :: String (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: String > > ()) ?)) ;
                            }
                        }
                ...
                Ok(fhirbolt_model::r5::types::Annotation {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Box<fhirbolt_model::r5::types::Annotation>>
{
    type Value = Box<fhirbolt_model::r5::types::Annotation>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::types::Annotation>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Vec<fhirbolt_model::r5::types::Annotation>>
{
    type Value = Vec<fhirbolt_model::r5::types::Annotation>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::types::Annotation>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
