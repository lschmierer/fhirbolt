...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::types::TriggerDefinition>
{
        ...
        if self.output_json {
            if let Some(some) = self.value.r#subscription_topic.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    self.with_context(&primitive_element, |ctx| {
                        state.serialize_entry("_subscriptionTopic", ctx)
                    })?;
                }
            }
        } else {
            if let Some(some) = self.value.r#subscription_topic.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("subscriptionTopic", ctx))?;
            }
        }
        if let Some(some) = self.value.r#timing.as_ref() {
            match some {
                fhirbolt_model::r5::types::TriggerDefinitionTiming::Timing(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingTiming", ctx))?;
                }
                fhirbolt_model::r5::types::TriggerDefinitionTiming::Reference(ref value) => {
                    self.with_context(value, |ctx| state.serialize_entry("timingReference", ctx))?;
                }
                fhirbolt_model::r5::types::TriggerDefinitionTiming::Date(ref value) => {
                    if self.output_json {
                ...
                fhirbolt_model::r5::types::TriggerDefinitionTiming::DateTime(ref value) => {
                    if self.output_json {
                        if let Some(some) = value.value.as_ref() {
                            let some = Ok(some)?;
                ...
                fhirbolt_model::r5::types::TriggerDefinitionTiming::Invalid => {
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<
        &Vec<Box<fhirbolt_model::r5::types::TriggerDefinition>>,
    >
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = fhirbolt_model::r5::types::TriggerDefinition;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::types::TriggerDefinition, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                enum Field {
                    ...
                    SubscriptionTopicPrimitiveElement,
                ...
                let mut r#subscription_topic: Option<fhirbolt_model::r5::types::Canonical> = None;
                let mut r#timing: Option<fhirbolt_model::r5::types::TriggerDefinitionTiming> = None;
                let mut r#data: Option<Vec<Box<fhirbolt_model::r5::types::DataRequirement>>> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::SubscriptionTopic => {
                            if self.0.from_json {
                                ...
                                if r#subscription_topic.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "subscriptionTopic",
                                    ));
                                }
                                r#subscription_topic = Some(map_access.next_value_seed(
                        ...
                        Field::SubscriptionTopicPrimitiveElement => {
                            if self.0.from_json {
                                ...
                                return unknown_field_error("subscriptionTopic");
                            }
                        }
                        Field::TimingTiming => {
                            if r#timing.is_some() {
                            ...
                            r#timing =
                                Some(fhirbolt_model::r5::types::TriggerDefinitionTiming::Timing(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingReference => {
                            ...
                            r#timing = Some(
                                fhirbolt_model::r5::types::TriggerDefinitionTiming::Reference(
                                    map_access.next_value_seed(
                                        self.0
                        ...
                        Field::TimingDate => {
                            if self.0.from_json {
                                let r#enum = r#timing.get_or_insert(
                                    fhirbolt_model::r5::types::TriggerDefinitionTiming::Date(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model::r5::types::TriggerDefinitionTiming::Date(
                                    variant,
                                ) = r#enum
                                {
                                ...
                                r#timing =
                                    Some(fhirbolt_model::r5::types::TriggerDefinitionTiming::Date(
                                        map_access.next_value_seed(
                                            self.0
                        ...
                        Field::TimingDateTime => {
                            if self.0.from_json {
                                let r#enum = r#timing.get_or_insert(
                                    fhirbolt_model::r5::types::TriggerDefinitionTiming::DateTime(
                                        Default::default(),
                                    ),
                                );
                                if let fhirbolt_model :: r5 :: types :: TriggerDefinitionTiming :: DateTime (variant) = r#enum { if variant . value . is_some () { return Err (serde :: de :: Error :: duplicate_field ("timingDateTime")) ; } let value : _ = map_access . next_value () ? ; variant . value = Some (value) ; } else { return Err (serde :: de :: Error :: duplicate_field ("timing[x]")) ; }
                            } else {
                                if r#timing.is_some() {
                                    return Err(serde::de::Error::duplicate_field(
                                        "timingDateTime",
                                ...
                                r#timing = Some (fhirbolt_model :: r5 :: types :: TriggerDefinitionTiming :: DateTime (map_access . next_value_seed (self . 0 . transmute :: < Box < fhirbolt_model :: r5 :: types :: DateTime > > ()) ?)) ;
                            }
                        }
                        Field::TimingDateTimePrimitiveElement => {
                            if self.0.from_json {
                                ...
                                if let fhirbolt_model :: r5 :: types :: TriggerDefinitionTiming :: DateTime (variant) = r#enum { if variant . id . is_some () || ! variant . extension . is_empty () { return Err (serde :: de :: Error :: duplicate_field ("_timingDateTime")) ; } let super :: super :: serde_helpers :: PrimitiveElementOwned { id , extension } = map_access . next_value_seed (self . 0 . transmute :: < super :: super :: serde_helpers :: PrimitiveElementOwned > ()) ? ; variant . id = id ; variant . extension = extension ; } else { return Err (serde :: de :: Error :: duplicate_field ("_timing[x]")) ; }
                            } else {
                ...
                Ok(fhirbolt_model::r5::types::TriggerDefinition {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Box<fhirbolt_model::r5::types::TriggerDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::types::TriggerDefinition>()
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<fhirbolt_model::r5::types::TriggerDefinition>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<fhirbolt_model::r5::types::TriggerDefinition>(),
                )? {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    ...
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::types::TriggerDefinition>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq.next_element_seed(
                    self.0
                        .transmute::<Box<fhirbolt_model::r5::types::TriggerDefinition>>(),
                )? {
                    values.push(value);
                }
                Ok(values)
