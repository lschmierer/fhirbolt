...
impl serde::ser::Serialize for SerializationContext<&VirtualServiceDetail> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if let Some(some) = self.value.r#channel_type.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("channelType", ctx)));
        }
        {
                    ...
                    _Enum::Url(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("addressUrl", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_addressUrl", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("addressUrl", ctx)));
                        }
                    }
                    _Enum::String(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("addressString", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_addressString", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("addressString", ctx)));
                        }
                    }
                    _Enum::ContactPoint(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("addressContactPoint", ctx)));
                    }
                    _Enum::ExtendedContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("addressExtendedContactDetail", ctx)));
                    }
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#additional_info.is_empty() {
                ...
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("additionalInfo", &values));
                }
                ...
                if requires_elements {
                    ...
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_additionalInfo", ctx)));
                }
            }
        } else if !self.value.r#additional_info.is_empty() {
            tri!(self.with_context(&self.value.r#additional_info, |ctx| state
                .serialize_entry("additionalInfo", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#max_participants.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("maxParticipants", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_maxParticipants", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#max_participants.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("maxParticipants", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#session_key.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("sessionKey", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_sessionKey", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#session_key.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("sessionKey", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::AddressString => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#address = Some(_Enum::String(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::AddressContactPoint => {
                            ...
                            > = self.0.transmute();
                            r#address = Some(_Enum::ContactPoint(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::AddressExtendedContactDetail => {
                            ...
                            > = self.0.transmute();
                            r#address = Some(_Enum::ExtendedContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
