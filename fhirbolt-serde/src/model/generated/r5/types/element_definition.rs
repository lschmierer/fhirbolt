                        ...
                        Field::Suppress => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#suppress = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        ...
                        Field::ShortDoco => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#short_doco = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                        ...
                        Field::Any => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#any = Some(map_access.next_value_seed(&mut *_context)?);
                            }
                        }
                    ...
                    match map_access_key {
                        ...
                        Field::Additional => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                r#additional = Some(map_access.next_value_seed(&mut *_context)?);
                            } else {
                    ...
                    match map_access_key {
                        ...
                        Field::DefaultValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Integer64(
                                    map_access.next_value_seed(&mut *_context)?,
                                ));
                            }
                        }
                        ...
                        Field::DefaultValueAvailability => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Availability>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Availability(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::DefaultValueExtendedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ExtendedContactDetail>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::ExtendedContactDetail(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        ...
                        Field::FixedAvailability => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Availability>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Availability(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::FixedExtendedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ExtendedContactDetail>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::ExtendedContactDetail(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::FixedDosage => {
                        ...
                        Field::PatternInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Integer64(
                                    map_access.next_value_seed(&mut *_context)?,
                                ));
                            }
                        }
                        ...
                        Field::PatternAvailability => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Availability>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Availability(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::PatternExtendedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ExtendedContactDetail>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::ExtendedContactDetail(
                                map_access.next_value_seed(&mut *_context)?,
                            ));
                        }
                        Field::PatternDosage => {
                        ...
                        Field::MinValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Integer64(
                                    map_access.next_value_seed(&mut *_context)?,
                                ));
                            }
                        }
                        ...
                        Field::MaxValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Integer64(
                                    map_access.next_value_seed(&mut *_context)?,
                                ));
                            }
                        }
