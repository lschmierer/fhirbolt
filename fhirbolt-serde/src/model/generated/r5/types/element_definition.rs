...
use fhirbolt_model::r5::types::ElementDefinitionSlicingDiscriminator;
...
use fhirbolt_model::r5::types::ElementDefinitionSlicing;
impl serde::ser::Serialize for SerializationContext<&ElementDefinitionSlicing> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.value.r#discriminator.is_empty() {
            tri!(self.with_context(&self.value.r#discriminator, |ctx| state
                .serialize_entry("discriminator", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#ordered.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("ordered", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_ordered", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#ordered.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("ordered", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#rules.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("rules", &some?));
            }
            if self.value.r#rules.id.is_some() || !self.value.r#rules.extension.is_empty() {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_rules", ctx)));
            }
        } else if self.value.r#rules.id.as_deref() == Some("$invalid") {
            return missing_field_error("rules");
        } else {
            tri!(self.with_context(&self.value.r#rules, |ctx| state
                .serialize_entry("rules", ctx)));
        }
        state.end()
    }
}
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::Discriminator => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: types :: ElementDefinitionSlicingDiscriminator >> = self . 0 . transmute () ;
                                r#discriminator =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                                let vec = r#discriminator.get_or_insert(Default::default());
                                let _context : & mut DeserializationContext < fhirbolt_model :: r5 :: types :: ElementDefinitionSlicingDiscriminator > = self . 0 . transmute () ;
                                vec.push(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        Field::Description => {
                        ...
                        Field::Ordered => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#ordered = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Rules => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Code,
                                > = self.0.transmute();
                                r#rules = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(ElementDefinitionSlicing {
                    ...
                    r#rules: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#rules.ok_or(serde::de::Error::missing_field("rules")))
                    },
                })
            }
        }
...
use fhirbolt_model::r5::types::ElementDefinitionBase;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#min.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("min", &some?));
            }
            ...
            tri!(self.with_context(&self.value.r#min, |ctx| state.serialize_entry("min", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#max.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("max", &some?));
            }
            ...
            tri!(self.with_context(&self.value.r#max, |ctx| state.serialize_entry("max", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::Min => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#min = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Max => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#max = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
...
use fhirbolt_model::r5::types::ElementDefinitionType;
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#target_profile.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("targetProfile", &values));
                }
                let requires_elements = self
                    .value
                    .r#target_profile
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_targetProfile", ctx)));
                }
            }
        } else if !self.value.r#target_profile.is_empty() {
            tri!(self.with_context(&self.value.r#target_profile, |ctx| state
                .serialize_entry("targetProfile", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#aggregation.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("aggregation", &values));
                }
                let requires_elements = self
                    .value
                    .r#aggregation
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_aggregation", ctx)));
                }
            }
        } else if !self.value.r#aggregation.is_empty() {
            tri!(self.with_context(&self.value.r#aggregation, |ctx| state
                .serialize_entry("aggregation", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#versioning.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("versioning", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_versioning", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#versioning.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("versioning", ctx)));
        }
        state.end()
    }
}
...
use fhirbolt_model::r5::types::ElementDefinitionExample;
impl serde::ser::Serialize for SerializationContext<&ElementDefinitionExample> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        {
            use fhirbolt_model::r5::types::ElementDefinitionExampleValue as _Enum;
            match self.value.r#value {
                ...
                _Enum::Boolean(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("valueBoolean", ctx)));
                    }
                }
                ...
                _Enum::Decimal(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("valueDecimal", ctx)));
                    }
                }
                _Enum::Id(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self.with_context(value, |ctx| state.serialize_entry("valueId", ctx)));
                    }
                }
                _Enum::Instant(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("valueInstant", ctx)));
                    }
                }
                _Enum::Integer(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("valueInteger", ctx)));
                    }
                }
                _Enum::Integer64(ref value) => {
                    if self.output == crate::context::Format::Json {
                        if let Some(some) = value.value.as_ref().map(|v| Ok(v.to_string())) {
                            tri!(state.serialize_entry("valueInteger64", &some?));
                        }
                        if value.id.is_some() || !value.extension.is_empty() {
                            use super::super::serde_helpers::PrimitiveElement;
                            let primitive_element = PrimitiveElement {
                            ...
                            tri!(self.with_context(&primitive_element, |ctx| state
                                .serialize_entry("_valueInteger64", ctx)));
                        }
                    } else {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("valueInteger64", ctx)));
                    }
                }
                ...
                _Enum::Oid(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self.with_context(value, |ctx| state.serialize_entry("valueOid", ctx)));
                    }
                }
                ...
                _Enum::Uri(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self.with_context(value, |ctx| state.serialize_entry("valueUri", ctx)));
                    }
                }
                _Enum::Url(ref value) => {
                    if self.output == crate::context::Format::Json {
                        ...
                        tri!(self.with_context(value, |ctx| state.serialize_entry("valueUrl", ctx)));
                    }
                }
                ...
                _Enum::Address(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueAddress", ctx)));
                }
                _Enum::Age(ref value) => {
                ...
                _Enum::Annotation(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueAnnotation", ctx)));
                }
                _Enum::Attachment(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueAttachment", ctx)));
                }
                ...
                _Enum::Coding(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueCoding", ctx)));
                }
                ...
                _Enum::Count(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueCount", ctx)));
                }
                ...
                _Enum::HumanName(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueHumanName", ctx)));
                }
                _Enum::Identifier(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueIdentifier", ctx)));
                }
                _Enum::Money(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueMoney", ctx)));
                }
                _Enum::Period(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valuePeriod", ctx)));
                }
                ...
                _Enum::Ratio(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueRatio", ctx)));
                }
                _Enum::RatioRange(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueRatioRange", ctx)));
                }
                ...
                _Enum::SampledData(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueSampledData", ctx)));
                }
                _Enum::Signature(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueSignature", ctx)));
                }
                _Enum::Timing(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueTiming", ctx)));
                }
                ...
                _Enum::Expression(ref value) => {
                    tri!(self
                        .with_context(value, |ctx| state.serialize_entry("valueExpression", ctx)));
                }
                ...
                _Enum::Availability(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("valueAvailability", ctx)));
                }
                _Enum::ExtendedContactDetail(ref value) => {
                    tri!(self.with_context(value, |ctx| state
                        .serialize_entry("valueExtendedContactDetail", ctx)));
                }
                _Enum::Dosage(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueDosage", ctx)));
                }
                _Enum::Meta(ref value) => {
                    tri!(self.with_context(value, |ctx| state.serialize_entry("valueMeta", ctx)));
                }
                _Enum::Invalid => {
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::ValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#value = Some(_Enum::Integer64(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::ValueAvailability => {
                            ...
                            > = self.0.transmute();
                            r#value = Some(_Enum::Availability(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::ValueExtendedContactDetail => {
                            ...
                            > = self.0.transmute();
                            r#value = Some(_Enum::ExtendedContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::ValueDosage => {
                ...
                Ok(ElementDefinitionExample {
                    ...
                    r#label: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#label.ok_or(serde::de::Error::missing_field("label")))
                    },
...
use fhirbolt_model::r5::types::ElementDefinitionConstraint;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#key.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("key", &some?));
            }
            ...
            tri!(self.with_context(&self.value.r#key, |ctx| state.serialize_entry("key", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#requirements.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("requirements", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_requirements", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#requirements.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("requirements", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#severity.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("severity", &some?));
            }
            if self.value.r#severity.id.is_some() || !self.value.r#severity.extension.is_empty() {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_severity", ctx)));
            }
        } else if self.value.r#severity.id.as_deref() == Some("$invalid") {
            return missing_field_error("severity");
        } else {
            tri!(self.with_context(&self.value.r#severity, |ctx| state
                .serialize_entry("severity", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#suppress.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("suppress", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_suppress", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#suppress.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("suppress", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#human.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("human", &some?));
            }
            if self.value.r#human.id.is_some() || !self.value.r#human.extension.is_empty() {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_human", ctx)));
            }
        } else if self.value.r#human.id.as_deref() == Some("$invalid") {
            return missing_field_error("human");
        } else {
            tri!(self.with_context(&self.value.r#human, |ctx| state
                .serialize_entry("human", ctx)));
        }
        if self.output == crate::context::Format::Json {
                ...
                V: serde::de::MapAccess<'de>,
            {
                        ...
                        Field::Key => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Id,
                                > = self.0.transmute();
                                r#key = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Severity => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Code,
                                > = self.0.transmute();
                                r#severity = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Suppress => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#suppress = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Human => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#human = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(ElementDefinitionConstraint {
                    ...
                    r#key: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        ...
                        tri!(r#key.ok_or(serde::de::Error::missing_field("key")))
                    },
                    r#requirements,
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#severity.ok_or(serde::de::Error::missing_field("severity")))
                    },
                    r#suppress,
                    r#human: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        r#human.unwrap_or(Default::default())
                    } else {
                        tri!(r#human.ok_or(serde::de::Error::missing_field("human")))
                    },
                    r#expression,
                    r#source,
                })
...
use fhirbolt_model::r5::types::ElementDefinitionBindingAdditional;
impl serde::ser::Serialize for SerializationContext<&ElementDefinitionBindingAdditional> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#purpose.value.as_ref().map(Ok) {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#documentation.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("documentation", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_documentation", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#documentation.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("documentation", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#short_doco.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("shortDoco", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_shortDoco", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#short_doco.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("shortDoco", ctx)));
        }
        if !self.value.r#usage.is_empty() {
            tri!(self.with_context(&self.value.r#usage, |ctx| state
                .serialize_entry("usage", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#any.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("any", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_any", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#any.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("any", ctx)));
        }
        state.end()
    }
}
impl serde::ser::Serialize for SerializationContext<&Box<ElementDefinitionBindingAdditional>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for SerializationContext<&Vec<ElementDefinitionBindingAdditional>> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<ElementDefinitionBindingAdditional>
{
    type Value = ElementDefinitionBindingAdditional;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<ElementDefinitionBindingAdditional>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = ElementDefinitionBindingAdditional;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<ElementDefinitionBindingAdditional, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                #[derive(serde :: Deserialize)]
                    ...
                    match map_access_key {
                        ...
                        Field::Usage => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#usage = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::Any => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#any = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(ElementDefinitionBindingAdditional {
                    r#id,
                    r#extension: r#extension.unwrap_or(vec![]),
                    r#purpose: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        r#purpose.unwrap_or(Default::default())
                    } else {
                        tri!(r#purpose.ok_or(serde::de::Error::missing_field("purpose")))
                    },
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#value_set.ok_or(serde::de::Error::missing_field("valueSet")))
                    },
                    r#documentation,
                    r#short_doco,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Box<ElementDefinitionBindingAdditional>>
{
    type Value = Box<ElementDefinitionBindingAdditional>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<ElementDefinitionBindingAdditional>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut DeserializationContext<Vec<ElementDefinitionBindingAdditional>>
{
    type Value = Vec<ElementDefinitionBindingAdditional>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        struct Visitor<'a>(&'a mut DeserializationContext<Vec<ElementDefinitionBindingAdditional>>);
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            type Value = Vec<ElementDefinitionBindingAdditional>;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("a sequence")
            ...
            {
                let mut values = Vec::new();
                let _context: &mut DeserializationContext<ElementDefinitionBindingAdditional> =
                    self.0.transmute();
                while let Some(value) = tri!(seq.next_element_seed(&mut *_context)) {
                    values.push(value);
                }
...
use fhirbolt_model::r5::types::ElementDefinitionBinding;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#strength.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("strength", &some?));
            }
        ...
        if !self.value.r#additional.is_empty() {
            tri!(self.with_context(&self.value.r#additional, |ctx| state
                .serialize_entry("additional", ctx)));
        }
        state.end()
    }
}
                    ...
                    match map_access_key {
                        ...
                        Field::Additional => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context : & mut DeserializationContext < Vec < fhirbolt_model :: r5 :: types :: ElementDefinitionBindingAdditional >> = self . 0 . transmute () ;
                                r#additional =
                                    Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
...
use fhirbolt_model::r5::types::ElementDefinitionMapping;
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#identity.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("identity", &some?));
            }
            if self.value.r#identity.id.is_some() || !self.value.r#identity.extension.is_empty() {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_identity", ctx)));
            }
        } else if self.value.r#identity.id.as_deref() == Some("$invalid") {
            return missing_field_error("identity");
        } else {
            tri!(self.with_context(&self.value.r#identity, |ctx| state
                .serialize_entry("identity", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#map.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("map", &some?));
            }
            ...
            tri!(self.with_context(&self.value.r#map, |ctx| state.serialize_entry("map", ctx)));
        }
        if self.output == crate::context::Format::Json {
                ...
                V: serde::de::MapAccess<'de>,
            {
                        ...
                        Field::Identity => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Id,
                                > = self.0.transmute();
                                r#identity = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Map => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#map = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(ElementDefinitionMapping {
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#identity.ok_or(serde::de::Error::missing_field("identity")))
                    },
                    r#language,
                    r#map: if self.0.config.mode == crate::context::de::DeserializationMode::Lax {
                        r#map.unwrap_or(Default::default())
                    } else {
                        tri!(r#map.ok_or(serde::de::Error::missing_field("map")))
                    },
                    r#comment,
                })
            }
...
use fhirbolt_model::r5::types::ElementDefinition;
impl serde::ser::Serialize for SerializationContext<&ElementDefinition> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output == crate::context::Format::Json {
            if !self.value.r#representation.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("representation", &values));
                }
                let requires_elements = self
                    .value
                    .r#representation
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_representation", ctx)));
                }
            }
        } else if !self.value.r#representation.is_empty() {
            tri!(self.with_context(&self.value.r#representation, |ctx| state
                .serialize_entry("representation", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#slice_name.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("sliceName", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_sliceName", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#slice_name.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("sliceName", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#slice_is_constraining.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("sliceIsConstraining", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
        ...
        if let Some(some) = self.value.r#slicing.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("slicing", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#short.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("short", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_short", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#short.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("short", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#definition.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("definition", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_definition", ctx)));
                }
            }
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#min.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_min", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#min.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("min", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#max.as_ref() {
                ...
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_max", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#max.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("max", ctx)));
        }
        if let Some(some) = self.value.r#base.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("base", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#content_reference.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("contentReference", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_contentReference", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#content_reference.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("contentReference", ctx)));
        }
        if !self.value.r#type.is_empty() {
            tri!(self.with_context(&self.value.r#type, |ctx| state.serialize_entry("type", ctx)));
        }
        {
            use fhirbolt_model::r5::types::ElementDefinitionDefaultValue as _Enum;
            if let Some(some) = self.value.r#default_value.as_ref() {
                match some {
                    _Enum::Base64Binary(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueBase64Binary", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueBase64Binary", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueBase64Binary", ctx)));
                        }
                    }
                    _Enum::Boolean(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueBoolean", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueBoolean", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueBoolean", ctx)));
                        }
                    }
                    _Enum::Canonical(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueCanonical", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueCanonical", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueCanonical", ctx)));
                        }
                    }
                    _Enum::Code(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueCode", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueCode", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueCode", ctx)));
                        }
                    }
                    _Enum::Date(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueDate", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueDate", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueDate", ctx)));
                        }
                    }
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueDateTime", ctx)));
                        }
                    }
                    _Enum::Decimal(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| {
                                ...
                                tri!(state.serialize_entry("defaultValueDecimal", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueDecimal", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueDecimal", ctx)));
                        }
                    }
                    _Enum::Id(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueId", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueId", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueId", ctx)));
                        }
                    }
                    _Enum::Instant(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueInstant", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueInstant", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueInstant", ctx)));
                        }
                    }
                    _Enum::Integer(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueInteger", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueInteger", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueInteger", ctx)));
                        }
                    }
                    _Enum::Integer64(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| Ok(v.to_string())) {
                                tri!(state.serialize_entry("defaultValueInteger64", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueInteger64", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueInteger64", ctx)));
                        }
                    }
                    _Enum::Markdown(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueMarkdown", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueMarkdown", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueMarkdown", ctx)));
                        }
                    }
                    _Enum::Oid(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueOid", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueOid", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueOid", ctx)));
                        }
                    }
                    _Enum::PositiveInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValuePositiveInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValuePositiveInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValuePositiveInt", ctx)));
                        }
                    }
                    _Enum::String(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueString", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueString", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueString", ctx)));
                        }
                    }
                    _Enum::Time(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueTime", ctx)));
                        }
                    }
                    _Enum::UnsignedInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueUnsignedInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueUnsignedInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueUnsignedInt", ctx)));
                        }
                    }
                    _Enum::Uri(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueUri", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueUri", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueUri", ctx)));
                        }
                    }
                    _Enum::Url(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueUrl", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueUrl", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueUrl", ctx)));
                        }
                    }
                    _Enum::Uuid(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("defaultValueUuid", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_defaultValueUuid", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("defaultValueUuid", ctx)));
                        }
                    }
                    _Enum::Address(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueAddress", ctx)));
                    }
                    _Enum::Age(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueAge", ctx)));
                    }
                    _Enum::Annotation(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueAnnotation", ctx)));
                    }
                    _Enum::Attachment(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueAttachment", ctx)));
                    }
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueCodeableConcept", ctx)));
                    }
                    _Enum::CodeableReference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueCodeableReference", ctx)));
                    }
                    _Enum::Coding(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueCoding", ctx)));
                    }
                    _Enum::ContactPoint(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueContactPoint", ctx)));
                    }
                    _Enum::Count(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueCount", ctx)));
                    }
                    _Enum::Distance(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueDistance", ctx)));
                    }
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueDuration", ctx)));
                    }
                    _Enum::HumanName(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueHumanName", ctx)));
                    }
                    _Enum::Identifier(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueIdentifier", ctx)));
                    }
                    _Enum::Money(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueMoney", ctx)));
                    }
                    _Enum::Period(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValuePeriod", ctx)));
                    }
                    _Enum::Quantity(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueQuantity", ctx)));
                    }
                    _Enum::Range(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueRange", ctx)));
                    }
                    _Enum::Ratio(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueRatio", ctx)));
                    }
                    _Enum::RatioRange(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueRatioRange", ctx)));
                    }
                    _Enum::Reference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueReference", ctx)));
                    }
                    _Enum::SampledData(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueSampledData", ctx)));
                    }
                    _Enum::Signature(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueSignature", ctx)));
                    }
                    _Enum::Timing(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueTiming", ctx)));
                    }
                    _Enum::ContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueContactDetail", ctx)));
                    }
                    _Enum::DataRequirement(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueDataRequirement", ctx)));
                    }
                    _Enum::Expression(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueExpression", ctx)));
                    }
                    _Enum::ParameterDefinition(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueParameterDefinition", ctx)));
                    }
                    _Enum::RelatedArtifact(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueRelatedArtifact", ctx)));
                    }
                    _Enum::TriggerDefinition(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueTriggerDefinition", ctx)));
                    }
                    _Enum::UsageContext(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueUsageContext", ctx)));
                    }
                    _Enum::Availability(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueAvailability", ctx)));
                    }
                    _Enum::ExtendedContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueExtendedContactDetail", ctx)));
                    }
                    _Enum::Dosage(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueDosage", ctx)));
                    }
                    _Enum::Meta(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("defaultValueMeta", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#meaning_when_missing.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("meaningWhenMissing", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_meaningWhenMissing", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#meaning_when_missing.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("meaningWhenMissing", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#order_meaning.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("orderMeaning", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_orderMeaning", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#order_meaning.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("orderMeaning", ctx)));
        }
        {
            use fhirbolt_model::r5::types::ElementDefinitionFixed as _Enum;
            if let Some(some) = self.value.r#fixed.as_ref() {
                match some {
                    _Enum::Base64Binary(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedBase64Binary", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedBase64Binary", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedBase64Binary", ctx)));
                        }
                    }
                    _Enum::Boolean(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedBoolean", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedBoolean", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedBoolean", ctx)));
                        }
                    }
                    _Enum::Canonical(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedCanonical", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedCanonical", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedCanonical", ctx)));
                        }
                    }
                    _Enum::Code(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedCode", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedCode", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedCode", ctx)));
                        }
                    }
                    _Enum::Date(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedDate", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedDate", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedDate", ctx)));
                        }
                    }
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedDateTime", ctx)));
                        }
                    }
                    _Enum::Decimal(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| {
                                ...
                                tri!(state.serialize_entry("fixedDecimal", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedDecimal", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedDecimal", ctx)));
                        }
                    }
                    _Enum::Id(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedId", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedId", ctx)));
                            }
                        } else {
                            tri!(self
                                .with_context(value, |ctx| state.serialize_entry("fixedId", ctx)));
                        }
                    }
                    _Enum::Instant(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedInstant", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedInstant", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedInstant", ctx)));
                        }
                    }
                    _Enum::Integer(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedInteger", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedInteger", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedInteger", ctx)));
                        }
                    }
                    _Enum::Integer64(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| Ok(v.to_string())) {
                                tri!(state.serialize_entry("fixedInteger64", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedInteger64", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedInteger64", ctx)));
                        }
                    }
                    _Enum::Markdown(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedMarkdown", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedMarkdown", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedMarkdown", ctx)));
                        }
                    }
                    _Enum::Oid(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedOid", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedOid", ctx)));
                            }
                        } else {
                            tri!(self
                                .with_context(value, |ctx| state.serialize_entry("fixedOid", ctx)));
                        }
                    }
                    _Enum::PositiveInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedPositiveInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedPositiveInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedPositiveInt", ctx)));
                        }
                    }
                    _Enum::String(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedString", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedString", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedString", ctx)));
                        }
                    }
                    _Enum::Time(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedTime", ctx)));
                        }
                    }
                    _Enum::UnsignedInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedUnsignedInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedUnsignedInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedUnsignedInt", ctx)));
                        }
                    }
                    _Enum::Uri(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedUri", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedUri", ctx)));
                            }
                        } else {
                            tri!(self
                                .with_context(value, |ctx| state.serialize_entry("fixedUri", ctx)));
                        }
                    }
                    _Enum::Url(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedUrl", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedUrl", ctx)));
                            }
                        } else {
                            tri!(self
                                .with_context(value, |ctx| state.serialize_entry("fixedUrl", ctx)));
                        }
                    }
                    _Enum::Uuid(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("fixedUuid", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_fixedUuid", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("fixedUuid", ctx)));
                        }
                    }
                    _Enum::Address(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedAddress", ctx)));
                    }
                    _Enum::Age(ref value) => {
                        tri!(self.with_context(value, |ctx| state.serialize_entry("fixedAge", ctx)));
                    }
                    _Enum::Annotation(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedAnnotation", ctx)));
                    }
                    _Enum::Attachment(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedAttachment", ctx)));
                    }
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedCodeableConcept", ctx)));
                    }
                    _Enum::CodeableReference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedCodeableReference", ctx)));
                    }
                    _Enum::Coding(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedCoding", ctx)));
                    }
                    _Enum::ContactPoint(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedContactPoint", ctx)));
                    }
                    _Enum::Count(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedCount", ctx)));
                    }
                    _Enum::Distance(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedDistance", ctx)));
                    }
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedDuration", ctx)));
                    }
                    _Enum::HumanName(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedHumanName", ctx)));
                    }
                    _Enum::Identifier(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedIdentifier", ctx)));
                    }
                    _Enum::Money(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedMoney", ctx)));
                    }
                    _Enum::Period(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedPeriod", ctx)));
                    }
                    _Enum::Quantity(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedQuantity", ctx)));
                    }
                    _Enum::Range(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedRange", ctx)));
                    }
                    _Enum::Ratio(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedRatio", ctx)));
                    }
                    _Enum::RatioRange(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedRatioRange", ctx)));
                    }
                    _Enum::Reference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedReference", ctx)));
                    }
                    _Enum::SampledData(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedSampledData", ctx)));
                    }
                    _Enum::Signature(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedSignature", ctx)));
                    }
                    _Enum::Timing(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedTiming", ctx)));
                    }
                    _Enum::ContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedContactDetail", ctx)));
                    }
                    _Enum::DataRequirement(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedDataRequirement", ctx)));
                    }
                    _Enum::Expression(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedExpression", ctx)));
                    }
                    _Enum::ParameterDefinition(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedParameterDefinition", ctx)));
                    }
                    _Enum::RelatedArtifact(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedRelatedArtifact", ctx)));
                    }
                    _Enum::TriggerDefinition(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedTriggerDefinition", ctx)));
                    }
                    _Enum::UsageContext(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedUsageContext", ctx)));
                    }
                    _Enum::Availability(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedAvailability", ctx)));
                    }
                    _Enum::ExtendedContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("fixedExtendedContactDetail", ctx)));
                    }
                    _Enum::Dosage(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("fixedDosage", ctx)));
                    }
                    _Enum::Meta(ref value) => {
                        tri!(
        ...
        {
            use fhirbolt_model::r5::types::ElementDefinitionPattern as _Enum;
            if let Some(some) = self.value.r#pattern.as_ref() {
                match some {
                    _Enum::Base64Binary(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternBase64Binary", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternBase64Binary", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternBase64Binary", ctx)));
                        }
                    }
                    _Enum::Boolean(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternBoolean", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternBoolean", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternBoolean", ctx)));
                        }
                    }
                    _Enum::Canonical(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternCanonical", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternCanonical", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternCanonical", ctx)));
                        }
                    }
                    _Enum::Code(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternCode", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternCode", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternCode", ctx)));
                        }
                    }
                    _Enum::Date(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternDate", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternDate", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternDate", ctx)));
                        }
                    }
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternDateTime", ctx)));
                        }
                    }
                    _Enum::Decimal(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| {
                                ...
                                tri!(state.serialize_entry("patternDecimal", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternDecimal", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternDecimal", ctx)));
                        }
                    }
                    _Enum::Id(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternId", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternId", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternId", ctx)));
                        }
                    }
                    _Enum::Instant(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternInstant", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternInstant", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternInstant", ctx)));
                        }
                    }
                    _Enum::Integer(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternInteger", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternInteger", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternInteger", ctx)));
                        }
                    }
                    _Enum::Integer64(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| Ok(v.to_string())) {
                                tri!(state.serialize_entry("patternInteger64", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternInteger64", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternInteger64", ctx)));
                        }
                    }
                    _Enum::Markdown(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternMarkdown", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternMarkdown", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternMarkdown", ctx)));
                        }
                    }
                    _Enum::Oid(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternOid", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternOid", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternOid", ctx)));
                        }
                    }
                    _Enum::PositiveInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternPositiveInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternPositiveInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternPositiveInt", ctx)));
                        }
                    }
                    _Enum::String(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternString", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternString", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternString", ctx)));
                        }
                    }
                    _Enum::Time(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternTime", ctx)));
                        }
                    }
                    _Enum::UnsignedInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternUnsignedInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternUnsignedInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternUnsignedInt", ctx)));
                        }
                    }
                    _Enum::Uri(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternUri", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternUri", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternUri", ctx)));
                        }
                    }
                    _Enum::Url(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternUrl", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternUrl", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternUrl", ctx)));
                        }
                    }
                    _Enum::Uuid(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("patternUuid", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_patternUuid", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("patternUuid", ctx)));
                        }
                    }
                    _Enum::Address(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternAddress", ctx)));
                    }
                    _Enum::Age(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("patternAge", ctx)));
                    }
                    _Enum::Annotation(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternAnnotation", ctx)));
                    }
                    _Enum::Attachment(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternAttachment", ctx)));
                    }
                    _Enum::CodeableConcept(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternCodeableConcept", ctx)));
                    }
                    _Enum::CodeableReference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternCodeableReference", ctx)));
                    }
                    _Enum::Coding(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternCoding", ctx)));
                    }
                    _Enum::ContactPoint(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternContactPoint", ctx)));
                    }
                    _Enum::Count(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("patternCount", ctx)));
                    }
                    _Enum::Distance(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternDistance", ctx)));
                    }
                    _Enum::Duration(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternDuration", ctx)));
                    }
                    _Enum::HumanName(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternHumanName", ctx)));
                    }
                    _Enum::Identifier(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternIdentifier", ctx)));
                    }
                    _Enum::Money(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("patternMoney", ctx)));
                    }
                    _Enum::Period(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternPeriod", ctx)));
                    }
                    _Enum::Quantity(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternQuantity", ctx)));
                    }
                    _Enum::Range(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("patternRange", ctx)));
                    }
                    _Enum::Ratio(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("patternRatio", ctx)));
                    }
                    _Enum::RatioRange(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternRatioRange", ctx)));
                    }
                    _Enum::Reference(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternReference", ctx)));
                    }
                    _Enum::SampledData(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternSampledData", ctx)));
                    }
                    _Enum::Signature(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternSignature", ctx)));
                    }
                    _Enum::Timing(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternTiming", ctx)));
                    }
                    _Enum::ContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternContactDetail", ctx)));
                    }
                    _Enum::DataRequirement(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternDataRequirement", ctx)));
                    }
                    _Enum::Expression(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternExpression", ctx)));
                    }
                    _Enum::ParameterDefinition(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternParameterDefinition", ctx)));
                    }
                    _Enum::RelatedArtifact(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternRelatedArtifact", ctx)));
                    }
                    _Enum::TriggerDefinition(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternTriggerDefinition", ctx)));
                    }
                    _Enum::UsageContext(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternUsageContext", ctx)));
                    }
                    _Enum::Availability(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternAvailability", ctx)));
                    }
                    _Enum::ExtendedContactDetail(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternExtendedContactDetail", ctx)));
                    }
                    _Enum::Dosage(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("patternDosage", ctx)));
                    }
                    _Enum::Meta(ref value) => {
                        tri!(self
                            .with_context(value, |ctx| state.serialize_entry("patternMeta", ctx)));
                    }
        ...
        if !self.value.r#example.is_empty() {
            tri!(self.with_context(&self.value.r#example, |ctx| state
                .serialize_entry("example", ctx)));
        }
        {
            use fhirbolt_model::r5::types::ElementDefinitionMinValue as _Enum;
            if let Some(some) = self.value.r#min_value.as_ref() {
                match some {
                    _Enum::Date(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValueDate", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueDate", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueDate", ctx)));
                        }
                    }
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValueDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueDateTime", ctx)));
                        }
                    }
                    _Enum::Instant(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValueInstant", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueInstant", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueInstant", ctx)));
                        }
                    }
                    _Enum::Time(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValueTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueTime", ctx)));
                        }
                    }
                    _Enum::Decimal(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| {
                                ...
                                tri!(state.serialize_entry("minValueDecimal", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueDecimal", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueDecimal", ctx)));
                        }
                    }
                    _Enum::Integer(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValueInteger", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueInteger", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueInteger", ctx)));
                        }
                    }
                    _Enum::Integer64(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| Ok(v.to_string())) {
                                tri!(state.serialize_entry("minValueInteger64", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueInteger64", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueInteger64", ctx)));
                        }
                    }
                    _Enum::PositiveInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValuePositiveInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValuePositiveInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValuePositiveInt", ctx)));
                        }
                    }
                    _Enum::UnsignedInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("minValueUnsignedInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_minValueUnsignedInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("minValueUnsignedInt", ctx)));
                        }
                    }
                    _Enum::Quantity(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("minValueQuantity", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        {
            use fhirbolt_model::r5::types::ElementDefinitionMaxValue as _Enum;
            if let Some(some) = self.value.r#max_value.as_ref() {
                match some {
                    _Enum::Date(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValueDate", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueDate", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueDate", ctx)));
                        }
                    }
                    _Enum::DateTime(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValueDateTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueDateTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueDateTime", ctx)));
                        }
                    }
                    _Enum::Instant(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValueInstant", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueInstant", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueInstant", ctx)));
                        }
                    }
                    _Enum::Time(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValueTime", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueTime", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueTime", ctx)));
                        }
                    }
                    _Enum::Decimal(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| {
                                ...
                                tri!(state.serialize_entry("maxValueDecimal", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueDecimal", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueDecimal", ctx)));
                        }
                    }
                    _Enum::Integer(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValueInteger", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueInteger", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueInteger", ctx)));
                        }
                    }
                    _Enum::Integer64(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(|v| Ok(v.to_string())) {
                                tri!(state.serialize_entry("maxValueInteger64", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueInteger64", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueInteger64", ctx)));
                        }
                    }
                    _Enum::PositiveInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValuePositiveInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValuePositiveInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValuePositiveInt", ctx)));
                        }
                    }
                    _Enum::UnsignedInt(ref value) => {
                        if self.output == crate::context::Format::Json {
                            if let Some(some) = value.value.as_ref().map(Ok) {
                                tri!(state.serialize_entry("maxValueUnsignedInt", &some?));
                            }
                            if value.id.is_some() || !value.extension.is_empty() {
                                use super::super::serde_helpers::PrimitiveElement;
                                let primitive_element = PrimitiveElement {
                                ...
                                tri!(self.with_context(&primitive_element, |ctx| state
                                    .serialize_entry("_maxValueUnsignedInt", ctx)));
                            }
                        } else {
                            tri!(self.with_context(value, |ctx| state
                                .serialize_entry("maxValueUnsignedInt", ctx)));
                        }
                    }
                    _Enum::Quantity(ref value) => {
                        tri!(self.with_context(value, |ctx| state
                            .serialize_entry("maxValueQuantity", ctx)));
                    }
                    _Enum::Invalid => {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#max_length.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("maxLength", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_maxLength", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#max_length.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("maxLength", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#condition.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("condition", &values));
                }
                let requires_elements = self
                    .value
                    .r#condition
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_condition", ctx)));
                }
            }
        ...
        if !self.value.r#constraint.is_empty() {
            tri!(self.with_context(&self.value.r#constraint, |ctx| state
                .serialize_entry("constraint", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#must_have_value.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("mustHaveValue", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_mustHaveValue", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#must_have_value.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("mustHaveValue", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if !self.value.r#value_alternatives.is_empty() {
                let values = tri!(self
                    ...
                    .collect::<Result<Vec<_>, _>>());
                if values.iter().any(|v| v.is_some()) {
                    tri!(state.serialize_entry("valueAlternatives", &values));
                }
                let requires_elements = self
                    .value
                    .r#value_alternatives
                ...
                if requires_elements {
                    ...
                    let primitive_elements: Vec<_> = self
                        ...
                        .collect();
                    tri!(self.with_context(&primitive_elements, |ctx| state
                        .serialize_entry("_valueAlternatives", ctx)));
                }
            }
        } else if !self.value.r#value_alternatives.is_empty() {
            tri!(
                self.with_context(&self.value.r#value_alternatives, |ctx| state
                    .serialize_entry("valueAlternatives", ctx))
            );
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#must_support.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("mustSupport", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
            ...
            tri!(self.with_context(some, |ctx| state.serialize_entry("mustSupport", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#is_modifier.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("isModifier", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_isModifier", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#is_modifier.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("isModifier", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#is_modifier_reason.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("isModifierReason", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_isModifierReason", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#is_modifier_reason.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("isModifierReason", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#is_summary.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("isSummary", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_isSummary", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#is_summary.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("isSummary", ctx)));
        }
        if let Some(some) = self.value.r#binding.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("binding", ctx)));
        }
        if !self.value.r#mapping.is_empty() {
            tri!(self.with_context(&self.value.r#mapping, |ctx| state
                .serialize_entry("mapping", ctx)));
        }
        state.end()
    }
}
                ...
                while let Some(map_access_key) = tri!(map_access.next_key()) {
                    match map_access_key {
                        ...
                        Field::Slicing => {
                            ...
                            > = self.0.transmute();
                            r#slicing = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Short => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#short = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Base => {
                            ...
                            > = self.0.transmute();
                            r#base = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        ...
                        Field::DefaultValueBase64Binary => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Base64Binary,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Base64Binary(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueBoolean => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Boolean(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Canonical,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Canonical(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueCode => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Code,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Code(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueDate => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Date,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Date(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::DateTime,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueDecimal => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Decimal,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Decimal(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueId => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Id,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Id(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueInstant => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Instant,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Instant(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueInteger => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Integer(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                let r#enum = r#default_value
                                    .get_or_insert(_Enum::Integer64(Default::default()));
                                if let _Enum::Integer64(variant) = r#enum {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "defaultValueInteger64",
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Integer64(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueMarkdown => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Markdown,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Markdown(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueOid => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Oid,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Oid(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValuePositiveInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::PositiveInt,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::PositiveInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueString => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::String(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Time,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Time(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueUnsignedInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::UnsignedInt,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::UnsignedInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueUri => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Uri,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Uri(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueUrl => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Url,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Url(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueUuid => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Uuid,
                                > = self.0.transmute();
                                r#default_value = Some(_Enum::Uuid(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::DefaultValueAddress => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Address>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Address(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        ...
                        Field::DefaultValueAnnotation => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Annotation>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Annotation(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueAttachment => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Attachment>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Attachment(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueCodeableConcept => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::CodeableConcept(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueCodeableReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableReference>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::CodeableReference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueCoding => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Coding>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Coding(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueContactPoint => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ContactPoint>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::ContactPoint(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueCount => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Count>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Count(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueDistance => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Distance>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Distance(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueDuration => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Duration>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Duration(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueHumanName => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::HumanName>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::HumanName(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueIdentifier => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Identifier>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Identifier(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueMoney => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Money>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Money(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValuePeriod => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Period>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Period(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueQuantity => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Quantity>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Quantity(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueRange => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Range>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Range(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueRatio => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Ratio>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Ratio(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueRatioRange => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::RatioRange>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::RatioRange(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Reference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueSampledData => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::SampledData>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::SampledData(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueSignature => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Signature>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Signature(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueTiming => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Timing>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Timing(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ContactDetail>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::ContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueDataRequirement => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::DataRequirement>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::DataRequirement(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueExpression => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Expression>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Expression(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueParameterDefinition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ParameterDefinition>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::ParameterDefinition(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueRelatedArtifact => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::RelatedArtifact>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::RelatedArtifact(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueTriggerDefinition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::TriggerDefinition>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::TriggerDefinition(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueUsageContext => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::UsageContext>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::UsageContext(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueAvailability => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Availability>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Availability(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueExtendedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ExtendedContactDetail>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::ExtendedContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueDosage => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Dosage>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Dosage(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::DefaultValueMeta => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Meta>,
                            > = self.0.transmute();
                            r#default_value = Some(_Enum::Meta(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        ...
                        Field::FixedBase64Binary => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Base64Binary,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Base64Binary(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedBoolean => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Boolean(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Canonical,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Canonical(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::DateTime,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedDecimal => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Decimal,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Decimal(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedInstant => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Instant,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Instant(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedInteger => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Integer(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                let r#enum =
                                    r#fixed.get_or_insert(_Enum::Integer64(Default::default()));
                                if let _Enum::Integer64(variant) = r#enum {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "fixedInteger64",
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Integer64(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedMarkdown => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Markdown,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::Markdown(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedPositiveInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::PositiveInt,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::PositiveInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedUnsignedInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::UnsignedInt,
                                > = self.0.transmute();
                                r#fixed = Some(_Enum::UnsignedInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::FixedAddress => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Address>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Address(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedAge => {
                        ...
                        Field::FixedAnnotation => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Annotation>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Annotation(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedAttachment => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Attachment>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Attachment(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedCodeableConcept => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::CodeableConcept(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedCodeableReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableReference>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::CodeableReference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedCoding => {
                        ...
                        Field::FixedContactPoint => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ContactPoint>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::ContactPoint(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedCount => {
                        ...
                        Field::FixedDistance => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Distance>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Distance(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedDuration => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Duration>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Duration(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedHumanName => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::HumanName>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::HumanName(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedIdentifier => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Identifier>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Identifier(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedMoney => {
                        ...
                        Field::FixedQuantity => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Quantity>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Quantity(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedRange => {
                        ...
                        Field::FixedRatioRange => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::RatioRange>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::RatioRange(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Reference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedSampledData => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::SampledData>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::SampledData(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedSignature => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Signature>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Signature(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedTiming => {
                        ...
                        Field::FixedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ContactDetail>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::ContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedDataRequirement => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::DataRequirement>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::DataRequirement(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedExpression => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Expression>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Expression(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedParameterDefinition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ParameterDefinition>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::ParameterDefinition(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedRelatedArtifact => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::RelatedArtifact>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::RelatedArtifact(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedTriggerDefinition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::TriggerDefinition>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::TriggerDefinition(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedUsageContext => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::UsageContext>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::UsageContext(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedAvailability => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Availability>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::Availability(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedExtendedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ExtendedContactDetail>,
                            > = self.0.transmute();
                            r#fixed = Some(_Enum::ExtendedContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::FixedDosage => {
                        ...
                        Field::PatternBase64Binary => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Base64Binary,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Base64Binary(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternBoolean => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Boolean,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Boolean(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternCanonical => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Canonical,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Canonical(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::DateTime,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternDecimal => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Decimal,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Decimal(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternInstant => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Instant,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Instant(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternInteger => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Integer(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                let r#enum =
                                    r#pattern.get_or_insert(_Enum::Integer64(Default::default()));
                                if let _Enum::Integer64(variant) = r#enum {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "patternInteger64",
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Integer64(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternMarkdown => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Markdown,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::Markdown(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternPositiveInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::PositiveInt,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::PositiveInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternString => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::String,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::String(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternUnsignedInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::UnsignedInt,
                                > = self.0.transmute();
                                r#pattern = Some(_Enum::UnsignedInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::PatternAddress => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Address>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Address(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternAge => {
                        ...
                        Field::PatternAnnotation => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Annotation>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Annotation(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternAttachment => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Attachment>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Attachment(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternCodeableConcept => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableConcept>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::CodeableConcept(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternCodeableReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::CodeableReference>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::CodeableReference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternCoding => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Coding>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Coding(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternContactPoint => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ContactPoint>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::ContactPoint(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternCount => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Count>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Count(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternDistance => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Distance>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Distance(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternDuration => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Duration>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Duration(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternHumanName => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::HumanName>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::HumanName(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternIdentifier => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Identifier>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Identifier(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternMoney => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Money>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Money(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternPeriod => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Period>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Period(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternQuantity => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Quantity>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Quantity(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternRange => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Range>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Range(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternRatio => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Ratio>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Ratio(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternRatioRange => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::RatioRange>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::RatioRange(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternReference => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Reference>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Reference(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternSampledData => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::SampledData>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::SampledData(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternSignature => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Signature>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Signature(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternTiming => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Timing>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Timing(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ContactDetail>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::ContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternDataRequirement => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::DataRequirement>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::DataRequirement(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternExpression => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Expression>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Expression(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternParameterDefinition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ParameterDefinition>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::ParameterDefinition(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternRelatedArtifact => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::RelatedArtifact>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::RelatedArtifact(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternTriggerDefinition => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::TriggerDefinition>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::TriggerDefinition(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternUsageContext => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::UsageContext>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::UsageContext(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternAvailability => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Availability>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Availability(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternExtendedContactDetail => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::ExtendedContactDetail>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::ExtendedContactDetail(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternDosage => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Dosage>,
                            > = self.0.transmute();
                            r#pattern = Some(_Enum::Dosage(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::PatternMeta => {
                        ...
                        Field::Example => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::types::ElementDefinitionExample>,
                                > = self.0.transmute();
                                r#example = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
                        ...
                        Field::MinValueDate => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Date,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Date(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::DateTime,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueInstant => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Instant,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Instant(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Time,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Time(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueDecimal => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Decimal,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Decimal(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueInteger => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Integer(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                let r#enum =
                                    r#min_value.get_or_insert(_Enum::Integer64(Default::default()));
                                if let _Enum::Integer64(variant) = r#enum {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "minValueInteger64",
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::Integer64(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValuePositiveInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::PositiveInt,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::PositiveInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueUnsignedInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::UnsignedInt,
                                > = self.0.transmute();
                                r#min_value = Some(_Enum::UnsignedInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MinValueQuantity => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Quantity>,
                            > = self.0.transmute();
                            r#min_value = Some(_Enum::Quantity(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::MaxValueDate => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Date,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Date(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueDateTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::DateTime,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::DateTime(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueInstant => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Instant,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Instant(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueTime => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Time,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Time(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueDecimal => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Decimal,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Decimal(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueInteger => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Integer(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueInteger64 => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                let r#enum =
                                    r#max_value.get_or_insert(_Enum::Integer64(Default::default()));
                                if let _Enum::Integer64(variant) = r#enum {
                                    if variant.value.is_some() {
                                        return Err(serde::de::Error::duplicate_field(
                                            "maxValueInteger64",
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::Integer64,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::Integer64(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValuePositiveInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::PositiveInt,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::PositiveInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueUnsignedInt => {
                            ...
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    fhirbolt_model::r5::types::UnsignedInt,
                                > = self.0.transmute();
                                r#max_value = Some(_Enum::UnsignedInt(tri!(
                                    map_access.next_value_seed(&mut *_context)
                                )));
                            }
                        }
                        ...
                        Field::MaxValueQuantity => {
                            ...
                            let _context: &mut DeserializationContext<
                                Box<fhirbolt_model::r5::types::Quantity>,
                            > = self.0.transmute();
                            r#max_value = Some(_Enum::Quantity(tri!(
                                map_access.next_value_seed(&mut *_context)
                            )));
                        }
                        Field::MaxLength => {
                        ...
                        Field::Binding => {
                            ...
                            > = self.0.transmute();
                            r#binding = Some(tri!(map_access.next_value_seed(&mut *_context)));
                        }
                        Field::Mapping => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                let _context: &mut DeserializationContext<
                                    Vec<fhirbolt_model::r5::types::ElementDefinitionMapping>,
                                > = self.0.transmute();
                                r#mapping = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            } else {
