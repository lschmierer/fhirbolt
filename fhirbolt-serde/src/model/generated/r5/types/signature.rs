...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&fhirbolt_model::r5::types::Signature>
{
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.output_json {
            ...
            if let Some(some) = self.value.r#when.as_ref() {
                self.with_context(some, |ctx| state.serialize_entry("when", ctx))?;
            }
        }
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Box<fhirbolt_model::r5::types::Signature>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<fhirbolt_model::r5::types::Signature>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl serde::ser::Serialize
    for crate::context::ser::SerializationContext<&Vec<Box<fhirbolt_model::r5::types::Signature>>>
{
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<fhirbolt_model::r5::types::Signature>
{
    type Value = fhirbolt_model::r5::types::Signature;
        ...
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
            ...
            fn visit_map<V>(
                self,
                mut map_access: V,
            ) -> Result<fhirbolt_model::r5::types::Signature, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut r#type: Option<Vec<Box<fhirbolt_model::r5::types::Coding>>> = None;
                let mut r#when: Option<fhirbolt_model::r5::types::Instant> = None;
                ...
                let mut r#target_format: Option<fhirbolt_model::r5::types::Code> = None;
                let mut r#sig_format: Option<fhirbolt_model::r5::types::Code> = None;
                    ...
                    match map_access_key {
                        ...
                        Field::Type => {
                            if self.0.from_json {
                                ...
                                r#type = Some (map_access . next_value_seed (self . 0 . transmute :: < Vec < Box < fhirbolt_model :: r5 :: types :: Coding > >> ()) ?) ;
                            } else {
                ...
                Ok(fhirbolt_model::r5::types::Signature {
                    r#id,
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Box<fhirbolt_model::r5::types::Signature>>
{
    type Value = Box<fhirbolt_model::r5::types::Signature>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        self.transmute::<fhirbolt_model::r5::types::Signature>()
            .deserialize(deserializer)
            .map(Box::new)
    }
}
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<Vec<fhirbolt_model::r5::types::Signature>>
{
    type Value = Vec<fhirbolt_model::r5::types::Signature>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor<'_> {
                ...
                A: serde::de::SeqAccess<'de>,
            {
                ...
                while let Some(value) = seq
                    .next_element_seed(self.0.transmute::<fhirbolt_model::r5::types::Signature>())?
                {
                    values.push(value);
                }
                Ok(values)
...
impl<'de> serde::de::DeserializeSeed<'de>
    for &mut crate::context::de::DeserializationContext<
        Vec<Box<fhirbolt_model::r5::types::Signature>>,
    >
{
    type Value = Vec<Box<fhirbolt_model::r5::types::Signature>>;
    fn deserialize<D>(self, deserializer: D) -> Result<Self::Value, D::Error>
    where
        D: serde::de::Deserializer<'de>,
    {
