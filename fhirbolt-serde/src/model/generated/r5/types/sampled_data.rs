        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#interval.as_ref() {
                if let Some(some) = some.value.as_ref().map(|v| {
                    ...
                    tri!(state.serialize_entry("interval", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_interval", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#interval.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("interval", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#interval_unit.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("intervalUnit", &some?));
            }
                ...
                || !self.value.r#interval_unit.extension.is_empty()
            {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_intervalUnit", ctx)));
            }
        } else if self.value.r#interval_unit.id.as_deref() == Some("$invalid") {
            return missing_field_error("intervalUnit");
        } else {
            tri!(self.with_context(&self.value.r#interval_unit, |ctx| state
                .serialize_entry("intervalUnit", ctx)));
        }
        if self.output == crate::context::Format::Json {
        ...
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#lower_limit.as_ref() {
                if let Some(some) = some.value.as_ref().map(|v| {
                    ...
                    tri!(state.serialize_entry("lowerLimit", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_lowerLimit", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#lower_limit.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("lowerLimit", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#upper_limit.as_ref() {
                if let Some(some) = some.value.as_ref().map(|v| {
                    ...
                    tri!(state.serialize_entry("upperLimit", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_upperLimit", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#upper_limit.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("upperLimit", ctx)));
        }
        if self.output == crate::context::Format::Json {
            ...
            if let Some(some) = self.value.r#dimensions.value.as_ref().map(Ok) {
                tri!(state.serialize_entry("dimensions", &some?));
            }
            if self.value.r#dimensions.id.is_some() || !self.value.r#dimensions.extension.is_empty()
            {
                ...
                tri!(self.with_context(&primitive_element, |ctx| state
                    .serialize_entry("_dimensions", ctx)));
            }
        } else if self.value.r#dimensions.id.as_deref() == Some("$invalid") {
            return missing_field_error("dimensions");
        } else {
            tri!(self.with_context(&self.value.r#dimensions, |ctx| state
                .serialize_entry("dimensions", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#code_map.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("codeMap", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_codeMap", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#code_map.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("codeMap", ctx)));
        }
        if self.output == crate::context::Format::Json {
            if let Some(some) = self.value.r#offsets.as_ref() {
                if let Some(some) = some.value.as_ref().map(Ok) {
                    tri!(state.serialize_entry("offsets", &some?));
                }
                if some.id.is_some() || !some.extension.is_empty() {
                    use super::super::serde_helpers::PrimitiveElement;
                    let primitive_element = PrimitiveElement {
                    ...
                    tri!(self.with_context(&primitive_element, |ctx| state
                        .serialize_entry("_offsets", ctx)));
                }
            }
        } else if let Some(some) = self.value.r#offsets.as_ref() {
            tri!(self.with_context(some, |ctx| state.serialize_entry("offsets", ctx)));
        }
        if self.output == crate::context::Format::Json {
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match map_access_key {
                        ...
                        Field::Interval => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#interval = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::CodeMap => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#code_map = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                        ...
                        Field::Offsets => {
                            if self.0.from == crate::context::Format::Json {
                                ...
                                > = self.0.transmute();
                                r#offsets = Some(tri!(map_access.next_value_seed(&mut *_context)));
                            }
                        }
                ...
                Ok(SampledData {
                    ...
                    r#origin: if self.0.config.mode == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#origin.ok_or(serde::de::Error::missing_field("origin")))
                    },
                    r#interval,
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#interval_unit.ok_or(serde::de::Error::missing_field("intervalUnit")))
                    },
                    r#factor,
                    r#lower_limit,
                    r#upper_limit,
                        ...
                        == crate::context::de::DeserializationMode::Lax
                    {
                        ...
                        tri!(r#dimensions.ok_or(serde::de::Error::missing_field("dimensions")))
                    },
                    r#code_map,
                    r#offsets,
                    r#data,
